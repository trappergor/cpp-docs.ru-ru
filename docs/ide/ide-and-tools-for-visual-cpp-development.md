...
|||
|-|-|
|[Написание и рефакторинг кода (C++)](writing-and-refactoring-code-cpp.md)| Сведения об использовании редактора кода C++ для написания кода, рефакторинга и перемещения по коду.|
...
|[Проекты "Открыть папку" в Visual Studio](non-msbuild-projects.md)|Описывается использование любой произвольный системы сборки C++ из Visual Studio.|
|[Проекты CMake в Visual C++](cmake-tools-for-visual-cpp.md)|Описывается создание проектов CMake в Visual Studio.|
...
|[Добавление функциональных возможностей с помощью мастеров кода (C++)](adding-functionality-with-code-wizards-cpp.md)| Добавление в проект классов, файлов и элементов пользовательского интерфейса с помощью мастеров.|
|[Документация XML (Visual C++)](xml-documentation-visual-cpp.md)| Создание документации в формате XML для интерфейсов API.|
|[Сборка проектов C++ в Visual Studio](building-cpp-projects-in-visual-studio.md)|Сведения об использовании среды IDE Visual Studio для сборки проектов.|

## <a name="related-articles"></a>Связанные статьи

|||
|-|-|
|[Сборка программ C/C++](../build/building-c-cpp-programs.md)|Подробные сведения о сборке проектов C++.|
