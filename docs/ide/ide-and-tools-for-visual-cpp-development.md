...
Развертывание приложения UWP для клиентов через магазин Microsoft через **проекта** > **хранилища** пункт меню. Развертывание CRT обрабатывается автоматически в фоновом режиме. Дополнительные сведения см. в разделе [Продажа приложений](http://go.microsoft.com/fwlink/p/?LinkId=262280).
