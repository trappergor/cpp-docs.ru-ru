...
3.  В контекстном меню выберите команду **Добавить**, а затем — **Добавить метод**.  
  
4.  В мастере добавления метода укажите сведения для создания метода.  
  
5.  Задайте параметры IDL для этого метода на странице [Атрибуты IDL](../ide/idl-attributes-add-method-wizard.md) мастера.  
