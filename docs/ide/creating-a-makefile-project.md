---
title: Создание проекта Makefile на C++
ms.date: 10/19/2018
f1_keywords:
...
- **Visual Studio 2017 и более поздних версий**: используйте функцию **Открыть папку**, чтобы открыть проект makefile, не преобразуя его в MSBuild. Дополнительные сведения см. в статье [Open Folder projects in Visual C++](non-msbuild-projects.md) (Открытие папки проектов в Visual C++).
