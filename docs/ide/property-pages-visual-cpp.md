...
С помощью страниц свойств можно задать параметры для проектов Visual Studio. Чтобы открыть **страницы свойств** диалоговое окно Visual Studio проект на **проекта** меню, нажмите кнопку **свойства**.  
...
> [!TIP]
>  Чтобы просмотреть окончательный набор значений свойств, используемых для построения проекта MSBuild, проверьте файл выходные данные препроцессора, который можно создавать с помощью командной строки: **MSBuild / предварительной обработки:***preprocessor_output_ Имя файла*необ*имя_файла_проекта*необязательно  
...
> [!TIP]
>  Чтобы обновить **страницы свойств** диалоговое окно, чтобы он отображал последние выбранные значения, щелкните **применить**.  
...
## <a name="see-also"></a>См. также  
 [Как: Создание и удаление зависимостей проекта](/visualstudio/ide/how-to-create-and-remove-project-dependencies)   
