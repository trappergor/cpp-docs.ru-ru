...
![Выделенный макрос](../ide/media/hint-squiggle-and-actions.png "Выделение волнистой линией и быстрые действия")
...
![Параметр "Макросы в пропущенных областях просмотра"](../ide/media/skipped-regions-squiggle-option.png "Вариант подчеркивания пропущенных областей волнистой линией")
