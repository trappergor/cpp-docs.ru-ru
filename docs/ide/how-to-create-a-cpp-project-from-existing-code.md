---
title: Как выполнить Создание проекта C++ из существующего кода
ms.date: 01/15/2019
helpviewer_keywords:
...
ms.locfileid: "54397346"
---
# <a name="how-to-create-a-c-project-from-existing-code"></a>Как выполнить Создание проекта C++ из существующего кода
