...
#### [Настраиваемый мастер](custom-wizard.md)
##### [Параметры приложения, настраиваемый мастер](application-settings-custom-wizard.md)
### [Разработка мастера](designing-a-wizard.md)
#### [Этапы разработки мастера](steps-to-designing-a-wizard.md)
##### [Изучение базового проекта мастера](examining-the-basic-wizard-project.md)
##### [Изучение принципов работы мастера](examining-the-mechanics-of-a-wizard.md)
...
###### [Файл Templates.inf](templates-inf-file.md)
...
##### [Обработка ошибок в HTML-файлах мастеров](error-handling-in-wizard-html-files.md)
