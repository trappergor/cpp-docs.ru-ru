...
#### [Практическое руководство. Использование IntelliSense для проектов Makefile](how-to-enable-intellisense-for-makefile-projects.md)
...
## [Пошаговое руководство. Компиляция программы на C++ для среды CLR в Visual Studio](walkthrough-compiling-a-cpp-program-that-targets-the-clr-in-visual-studio.md)
