---
title: Добавление функции-члена (Visual C++) | Документы Майкрософт
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-ide
...
### <a name="to-add-a-member-function-to-a-class"></a>Добавление функции-члена в класс  
...
3.  Укажите необходимые сведения о функции-члене. Дополнительные сведения см. в разделе [Мастер добавления функции-члена](../ide/add-member-function-wizard.md).  
