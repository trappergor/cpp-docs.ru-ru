...
Некоторые символы пропускаются автоматически, чтобы еще больше сократить список результатов. Например, обращаясь к членам объекта класса за пределами класса, вы не сможете просмотреть закрытые члены по умолчанию или защищенные члены (если вы не находитесь в контексте дочернего класса). Вы можете настроить фильтрацию с помощью кнопок в нижней части.

Выбрав нужный символ из раскрывающегося списка, вы можете выполнить автозаполнение с помощью клавиш (**TAB**или **ВВОД**) либо используя один из других символов фиксации по умолчанию ({}[]().,:;+-*/%&|^!=?@#\)). Чтобы добавить или удалить символы из этого списка, выполните поиск по слову IntelliSense в поле **быстрого запуска** (CTRL+Q) и последовательно выберите **Текстовый редактор > C/C++ > Дополнительно**. Параметр **Символы фиксации списка членов** позволяет настроить список, внеся необходимые изменения.
...
![IntelliCode в С++](../ide/media/intellicode-cpp.png "IntelliCode в С++")
...
![Прогнозный IntelliSense в С++](../ide/media/predictive-intellisense-cpp.png "Прогнозный IntelliSense")
...
![Шаблон IntelliSense с отображением существующих экземпляров в С++](../ide/media/template-intellisense-cpp-1.png "Шаблон IntelliSense с отображением существующих экземпляров")
...
![Шаблон IntelliSense в С++](../ide/media/template-intellisense-cpp-3.png "Шаблон IntelliSense")
...
![Шаблон IntelliSense со списком результатов в С++](../ide/media/template-intellisense-cpp-2.png "Шаблон IntelliSense со списком результатов IntelliSense")

В окне в нижней части редактора отображаются расположение и аргументы каждого экземпляра.

![Шаблон IntelliSense с отображением схемы экземпляров в С++](../ide/media/template-intellisense-cpp-4.png "Шаблон IntelliSense с отображением схемы экземпляров")
...
![Быстрое исправление в С++](../ide/media/quick-fix-for-header-cpp.png "Быстрое исправление в С++")
...
![Быстрое исправление в С++](../ide/media/quick-fix.png "Быстрое исправление в С++")
...
![Отслеживание изменений в С++](../ide/media/change-tracking-cpp.png "Отслеживание изменений")
...
![Раскрывающийся список для вставки фрагментов в C++](../ide/media/vs2015_cpp_surround_with.png "vs2015_cpp_surround_with")
...
![ClangFormat для C++](../ide/media/clang-format-cpp.png "ClangFormat")
...
![Поле быстрого запуска в Visual Studio](../ide/media/vs2015_cpp_quick_launch.png "Поле быстрого запуска")
