---
title: "Страницы свойств MIDL: &quot;Выходные данные&quot; | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
---
# Страницы свойств MIDL: &quot;Выходные данные&quot;
[!INCLUDE[vs2017banner](../assembler/inline/includes/vs2017banner.md)]

На странице свойств **Выходные данные** в папке **MIDL** задаются следующие параметры компилятора MIDL:  
...
-   Библиотека типов \([\/tlb](http://msdn.microsoft.com/library/windows/desktop/aa367372)\)  
 ...
 Сведения о том, как получить доступ к странице свойств **Выходные данные** в папке **MIDL**, см. в разделе [Практическое руководство. Задание свойств проекта при помощи страниц свойств](../Topic/How%20to:%20Specify%20Project%20Properties%20with%20Property%20Pages.md).  
