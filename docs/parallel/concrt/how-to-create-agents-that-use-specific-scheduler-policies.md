...
Простой пример, использующий пользовательский планировщик политики вместе с асинхронные блоки сообщений, см. в разделе [как: Задание определенных политик планировщика](../../parallel/concrt/how-to-specify-specific-scheduler-policies.md).
