...
|[Примеры приложений среда выполнения Windows](https://docs.microsoft.com/samples/browse/?languages=cpp&expanded=windows&products=windows-uwp)|Содержит загружаемые примеры кода и демонстрационные приложения для среда выполнения Windows.|
