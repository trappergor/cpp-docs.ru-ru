...
|[Пошаговое руководство. Подключение с использованием задач и HTTP-запросов XML](../../parallel/concrt/walkthrough-connecting-using-tasks-and-xml-http-requests.md)|Показывает, как объединять задачи PPL с `IXMLHTTPRequest2` интерфейсами и `IXMLHTTPRequest2Callback` для отправки запросов HTTP GET и POST к веб-службе в приложении UWP.|
...
|[Планирование групп](../../parallel/concrt/schedule-groups.md)<br /><br /> [Практическое руководство. Использование групп планирования для определения порядка выполнения](../../parallel/concrt/how-to-use-schedule-groups-to-influence-order-of-execution.md)|Демонстрирует использование групп планирования для группировки связанных задач. Например, вам может потребоваться высокая локальность связанных задач, если эти задачи лучше выполнять в одном узле процессора.|
