...
1. В файле *PCH. h* (*stdafx. h* в Visual Studio 2017 и более ранних версиях) `#include` добавьте следующую директиву:
...
1. В файле *PCH. h* (*stdafx. h* в Visual Studio 2017 и более ранних версиях) `#include` добавьте следующие директивы:
