...
|[Id](#id)|Возвращает идентификатор для текущего контекста, уникальный в пределах планировщик, к которой принадлежит текущий контекст.|  
...
|[Unblock](#unblock)|Разблокирует контекст и приводит к запуску.|  
...
##  <a name="oversubscribe">Использовать превышение лимита подписки</a> 
