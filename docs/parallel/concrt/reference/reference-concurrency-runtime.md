---
title: "Справочные материалы (среда выполнения с параллелизмом) | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
Этот раздел содержит справочную информацию для среды выполнения с параллелизмом.  
  
> [!NOTE]
>  В стандарте языка C\+\+ использование идентификаторов, начинающихся с символа подчеркивания \(`_`\), зарезервировано для таких реализаций, как библиотеки.  Не используйте такие имена в своем коде.  Поведение элементов кода, имена которых следуют этому соглашению, не гарантируется и может измениться в будущих версиях.  По этой причине такие элементы кода на включены в документацию среды выполнения с параллелизмом.  
  
## В этом подразделе  
 [Пространство имен concurrency](../../../parallel/concrt/reference/concurrency-namespace.md)  
 Пространство имен `concurrency` содержит классы и функции, предоставляющие доступ к среде выполнения с параллелизмом, которая является платформой параллельного программирования для C\+\+.  Для получения дополнительной информации см. [Среда выполнения с параллелизмом](../../../parallel/concrt/concurrency-runtime.md).  
