...
|Имя|Описание|  
|----------|-----------------|  
|[Метод IThreadProxy::GetId](#getid)|Возвращает уникальный идентификатор для прокси-поток.|  
|[Метод IThreadProxy::SwitchOut](#switchout)|Отсоединяет контекст от базового корневого виртуального процессора.|  
|[Метод IThreadProxy::SwitchTo](#switchto)|Выполняет совместное контекстное переключение из текущего контекста на другой ресурс.|  
|[Метод IThreadProxy::YieldToSystem](#yieldtosystem)|Позволяет вызвавшему потоку передать выполнение другому потоку, готовому к использованию на текущем процессоре. Операционная система выбирает следующий поток для выполнения.|  
...
##  <a name="a-namegetida--ithreadproxygetid-method"></a><a name="getid"></a>Метод IThreadProxy::GetId  
...
##  <a name="a-nameswitchouta--ithreadproxyswitchout-method"></a><a name="switchout"></a>Метод IThreadProxy::SwitchOut  
...
##  <a name="a-nameswitchtoa--ithreadproxyswitchto-method"></a><a name="switchto"></a>Метод IThreadProxy::SwitchTo  
...
##  <a name="a-nameyieldtosystema--ithreadproxyyieldtosystem-method"></a><a name="yieldtosystem"></a>Метод IThreadProxy::YieldToSystem  
