...
ms.locfileid: "77141385"
---
# <a name="concurrency-namespace-constants"></a>константы пространства имен Concurrency

||||
|-|-|-|
|[ажентевентгуид](#agenteventguid)|[CONCRT_RM_VERSION_1](#concrt_rm_version_1)|[COOPERATIVE_TIMEOUT_INFINITE](#cooperative_timeout_infinite)|
|[COOPERATIVE_WAIT_TIMEOUT](#cooperative_wait_timeout)|[чоривентгуид](#choreeventguid)|[конкртевентгуид](#concrteventguid)|
|[ConcRT_ProviderGuid](#concrt_providerguid)|[контекстевентгуид](#contexteventguid)|[INHERIT_THREAD_PRIORITY](#inherit_thread_priority)|
|[локкевентгуид](#lockeventguid)|[максексекутионресаурцес](#maxexecutionresources)|[пплпараллелфоревентгуид](#pplparallelforeventguid)|
|[пплпараллелфореачевентгуид](#pplparallelforeacheventguid)|[пплпараллелинвокивентгуид](#pplparallelinvokeeventguid)|[ресаурцеманажеревентгуид](#resourcemanagereventguid)|
|[счедулеграупевентгуид](#schedulegroupeventguid)|[счедулеревентгуид](#schedulereventguid)|[виртуалпроцессоревентгуид](#virtualprocessoreventguid)|

## <a name="agenteventguid"></a>ажентевентгуид
...
## <a name="choreeventguid"></a>чоривентгуид
...
## <a name="concrteventguid"></a>конкртевентгуид
...
## <a name="contexteventguid"></a>контекстевентгуид
...
## <a name="lockeventguid"></a>локкевентгуид
...
## <a name="maxexecutionresources"></a>максексекутионресаурцес
...
## <a name="pplparallelforeventguid"></a>пплпараллелфоревентгуид
...
## <a name="pplparallelforeacheventguid"></a>пплпараллелфореачевентгуид
...
## <a name="pplparallelinvokeeventguid"></a>пплпараллелинвокивентгуид
...
## <a name="resourcemanagereventguid"></a>ресаурцеманажеревентгуид
...
## <a name="schedulegroupeventguid"></a>счедулеграупевентгуид
...
## <a name="schedulereventguid"></a>счедулеревентгуид
...
## <a name="virtualprocessoreventguid"></a>виртуалпроцессоревентгуид
