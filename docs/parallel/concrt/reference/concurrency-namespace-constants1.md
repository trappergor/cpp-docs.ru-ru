---
title: константы пространства имен Concurrency | Документация Майкрософт
ms.custom: ''
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
...
Эта категория событий в данный момент не запущено средой выполнения с параллелизмом.
