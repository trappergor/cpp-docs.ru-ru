---
title: "Класс norm_3 | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
Представляет короткий вектор из трех нормальных чисел.  
...
|Имя|Описание|  
|---------|--------------|  
|[Конструктор norm\_3::norm\_3](../Topic/norm_3::norm_3%20Constructor.md)|Перегружен.  Конструктор по умолчанию, инициализирует все элементы нулем.|  
  
### Открытые методы  
  
|Имя|Описание|  
|---------|--------------|  
|Метод norm\_3::get\_x||  
|Метод norm\_3::get\_xy||  
|Метод norm\_3::get\_xyz||  
|Метод norm\_3::get\_xz||  
|Метод norm\_3::get\_xzy||  
|Метод norm\_3::get\_y||  
|Метод norm\_3::get\_yx||  
|Метод norm\_3::get\_yxz||  
|Метод norm\_3::get\_yz||  
|Метод norm\_3::get\_yzx||  
|Метод norm\_3::get\_z||  
|Метод norm\_3::get\_zx||  
|Метод norm\_3::get\_zxy||  
|Метод norm\_3::get\_zy||  
|Метод norm\_3::get\_zyx||  
|Метод norm\_3::ref\_b||  
|Метод norm\_3::ref\_g||  
|Метод norm\_3::ref\_r||  
|Метод norm\_3::ref\_x||  
|Метод norm\_3::ref\_y||  
|Метод norm\_3::ref\_z||  
|Метод norm\_3::set\_x||  
|Метод norm\_3::set\_xy||  
|Метод norm\_3::set\_xyz||  
|Метод norm\_3::set\_xz||  
|Метод norm\_3::set\_xzy||  
|Метод norm\_3::set\_y||  
|Метод norm\_3::set\_yx||  
|Метод norm\_3::set\_yxz||  
|Метод norm\_3::set\_yz||  
|Метод norm\_3::set\_yzx||  
|Метод norm\_3::set\_z||  
|Метод norm\_3::set\_zx||  
|Метод norm\_3::set\_zxy||  
|Метод norm\_3::set\_zy||  
|Метод norm\_3::set\_zyx||  
  
### Открытые операторы  
  
|Имя|Описание|  
|---------|--------------|  
|Оператор norm\_3::operator\-||  
|Оператор norm\_3::operator\-\-||  
|Оператор norm\_3::operator\*\=||  
|Оператор norm\_3::operator\/\=||  
|Оператор norm\_3::operator\+\+||  
...
|Имя|Описание|  
|---------|--------------|  
|[Константа norm\_3::size](../Topic/norm_3::size%20Constant.md)||  
  
### Открытые члены данных  
  
|Имя|Описание|  
|---------|--------------|  
|Член данных norm\_3::b||  
|Член данных norm\_3::bg||  
|Член данных norm\_3::bgr||  
|Член данных norm\_3::br||  
|Член данных norm\_3::brg||  
|Член данных norm\_3::g||  
|Член данных norm\_3::gb||  
|Член данных norm\_3::gbr||  
|Член данных norm\_3::gr||  
|Член данных norm\_3::grb||  
|Член данных norm\_3::r||  
|Член данных norm\_3::rb||  
|Член данных norm\_3::rbg||  
|Член данных norm\_3::rg||  
|Член данных norm\_3::rgb||  
|Член данных norm\_3::x||  
|Член данных norm\_3::xy||  
|Член данных norm\_3::xyz||  
|Член данных norm\_3::xz||  
|Член данных norm\_3::xzy||  
|Член данных norm\_3::y||  
|Член данных norm\_3::yx||  
|Член данных norm\_3::yxz||  
|Член данных norm\_3::yz||  
|Член данных norm\_3::yzx||  
|Член данных norm\_3::z||  
|Член данных norm\_3::zx||  
|Член данных norm\_3::zxy||  
|Член данных norm\_3::zy||  
|Член данных norm\_3::zyx||  
