---
title: "Класс int_3 | Microsoft Docs"
ms.custom: ""
ms.date: "12/05/2016"
...
|Имя|Описание|  
|---------|--------------|  
|[Конструктор int\_3::int\_3](../Topic/int_3::int_3%20Constructor.md)|Перегружен.  Конструктор по умолчанию, инициализирует все элементы нулем.|  
...
|---------|--------------|  
|Метод int\_3::get\_x||  
|Метод int\_3::get\_xy||  
|Метод int\_3::get\_xyz||  
|Метод int\_3::get\_xz||  
|Метод int\_3::get\_xzy||  
|Метод int\_3::get\_y||  
|Метод int\_3::get\_yx||  
|Метод int\_3::get\_yxz||  
|Метод int\_3::get\_yz||  
|Метод int\_3::get\_yzx||  
|Метод int\_3::get\_z||  
|Метод int\_3::get\_zx||  
|Метод int\_3::get\_zxy||  
|Метод int\_3::get\_zy||  
|Метод int\_3::get\_zyx||  
|Метод int\_3::ref\_b||  
|Метод int\_3::ref\_g||  
|Метод int\_3::ref\_r||  
|Метод int\_3::ref\_x||  
...
|Метод int\_3::ref\_z||  
|Метод int\_3::set\_x||  
|Метод int\_3::set\_xy||  
|Метод int\_3::set\_xyz||  
|Метод int\_3::set\_xz||  
|Метод int\_3::set\_xzy||  
|Метод int\_3::set\_y||  
|Метод int\_3::set\_yx||  
|Метод int\_3::set\_yxz||  
|Метод int\_3::set\_yz||  
|Метод int\_3::set\_yzx||  
|Метод int\_3::set\_z||  
|Метод int\_3::set\_zx||  
|Метод int\_3::set\_zxy||  
|Метод int\_3::set\_zy||  
|Метод int\_3::set\_zyx||  
  
### Открытые операторы  
  
|Имя|Описание|  
|---------|--------------|  
|Оператор int\_3::operator\-||  
|Оператор int\_3::operator\-\-||  
|Оператор int\_3::operator%\=||  
|Оператор int\_3::operator&\=||  
|Оператор int\_3::operator\*\=||  
...
|Имя|Описание|  
|---------|--------------|  
|[Константа int\_3::size](../Topic/int_3::size%20Constant.md)||  
  
### Открытые члены данных  
  
|Имя|Описание|  
|---------|--------------|  
|Член данных int\_3::b||  
|Член данных int\_3::bg||  
|Член данных int\_3::bgr||  
|Член данных int\_3::br||  
|Член данных int\_3::brg||  
|Член данных int\_3::g||  
|Член данных int\_3::gb||  
|Член данных int\_3::gbr||  
|Член данных int\_3::gr||  
|Член данных int\_3::grb||  
|Член данных int\_3::r||  
|Член данных int\_3::rb||  
|Член данных int\_3::rbg||  
|Член данных int\_3::rg||  
|Член данных int\_3::rgb||  
|Член данных int\_3::x||  
|Член данных int\_3::xy||  
|Член данных int\_3::xyz||  
|Член данных int\_3::xz||  
|Член данных int\_3::xzy||  
|Член данных int\_3::y||  
|Член данных int\_3::yx||  
|Член данных int\_3::yxz||  
|Член данных int\_3::yz||  
|Член данных int\_3::yzx||  
|Член данных int\_3::z||  
|Член данных int\_3::zx||  
|Член данных int\_3::zxy||  
|Член данных int\_3::zy||  
|Член данных int\_3::zyx||  
