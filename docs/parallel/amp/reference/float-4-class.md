---
title: "Класс float_4 | Microsoft Docs"
ms.custom: ""
ms.date: "12/05/2016"
...
Представляет короткий вектор из четырёх чисел с плавающей точкой.  
...
|Имя|Описание|  
|---------|--------------|  
|[Конструктор float\_4::float\_4](../Topic/float_4::float_4%20Constructor.md)|Перегружен.  Конструктор по умолчанию, инициализирует все элементы нулем.|  
  
### Открытые методы  
  
|Имя|Описание|  
|---------|--------------|  
|Метод float\_4::get\_w||  
|Метод float\_4::get\_wx||  
|Метод float\_4::get\_wxy||  
|Метод float\_4::get\_wxyz||  
|Метод float\_4::get\_wxz||  
|Метод float\_4::get\_wxzy||  
|Метод float\_4::get\_wy||  
|Метод float\_4::get\_wyx||  
|Метод float\_4::get\_wyxz||  
|Метод float\_4::get\_wyz||  
|Метод float\_4::get\_wyzx||  
|Метод float\_4::get\_wz||  
|Метод float\_4::get\_wzx||  
|Метод float\_4::get\_wzxy||  
|Метод float\_4::get\_wzy||  
|Метод float\_4::get\_wzyx||  
|Метод float\_4::get\_x||  
|Метод float\_4::get\_xw||  
|Метод float\_4::get\_xwy||  
|Метод float\_4::get\_xwyz||  
|Метод float\_4::get\_xwz||  
|Метод float\_4::get\_xwzy||  
|Метод float\_4::get\_xy||  
|Метод float\_4::get\_xyw||  
|Метод float\_4::get\_xywz||  
|Метод float\_4::get\_xyz||  
|Метод float\_4::get\_xyzw||  
|Метод float\_4::get\_xz||  
|Метод float\_4::get\_xzw||  
|Метод float\_4::get\_xzwy||  
|Метод float\_4::get\_xzy||  
|Метод float\_4::get\_xzyw||  
|Метод float\_4::get\_y||  
|Метод float\_4::get\_yw||  
|Метод float\_4::get\_ywx||  
|Метод float\_4::get\_ywxz||  
|Метод float\_4::get\_ywz||  
|Метод float\_4::get\_ywzx||  
|Метод float\_4::get\_yx||  
|Метод float\_4::get\_yxw||  
|Метод float\_4::get\_yxwz||  
|Метод float\_4::get\_yxz||  
|Метод float\_4::get\_yxzw||  
|Метод float\_4::get\_yz||  
|Метод float\_4::get\_yzw||  
|Метод float\_4::get\_yzwx||  
|Метод float\_4::get\_yzx||  
|Метод float\_4::get\_yzxw||  
|Метод float\_4::get\_z||  
|Метод float\_4::get\_zw||  
|Метод float\_4::get\_zwx||  
|Метод float\_4::get\_zwxy||  
|Метод float\_4::get\_zwy||  
|Метод float\_4::get\_zwyx||  
|Метод float\_4::get\_zx||  
|Метод float\_4::get\_zxw||  
|Метод float\_4::get\_zxwy||  
|Метод float\_4::get\_zxy||  
|Метод float\_4::get\_zxyw||  
|Метод float\_4::get\_zy||  
|Метод float\_4::get\_zyw||  
|Метод float\_4::get\_zywx||  
|Метод float\_4::get\_zyx||  
|Метод float\_4::get\_zyxw||  
|Метод float\_4::ref\_a||  
|Метод float\_4::ref\_b||  
|Метод float\_4::ref\_g||  
|Метод float\_4::ref\_r||  
|Метод float\_4::ref\_w||  
|Метод float\_4::ref\_x||  
|Метод float\_4::ref\_y||  
|Метод float\_4::ref\_z||  
|Метод float\_4::set\_w||  
|Метод float\_4::set\_wx||  
|Метод float\_4::set\_wxy||  
|Метод float\_4::set\_wxyz||  
|Метод float\_4::set\_wxz||  
|Метод float\_4::set\_wxzy||  
|Метод float\_4::set\_wy||  
|Метод float\_4::set\_wyx||  
|Метод float\_4::set\_wyxz||  
|Метод float\_4::set\_wyz||  
|Метод float\_4::set\_wyzx||  
|Метод float\_4::set\_wz||  
|Метод float\_4::set\_wzx||  
|Метод float\_4::set\_wzxy||  
|Метод float\_4::set\_wzy||  
|Метод float\_4::set\_wzyx||  
|Метод float\_4::set\_x||  
|Метод float\_4::set\_xw||  
|Метод float\_4::set\_xwy||  
|Метод float\_4::set\_xwyz||  
|Метод float\_4::set\_xwz||  
|Метод float\_4::set\_xwzy||  
|Метод float\_4::set\_xy||  
|Метод float\_4::set\_xyw||  
|Метод float\_4::set\_xywz||  
|Метод float\_4::set\_xyz||  
|Метод float\_4::set\_xyzw||  
|Метод float\_4::set\_xz||  
|Метод float\_4::set\_xzw||  
|Метод float\_4::set\_xzwy||  
|Метод float\_4::set\_xzy||  
|Метод float\_4::set\_xzyw||  
|Метод float\_4::set\_y||  
|Метод float\_4::set\_yw||  
|Метод float\_4::set\_ywx||  
|Метод float\_4::set\_ywxz||  
|Метод float\_4::set\_ywz||  
|Метод float\_4::set\_ywzx||  
|Метод float\_4::set\_yx||  
|Метод float\_4::set\_yxw||  
|Метод float\_4::set\_yxwz||  
|Метод float\_4::set\_yxz||  
|Метод float\_4::set\_yxzw||  
|Метод float\_4::set\_yz||  
|Метод float\_4::set\_yzw||  
|Метод float\_4::set\_yzwx||  
|Метод float\_4::set\_yzx||  
|Метод float\_4::set\_yzxw||  
|Метод float\_4::set\_z||  
|Метод float\_4::set\_zw||  
|Метод float\_4::set\_zwx||  
|Метод float\_4::set\_zwxy||  
|Метод float\_4::set\_zwy||  
|Метод float\_4::set\_zwyx||  
|Метод float\_4::set\_zx||  
|Метод float\_4::set\_zxw||  
|Метод float\_4::set\_zxwy||  
|Метод float\_4::set\_zxy||  
|Метод float\_4::set\_zxyw||  
|Метод float\_4::set\_zy||  
|Метод float\_4::set\_zyw||  
|Метод float\_4::set\_zywx||  
|Метод float\_4::set\_zyx||  
|Метод float\_4::set\_zyxw||  
  
### Открытые операторы  
  
|Имя|Описание|  
|---------|--------------|  
|Оператор float\_4::operator\-||  
|Оператор float\_4::operator\-\-||  
|Оператор float\_4::operator\*\=||  
|Оператор float\_4::operator\/\=||  
|Оператор float\_4::operator\+\+||  
...
|Имя|Описание|  
|---------|--------------|  
|[Константа float\_4::size](../Topic/float_4::size%20Constant.md)||  
  
### Открытые члены данных  
  
|Имя|Описание|  
|---------|--------------|  
|Член данных float\_4::a||  
|Член данных float\_4::ab||  
|Член данных float\_4::abg||  
|Член данных float\_4::abgr||  
|Член данных float\_4::abr||  
|Член данных float\_4::abrg||  
|Член данных float\_4::ag||  
|Член данных float\_4::agb||  
|Член данных float\_4::agbr||  
|Член данных float\_4::agr||  
|Член данных float\_4::agrb||  
|Член данных float\_4::ar||  
|Член данных float\_4::arb||  
|Член данных float\_4::arbg||  
|Член данных float\_4::arg||  
|Член данных float\_4::argb||  
|Член данных float\_4::b||  
|Член данных float\_4::ba||  
|Член данных float\_4::bag||  
|Член данных float\_4::bagr||  
|Член данных float\_4::bar||  
|Член данных float\_4::barg||  
|Член данных float\_4::bg||  
|Член данных float\_4::bga||  
|Член данных float\_4::bgar||  
|Член данных float\_4::bgr||  
|Член данных float\_4::bgra||  
|Член данных float\_4::br||  
|Член данных float\_4::bra||  
|Член данных float\_4::brag||  
|Член данных float\_4::brg||  
|Член данных float\_4::brga||  
|Член данных float\_4::g||  
|Член данных float\_4::ga||  
|Член данных float\_4::gab||  
|Член данных float\_4::gabr||  
|Член данных float\_4::gar||  
|Член данных float\_4::garb||  
|Член данных float\_4::gb||  
|Член данных float\_4::gba||  
|Член данных float\_4::gbar||  
|Член данных float\_4::gbr||  
|Член данных float\_4::gbra||  
|Член данных float\_4::gr||  
|Член данных float\_4::gra||  
|Член данных float\_4::grab||  
|Член данных float\_4::grb||  
|Член данных float\_4::grba||  
|Член данных float\_4::r||  
|Член данных float\_4::ra||  
|Член данных float\_4::rab||  
|Член данных float\_4::rabg||  
|Член данных float\_4::rag||  
|Член данных float\_4::ragb||  
|Член данных float\_4::rb||  
|Член данных float\_4::rba||  
|Член данных float\_4::rbag||  
|Член данных float\_4::rbg||  
|Член данных float\_4::rbga||  
|Член данных float\_4::rg||  
|Член данных float\_4::rga||  
|Член данных float\_4::rgab||  
|Член данных float\_4::rgb||  
|Член данных float\_4::rgba||  
|Член данных float\_4::w||  
|Член данных float\_4::wx||  
|Член данных float\_4::wxy||  
|Член данных float\_4::wxyz||  
|Член данных float\_4::wxz||  
|Член данных float\_4::wxzy||  
|Член данных float\_4::wy||  
|Член данных float\_4::wyx||  
|Член данных float\_4::wyxz||  
|Член данных float\_4::wyz||  
|Член данных float\_4::wyzx||  
|Член данных float\_4::wz||  
|Член данных float\_4::wzx||  
|Член данных float\_4::wzxy||  
|Член данных float\_4::wzy||  
|Член данных float\_4::wzyx||  
|Член данных float\_4::x||  
|Член данных float\_4::xw||  
|Член данных float\_4::xwy||  
|Член данных float\_4::xwyz||  
|Член данных float\_4::xwz||  
|Член данных float\_4::xwzy||  
|Член данных float\_4::xy||  
|Член данных float\_4::xyw||  
|Член данных float\_4::xywz||  
|Член данных float\_4::xyz||  
|Член данных float\_4::xyzw||  
|Член данных float\_4::xz||  
|Член данных float\_4::xzw||  
|Член данных float\_4::xzwy||  
|Член данных float\_4::xzy||  
|Член данных float\_4::xzyw||  
|Член данных float\_4::y||  
|Член данных float\_4::yw||  
|Член данных float\_4::ywx||  
|Член данных float\_4::ywxz||  
|Член данных float\_4::ywz||  
|Член данных float\_4::ywzx||  
|Член данных float\_4::yx||  
|Член данных float\_4::yxw||  
|Член данных float\_4::yxwz||  
|Член данных float\_4::yxz||  
|Член данных float\_4::yxzw||  
|Член данных float\_4::yz||  
|Член данных float\_4::yzw||  
|Член данных float\_4::yzwx||  
|Член данных float\_4::yzx||  
|Член данных float\_4::yzxw||  
|Член данных float\_4::z||  
|Член данных float\_4::zw||  
|Член данных float\_4::zwx||  
|Член данных float\_4::zwxy||  
|Член данных float\_4::zwy||  
|Член данных float\_4::zwyx||  
|Член данных float\_4::zx||  
|Член данных float\_4::zxw||  
|Член данных float\_4::zxwy||  
|Член данных float\_4::zxy||  
|Член данных float\_4::zxyw||  
|Член данных float\_4::zy||  
|Член данных float\_4::zyw||  
|Член данных float\_4::zywx||  
|Член данных float\_4::zyx||  
|Член данных float\_4::zyxw||  
