---
title: "Класс float_3 | Microsoft Docs"
ms.custom: ""
ms.date: "12/05/2016"
...
Представляет короткий вектор из трех чисел с плавающей запятой.  
...
|Имя|Описание|  
|---------|--------------|  
|[Конструктор float\_3::float\_3](../Topic/float_3::float_3%20Constructor.md)|Перегружен.  Конструктор по умолчанию, инициализирует все элементы нулем.|  
  
### Открытые методы  
  
|Имя|Описание|  
|---------|--------------|  
|Метод float\_3::get\_x||  
|Метод float\_3::get\_xy||  
|Метод float\_3::get\_xyz||  
|Метод float\_3::get\_xz||  
|Метод float\_3::get\_xzy||  
|Метод float\_3::get\_y||  
|Метод float\_3::get\_yx||  
|Метод float\_3::get\_yxz||  
|Метод float\_3::get\_yz||  
|Метод float\_3::get\_yzx||  
|Метод float\_3::get\_z||  
|Метод float\_3::get\_zx||  
|Метод float\_3::get\_zxy||  
|Метод float\_3::get\_zy||  
|Метод float\_3::get\_zyx||  
|Метод float\_3::ref\_b||  
|Метод float\_3::ref\_g||  
|Метод float\_3::ref\_r||  
|Метод float\_3::ref\_x||  
|Метод float\_3::ref\_y||  
|Метод float\_3::ref\_z||  
|Метод float\_3::set\_x||  
|Метод float\_3::set\_xy||  
|Метод float\_3::set\_xyz||  
|Метод float\_3::set\_xz||  
|Метод float\_3::set\_xzy||  
|Метод float\_3::set\_y||  
|Метод float\_3::set\_yx||  
|Метод float\_3::set\_yxz||  
|Метод float\_3::set\_yz||  
|Метод float\_3::set\_yzx||  
|Метод float\_3::set\_z||  
|Метод float\_3::set\_zx||  
|Метод float\_3::set\_zxy||  
|Метод float\_3::set\_zy||  
|Метод float\_3::set\_zyx||  
  
### Открытые операторы  
  
|Имя|Описание|  
|---------|--------------|  
|Оператор float\_3::operator\-||  
|Оператор float\_3::operator\-\-||  
|Оператор float\_3::operator\*\=||  
|Оператор float\_3::operator\/\=||  
|Оператор float\_3::operator\+\+||  
...
|Имя|Описание|  
|---------|--------------|  
|[Константа float\_3::size](../Topic/float_3::size%20Constant.md)||  
  
### Открытые члены данных  
  
|Имя|Описание|  
|---------|--------------|  
|Член данных float\_3::b||  
|Член данных float\_3::bg||  
|Член данных float\_3::bgr||  
|Член данных float\_3::br||  
|Член данных float\_3::brg||  
|Член данных float\_3::g||  
|Член данных float\_3::gb||  
|Член данных float\_3::gbr||  
|Член данных float\_3::gr||  
|ЭЧлен данных float\_3::grb||  
|Член данных float\_3::r||  
|Член данных float\_3::rb||  
|Член данных float\_3::rbg||  
|Член данных float\_3::rg||  
|Член данных float\_3::rgb||  
|Член данных float\_3::x||  
|Член данных float\_3::xy||  
|Член данных float\_3::xyz||  
|Член данных float\_3::xz||  
|Член данных float\_3::xzy||  
|Член данных float\_3::y||  
|Член данных float\_3::yx||  
|Член данных float\_3::yxz||  
|Член данных float\_3::yz||  
|Член данных float\_3::yzx||  
|Член данных float\_3::z||  
|Член данных float\_3::zx||  
|Член данных float\_3::zxy||  
|Член данных float\_3::zy||  
|Член данных float\_3::zyx||  
