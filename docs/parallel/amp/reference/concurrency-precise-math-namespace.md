---
title: Пространство имен Concurrency::precise_math | Документация Майкрософт
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-amp
...
|[fmaf](concurrency-precise-math-namespace-functions.md#fmaf)|Вычисления (_X \* _Y) + _Z, округленное в рамках одной операции троичный|
