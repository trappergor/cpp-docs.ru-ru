---
title: Класс unorm_4 | Документы Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-amp
...
ms.locfileid: "33694619"
---
# <a name="unorm4-class"></a>Класс unorm_4
Представляет короткий вектор из четырех чисел без знака обычного.  
...
|name|Описание|  
|----------|-----------------|  
|[Размер константы](#unorm_4__size)||  
