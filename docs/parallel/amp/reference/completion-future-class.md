...
2.  `std::future_status::ready` Если соответствующая асинхронная операция завершена.  
  
3.  `std::future_status::timeout` Если заданный период времени истек.  
