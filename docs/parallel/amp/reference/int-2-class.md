...
|Имя|Описание|  
|----------|-----------------|  
|Элемент данных int_2::g||  
|Элемент данных int_2::GR||  
|Элемент данных int_2::r||  
|Элемент данных int_2::RG||  
|Элемент данных int_2::x||  
|Элемент данных int_2::XY||  
|Элемент данных int_2::y||  
|Элемент данных int_2::YX||  
...
##  <a name="a-nameint2sizea-size"></a><a name="int_2__size"></a>размер 
