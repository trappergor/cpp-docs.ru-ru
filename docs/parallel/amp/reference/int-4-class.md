---
title: "Класс int_4 | Microsoft Docs"
ms.custom: ""
ms.date: "12/05/2016"
...
Представляет короткий вектор из четырёх целых чисел.  
...
|Имя|Описание|  
|---------|--------------|  
|[Конструктор int\_4::int\_4](../Topic/int_4::int_4%20Constructor.md)|Перегружен.  Конструктор по умолчанию, инициализирует все элементы нулем.|  
...
|---------|--------------|  
|Метод int\_4::get\_w||  
|Метод int\_4::get\_wx||  
|Метод int\_4::get\_wxy||  
|Метод int\_4::get\_wxyz||  
|Метод int\_4::get\_wxz||  
|Метод int\_4::get\_wxzy||  
|Метод int\_4::get\_wy||  
|Метод int\_4::get\_wyx||  
|Метод int\_4::get\_wyxz||  
|Метод int\_4::get\_wyz||  
|Метод int\_4::get\_wyzx||  
|Метод int\_4::get\_wz||  
|Метод int\_4::get\_wzx||  
|Метод int\_4::get\_wzxy||  
|Метод int\_4::get\_wzy||  
|Метод int\_4::get\_wzyx||  
|Метод int\_4::get\_x||  
|Метод int\_4::get\_xw||  
|Метод int\_4::get\_xwy||  
|Метод int\_4::get\_xwyz||  
|Метод int\_4::get\_xwz||  
|Метод int\_4::get\_xwzy||  
|Метод int\_4::get\_xy||  
|Метод int\_4::get\_xyw||  
|Метод int\_4::get\_xywz||  
|Метод int\_4::get\_xyz||  
|Метод int\_4::get\_xyzw||  
|Метод int\_4::get\_xz||  
|Метод int\_4::get\_xzw||  
|Метод int\_4::get\_xzwy||  
|Метод int\_4::get\_xzy||  
|Метод int\_4::get\_xzyw||  
|Метод int\_4::get\_y||  
|Метод int\_4::get\_yw||  
|Метод int\_4::get\_ywx||  
|Метод int\_4::get\_ywxz||  
|Метод int\_4::get\_ywz||  
|Метод int\_4::get\_ywzx||  
|Метод int\_4::get\_yx||  
|Метод int\_4::get\_yxw||  
|Метод int\_4::get\_yxwz||  
|Метод int\_4::get\_yxz||  
|Метод int\_4::get\_yxzw||  
|Метод int\_4::get\_yz||  
|Метод int\_4::get\_yzw||  
|Метод int\_4::get\_yzwx||  
|Метод int\_4::get\_yzx||  
|Метод int\_4::get\_yzxw||  
|Метод int\_4::get\_z||  
|Метод int\_4::get\_zw||  
|Метод int\_4::get\_zwx||  
|Метод int\_4::get\_zwxy||  
|Метод int\_4::get\_zwy||  
|Метод int\_4::get\_zwyx||  
|Метод int\_4::get\_zx||  
|Метод int\_4::get\_zxw||  
|Метод int\_4::get\_zxwy||  
|Метод int\_4::get\_zxy||  
|Метод int\_4::get\_zxyw||  
|Метод int\_4::get\_zy||  
|Метод int\_4::get\_zyw||  
|Метод int\_4::get\_zywx||  
|Метод int\_4::get\_zyx||  
|Метод int\_4::get\_zyxw||  
|Метод int\_4::ref\_a||  
|Метод int\_4::ref\_b||  
|Метод int\_4::ref\_g||  
|Метод int\_4::ref\_r||  
...
|Метод int\_4::ref\_z||  
|Метод int\_4::set\_w||  
|Метод int\_4::set\_wx||  
|Метод int\_4::set\_wxy||  
|Метод int\_4::set\_wxyz||  
|Метод int\_4::set\_wxz||  
|Метод int\_4::set\_wxzy||  
|Метод int\_4::set\_wy||  
|Метод int\_4::set\_wyx||  
|Метод int\_4::set\_wyxz||  
|Метод int\_4::set\_wyz||  
|Метод int\_4::set\_wyzx||  
|Метод int\_4::set\_wz||  
|Метод int\_4::set\_wzx||  
|Метод int\_4::set\_wzxy||  
|Метод int\_4::set\_wzy||  
|Метод int\_4::set\_wzyx||  
|Метод int\_4::set\_x||  
|Метод int\_4::set\_xw||  
|Метод int\_4::set\_xwy||  
|Метод int\_4::set\_xwyz||  
|Метод int\_4::set\_xwz||  
|Метод int\_4::set\_xwzy||  
|Метод int\_4::set\_xy||  
|Метод int\_4::set\_xyw||  
|Метод int\_4::set\_xywz||  
|Метод int\_4::set\_xyz||  
|Метод int\_4::set\_xyzw||  
|Метод int\_4::set\_xz||  
|Метод int\_4::set\_xzw||  
|Метод int\_4::set\_xzwy||  
|Метод int\_4::set\_xzy||  
|Метод int\_4::set\_xzyw||  
|Метод int\_4::set\_y||  
|Метод int\_4::set\_yw||  
|Метод int\_4::set\_ywx||  
|Метод int\_4::set\_ywxz||  
|Метод int\_4::set\_ywz||  
|Метод int\_4::set\_ywzx||  
|Метод int\_4::set\_yx||  
|Метод int\_4::set\_yxw||  
|Метод int\_4::set\_yxwz||  
|Метод int\_4::set\_yxz||  
|Метод int\_4::set\_yxzw||  
|Метод int\_4::set\_yz||  
|Метод int\_4::set\_yzw||  
|Метод int\_4::set\_yzwx||  
|Метод int\_4::set\_yzx||  
|Метод int\_4::set\_yzxw||  
|Метод int\_4::set\_z||  
|Метод int\_4::set\_zw||  
|Метод int\_4::set\_zwx||  
|Метод int\_4::set\_zwxy||  
|Метод int\_4::set\_zwy||  
|Метод int\_4::set\_zwyx||  
|Метод int\_4::set\_zx||  
|Метод int\_4::set\_zxw||  
|Метод int\_4::set\_zxwy||  
|Метод int\_4::set\_zxy||  
|Метод int\_4::set\_zxyw||  
|Метод int\_4::set\_zy||  
|Метод int\_4::set\_zyw||  
|Метод int\_4::set\_zywx||  
|Метод int\_4::set\_zyx||  
|Метод int\_4::set\_zyxw||  
  
### Открытые операторы  
  
|Имя|Описание|  
|---------|--------------|  
|Оператор int\_4::operator\-||  
|Оператор int\_4::operator\-\-||  
|Оператор int\_4::operator%\=||  
|Оператор int\_4::operator&\=||  
|Оператор int\_4::operator\*\=||  
...
|Имя|Описание|  
|---------|--------------|  
|[Константа int\_4::size](../Topic/int_4::size%20Constant.md)||  
  
### Открытые члены данных  
  
|Имя|Описание|  
|---------|--------------|  
|Член данных int\_4::a||  
|Член данных int\_4::ab||  
|Член данных int\_4::abg||  
|Член данных int\_4::abgr||  
|Член данных int\_4::abr||  
|Член данных int\_4::abrg||  
|Член данных int\_4::ag||  
|Член данных int\_4::agb||  
|Член данных int\_4::agbr||  
|Член данных int\_4::agr||  
|Член данных int\_4::agrb||  
|Член данных int\_4::ar||  
|Член данных int\_4::arb||  
|Член данных int\_4::arbg||  
|Член данных int\_4::arg||  
|Член данных int\_4::argb||  
|Член данных int\_4::b||  
|Член данных int\_4::ba||  
|Член данных int\_4::bag||  
|Член данных int\_4::bagr||  
|Член данных int\_4::bar||  
|Член данных int\_4::barg||  
|Член данных int\_4::bg||  
|Член данных int\_4::bga||  
|Член данных int\_4::bgar||  
|Член данных int\_4::bgr||  
|Член данных int\_4::bgra||  
|Член данных int\_4::br||  
|Член данных int\_4::bra||  
|Член данных int\_4::brag||  
|Член данных int\_4::brg||  
|Член данных int\_4::brga||  
|Член данных int\_4::g||  
|Член данных int\_4::ga||  
|Член данных int\_4::gab||  
|Член данных int\_4::gabr||  
|Член данных int\_4::gar||  
|Член данных int\_4::garb||  
|Член данных int\_4::gb||  
|Член данных int\_4::gba||  
|Член данных int\_4::gbar||  
|Член данных int\_4::gbr||  
|Член данных int\_4::gbra||  
|Член данных int\_4::gr||  
|Член данных int\_4::gra||  
|Член данных int\_4::grab||  
|Член данных int\_4::grb||  
|Член данных int\_4::grba||  
|Член данных int\_4::r||  
|Член данных int\_4::ra||  
|Член данных int\_4::rab||  
|Член данных int\_4::rabg||  
|Член данных int\_4::rag||  
|Член данных int\_4::ragb||  
|Член данных int\_4::rb||  
|Член данных int\_4::rba||  
|Член данных int\_4::rbag||  
|Член данных int\_4::rbg||  
|Член данных int\_4::rbga||  
|Член данных int\_4::rg||  
|Член данных int\_4::rga||  
|Член данных int\_4::rgab||  
|Член данных int\_4::rgb||  
|Член данных int\_4::rgba||  
|Член данных int\_4::w||  
|Член данных int\_4::wx||  
|Член данных int\_4::wxy||  
|Член данных int\_4::wxyz||  
|Член данных int\_4::wxz||  
|Член данных int\_4::wxzy||  
|Член данных int\_4::wy||  
|Член данных int\_4::wyx||  
|Член данных int\_4::wyxz||  
|Член данных int\_4::wyz||  
|Член данных int\_4::wyzx||  
|Член данных int\_4::wz||  
|Член данных int\_4::wzx||  
|Член данных int\_4::wzxy||  
|Член данных int\_4::wzy||  
|Член данных int\_4::wzyx||  
|Член данных int\_4::x||  
|Член данных int\_4::xw||  
|Член данных int\_4::xwy||  
|Член данных int\_4::xwyz||  
|Член данных int\_4::xwz||  
|Член данных int\_4::xwzy||  
|Член данных int\_4::xy||  
|Член данных int\_4::xyw||  
|Член данных int\_4::xywz||  
|Член данных int\_4::xyz||  
|Член данных int\_4::xyzw||  
|Член данных int\_4::xz||  
|Член данных int\_4::xzw||  
|Член данных int\_4::xzwy||  
|Член данных int\_4::xzy||  
|Член данных int\_4::xzyw||  
|Член данных int\_4::y||  
|Член данных int\_4::yw||  
|Член данных int\_4::ywx||  
|Член данных int\_4::ywxz||  
|Член данных int\_4::ywz||  
|Член данных int\_4::ywzx||  
|Член данных int\_4::yx||  
|Член данных int\_4::yxw||  
|Член данных int\_4::yxwz||  
|Член данных int\_4::yxz||  
|Член данных int\_4::yxzw||  
|Член данных int\_4::yz||  
|Член данных int\_4::yzw||  
|Член данных int\_4::yzwx||  
|Член данных int\_4::yzx||  
|Член данных int\_4::yzxw||  
|Член данных int\_4::z||  
|Член данных int\_4::zw||  
|Член данных int\_4::zwx||  
|Член данных int\_4::zwxy||  
|Член данных int\_4::zwy||  
|Член данных int\_4::zwyx||  
|Член данных int\_4::zx||  
|Член данных int\_4::zxw||  
|Член данных int\_4::zxwy||  
|Член данных int\_4::zxy||  
|Член данных int\_4::zxyw||  
|Член данных int\_4::zy||  
|Член данных int\_4::zyw||  
|Член данных int\_4::zywx||  
|Член данных int\_4::zyx||  
|Член данных int\_4::zyxw||  
