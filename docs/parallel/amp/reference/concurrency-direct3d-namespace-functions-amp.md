---
title: Функции пространства имен Concurrency::Direct3D (AMP) | Документация Майкрософт
ms.custom: ''
ms.date: 08/31/2018
ms.topic: reference
f1_keywords:
...
### <a name="parameters"></a>Параметры
`Av` Accelerator_view D3D, для которого возвращается базовый интерфейс устройства D3D.
