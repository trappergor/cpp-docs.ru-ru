...
```  
### <a name="parameters"></a>Параметры
_Rhs число, которое делится по, чтобы найти остаток.
...
### <a name="parameters"></a>Параметры
_Index целое число от 0 до ранга минус 1.
...
``` 
### <a name="parameters"></a>Параметры
_Другое объект для копирования из индекса.
