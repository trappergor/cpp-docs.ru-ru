...
4.  В **тип отладчика** убедитесь, что **автоматически** выбран.

    **Auto** значение по умолчанию. До Windows 10 **только графический Процессор** необходимо указать значение вместо **автоматически**.
