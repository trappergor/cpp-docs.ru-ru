...
- construct
  ...
  Это конструкция является оператором. Он состоит из директивы, за которым следует структурированный блок. Некоторые директивы не входят в конструкции. (См. в разделе *openmp директива* в [приложении C](c-openmp-c-and-cpp-grammar.md)).
...
- [Функции библиотеки времени выполнения](3-run-time-library-functions.md)
