...
Для совместимости с предыдущими версиями **_assume** является синонимом для **__assume** , если не задан параметр компилятора [/Za \(отключить расширения языка)](../build/reference/za-ze-disable-language-extensions.md) .
