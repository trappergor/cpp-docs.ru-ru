...
ms.locfileid: "65448580"
---
# <a name="x64-amd64-intrinsics-list"></a>x64 (amd64) список встроенных объектов

В этом документе перечислены встроенные функции, Microsoft C++ поддерживаемые компилятором при ориентировании x64 (также называемую amd64).
