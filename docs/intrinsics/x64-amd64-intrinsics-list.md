...
ms.locfileid: "39209291"
---
# <a name="x64-amd64-intrinsics-list"></a>Список встроенных объектов x64 (amd64)

В этом документе перечислены встроенные функции, поддерживаемые компилятором Visual C++ при ориентировании на архитектуру x64 (также называемую amd64).
...
|--------------------|----------------|------------|------------------------|
|_addcarry_u16||intrin.h|unsigned char _addcarry_u16 (unsigned char c_in, без знака src1 короткое, короткое src2 без знака, short без знака \*sum)|
|[_addcarry_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_addcarry_u32)||intrin.h|unsigned char _addcarry_u32 (unsigned char c_in, src1 типа int без знака, src2 unsigned int, unsigned int \*sum)|
...
|_addcarry_u8||intrin.h|unsigned char _addcarry_u8 (unsigned char c_in, src1 char без знака, src2 char без знака, char без знака \*sum)|
|[_addcarryx_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_addcarryx_u32)|ADX [2]|immintrin.h|unsigned char _addcarryx_u32 (unsigned char c_in, src1 типа int без знака, src2 unsigned int, unsigned int \*sum)|
...
|[_BitScanForward](../intrinsics/bitscanforward-bitscanforward64.md)||intrin.h|ЛОГИЧЕСКОЕ _BitScanForward (OUT ULONG\* маска ULONG индекса, IN)|
|[_BitScanForward64](../intrinsics/bitscanforward-bitscanforward64.md)||intrin.h|ЛОГИЧЕСКОЕ _BitScanForward64 (OUT ULONG\* маска ULONG64 индекса, IN)|
|[_BitScanReverse](../intrinsics/bitscanreverse-bitscanreverse64.md)||intrin.h|ЛОГИЧЕСКОЕ _BitScanReverse (OUT ULONG\* маска ULONG индекса, IN)|
|[_BitScanReverse64](../intrinsics/bitscanreverse-bitscanreverse64.md)||intrin.h|ЛОГИЧЕСКОЕ _BitScanReverse64 (OUT ULONG\* маска ULONG64 индекса, IN)|
|[_bittest](../intrinsics/bittest-bittest64.md)||intrin.h|unsigned char _bittest (долго const \*, long b).|
|[_bittest64](../intrinsics/bittest-bittest64.md)||intrin.h|char без знака _bittest64 (\__int64 const \*,\__int64 b).|
...
|[_bittestandcomplement64](../intrinsics/bittestandcomplement-bittestandcomplement64.md)||intrin.h|char без знака _bittestandcomplement64 (\__int64 \*,\__int64 b).|
|[_bittestandreset](../intrinsics/bittestandreset-bittestandreset64.md)||intrin.h|unsigned char _bittestandreset (long \*, long b).|
|[_bittestandreset64](../intrinsics/bittestandreset-bittestandreset64.md)||intrin.h|char без знака _bittestandreset64 (\__int64 \*,\__int64 b).|
|[_bittestandset](../intrinsics/bittestandset-bittestandset64.md)||intrin.h|unsigned char _bittestandset (long \*, long b).|
|[_bittestandset64](../intrinsics/bittestandset-bittestandset64.md)||intrin.h|char без знака _bittestandset64 (\__int64 \*,\__int64 b).|
...
|[__debugbreak](../intrinsics/debugbreak.md)||intrin.h|void __cdecl __debugbreak(void);|
...
|[__inbyte](../intrinsics/inbyte.md)||intrin.h|unsigned char __inbyte(unsigned short);|
|[__inbytestring](../intrinsics/inbytestring.md)||intrin.h|void __inbytestring (без знака короткий порт, unsigned char \*буфера без знака длинное число)|
...
|[__indword](../intrinsics/indword.md)||intrin.h|unsigned long __indword(unsigned short);|
|[__indwordstring](../intrinsics/indwordstring.md)||intrin.h|void __indwordstring (unsigned короткий порт, unsigned long \*буфера без знака длинное число)|
...
|[_InterlockedAnd16](../intrinsics/interlockedand-intrinsic-functions.md)||intrin.h|Short _InterlockedAnd16 (короткий volatile \*, short)|
|[_InterlockedAnd16_np](../intrinsics/interlockedand-intrinsic-functions.md)||intrin.h|короткий _InterlockedAnd16_np (short \*, short)|
...
|[_interlockedbittestandreset64](../intrinsics/interlockedbittestandreset-intrinsic-functions.md)||intrin.h|char без знака _interlockedbittestandreset64 (\__int64 \*,\__int64 b).|
|[_interlockedbittestandreset64_HLEAcquire](../intrinsics/interlockedbittestandreset-intrinsic-functions.md)|HLE [2]|immintrin.h|char без знака _interlockedbittestandreset64_HLEAcquire (\__int64 \*,\__int64 b).|
|[_interlockedbittestandreset64_HLERelease](../intrinsics/interlockedbittestandreset-intrinsic-functions.md)|HLE [2]|immintrin.h|char без знака _interlockedbittestandreset64_HLERelease (\__int64 \*,\__int64 b).|
...
|[_interlockedbittestandset64](../intrinsics/interlockedbittestandset-intrinsic-functions.md)||intrin.h|char без знака _interlockedbittestandset64 (\__int64 \*,\__int64 b).|
|[_interlockedbittestandset64_HLEAcquire](../intrinsics/interlockedbittestandset-intrinsic-functions.md)|HLE [2]|immintrin.h|char без знака _interlockedbittestandset64_HLEAcquire (\__int64 \*,\__int64 b).|
|[_interlockedbittestandset64_HLERelease](../intrinsics/interlockedbittestandset-intrinsic-functions.md)|HLE [2]|immintrin.h|char без знака _interlockedbittestandset64_HLERelease (\__int64 \*,\__int64 b).|
...
|[_InterlockedCompareExchange128](../intrinsics/interlockedcompareexchange128.md)||intrin.h|_InterlockedCompareExchange128 char без знака (\__int64 volatile \*,\__int64,\__int64,\__int64\*)|
|[_InterlockedCompareExchange128_np](../intrinsics/interlockedcompareexchange128.md)||intrin.h|_InterlockedCompareExchange128 char без знака (\__int64 volatile \*,\__int64,\__int64,\__int64\*)|
|[_InterlockedCompareExchange16](../intrinsics/interlockedcompareexchange-intrinsic-functions.md)||intrin.h|_InterlockedCompareExchange16 короткое (короткий volatile \*короткий Comparand назначения, короткие Exchange)|
|[_InterlockedCompareExchange16_np](../intrinsics/interlockedcompareexchange-intrinsic-functions.md)||intrin.h|_InterlockedCompareExchange16_np короткое (короткий volatile \*короткий Comparand назначения, короткие Exchange)|
...
|[_InterlockedCompareExchange8](../intrinsics/interlockedcompareexchange-intrinsic-functions.md)||intrin.h|char _InterlockedCompareExchange8 (char volatile \*назначения, char Exchange, char сравниваемый операнд)|
...
|[_InterlockedDecrement16](../intrinsics/interlockeddecrement-intrinsic-functions.md)||intrin.h|_InterlockedDecrement16 короткое (короткий volatile \*Слагаемое)|
...
|[_InterlockedExchange16](../intrinsics/interlockedexchange-intrinsic-functions.md)||intrin.h|_InterlockedExchange16 короткое (короткий volatile \*, short)|
...
|[_InterlockedExchangeAdd16](../intrinsics/interlockedexchangeadd-intrinsic-functions.md)||intrin.h|Short _InterlockedExchangeAdd16 (короткий volatile \*, short)|
...
|[_InterlockedIncrement16](../intrinsics/interlockedincrement-intrinsic-functions.md)||intrin.h|_InterlockedIncrement16 короткое (короткий volatile \*Слагаемое)|
...
|[_InterlockedOr16](../intrinsics/interlockedor-intrinsic-functions.md)||intrin.h|Short _InterlockedOr16 (короткий volatile \*, short)|
|[_InterlockedOr16_np](../intrinsics/interlockedor-intrinsic-functions.md)||intrin.h|короткий _InterlockedOr16_np (short \*, short)|
...
|[_InterlockedXor16](../intrinsics/interlockedxor-intrinsic-functions.md)||intrin.h|Short _InterlockedXor16 (короткий volatile \*, short)|
|[_InterlockedXor16_np](../intrinsics/interlockedxor-intrinsic-functions.md)||intrin.h|короткий _InterlockedXor16_np (short \*, short)|
...
|[__inwordstring](../intrinsics/inwordstring.md)||intrin.h|void __inwordstring (unsigned короткий порт, unsigned short \*буфера без знака длинное число)|
...
|_load_be_u16<br /><br /> [_loadbe_i16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_loadbe_i16&expand=3071)|MOVBE|immintrin.h|без знака короткий _load_be_u16 (void const\*);<br /><br /> короткий _loadbe_i16 (void const\*); [3]|
...
|[_mm_broadcast_ss](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_broadcast_ss)|AVX [2]|immintrin.h|__m128 _mm_broadcast_ss (число с плавающей запятой const \*)|
...
|[_mm_cvtsd_f64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cvtsd_f64)|SSSE3|intrin.h|двойные _mm_cvtsd_f64 (\__m128d)|
...
|[_mm_cvtss_f32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cvtss_f32)|SSSE3|intrin.h|число с плавающей запятой _mm_cvtss_f32 (\__m128)|
...
|[_mm_i32gather_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_i32gather_epi32)|AVX2 [2]|immintrin.h|__m128i _mm_i32gather_epi32 (int const \*базы,\__m128i индекса, const int масштабирования)|
|[_mm_i32gather_epi64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_i32gather_epi64)|AVX2 [2]|immintrin.h|__m128i _mm_i32gather_epi64 (\__int64 const \*базовый,\__m128i индекса, const int масштабирования)|
|[_mm_i32gather_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_i32gather_pd)|AVX2 [2]|immintrin.h|__m128d _mm_i32gather_pd (double const \*базы,\__m128i индекса, const int масштабирования)|
|[_mm_i32gather_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_i32gather_ps)|AVX2 [2]|immintrin.h|__m128 _mm_i32gather_ps (число с плавающей запятой const \*базы,\__m128i индекса, const int масштабирования)|
|[_mm_i64gather_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_i64gather_epi32)|AVX2 [2]|immintrin.h|__m128i _mm_i64gather_epi32 (int const \*базы,\__m128i индекса, const int масштабирования)|
|[_mm_i64gather_epi64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_i64gather_epi64)|AVX2 [2]|immintrin.h|__m128i _mm_i64gather_epi64 (\__int64 const \*базовый,\__m128i индекса, const int масштабирования)|
|[_mm_i64gather_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_i64gather_pd)|AVX2 [2]|immintrin.h|__m128d _mm_i64gather_pd (double const \*базы,\__m128i индекса, const int масштабирования)|
|[_mm_i64gather_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_i64gather_ps)|AVX2 [2]|immintrin.h|__m128 _mm_i64gather_ps (число с плавающей запятой const \*базы,\__m128i индекса, const int масштабирования)|
...
|[_mm_load_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_load_ps)|SSE|intrin.h|__m128 _mm_load_ps (число с плавающей запятой\*)|
|[_mm_load_ps1](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_load_ps1)|SSE|intrin.h|__m128 _mm_load_ps1 (число с плавающей запятой\*)|
...
|[_mm_load_ss](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_load_ss)|SSE|intrin.h|__m128 _mm_load_ss (число с плавающей запятой\*)|
...
|[_mm_loadh_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_loadh_pd)|SSE2|intrin.h|__m128d _mm_loadh_pd (\__m128d, двойные\*)|
...
|[_mm_loadl_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_loadl_pd)|SSE2|intrin.h|__m128d _mm_loadl_pd (\__m128d, двойные\*)|
...
|[_mm_loadr_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_loadr_ps)|SSE|intrin.h|__m128 _mm_loadr_ps (число с плавающей запятой\*)|
...
|[_mm_loadu_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_loadu_ps)|SSE|intrin.h|__m128 _mm_loadu_ps (число с плавающей запятой\*)|
...
|[_mm_mask_i32gather_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_mask_i32gather_epi32)|AVX2 [2]|immintrin.h|__m128i _mm_mask_i32gather_epi32 (\__m128i src, int const \*базовый,\_индекс _m128i\__m128i маски, const int масштабирования)|
|[_mm_mask_i32gather_epi64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_mask_i32gather_epi64)|AVX2 [2]|immintrin.h|__m128i _mm_mask_i32gather_epi64 (\__m128i src\__int64 const \*базовый,\_индекс _m128i\__m128i маски, const int масштабирования)|
|[_mm_mask_i32gather_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_mask_i32gather_pd)|AVX2 [2]|immintrin.h|__m128d _mm_mask_i32gather_pd (\__m128d src, двойные const \*базовый,\_индекс _m128i\__m128d маски, const int масштабирования)|
|[_mm_mask_i32gather_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_mask_i32gather_ps)|AVX2 [2]|immintrin.h|__m128 _mm_mask_i32gather_ps (\__m128 src, число с плавающей запятой const \*базовый,\_индекс _m128i\__m128 маски, const int масштабирования)|
|[_mm_mask_i64gather_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_mask_i64gather_epi32)|AVX2 [2]|immintrin.h|__m128i _mm_mask_i64gather_epi32 (\__m128i src, int const \*базовый,\_индекс _m128i\__m128i маски, const int масштабирования)|
|[_mm_mask_i64gather_epi64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_mask_i64gather_epi64)|AVX2 [2]|immintrin.h|__m128i _mm_mask_i64gather_epi64 (\__m128i src\__int64 const \*базовый,\_индекс _m128i\__m128i маски, const int масштабирования)|
|[_mm_mask_i64gather_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_mask_i64gather_pd)|AVX2 [2]|immintrin.h|__m128d _mm_mask_i64gather_pd (\__m128d src, двойные const \*базовый,\_индекс _m128i\__m128d маски, const int масштабирования)|
|[_mm_mask_i64gather_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_mask_i64gather_ps)|AVX2 [2]|immintrin.h|__m128 _mm_mask_i64gather_ps (\__m128 src, число с плавающей запятой const \*базовый,\_индекс _m128i\__m128 маски, const int масштабирования)|
...
|[_mm_maskload_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_maskload_ps)|AVX [2]|immintrin.h|__m128 _mm_maskload_ps (число с плавающей запятой const \*,\__m128i)|
...
|[_mm_maskstore_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_maskstore_pd)|AVX [2]|immintrin.h|void _mm_maskstore_pd (двойной \*,\__m128i,\__m128d)|
|[_mm_maskstore_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_maskstore_ps)|AVX [2]|immintrin.h|void _mm_maskstore_ps (число с плавающей запятой \*,\__m128i,\__m128)|
...
|[_mm_set1_epi64x](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_set1_epi64x)|SSE2|intrin.h|__m128i _mm_set1_epi64x (\__int64 я)|
...
|[_mm_store_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_store_pd)|SSE2|intrin.h|void _mm_store_pd (двойной\*,\__m128d)|
|[_mm_store_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_store_ps)|SSE|intrin.h|void _mm_store_ps (число с плавающей запятой\*,\__m128)|
|[_mm_store_ps1](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_store_ps1)|SSE|intrin.h|void _mm_store_ps1 (число с плавающей запятой\*,\__m128)|
|[_mm_store_sd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_store_sd)|SSE2|intrin.h|void _mm_store_sd (двойной\*,\__m128d)|
...
|[_mm_store_ss](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_store_ss)|SSE|intrin.h|void _mm_store_ss (число с плавающей запятой\*,\__m128)|
|[_mm_store1_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_store1_pd)|SSE2|intrin.h|void _mm_store1_pd (двойной\*,\__m128d)|
|[_mm_storeh_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_storeh_pd)|SSE2|intrin.h|void _mm_storeh_pd (двойной\*,\__m128d)|
...
|[_mm_storel_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_storel_pd)|SSE2|intrin.h|void _mm_storel_pd (двойной\*,\__m128d)|
...
|[_mm_storer_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_storer_pd)|SSE2|intrin.h|void _mm_storer_pd (двойной\*,\__m128d)|
|[_mm_storer_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_storer_ps)|SSE|intrin.h|void _mm_storer_ps (число с плавающей запятой\*,\__m128)|
|[_mm_storeu_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_storeu_pd)|SSE2|intrin.h|void _mm_storeu_pd (двойной\*,\__m128d)|
|[_mm_storeu_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_storeu_ps)|SSE|intrin.h|void _mm_storeu_ps (число с плавающей запятой\*,\__m128)|
...
|[_mm_stream_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_stream_pd)|SSE2|intrin.h|void _mm_stream_pd (двойной\*,\__m128d)|
|[_mm_stream_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_stream_ps)|SSE|intrin.h|void _mm_stream_ps (число с плавающей запятой\*,\__m128)|
|[_mm_stream_sd](../intrinsics/mm-stream-sd.md)|SSE4a|intrin.h|void _mm_stream_sd (двойной\*,\__m128d)|
...
|[_mm_stream_ss](../intrinsics/mm-stream-ss.md)|SSE4a|intrin.h|void _mm_stream_ss (число с плавающей запятой\*,\__m128)|
...
|[_mm256_broadcast_ss](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_broadcast_ss)|AVX [2]|immintrin.h|__m256 _mm256_broadcast_ss (число с плавающей запятой const \*)|
...
|[_mm256_i32gather_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_i32gather_epi32)|AVX2 [2]|immintrin.h|__m256i _mm256_i32gather_epi32 (int const \*базы,\__m256i индекса, const int масштабирования)|
|[_mm256_i32gather_epi64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_i32gather_epi64)|AVX2 [2]|immintrin.h|__m256i _mm256_i32gather_epi64 (\__int64 const \*базовый,\__m128i индекса, const int масштабирования)|
|[_mm256_i32gather_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_i32gather_pd)|AVX2 [2]|immintrin.h|__m256d _mm256_i32gather_pd (double const \*базы,\__m128i индекса, const int масштабирования)|
|[_mm256_i32gather_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_i32gather_ps)|AVX2 [2]|immintrin.h|__m256 _mm256_i32gather_ps (число с плавающей запятой const \*базы,\__m256i индекса, const int масштабирования)|
|[_mm256_i64gather_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_i64gather_epi32)|AVX2 [2]|immintrin.h|__m256i _mm256_i64gather_epi32 (int const \*базы,\__m256i индекса, const int масштабирования)|
|[_mm256_i64gather_epi64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_i64gather_epi64)|AVX2 [2]|immintrin.h|__m256i _mm256_i64gather_epi64 (\__int64 const \*базовый,\__m256i индекса, const int масштабирования)|
|[_mm256_i64gather_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_i64gather_pd)|AVX2 [2]|immintrin.h|__m256d _mm256_i64gather_pd (double const \*базы,\__m256i индекса, const int масштабирования)|
|[_mm256_i64gather_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_i64gather_ps)|AVX2 [2]|immintrin.h|__m128 _mm256_i64gather_ps (число с плавающей запятой const \*базы,\__m256i индекса, const int масштабирования)|
...
|[_mm256_load_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_load_ps)|AVX [2]|immintrin.h|__m256 _mm256_load_ps (число с плавающей запятой const \*)|
...
|[_mm256_loadu_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_loadu_ps)|AVX [2]|immintrin.h|__m256 _mm256_loadu_ps (число с плавающей запятой const \*)|
...
|[_mm256_mask_i32gather_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_mask_i32gather_epi32)|AVX2 [2]|immintrin.h|__m256i _mm256_mask_i32gather_epi32 (\__m256i src, int const \*базовый,\_индекс _m256i\__m256i маски, const int масштабирования)|
|[_mm256_mask_i32gather_epi64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_mask_i32gather_epi64)|AVX2 [2]|immintrin.h|__m256i _mm256_mask_i32gather_epi64 (\__m256i src\__int64 const \\* базовый,\_индекс _m128i\__m256i маски, const int масштабирования)|
|[_mm256_mask_i32gather_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_mask_i32gather_pd)|AVX2 [2]|immintrin.h|__m256d _mm256_mask_i32gather_pd (\__m256d src, двойные const \*базовый,\_индекс _m128i\__m256d маски, const int масштабирования)|
|[_mm256_mask_i32gather_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_mask_i32gather_ps)|AVX2 [2]|immintrin.h|__m256 _mm256_mask_i32gather_ps (\__m256 src, число с плавающей запятой const \*базовый,\_индекс _m256i\__m256 маски, const int масштабирования)|
|[_mm256_mask_i64gather_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_mask_i64gather_epi32)|AVX2 [2]|immintrin.h|__m128i _mm256_mask_i64gather_epi32 (\__m128i src, int const \*базовый,\_индекс _m256i\__m128i маски, const int масштабирования)|
|[_mm256_mask_i64gather_epi64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_mask_i64gather_epi64)|AVX2 [2]|immintrin.h|__m256i _mm256_mask_i64gather_epi64 (\__m256i src\__int64 const \*базовый,\_индекс _m256i\__m256i маски, const int масштабирования)|
|[_mm256_mask_i64gather_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_mask_i64gather_pd)|AVX2 [2]|immintrin.h|__m256d _mm256_mask_i64gather_pd (\__m256d src, двойные const \*базовый,\_индекс _m256i\__m256d маски, const int масштабирования)|
|[_mm256_mask_i64gather_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_mask_i64gather_ps)|AVX2 [2]|immintrin.h|__m128 _mm256_mask_i64gather_ps (\__m128 src, число с плавающей запятой const \*базовый,\_индекс _m256i\__m128 маски, const int масштабирования)|
...
|[_mm256_maskload_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_maskload_ps)|AVX [2]|immintrin.h|__m256 _mm256_maskload_ps (число с плавающей запятой const \*,\__m256i)|
...
|[_mm256_maskstore_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_maskstore_pd)|AVX [2]|immintrin.h|void _mm256_maskstore_pd (двойной \*,\__m256i,\__m256d)|
|[_mm256_maskstore_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_maskstore_ps)|AVX [2]|immintrin.h|void _mm256_maskstore_ps (число с плавающей запятой \*,\__m256i,\__m256)|
...
|[_mm256_store_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_store_pd)|AVX [2]|immintrin.h|void _mm256_store_pd (двойной \*,\__m256d)|
|[_mm256_store_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_store_ps)|AVX [2]|immintrin.h|void _mm256_store_ps (число с плавающей запятой \*,\__m256)|
...
|[_mm256_storeu_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_storeu_pd)|AVX [2]|immintrin.h|void _mm256_storeu_pd (двойной \*,\__m256d)|
|[_mm256_storeu_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_storeu_ps)|AVX [2]|immintrin.h|void _mm256_storeu_ps (число с плавающей запятой \*,\__m256)|
...
|[_mm256_stream_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_stream_pd)|AVX [2]|immintrin.h|void __mm256_stream_pd (двойной \*,\__m256d)|
|[_mm256_stream_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_stream_ps)|AVX [2]|immintrin.h|void _mm256_stream_ps (число с плавающей запятой \*p,\__m256)|
...
|[__movsb](../intrinsics/movsb.md)||intrin.h|VOID __movsb (PBYTE Индия, IN BYTE const \*, IN SIZE_T)|
|[__movsd](../intrinsics/movsd.md)||intrin.h|VOID __movsd (PDWORD Индия, IN DWORD const \*, IN SIZE_T)|
|[__movsq](../intrinsics/movsq.md)||intrin.h|VOID __movsq (PDWORD64 Индия, IN DWORD64 const \*, IN SIZE_T)|
|[__movsw](../intrinsics/movsw.md)||intrin.h|VOID __movsw (IN PWORD, в WORD const \*, IN SIZE_T)|
|[_mul128](../intrinsics/mul128.md)||intrin.h|__int64 _mul128 (\_множитель _int64\_множимое _int64\__int64 \*highproduct)|
...
|[__outbytestring](../intrinsics/outbytestring.md)||intrin.h|void __outbytestring (без знака короткий порт, unsigned char \*буфера без знака длинное число)|
|[__outdword](../intrinsics/outdword.md)||intrin.h|void __outdword(unsigned short Port,unsigned long Data)|
|[__outdwordstring](../intrinsics/outdwordstring.md)||intrin.h|void __outdwordstring (unsigned короткий порт, unsigned long \*буфера без знака длинное число)|
|[Встроенная функция __outword](../intrinsics/outword.md)||intrin.h|void __outword(unsigned short Port,unsigned short Data)|
|[__outwordstring](../intrinsics/outwordstring.md)||intrin.h|void __outwordstring (unsigned короткий порт, unsigned short \*буфера без знака длинное число)|
...
|[__readgsqword](../intrinsics/readgsbyte-readgsdword-readgsqword-readgsword.md)||intrin.h|unsigned __int64 \__readgsqword (unsigned long смещения)|
...
|_rorx_u64|BMI [2]|immintrin.h|unsigned __int64 _rorx_u64 (unsigned \__int64, const int без знака)|
...
|[__shiftleft128](../intrinsics/shiftleft128.md)||intrin.h|unsigned __int64 \__shiftleft128 (unsigned \_значение подверсии _int64, unsigned \__int64 HighPart, unsigned char Shift)|
|[__shiftright128](../intrinsics/shiftright128.md)||intrin.h|unsigned __int64 \__shiftright128 (unsigned \_значение подверсии _int64, unsigned \__int64 HighPart, unsigned char Shift)|
...
|_store_be_u16<br /><br /> [_storebe_i16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_storebe_i16&expand=5141)|MOVBE|immintrin.h|void _store_be_u16 (void \*, short без знака);<br /><br /> void _storebe_i16 (void \*, short); [3]|
...
|_store_be_u64<br /><br /> [_storebe_i64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_storebe_i64&expand=5143)|MOVBE|immintrin.h|void _store_be_u64 (void \*без знака \__int64);<br /><br /> void _storebe_i64 (void \*, \__int64); [3]|
...
|_subborrow_u16||intrin.h|unsigned char _subborrow_u16 (unsigned char b_in, без знака src1 короткое, короткое src2 без знака, short без знака \*diff)|
|[_subborrow_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_subborrow_u32)||intrin.h|unsigned char _subborrow_u32 (unsigned char b_in, src1 типа int без знака, src2 unsigned int, unsigned int \*diff)|
...
|_subborrow_u8||intrin.h|unsigned char _subborrow_u8 (unsigned char b_in, src1 char без знака, src2 char без знака, char без знака \*diff)|
...
|[_umul128](../intrinsics/umul128.md)||intrin.h|unsigned __int64 _umul128 (unsigned \__int64 множитель, unsigned \__int64 множитель, unsigned \__int64 \*highproduct)|
...
|[__writedr](../intrinsics/writedr.md)||intrin.h|void __writedr (без знака, unsigned \__int64)|
...
|[__writegsqword](../intrinsics/writegsbyte-writegsdword-writegsqword-writegsword.md)||intrin.h|void __writegsqword (unsigned long смещение, unsigned \__int64 данных)|
...
|[_xrstor](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xrstor)|XSAVE [2]|immintrin.h|void _xrstor (void const\*без знака \__int64)|
|[_xrstor64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xrstor64)|XSAVE [2]|immintrin.h|void _xrstor64 (void const\*без знака \__int64)|
|[_xsave](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xsave)|XSAVE [2]|immintrin.h|void _xsave (void\*без знака \__int64)|
|[_xsave64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xsave64)|XSAVE [2]|immintrin.h|void _xsave64 (void\*без знака \__int64)|
|[_xsaveopt](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xsaveopt)|XSAVEOPT [2]|immintrin.h|void _xsaveopt (void\*без знака \__int64)|
|[_xsaveopt64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xsaveopt64)|XSAVEOPT [2]|immintrin.h|void _xsaveopt64 (void\*без знака \__int64)|
