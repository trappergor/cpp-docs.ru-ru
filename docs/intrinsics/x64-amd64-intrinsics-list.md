---
title: x64 (amd64) список встроенных объектов
ms.date: 04/18/2019
helpviewer_keywords:
...
ms.locfileid: "59982412"
---
# <a name="x64-amd64-intrinsics-list"></a>x64 (amd64) список встроенных объектов
...
## <a name="x64-intrinsics"></a>x64 встроенные функции
...
|_addcarry_u8||intrin.h|unsigned char _addcarry_u8 (unsigned char, char без знака, char без знака, char без знака \*)|
...
|[__addgsword](addgsbyte-addgsword-addgsdword-addgsqword.md)||intrin.h|void __addgsword (unsigned long без знака, short)|
...
|[_BitScanForward](bitscanforward-bitscanforward64.md)||intrin.h|unsigned char _BitScanForward (unsigned long\*, long без знака)|
|[_BitScanForward64](bitscanforward-bitscanforward64.md)||intrin.h|unsigned char _BitScanForward64 (unsigned long\*без знака \__int64)|
|[_BitScanReverse](bitscanreverse-bitscanreverse64.md)||intrin.h|unsigned char _BitScanReverse (unsigned long\*, long без знака)|
|[_BitScanReverse64](bitscanreverse-bitscanreverse64.md)||intrin.h|unsigned char _BitScanReverse64 (unsigned long\*без знака \__int64)|
|[_bittest](bittest-bittest64.md)||intrin.h|unsigned char _bittest (долго const \*, long)|
...
|[__inbyte](inbyte.md)||intrin.h|__inbyte(unsigned short) char без знака|
|[__inbytestring](inbytestring.md)||intrin.h|void __inbytestring (unsigned short, char без знака \*, long без знака)|
...
|[__indwordstring](indwordstring.md)||intrin.h|void __indwordstring (unsigned short, unsigned long \*, long без знака)|
...
|[_InterlockedAnd16](interlockedand-intrinsic-functions.md)||intrin.h|Short _InterlockedAnd16 (короткий volatile \*, short)|
|[_InterlockedAnd16_np](interlockedand-intrinsic-functions.md)||intrin.h|короткий _InterlockedAnd16_np (short \*, short)|
...
|[_interlockedbittestandreset64_HLERelease](interlockedbittestandreset-intrinsic-functions.md)|HLE [2]|immintrin.h|char без знака _interlockedbittestandreset64_HLERelease (\__int64 \*, \__int64)|
...
|[_interlockedbittestandset64_HLEAcquire](interlockedbittestandset-intrinsic-functions.md)|HLE [2]|immintrin.h|char без знака _interlockedbittestandset64_HLEAcquire (\__int64 \*, \__int64)|
|[_interlockedbittestandset64_HLERelease](interlockedbittestandset-intrinsic-functions.md)|HLE [2]|immintrin.h|char без знака _interlockedbittestandset64_HLERelease (\__int64 \*, \__int64)|
...
|[_InterlockedCompareExchange128](interlockedcompareexchange128.md)||intrin.h|_InterlockedCompareExchange128 char без знака (\__int64 volatile \*, \__int64, \__int64, \__int64\*)|
|[_InterlockedCompareExchange128_np](interlockedcompareexchange128.md)||intrin.h|_InterlockedCompareExchange128 char без знака (\__int64 volatile \*, \__int64, \__int64, \__int64\*)|
|[_InterlockedCompareExchange16](interlockedcompareexchange-intrinsic-functions.md)||intrin.h|_InterlockedCompareExchange16 короткое (короткий volatile \*, короткое, короткое)|
|[_InterlockedCompareExchange16_np](interlockedcompareexchange-intrinsic-functions.md)||intrin.h|_InterlockedCompareExchange16_np короткое (короткий volatile \*, короткое, короткое)|
...
|[_InterlockedDecrement16](interlockeddecrement-intrinsic-functions.md)||intrin.h|_InterlockedDecrement16 короткое (короткий volatile \*)|
...
|[_InterlockedExchange16](interlockedexchange-intrinsic-functions.md)||intrin.h|_InterlockedExchange16 короткое (короткий volatile \*, short)|
...
|[_InterlockedExchangeAdd16](interlockedexchangeadd-intrinsic-functions.md)||intrin.h|Short _InterlockedExchangeAdd16 (короткий volatile \*, short)|
...
|[_InterlockedIncrement16](interlockedincrement-intrinsic-functions.md)||intrin.h|_InterlockedIncrement16 короткое (короткий volatile \*)|
...
|[_InterlockedOr16](interlockedor-intrinsic-functions.md)||intrin.h|Short _InterlockedOr16 (короткий volatile \*, short)|
|[_InterlockedOr16_np](interlockedor-intrinsic-functions.md)||intrin.h|короткий _InterlockedOr16_np (short \*, short)|
...
|[_InterlockedXor16](interlockedxor-intrinsic-functions.md)||intrin.h|Short _InterlockedXor16 (короткий volatile \*, short)|
|[_InterlockedXor16_np](interlockedxor-intrinsic-functions.md)||intrin.h|короткий _InterlockedXor16_np (short \*, short)|
...
|[__inwordstring](inwordstring.md)||intrin.h|void __inwordstring (unsigned short, short без знака \*, long без знака)|
...
|[_mm_i32gather_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_i32gather_ps)|AVX2 [2]|immintrin.h|__m128 _mm_i32gather_ps (число с плавающей запятой const \*, \__m128i, const int)|
...
|[_mm_i64gather_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_i64gather_ps)|AVX2 [2]|immintrin.h|__m128 _mm_i64gather_ps (число с плавающей запятой const \*, \__m128i, const int)|
...
|[_mm_mask_i32gather_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_mask_i32gather_ps)|AVX2 [2]|immintrin.h|__m128 _mm_mask_i32gather_ps (\__m128, число с плавающей запятой const \*, \__m128i, \__m128, const int)|
...
|[_mm_mask_i64gather_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_mask_i64gather_ps)|AVX2 [2]|immintrin.h|__m128 _mm_mask_i64gather_ps (\__m128, число с плавающей запятой const \*, \__m128i, \__m128, const int)|
...
|[_mm_stream_ss](mm-stream-ss.md)|SSE4a|intrin.h|void _mm_stream_ss (число с плавающей запятой\*, \__m128)|
...
|[_mm256_i32gather_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_i32gather_ps)|AVX2 [2]|immintrin.h|__m256 _mm256_i32gather_ps (число с плавающей запятой const \*, \__m256i, const int)|
...
|[_mm256_i64gather_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_i64gather_ps)|AVX2 [2]|immintrin.h|__m128 _mm256_i64gather_ps (число с плавающей запятой const \*, \__m256i, const int)|
...
|[_mm256_mask_i32gather_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_mask_i32gather_ps)|AVX2 [2]|immintrin.h|__m256 _mm256_mask_i32gather_ps (\__m256, число с плавающей запятой const \*, \__m256i, \__m256, const int)|
...
|[_mm256_mask_i64gather_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_mask_i64gather_ps)|AVX2 [2]|immintrin.h|__m128 _mm256_mask_i64gather_ps (\__m128, число с плавающей запятой const \*, \__m256i, \__m128, const int)|
...
|[_mm256_stream_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_stream_ps)|AVX [2]|immintrin.h|void _mm256_stream_ps (число с плавающей запятой \*, \__m256)|
...
|[__movsq](movsq.md)||intrin.h|VOID __movsq (unsigned \__int64 \*без знака \__int64 const \*, size_t)|
|[__movsw](movsw.md)||intrin.h|VOID __movsw (unsigned short \*, без знака короткий const \*, size_t)|
...
|[__outbyte](outbyte.md)||intrin.h|void __outbyte (без знака короткое без знака, char)|
|[__outbytestring](outbytestring.md)||intrin.h|void __outbytestring (unsigned short, char без знака \*, long без знака)|
|[__outdword](outdword.md)||intrin.h|void __outdword(unsigned short, unsigned long)|
|[__outdwordstring](outdwordstring.md)||intrin.h|void __outdwordstring (unsigned short, unsigned long \*, long без знака)|
|[Встроенная функция __outword](outword.md)||intrin.h|void __outword (unsigned short без знака, short)|
|[__outwordstring](outwordstring.md)||intrin.h|void __outwordstring (unsigned short, short без знака \*, long без знака)|
...
|[__shiftleft128](shiftleft128.md)||intrin.h|unsigned __int64 \__shiftleft128 (unsigned \__int64, unsigned \__int64, char без знака)|
|[__shiftright128](shiftright128.md)||intrin.h|unsigned __int64 \__shiftright128 (unsigned \__int64, unsigned \__int64, char без знака)|
...
|[__stosb](stosb.md)||intrin.h|void __stosb (unsigned char \*, char без знака, size_t)|
...
|_subborrow_u16||intrin.h|unsigned char _subborrow_u16 (unsigned char, short без знака, short без знака, short без знака \*)|
...
|_subborrow_u8||intrin.h|unsigned char _subborrow_u8 (unsigned char, char без знака, char без знака, char без знака \*)|
...
|[__vmx_vmwrite](vmx-vmwrite.md)||intrin.h|char без знака __vmx_vmwrite (size_t, size_t)|
...
|[__writegsbyte](writegsbyte-writegsdword-writegsqword-writegsword.md)||intrin.h|void __writegsbyte (unsigned long без знака, char)|
...
|[__writegsword](writegsbyte-writegsdword-writegsqword-writegsword.md)||intrin.h|void __writegsword (unsigned long без знака, short)|
...
[Встроенные объекты компилятора](compiler-intrinsics.md)<br/>
[Встроенные функции ARM](arm-intrinsics.md)<br/>
[x86 встроенные функции](x86-intrinsics-list.md)