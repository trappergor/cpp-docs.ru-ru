...
Внутренние деления, делимые на *делитель*. `_udiv64` Он сохраняет остаток в 32-битовом целом число без знака, на который указывает *остаток*, и возвращает биты числа 32.
