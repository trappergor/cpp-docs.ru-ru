---
title: x86 список встроенных объектов
ms.date: 04/18/2019
helpviewer_keywords:
...
ms.locfileid: "62389649"
---
# <a name="x86-intrinsics-list"></a>x86 список встроенных объектов

В этом документе перечислены встроенные функции, Microsoft C /C++ поддерживаемые компилятором при ориентировании x86.
...
## <a name="x86-intrinsics"></a>x86 встроенные функции
...
|[_mm_monitor](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_monitor)|SSE3|intrin.h|void _mm_monitor (const void *, unsigned int, unsigned int)|
...
[x64 (amd64) встроенные функции](x64-amd64-intrinsics-list.md)
