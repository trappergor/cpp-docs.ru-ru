...
ms.locfileid: "78215480"
---
# <a name="x86-intrinsics-list"></a>Список встроенных объектов x86

В этом документе перечислены встроенные компоненты, которые поддерживаются компилятором Microsoft C/C++ компилятора при использовании платформы x86.
...
|[_InterlockedAddLargeStatistic](interlockedaddlargestatistic.md)||intrin.h|длинный _InterlockedAddLargeStatistic (\__int64 volatile \*, Long)|
...
|_m_to_float|3DNOW|intrin.h|_m_to_float с плавающей запятой (\__m64)|
...
|[_udiv64](udiv64.md)||intrin.h|Неподписанное целое число \_udiv64 (неподписанные \__int64, int без знака, беззнаковое целое \*)|
