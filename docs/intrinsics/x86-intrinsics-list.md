...
В этом документе перечислены встроенные функции, поддерживаемые компилятором Visual C++ при ориентировании на x86.
...
|_m_to_float|3DNOW|intrin.h|число с плавающей запятой _m_to_float (\__m64)|
