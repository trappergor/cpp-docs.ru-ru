---
title: x86 список встроенных объектов | Документы Microsoft
ms.custom: ''
ms.date: 06/01/2018
ms.technology:
- cpp-tools
...
|[_InterlockedAddLargeStatistic](../intrinsics/interlockedaddlargestatistic.md)||intrin.h|длинное _InterlockedAddLargeStatistic (\__int64 volatile *, long)|
