...
Доступен файл \<заголовка Intrin. h >, который объявляет прототипы для общих встроенных функций. Встроенные функции, зависящие от производителя, \<доступны в файлах заголовков использованием immintrin. h > и \<амминтрин. h >. Кроме того некоторые заголовки Windows объявляют функции, которые ссылаются на встроенные функции компилятора.
