---
title: __lzcnt16, __lzcnt, __lzcnt64 | Документация Майкрософт
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-tools
...
|`__lzcnt64`|AMD: Расширенные манипуляции бит (ABM) в 64-разрядном режиме.<br /><br /> Intel: Haswell|  
