...
Можно использовать контекстное меню в **диалоговое окно** редактор, чтобы быстро добавить зарегистрированных элементов управления ActiveX в диалоговое окно, а также можно добавить элементы управления ActiveX для **элементов** для быстрого доступа (Дополнительные сведения см. в разделе [Элементов](/visualstudio/ide/reference/toolbox)).
