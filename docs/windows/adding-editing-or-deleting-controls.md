---
title: Как Добавление, редактирование или удаление элементов управления (C++)
ms.date: 02/15/2019
f1_keywords:
...
ms.locfileid: "67400752"
---
# <a name="how-to-add-edit-or-delete-controls-c"></a>Как Добавление, редактирование или удаление элементов управления (C++)
...
1. На **редактор диалоговых окон** вкладке **элементов** окно, выберите нужный элемент управления, а затем —:
   ...
   - Перетаскивание элемента управления с **элементов** окно в расположение в диалоговом окне. Затем можно переместить элемент управления или изменить его размер и форму.

   - Дважды щелкните элемент управления **элементов** окне он отображается в диалоговом окне. Переместите его в нужное место.
...
1. Выберите и удерживайте кнопку мыши, чтобы закрепить в левом верхнем углу элемента управления в диалоговом окне. Затем перетащите курсор вправо и вниз, пока элемент управления не нужного размера.
...
Можно также использовать **переменных-членов** вкладке [мастер классов MFC](../mfc/reference/mfc-class-wizard.md) Чтобы добавить новые переменные-члены для заданного класса и просмотреть переменные-члены уже определено.
...
После добавления общего элемента управления или элемента управления форматированным редактированием в диалоговое окно, он не будет отображаться при тестировании диалоговое окно. Или не будет отображаться для самого диалогового окна. Пример:
...
> [!CAUTION]
> Распространение всех элементов ActiveX в системе может быть незаконным. См. в лицензионном соглашении программного обеспечения, установленную в элементы управления или обратиться в компанию программного обеспечения.
...
Элементы управления ActiveX, предоставляемые независимыми поставщиками могут поставляться с их свойствами и характеристики предварительно. Эти свойства отображаются в **свойства** окна. Все страницы свойств, созданные изготовителем элемента управления ActiveX, отображаются в **страницы свойств** диалоговое окно. (Чтобы просмотреть **страницу свойств** для конкретного элемента управления ActiveX, выберите **страницу свойств** кнопку [окно "Свойства"](/visualstudio/ide/reference/properties-window)).
