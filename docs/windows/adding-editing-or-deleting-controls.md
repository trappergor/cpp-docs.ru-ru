...
В диалоговое окно можно добавить пользовательские элементы управления. Выберите значок **настраиваемого элемента управления** на **панели элементов** и перетащите его в диалоговое окно. Чтобы добавить элемент управления `Syslink`, добавьте пользовательский элемент управления, а затем измените свойство **класса** элемента управления на `Syslink`. Это действие вызовет обновление свойств и отображение свойств элемента управления `Syslink`. Сведения о классе-оболочке MFC см. в разделе [CLinkCtrl](../mfc/reference/clinkctrl-class.md).
...
- Выберите элемент **ActiveX** и перейдите в меню **вид** > **Страница свойств** , чтобы просмотреть свойства. Внесите необходимые изменения на странице свойств.
