...
## Возвращаемое значение  
 `true` при `t` больше или равно `u`; в противном случае `false`.  
  
## Заметки  
 `SafeGreaterThanEquals` увеличивается стандартный оператор сравнения, поскольку он позволяет сравнивать 2 другого типа чисел.  
