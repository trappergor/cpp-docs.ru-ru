 ...
 **Заметки**  
 ...
 См. в разделе [классы и структуры ссылки](http://msdn.microsoft.com/library/windows/apps/hh699870.aspx) и [классы и структуры значений](http://msdn.microsoft.com/library/windows/apps/hh699861.aspx).  
