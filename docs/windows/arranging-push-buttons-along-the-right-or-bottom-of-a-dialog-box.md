---
title: Упорядочивание кнопок по правому или нижнему краю диалогового окна | Документация Майкрософт
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
2. Из **формат** меню, выберите **упорядочить кнопки**, а затем выберите один из следующих размещений:
   ...
   - `Bottom`: выравнивает кнопки вдоль нижней границы окна.
       ...
       Если выбрать элемент управления не является кнопкой, его положение не изменяется.
