---
title: Упорядочивание кнопок по правому или нижнему краю диалогового окна | Документы Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
2.  Из **формат** меню, выберите **упорядочить кнопки**, а затем выберите один из следующих размещений:  
  
    -   **Право**: выравнивает кнопки по правому краю диалогового окна.  
  
    -   **Нижней**: выравнивает кнопки вдоль нижнего края окна.  
