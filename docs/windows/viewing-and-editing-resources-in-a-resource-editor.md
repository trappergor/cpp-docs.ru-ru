---
title: Просмотр и редактирование ресурсов в редакторе ресурсов | Документация Майкрософт
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
2.  Если окно представления ресурсов не поверх остальных окон, нажмите кнопку **представление ресурсов** tab, чтобы вернуть его в начало.  
  
3.  В представлении ресурсов разверните папку для проекта, содержащего ресурсы, которые вы хотите просмотреть. Например если вы хотите просмотреть ресурс диалогового окна, разверните папку диалоговое окно.  
...
4.  Дважды щелкните ресурс, например IDD_ABOUTBOX.  
     ...
     Ресурс открывается в соответствующем редакторе. Например для диалоговых ресурсов, ресурс откроется в редакторе диалоговых окон.  
