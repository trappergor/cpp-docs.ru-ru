...
> [!NOTE]
> Визуальный C++ элемент содержит образцы файлов ресурсов, которые можно использовать в своем приложении. Дополнительные сведения см. в разделе [картинка: общие ресурсы](https://github.com/Microsoft/VCSamples/tree/master/VC2010Samples/MFC/general).
...
[Практическое руководство. Включение ресурсов во время компиляции](../windows/how-to-include-resources-at-compile-time.md)
