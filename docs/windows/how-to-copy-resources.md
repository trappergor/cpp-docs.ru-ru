...
2.  В первом RC-файле выберите ресурс, который требуется скопировать. Например, в Source1.rc, щелкните **IDD_DIALOG1**.  
...
3.  Удерживайте нажатой клавишу CTRL и перетащите ресурс во втором RC-файл. Например, перетащите **IDD_DIALOG1** из Source1.rc для Source2.rc.  
    ...
    > [!NOTE]
    >  Перетаскивание ресурса без удерживания нажатой клавишу CTRL перемещает ресурс, а не копировать его.  
...
2.  В исходном файле, из которого вы хотите скопировать ресурс (например, Source1.rc), щелкните правой кнопкой мыши ресурс и выберите **копирования** в контекстном меню.  
...
3.  Щелкните правой кнопкой мыши файл ресурсов, в которую вы хотите добавить ресурс (например, Source2.rc). Выберите **вставить** в контекстном меню.  
    ...
    > [!NOTE]
    >  Вы не может перетащить и drop, копирования, вырезания и вставки между файлами ресурсов в проекте (ресурсов) и автономный RC-файлов, (которые open в окнах документов). Это можно сделать в предыдущих версиях продукта.  
