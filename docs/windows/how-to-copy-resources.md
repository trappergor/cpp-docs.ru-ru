...
ms.locfileid: "56676413"
---
# <a name="how-to-manage-resources-c"></a>Практическое руководство. Управление ресурсами (C++)

Вы можете управлять ресурсами в своем проекте:

- Копирование и редактирование ресурсов.
...
Можно использовать метод перетаскивания и вставки между RC-файлов, открытых вне проекта.
...
1. В RC-файле или в [представление ресурсов](../windows/resource-view-window.md) окно, щелкните правой кнопкой мыши ресурс, нужно скопировать и выберите **вставить копию**. Затем установите следующие значения:
