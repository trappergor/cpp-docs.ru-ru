...
### <a name="to-change-the-language-or-condition-of-a-resource-while-copying"></a>Чтобы изменить язык или условие ресурса при копировании
...
Копирование существующего ресурса и изменение языка или условий:
...
## <a name="to-edit-managed-resource-files"></a>Редактирование файлов управляемых ресурсов
...
## <a name="to-import-and-export-resources"></a>Импорт и экспорт ресурсов
...
1. Выберите **Экспорт** в контекстном меню.

1. В **Экспорт ресурса** диалогового окна поле примите текущее имя файла или введите новое.
