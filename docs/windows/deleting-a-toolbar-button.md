---
title: Удаление кнопки панели инструментов | Документы Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
---
# <a name="deleting-a-toolbar-button"></a>Удаление кнопки панели инструментов
### <a name="to-delete-a-toolbar-button"></a>Чтобы удалить кнопку панели инструментов  
  
1.  Выберите кнопку панели инструментов и перетащите ее с панели инструментов.  
