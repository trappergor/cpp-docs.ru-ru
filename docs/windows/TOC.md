...
###### [Общие сведения об управлении доступом и значениях](defining-mnemonics-access-keys.md)
#### [Редактор изображений для значков](image-editor-for-icons.md)
##### [Создание значка или другого изображения](creating-an-icon-or-other-image-image-editor-for-icons.md)
##### [Редактирование изображения](selecting-an-area-of-an-image-image-editor-for-icons.md)
##### [Использование инструмента рисования](using-a-drawing-tool-image-editor-for-icons.md)
##### [Работа с цветом](working-with-color-image-editor-for-icons.md)
##### [Сочетания клавиш](accelerator-keys-image-editor-for-icons.md)
#### [Редактор меню](menu-editor.md)
##### [Создание и редактирование меню](creating-a-menu.md)
