...
### <a name="remarks"></a>Примечания  
 Дополнительные сведения и примеры со строками, см. в разделе [Platform::String, std::wstring и литералы (платформы)](http://msdn.microsoft.com/ec92fbc6-edf3-4137-a85e-8e29bdb857a8)  
