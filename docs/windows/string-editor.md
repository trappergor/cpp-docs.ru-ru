...
Чтобы добавить записи в таблице строк:
...
Чтобы удалить записи в таблице строк:
...
1. В RC-файле, к которому нужно вставить строку, щелкните правой кнопкой мыши и выберите **вставить**.
...
Чтобы изменить строку или его идентификатор:
...
Изменение свойство заголовка для нескольких строковых ресурсов.
