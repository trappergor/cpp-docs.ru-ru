---
title: Устранение неполадок редактора диалоговых окон | Документация Майкрософт
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
ms.locfileid: "40011108"
---
# <a name="troubleshooting-the-dialog-editor"></a>Устранение неполадок редактора диалоговых окон
Ниже приведены некоторые проблемы, которые следует иметь в виду при работе **диалоговое окно** редактора.  
