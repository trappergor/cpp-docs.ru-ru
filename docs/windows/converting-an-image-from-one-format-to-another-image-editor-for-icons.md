---
title: Преобразование изображения из одного формата в другой (редактор изображений для значков) | Документы Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
3.  В **сохранить файл как** диалогового **имя файла** введите имя файла и расширение, обозначающее нужный формат.  
