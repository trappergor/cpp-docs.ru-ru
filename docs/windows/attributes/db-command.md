...
> блок параметров привязки 1 &nbsp;&nbsp;команда OLE DB блок параметров привязки 2 &nbsp;&nbsp;продолжение команды OLE DB блок параметров привязки 3 ...
...
- **\[** *bindtype* **]** содержит одну из следующих строк без учета регистра:
