...
> **(\[ ** *биндтипе* **]** *szVar1* szVar1 \[, *szVar2* szVar2 \[, *nVar3* nVar3 \[,...]]] **)**
...
- **\[***биндтипе* **]** является одной из следующих строк без учета регистра:
  ...
  - ** \[в]** привязывает переменные члена в качестве входных параметров.
...
|||
|-|-|
|**Относится к**|**class**, **struct**, member, method, local|
|**REPEATABLE**|нет|
