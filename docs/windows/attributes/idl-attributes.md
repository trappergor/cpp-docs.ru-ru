...
Обратите внимание, что [idl_quote](idl-quote.md) позволяет использовать MIDL конструкции, которые не поддерживаются в текущей версии Visual C++. Это и другие атрибуты, такие как [importlib](importlib.md) и [includelib](includelib-cpp.md) позволяют использовать существующие IDL-файлы в текущем проекте Visual C++.
...
|[элемент управления](control.md)|Указывает, что определяемый пользователем тип элемента управления.|
...
|[импорт](import.md)|Указывает другой .idl, .odl или заголовка файла, содержащего определения, как нужно ссылаться из вашей основной IDL-файла.|
...
|[источник](source-cpp.md)|Указывает, что член класса, свойство или метод является источником событий.|
