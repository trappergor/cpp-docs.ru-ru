...
> [!NOTE]
> **Атрибут** атрибут считается устаревшим.  Использовать общий атрибут среды выполнения языка `System.Attribute` к непосредственно для создания пользовательских attirbutes. Дополнительные сведения см. в разделе [определяемые пользователем атрибуты](../user-defined-attributes-cpp-component-extensions.md).

Вы определите [настраиваемого атрибута](custom-attributes-cpp.md) , поместив **атрибут** атрибута в определении управляемого класса или структуры. Имя класса является настраиваемого атрибута. Пример:
...
Список допустимых типов параметров, см. в разделе [пользовательские атрибуты](custom-attributes-cpp.md).

См. в разделе [определяемые пользователем атрибуты](../user-defined-attributes-cpp-component-extensions.md) обсуждение целевые объекты атрибутов.
