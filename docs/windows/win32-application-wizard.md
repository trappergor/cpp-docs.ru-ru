...
-   проект не включает поддержку MFC и ATL.  
 ...
 Чтобы изменить эти значения по умолчанию, перейдите на вкладку [Параметры приложения](../Topic/Application%20Settings,%20Win%2032%20Project%20Wizard.md) в левом столбце мастера и внесите необходимые изменения.  
