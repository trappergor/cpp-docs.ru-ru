---
title: Атрибуты членов данных | Документы Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
|Атрибут|Описание|  
|---------------|-----------------|  
|[db_accessor](../windows/db-accessor.md)|Группы **db_column** атрибутов, участвующих в `IAccessor`-привязку на основе.|  
