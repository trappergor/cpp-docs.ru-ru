...
1.  В диалоговом окне выберите элемент управления и нажмите клавишу **DELETE**.  
...
2.  В меню **Правка** выберите команду **Удалить**.  
    ...
    > [!TIP]
    >  Во время работы с редактором диалоговых окон с помощью контекстного меню, которое вызывается щелчком правой кнопки мыши, можно получить быстрый доступ к наиболее часто используемым командам.  
