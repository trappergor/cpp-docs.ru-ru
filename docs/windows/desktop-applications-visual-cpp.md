...
**Мост для классических приложений** набор Windows API в Windows 10 можно упаковать в существующего классического приложения или COM-объект как приложение универсальной платформы Windows и добавить функции универсальной платформы Windows, такие как менять или вызов API из modern. Также можно добавить приложения универсальной платформы Windows для настольных решений в Visual Studio и пакета их вместе в один пакет и использовать API-интерфейсы Windows для связи между ними.  
