...
|[Hilo: разработка приложений C++ для Windows 7](https://msdn.microsoft.com/library/windows/desktop/ff708696.aspx)|Описание способов создания классического приложения Windows, использующего анимацию Windows и Direct2D для создания интерфейса пользователя по принципу карусели.  Этот учебник не был обновлен с момента выпуска Windows 7, но он по-прежнему предоставляет исчерпывающие сведения о программировании Win32.|
