...
*Interface2*<br/>
(Необязательно) Исходный интерфейс по умолчанию. Этот интерфейс также необходимо указать с помощью атрибута [source](../windows/source-cpp.md) .
...
**По умолчанию** атрибут C++ имеет ту же функциональность, что [по умолчанию](/windows/desktop/Midl/default) описании атрибута MIDL. Атрибут **default** также используется вместе с атрибутом [case](../windows/case-cpp.md) .
