...
*базовый_список* (необязательно)  
Список, содержащий один или несколько явные базовые интерфейсы, разделенные запятыми.

*теле интерфейса*  
Объявления членов интерфейса.

*деклараторы* (необязательно)  
Объявления переменных, на основе этого типа.
