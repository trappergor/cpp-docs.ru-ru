---
title: Создание классического приложения Windows пустой | Документация Майкрософт
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
ms.locfileid: "39464367"
---
# <a name="creating-an-empty-windows-desktop-application"></a>Создание пустого классического приложения Windows
### <a name="to-create-an-empty-windows-desktop-application"></a>Создание пустого классического приложения Windows  
