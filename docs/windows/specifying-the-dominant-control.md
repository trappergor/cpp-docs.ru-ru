---
title: Задание главного элемента управления | Документы Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
ms.locfileid: "33889657"
---
# <a name="specifying-the-dominant-control"></a>Задание главного элемента управления
Первого выбранного элемента управления — главного элемента управления.  
  
### <a name="to-specify-the-dominant-control"></a>Чтобы указать главного элемента управления  
  
1.  Удерживайте клавишу **CTRL** ключа и щелкните элемент управления, который вы хотите использовать для изменения размера или размещения других элементов управления *первый*.  
  
     **Примечание** маркеры размера главного элемента управления показываются сплошными, а маркеры подчиненных элементов управления — пустыми. Все дальнейшее изменение размера или выравнивание зависит главного элемента управления.  
