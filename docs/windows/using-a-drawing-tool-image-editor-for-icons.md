---
title: Использование инструмента рисования
ms.date: 11/04/2016
f1_keywords:
...
ms.locfileid: "56320553"
---
# <a name="using-a-drawing-tool"></a>Использование инструмента рисования
...
1. Выберите **изображение** меню и выберите **средства** команды.

1. Каскадные подменю выберите средство, которое вы хотите использовать.

## <a name="drawing-lines-or-closed-figures"></a>Рисование линий и замкнутых фигур
...
1. На [панель инструментов редактора изображений](../windows/toolbar-image-editor-for-icons.md) (или из **изображение** меню **средства** команды), выберите **строки** средство.
...
1. На **редактор изображений** панели инструментов (или из **изображение** меню **средства** команда) выберите **Рисование замкнутой фигуры** средство.
...
## <a name="create-a-custom-brush"></a>Создание настраиваемой кисти
...
1. Удерживая **Shift** ключа вниз, выберите в выделенном фрагменте и перетащите его по изображению.

   \- или -

1. Из **изображение** меню, выберите **использовать выделенную область как кисть**.
...
1. [Задайте цвет фона](../windows/selecting-foreground-or-background-colors-image-editor-for-icons.md) цвет, в котором необходимо нарисовать.
