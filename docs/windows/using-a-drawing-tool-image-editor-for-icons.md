---
title: Как выполнить  Использование инструмента рисования
ms.date: 02/15/2019
f1_keywords:
...
ms.locfileid: "56336557"
---
# <a name="how-to-use-a-drawing-tool"></a>Как выполнить  Использование инструмента рисования
...
1. Удерживайте **Shift** ключа вниз, выберите в выделенном фрагменте и перетащите его по изображению. Или из **изображение** меню, выберите **использовать выделенную область как кисть**.
