...
Можно легко открыть файл ресурсов в текстовом формате, чтобы просмотреть все содержащиеся в ней ресурсы и выполнить глобальные операции, поддерживаемые [текстовый редактор](https://msdn.microsoft.com/508e1f18-99d5-48ad-b5ad-d011b21c6ab1).
