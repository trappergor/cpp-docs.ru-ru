---
title: Растяжение всего изображения (редактор изображений для значков) и | Документация Майкрософт
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
2.  Удерживая нажатой **Shift** ключа и перетащите маркер изменения размера изображения нужного размера.  
