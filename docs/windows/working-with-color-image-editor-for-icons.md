---
title: Как выполнить  Работать с цветом
ms.date: 02/15/2019
f1_keywords:
...
ms.locfileid: "56336648"
---
# <a name="how-to-work-with-color"></a>Как выполнить  Работать с цветом
...
- Для отображения **цвета** окно, щелкните правой кнопкой мыши в **редактор изображений** панели и выберите **Показать окно "цвета"**, или выберите **Показать окно "цвета"** на [меню "изображение"](../windows/image-menu-image-editor-for-icons.md).
...
1. На **редактор изображений** панели инструментов (или используйте **изображение** > **средства**) выберите **заполнения** средство.
...
Инвертирование цветов в выделенной области, на **изображение** меню, выберите **обратить цвета**.
