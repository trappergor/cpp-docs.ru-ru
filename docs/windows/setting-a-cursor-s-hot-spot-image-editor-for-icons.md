---
title: "Установка курсора &#39; s горячей позицию (редактор изображений для значков) | Документы Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
ms.author: mblome
manager: ghogen
ms.openlocfilehash: c8482e50eb57013d366389217ad13a6c5b14c092
ms.sourcegitcommit: ebec1d449f2bd98aa851667c2bfeb7e27ce657b2
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 10/24/2017
---
# <a name="setting-a-cursor39s-hot-spot-image-editor-for-icons"></a>Установка курсора &#39; s горячей позицию (редактор изображений для значков)
...
1.  На [панель инструментов редактора изображений](../windows/toolbar-image-editor-for-icons.md), нажмите кнопку **задать активную зону** средства.  
  
2.  Выберите пиксель, который вы хотите назначить в качестве активной точки курсора.  
  
     **Гиперобъектов** свойство в **свойства** окне отображаются новые координаты.  
