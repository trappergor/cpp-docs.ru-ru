...
Выберите имя существующего меню и нажмите клавишу **вставить** либо щелкните правой кнопкой мыши в строке меню и выберите **вставить новое** в контекстном меню.
...
Щелкните правой кнопкой мыши имя меню или команду и выберите **удалить** в контекстном меню.
...
1. Создание меню с пустым заголовком (не предоставляют **заголовок**).
...
> [!NOTE]
> Чтобы вернуться в представление строки меню, выберите **отобразить как всплывающее** снова (которая снимается флажок и возвращает представление строки меню).
