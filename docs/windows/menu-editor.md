...
1. Перейдите в **представление** меню > **другие** > Windows **представление ресурсов** и щелкните правой кнопкой мыши заголовок **меню** . Выберите **Добавить ресурс**, а затем — **меню**.
