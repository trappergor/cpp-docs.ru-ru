...
-   [изменение свойств команды меню.](../windows/menu-command-properties.md)  
    ...
    > [!TIP]
    >  При использовании редактора меню во многих случаях можно щелкнуть правой кнопкой мыши, чтобы открыть контекстное меню с часто используемыми командами. Доступные команды зависят от объекта, на который наведен указатель мыши.  
