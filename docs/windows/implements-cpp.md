...
## <a name="example"></a>Пример  
 Следующий пример состоит из трех частей: IDL-файл и его связанные h-файл и файл на языке C++.  
  
 Предположим, следующие IDL-файл, который можно найти в компилятор.  
...
## <a name="example"></a>Пример  
 И следующие h-файл, который также должен быть доступен для компилятора.  
...
## <a name="example"></a>Пример  
 В следующей программе, не реализует IBar1, IBar2 и ЕНД не будет в компонентном классе в созданном IDL.  
