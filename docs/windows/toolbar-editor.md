...
1. Последовательно выберите пункты **изображение** меню > **Редактор панели инструментов**.
...
1. Последовательно выберите пункты меню **изменить** > **Копировать**.
...
1. Взгляните на строку состояния в нижней части окна **WordPad** и обратите внимание на то, что теперь отображается текст `Prints the active document`.

`Print` — это имя подсказки, а `Prints the active document` — описание кнопки для строки состояния.
...
[меню и других ресурсов](/windows/win32/menurc/resources)<br/>
