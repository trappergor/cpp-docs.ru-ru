---
title: Элемент данных Factorycache::Factory | Документы Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
ms.locfileid: "33881443"
---
# <a name="factorycachefactory-data-member"></a>Элемент данных FactoryCache::factory
