---
title: "Элемент данных FactoryCache::factory | Microsoft Docs"
ms.custom: ""
ms.date: "12/16/2016"
...
manager: "ghogen"
---
# Элемент данных FactoryCache::factory
...
## Заметки  
 Указывает на фабрику классов [!INCLUDE[wrt](../atl/reference/includes/wrt_md.md)] или модели COM.  
