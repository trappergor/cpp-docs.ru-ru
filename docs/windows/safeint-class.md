...
|Параметр|Описание:|
|---------------|-----------------|
|[in] *правая часть*|Входной параметр, представляющий значение правой стороны оператора в несколько отдельные функции.|
|[in] *я*|Входной параметр, представляющий значение правой стороны оператора в несколько отдельные функции.|
|[in] *bits*|Входной параметр, представляющий значение правой стороны оператора в несколько отдельные функции.|
