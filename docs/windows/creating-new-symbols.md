...
|**Изменение**|Открывает **Изменение символа** диалоговое окно, позволяющее изменить имя или значение символа. Если символ принадлежит элементу управления или используемому ресурсу, то его можно изменить только в соответствующем редакторе ресурсов. Дополнительные сведения см. в разделе [управление символы](../windows/changing-unassigned-symbols.md).|
...
Чтобы открыть к редактору ресурсов заданного символа:
