---
title: Новый &lt;устройства&gt; изображения диалоговое окно «тип» (редактор изображений для значков) | Документация Майкрософт
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
ms.locfileid: "40019290"
---
# <a name="new-ltdevicegt-image-type-dialog-box-image-editor-for-icons"></a>Новый &lt;устройства&gt; изображения диалоговое окно «тип» (редактор изображений для значков)
