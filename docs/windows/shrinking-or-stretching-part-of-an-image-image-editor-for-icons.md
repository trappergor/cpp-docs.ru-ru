---
title: Растяжение и сжатие фрагмента изображения (редактор изображений для значков) | Документация Майкрософт
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
2.  Перетащите один из маркеров изменения размера выделение требуемого размера.  
