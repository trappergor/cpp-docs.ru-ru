---
title: Перемещение кнопки панели инструментов | Документация Майкрософт
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
1.  В **инструментов представления** панели, перетащите кнопку, вы хотите переместить в новое место на панели инструментов.  
