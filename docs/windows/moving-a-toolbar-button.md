...
### Перемещение кнопки в панели инструментов  
  
1.  В области **Представление панели инструментов** перетащите кнопку, которую требуется переместить, на ее новое место в панели инструментов.  
