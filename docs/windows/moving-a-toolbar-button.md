---
title: Перемещение кнопки панели инструментов | Документы Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
1.  В **инструментов представления** панели, перетащите кнопку, которую требуется переместить в новое место на панели инструментов.  
