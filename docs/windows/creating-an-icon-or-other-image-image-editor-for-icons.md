...
**Конечный тип изображений** свойство перечисляет доступные типы изображений. Выберите тип образа, который вы хотите открыть:
...
## <a name="saving-bitmaps-as-gifs-or-jpegs"></a>Сохранение растровых изображений как изображений GIF или JPEG
...
1. Все еще открыт в растровое изображение **изображение** редакторе, выберите пункт **Сохранить *filename*.bmp как** на **файл** меню.
...
## <a name="converting-an-image-from-one-format-to-another"></a>Преобразование изображения из одного формата в другой
...
1. Из **файл** меню, выберите **Сохранить *filename* как**.
