...
- Чтобы открыть файл скрипта ресурсов за пределами проекта, в меню последовательно выберите пункты **File**  >  **Открыть**файл и **файл**. Перейдите к файлу описания ресурсов, выделите его и нажмите кнопку **Открыть**.
