---
title: "Работа с файлами ресурсов | Документы Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
> [!WARNING]
>  Этот раздел относится к классическим приложениям Windows, написанным на C++. Сведения о ресурсах в приложениях универсальной платформы Windows, написанного на языке C++ см. в разделе [определение ресурсов приложения](http://msdn.microsoft.com/en-us/476ea844-632c-4467-9ce3-966be1350dd4).  
>   
>  Сведения о добавлении ресурсов в C + +/ CLI проектов, см. в разделе [ресурсы в классических приложениях](/dotnet/framework/resources/index) в *руководства разработчика .NET Framework.*  
...
## <a name="related-sections"></a>Связанные разделы  
 ...
 [Введение в Visual Studio](http://msdn.microsoft.com/en-us/99997089-56ff-4d60-81a9-447062dc98ac)  
