...
- Чтобы показать или скрыть панель инструментов **редактора диалоговых окон** , перейдите **в меню**  >  **Toolbars**  >  **Редактор диалоговых окон**панели инструментов.
...
|Format.ToggleGuides|**CTRL**  +  **Ж**|Переключение между отсутствием сетки, руководств и сетки при редактировании диалогового окна.|
