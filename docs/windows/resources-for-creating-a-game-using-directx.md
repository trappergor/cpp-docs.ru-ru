...
## <a name="resources"></a>Ресурсы  
 Visual C++ входит во все выпуски Visual Studio. Сведения о Visual Studio см. в разделе [Visual Studio](http://www.visualstudio.com/) веб-сайта.  
  
 Для [!INCLUDE[win81](../misc/includes/win81_md.md)] DirectX входит в состав Windows SDK. Не требуется загружать никаких дополнительных компонентов. Дополнительные сведения см. в разделе [где — пакет SDK DirectX?](http://msdn.microsoft.com/library/windows/desktop/ee663275.aspx).  
