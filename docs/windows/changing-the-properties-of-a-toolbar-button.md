---
title: Изменение свойств кнопки панели инструментов (C++) | Документация Майкрософт
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
ms.locfileid: "44313538"
---
# <a name="changing-the-properties-of-a-toolbar-button-c"></a>Изменение свойств кнопки панели инструментов (C++)
