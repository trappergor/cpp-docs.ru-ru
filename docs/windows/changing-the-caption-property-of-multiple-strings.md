---
title: Изменение капитализации нескольких строк | Документы Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
2.  Выберите строки, которые требуется изменить, удерживая нажатой **CTRL** ключа, щелкните каждый из них.  
  
3.  В [окно свойств](/visualstudio/ide/reference/properties-window), введите новое значение для свойства, которые требуется изменить.  
