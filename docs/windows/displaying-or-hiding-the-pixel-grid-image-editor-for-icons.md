---
title: Отображение или скрытие пиксельной сетки (редактор изображений для значков)
ms.date: 11/04/2016
helpviewer_keywords:
- grids, pixel
...
1. На **изображение** меню, щелкните **параметры сетки**.

2. Выберите **пиксельную сетку** флажок, чтобы отобразить сетку, или снимите флажок, чтобы скрыть сетку.
