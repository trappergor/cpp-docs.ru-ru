---
title: "Оператор дескриптора объекта (^) (расширения компонентов C++) | Microsoft Docs"
ms.custom: ""
ms.date: "12/16/2016"
...
*Декларатор дескриптора* \(`^`, произносится как "шляпка"\) изменяет [спецификатор](../cpp/overview-of-declarators.md) типа и указывает, что объявленный объект будет автоматически удален, когда система определит, что он более недоступен.  
  
## Доступ к объявленному объекту  
 ...
 **Output**  
  ...
  **Array value: 7**  
 **Cannot access array element 11, size is 10** **Пример**  
