...
Все средства, доступные на панели инструментов **редактора изображений** , также доступны из меню **изображений**  >  **Tools**. Чтобы использовать панель инструментов **редактора изображений** и селектор **параметров** , выберите нужный инструмент или параметр.
...
- Чтобы отобразить или скрыть панель инструментов **редактора изображений** , перейдите к **View**  >  **панели инструментов** представления меню и выберите **Редактор изображений**.
...
Чтобы открыть это диалоговое окно, откройте **Редактор изображений** и перейдите в меню **Image**  >  **инструменты**изображения, а затем выберите команду **инструмент "текст** ".
...
1. Перейдите в меню **Image**  >  **инструменты** изображения и выберите **инструмент "текст**".
...
1. Последовательно выберите пункты **Image**  >  **Параметры сетка**изображений.
