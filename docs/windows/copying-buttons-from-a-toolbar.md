...
### Копирование кнопок из панели инструментов  
  
1.  Удерживайте нажатой клавишу **CTRL**.  
  
2.  В области **Представление панели инструментов** перетащите кнопку либо в ее новое место в панели инструментов, либо на другую панель инструментов.  
