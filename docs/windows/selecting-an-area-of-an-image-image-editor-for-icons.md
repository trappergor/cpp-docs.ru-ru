...
1. Используйте панель инструментов **редактора изображений** или перейдите к меню **Image**  >  **инструменты** изображения и выберите нужное средство выбора.
