---
title: Как выполнить Изменить изображение
ms.date: 02/15/2019
f1_keywords:
...
ms.locfileid: "56336535"
---
# <a name="how-to-edit-an-image"></a>Как выполнить Изменить изображение
...
## <a name="select-an-image"></a>Выберите образ
...
## <a name="edit-parts-of-an-image"></a>Изменение фрагментов изображения
...
## <a name="flip-an-image"></a>Отражение изображения
...
## <a name="resize-an-image"></a>Изменение размера изображения
...
## <a name="edit-an-image-outside-of-a-project"></a>Редактирование изображения за пределами проекта
...
## <a name="change-image-properties"></a>Изменение свойств изображения
