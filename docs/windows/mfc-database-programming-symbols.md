---
title: Символы программирования базы данных MFC | Документация Майкрософт
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
|AFX_IDP_SQL_NO_POSITIONED_ ОБНОВЛЕНИЙ|AFX_IDP_SQL_NO_ROWS_AFFECTED|
