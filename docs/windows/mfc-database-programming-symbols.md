...
Символы в этой таблице появляются в проекте MFC только при добавлении поддержки базы данных.  Они поддерживают подключение MFC к серверам SQL и программированию базы данных.  
