...
-   [OBJECT_ENTRY_AUTO](../atl/reference/object-map-macros.md#object_entry_auto) макрос вставляется в сопоставление COM.
 ...
 Имя компонентного класса, созданный в IDL-файл для класса будет иметь имя, совпадающее с именем класса.  Например, и ссылающийся на приведенный ниже для доступа к идентификатор класса для компонентного класса CMyClass, в клиенте с помощью файла заголовка, созданные MIDL, используйте CLSID_CMyClass.  
