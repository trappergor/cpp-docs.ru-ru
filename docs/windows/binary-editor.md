...
## <a name="binary-editor-how-to"></a>Практическое руководство двоичный редактор

С помощью **двоичных** редактора, см. следующие действия:

### <a name="to-open-a-resource-for-binary-editing"></a>Открытие ресурса для редактирования в двоичном редакторе

#### <a name="to-open-a-windows-desktop-resource"></a>Открытие ресурса рабочего стола Windows
...
#### <a name="to-open-a-managed-resource"></a>Открытие управляемого ресурса
