---
title: Добавление изображения для другого устройства отображения (редактор изображений для значков) | Документация Майкрософт
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
1.  На **изображение** меню, щелкните **изображения для устройства** (или щелкните правой кнопкой мыши в **редактор изображений** панели и выберите **изображения для устройства** из контекстное меню).  
  
2.  Выберите тип образа, который вы хотите добавить. Можно также щелкнуть **Custom** по созданию значков, размер которых не доступен в списке по умолчанию.  
