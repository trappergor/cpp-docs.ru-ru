---
title: 'Практическое: объявление внутренних указателей с помощью ключевого слова const (C + +/ CLI) | Документация Майкрософт'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
Ниже приведен пример, как использовать **const** в объявлении внутреннего указателя.  
