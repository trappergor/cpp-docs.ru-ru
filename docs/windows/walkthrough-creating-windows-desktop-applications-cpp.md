...
- Копия Visual Studio 2017 г. Сведения о том, как загрузить и установить Visual Studio см. в разделе [установить Visual Studio 2017 г.](/visualstudio/install/install-visual-studio) При запуске программы установки, убедитесь, что **разработки настольных приложений с помощью C++** проверяется рабочей нагрузки. Не беспокойтесь, если рабочая нагрузка не установлен, при установке Visual Studio. Можно еще раз запустите программу установки и установите его.
