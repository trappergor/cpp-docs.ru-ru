---
title: Как выполнить Завершение асинхронных операций с использованием WRL
ms.date: 11/04/2016
ms.topic: reference
...
ms.locfileid: "54337683"
---
# <a name="how-to-complete-asynchronous-operations-using-wrl"></a>Как выполнить Завершение асинхронных операций с использованием WRL
