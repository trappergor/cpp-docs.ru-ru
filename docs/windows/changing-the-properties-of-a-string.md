---
title: Изменение свойств строки | Документы Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
ms.locfileid: "33860607"
---
# <a name="changing-the-properties-of-a-string"></a>Изменение свойств строки
### <a name="to-change-a-string-or-its-identifier"></a>Чтобы изменить строку или его идентификатор  
...
2.  Выберите строку, необходимо изменить и дважды щелкните **идентификатор**, **значение**, или **заголовок** столбца. Теперь вы можете:  
  
    -   Выберите **идентификатор** из **идентификатор раскрывающегося списка** списке или введите идентификатор непосредственно на месте.  
