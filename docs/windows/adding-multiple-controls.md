...
1.  Удерживая клавишу **CTRL**, выберите элемент управления в [окне панели элементов](../Topic/Toolbox.md).  
  
2.  Отпустите клавишу **CTRL** и щелкните диалоговое окно столько раз, сколько экземпляров данного элемента управления необходимо добавить.  
