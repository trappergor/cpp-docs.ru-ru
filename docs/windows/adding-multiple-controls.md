---
title: Добавление нескольких элементов управления | Документация Майкрософт
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
2. Выпуск **Ctrl** ключа и щелкните диалоговое окно столько раз, сколько вы хотите добавить конкретного элемента управления.

3. Нажмите клавишу **Esc** остановить размещения элементов управления.
