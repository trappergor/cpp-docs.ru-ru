...
1. Последовательно выберите пункты **вид**меню  >  другие**представление ресурсов** **Windows** > .
...
1. В [окно свойств](/visualstudio/ide/reference/properties-window)нажмите кнопку **страницы свойств** .
   ...
   > [!TIP]
   > Используйте ярлык, перейдите к **представлению**меню  > **страницы свойств**.
