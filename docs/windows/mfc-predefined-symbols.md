...
Проекты MFC всегда содержат несколько файлов заголовков, которые поддерживают работу с окнами.  Их можно добавить с помощью операторов \#include в файле StdAfx.h:  
...
```  
 ...
 Файлы заголовков содержат значения идентификаторов символов для общих значений MFC.  Эти символы доступны только при работе с проектами MFC.  Обратите внимание, что за префиксом AFX\_ следуют стандартные префиксы имени символа.  
