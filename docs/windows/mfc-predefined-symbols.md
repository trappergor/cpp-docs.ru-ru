...
Файлы заголовков, которые содержат значения Идентификаторов символов для общих значений MFC. Эти символы доступны только при работе в проекте MFC. Обратите внимание, что префикс AFX_ следуют стандартные префиксы имени символа.
...
|AFX_IDP_DAO_DFX_BIND|ИНИЦИАЛИЗАЦИЯ AFX_IDP_DAO_ENGINE_|
...
|AFX_IDS_METAFILE_FORMAT|AFX_IDS_MINI ШРИФТА|
|AFX_IDS_NOT_DOCOBJECT|ИСКЛЮЧЕНИЕ AFX_IDS_NOT_SUPPORTED_|
