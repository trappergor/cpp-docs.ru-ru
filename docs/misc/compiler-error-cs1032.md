...
Невозможно определить символы препроцессора или отменить их определение где\-либо, кроме начала файла.  
 ...
 [Директивы препроцессора](../Topic/C%23%20Preprocessor%20Directives.md) `#define` и `#undef` необходимо использовать в начале программы, перед другими ключевыми словами, например используемыми в объявлении пространства имен.  
