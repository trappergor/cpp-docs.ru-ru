...
Абстрактный метод "метод" не может быть помечен как виртуальный  
 ...
 Излишне одновременно помечать метод как [абстрактный](../Topic/abstract%20\(C%23%20Reference\).md) и как [виртуальный](../Topic/virtual%20\(C%23%20Reference\).md), потому что подразумевается, что **абстрактный** метод является **виртуальным**.  
