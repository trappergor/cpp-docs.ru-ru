...
"переопределение\_свойства": невозможно переопределить, поскольку "не\_свойство" не является свойством  
 ...
 Предпринята попытка переопределения типа данных, не являющегося свойством, как [свойства](../Topic/Properties%20\(C%23%20Programming%20Guide\).md), что недопустимо.  
