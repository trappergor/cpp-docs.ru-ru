...
К указателю должен быть применен оператор \* или \-\>.  
 ...
 Оператор **\*** или **\-\>** используется с типом, не являющимся указателем. Дополнительные сведения см. в разделе [Типы указателей](../Topic/Pointer%20types%20\(C%23%20Programming%20Guide\).md).  
