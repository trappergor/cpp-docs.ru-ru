---
title: "Предупреждение о соответствии спецификации CLS CLS03603 | Microsoft Docs"
ms.custom: ""
ms.date: "10/29/2016"
...
manager: "douge"
---
# Предупреждение о соответствии спецификации CLS CLS03603
Глобальные статические поля несовместимы с CLS  
 ...
 В следующем примере возникает ошибка CLS03603:  
