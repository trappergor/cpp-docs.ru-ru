...
Не используйте System.ParamArrayAttribute. Используйте ключевое слово "params".  
 ...
 Компилятор C\# не допускает использование <xref:System.ParamArrayAttribute?displayProperty=fullName>. Используйте вместо этого ключевое слово [params](../Topic/params%20\(C%23%20Reference\).md).  
