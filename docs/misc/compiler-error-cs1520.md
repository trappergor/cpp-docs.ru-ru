...
Метод должен иметь тип возвращаемого значения  
 ...
 Метод, объявленный в классе, структуре или интерфейсе, должен иметь явный тип возврата. В следующем примере метод Square имеет возвращаемое значение [string](../Topic/string%20\(C%23%20Reference\).md):  
...
## См. также  
 [Методы](../Topic/Methods%20\(C%23%20Programming%20Guide\).md)   
 [Конструкторы](../Topic/Constructors%20\(C%23%20Programming%20Guide\).md)