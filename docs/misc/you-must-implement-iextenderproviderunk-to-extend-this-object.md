...
Объект расширителя основывается на интерфейсе IUnknown, а не на интерфейсе IDispatch.  
  
### Чтобы исправить эту ошибку  
  
1.  Поставщик расширителя должен реализовать IExtenderProviderUnk вместо IExtenderProvider.  
