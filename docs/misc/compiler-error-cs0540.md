...
"член\_интерфейса": вмещающий тип не реализует интерфейс "интерфейс"  
 ...
 Попытка реализовать член интерфейса в [классе](../Topic/class%20\(C%23%20Reference\).md), который не наследует от соответствующего [интерфейса](../Topic/interface%20\(C%23%20Reference\).md). Следует удалить реализацию члена интерфейса или добавить интерфейс в список базовых классов класса.  
