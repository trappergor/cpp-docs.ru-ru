...
"член": новый защищенный член объявлен в запечатанном классе  
 ...
 [Запечатанный](../Topic/sealed%20\(C%23%20Reference\).md) класс не может вводить [защищенный](../Topic/protected%20\(C%23%20Reference\).md) член, так как никакому другому классу не удастся наследовать от класса с атрибутом `sealed` и использовать член с атрибутом `protected`.  
