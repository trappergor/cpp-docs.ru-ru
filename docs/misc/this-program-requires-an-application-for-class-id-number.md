...
Visual Studio не удалось найти приложение, выбранное для использования.  Данное сообщение — это ошибка операционной системы.  
  
### Чтобы исправить эту ошибку  
  
1.  Переустановите соответствующее приложение и повторите попытку.  
  
     —или—  
  
     Переустановите Visual Studio и повторите попытку.