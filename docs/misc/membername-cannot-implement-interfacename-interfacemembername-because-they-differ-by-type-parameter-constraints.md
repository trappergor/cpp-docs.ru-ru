...
-   Если ограничения параметров типов должны остаться без изменений, вы не сможете реализовать член интерфейса в этом объявлении. Удалите ключевое слово [Implements](../Topic/Implements%20Clause%20\(Visual%20Basic\).md) из объявления.  
