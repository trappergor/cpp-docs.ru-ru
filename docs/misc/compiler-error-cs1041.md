...
Требуется идентификатор, "ключевое слово" является ключевым словом  
 ...
 Вместо ожидавшегося идентификатора обнаружено зарезервированное слово языка C\#. Замените [ключевое слово](../Topic/C%23%20Keywords.md) пользовательским идентификатором.  
