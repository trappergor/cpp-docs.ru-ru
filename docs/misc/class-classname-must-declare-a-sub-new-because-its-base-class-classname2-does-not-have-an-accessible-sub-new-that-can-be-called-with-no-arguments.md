...
Производный класс не объявляет конструктор, и [!INCLUDE[vbprvb](../dotnet/includes/vbprvb_md.md)] не может создать его, так как отсутствует конструктор базового класса, который он может вызвать.  
