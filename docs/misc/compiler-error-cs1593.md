...
Делегат "делегат" не принимает "число" аргументов  
 ...
 Число аргументов, переданных при вызове [делегата](../Topic/delegate%20\(C%23%20Reference\).md), не совпадает с числом параметров, указанных в объявлении делегата.  
