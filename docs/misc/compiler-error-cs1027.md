...
Требуется директива \#endif.  
 ...
 Для указанной директивы `#if` не найдена соответствующая [директива препроцессора](../Topic/C%23%20Preprocessor%20Directives.md)`#endif`. Возможно также, что внутри блока `#if` компилятор обнаружил директиву `#endregion` без соответствующей директивы `#region`.  
