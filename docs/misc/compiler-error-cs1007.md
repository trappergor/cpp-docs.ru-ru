...
Метод доступа к свойству уже определен.  
 ...
 При объявлении [свойства](../Topic/Using%20Properties%20\(C%23%20Programming%20Guide\).md) также необходимо объявить его методы доступа. Однако свойство не может иметь несколько методов доступа `get` или несколько методов доступа `set`.  
