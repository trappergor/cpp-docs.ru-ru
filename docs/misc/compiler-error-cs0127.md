...
Поскольку "функция" возвращает значение void, после ключевого слова return не должно задаваться выражение объекта  
 ...
 Метод с типом возврата [void](../Topic/void%20\(C%23%20Reference\).md) не может возвращать значение. Дополнительные сведения см. в разделе [Методы](../Topic/Methods%20\(C%23%20Programming%20Guide\).md).  
