...
Наследуемый интерфейс "интерфейс1" образует циклическую ссылку в иерархии интерфейсов "интерфейс2".  
 ...
 Список наследования для [интерфейса](../Topic/interface%20\(C%23%20Reference\).md) включает прямую или косвенную ссылку на самого себя. Интерфейс не может наследовать от самого себя.  
