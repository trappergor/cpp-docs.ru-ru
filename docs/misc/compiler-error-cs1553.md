...
Декларация недопустима; используйте вместо нее "modifier operator \<dest\-type\> \(..."  
 ...
 Тип возврата для [оператора](../Topic/operator%20\(C%23%20Reference\)2.md) должен находиться непосредственно перед списком параметров, и *модификатор* либо `implicit`, либо **explicit**.  
