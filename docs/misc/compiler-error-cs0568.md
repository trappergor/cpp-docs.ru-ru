...
Структуры не могут содержать явных конструкторов без параметров.  
 ...
 Каждая [структура](../Topic/struct%20\(C%23%20Reference\).md) уже имеет конструктор по умолчанию, который инициализирует объект с нулевым значением. Таким образом, конструкторы, которые можно создать для структуры, должны принимать один или несколько параметров.  
