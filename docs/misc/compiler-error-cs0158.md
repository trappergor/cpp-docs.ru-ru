...
Метка "метка" затемняет другую метку с тем же именем во вложенной области  
 ...
 Метка во внутренней области скрывает метку с тем же именем во внешней области. Для получения дополнительной информации см. [goto](../Topic/goto%20\(C%23%20Reference\).md).  
