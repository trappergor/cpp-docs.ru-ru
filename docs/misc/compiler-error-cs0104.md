...
"ссылка" является неоднозначной ссылкой между "идентификатор" и "идентификатор"  
 ...
 Программа содержит директивы [using](../Topic/using%20\(C%23%20Reference\).md) для двух пространств имен, и код ссылается на имя, которое отображается в обоих пространствах имен.  
