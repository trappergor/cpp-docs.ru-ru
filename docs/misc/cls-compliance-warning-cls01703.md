---
title: "Предупреждение о соответствии спецификации CLS CLS01703 | Microsoft Docs"
ms.custom: ""
ms.date: "10/29/2016"
...
manager: "douge"
---
# Предупреждение о соответствии спецификации CLS CLS01703
Типы неуправляемых указателей не являются CLS\-совместимыми.  
  
 CLS\-совместимое поле не может содержать объявление собственного указателя.  
 ...
 В следующем примере возникает ошибка CLS01703:  
