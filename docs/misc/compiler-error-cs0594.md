...
Константа с плавающей запятой вне допустимого диапазона для типа "тип"  
 ...
 Переменной с плавающей запятой присвоено слишком большое для этого типа данных значение. Сведения о допустимых диапазонах значений для различных типов данных см. в разделе [Таблица целых типов](../Topic/Integral%20Types%20Table%20\(C%23%20Reference\).md).  
