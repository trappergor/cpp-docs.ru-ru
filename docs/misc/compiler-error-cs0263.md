...
Частичные объявления типа "тип" не должны указывать разные базовые классы  
 ...
 При определении типа в частичных объявлениях укажите одни и те же базовые типы в каждом частичном объявлении. Для получения дополнительной информации см. [Разделяемые классы и методы](../Topic/Partial%20Classes%20and%20Methods%20\(C%23%20Programming%20Guide\).md).  
