...
"объявление": явное объявление может содержаться только в классе или в структуре  
 ...
 Явное объявление [интерфейса](../Topic/interface%20\(C%23%20Reference\).md) найдено вне [класса](../Topic/class%20\(C%23%20Reference\).md) или [структуры](../Topic/struct%20\(C%23%20Reference\).md).  
