...
Ошибка инициализации класса. Одной из возможных причин является повреждение установки [!INCLUDE[dnprdnshort](../error-messages/tool-errors/includes/dnprdnshort_md.md)].  
...
2.  Переустановите [!INCLUDE[dnprdnshort](../error-messages/tool-errors/includes/dnprdnshort_md.md)] и выполните повторную компиляцию программы.  
