...
Пустая символьная константа.  
 ...
 Переменная типа [char](../Topic/char%20\(C%23%20Reference\).md) объявлена и инициализирована со значением NULL. При инициализации `char` необходимо указать символ.  
