...
Директива using для "пространство\_имен" ранее встречалась в этом пространстве имен  
 ...
 [Пространство имен](../Topic/namespace%20\(C%23%20Reference\).md), которое должно быть объявлено только один раз, было объявлено несколько раз; удалите все повторяющиеся объявления пространства имен.  
