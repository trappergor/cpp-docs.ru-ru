...
"член": члены интерфейса не могут иметь определения  
 ...
 Методы, объявленные в [интерфейсе](../Topic/interface%20\(C%23%20Reference\).md), должны быть реализованы в классе, который наследует от него, а не в самом интерфейсе.  
