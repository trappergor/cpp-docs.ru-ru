...
Эта ошибка обычно возникает, когда во время завершения работы операционной системы в приложении открыто модальное диалоговое окно, мешающее закрыть приложение.  
  
### Чтобы исправить эту ошибку  
  
1.  Закройте модальное диалоговое окно, а затем закройте приложение или завершите работу операционной системы.