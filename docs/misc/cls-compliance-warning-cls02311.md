---
title: "Предупреждение о соответствии спецификации CLS CLS02311 | Microsoft Docs"
ms.custom: ""
ms.date: "10/29/2016"
...
manager: "douge"
---
# Предупреждение о соответствии спецификации CLS CLS02311
CLS\-совместимый класс должен наследовать от CLS\-совместимого класса  
  
 CLS\-совместимый класс должен наследовать от CLS\-совместимого класса  Например, System::Object.  
 ...
 В следующем примере возникает ошибка CLS02311:  
