...
Разделяемые объявления типа "тип" должны быть все классами, все структурами или все интерфейсами  
 ...
 Эта ошибка возникает, если разделяемый тип объявлен как разный тип конструктора в различных местах. Для получения дополнительной информации см. [Разделяемые классы и методы](../Topic/Partial%20Classes%20and%20Methods%20\(C%23%20Programming%20Guide\).md).  
