...
Инициализаторы объектов не могут использоваться для инициализации любого члена класса, объявленного общим. Дополнительные сведения см. в разделе [Shared](../Topic/Shared%20\(Visual%20Basic\).md).  
