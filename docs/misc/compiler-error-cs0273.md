...
Модификатор доступности функции доступа "метод\_доступа\_свойства" должен содержать более жесткие ограничения, чем свойство или индексатор "свойство"  
 ...
 Эта ошибка возникает при объявлении свойства или индексатора с модификатором доступа, который менее ограничивающий, чем модификатор доступа одного из его методов доступа. Для устранения этой ошибки используйте соответствующий модификатор доступа для свойства или метода доступа set. Дополнительные сведения см. в разделе [Доступность методов доступа](../Topic/Restricting%20Accessor%20Accessibility%20\(C%23%20Programming%20Guide\).md).  
