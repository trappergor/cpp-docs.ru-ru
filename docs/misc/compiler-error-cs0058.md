...
Несогласованность по доступности: тип возврата "тип" менее доступен, чем делегат "делегат"  
 ...
 Открытая конструкция должна возвращать общедоступный объект. Для получения дополнительной информации см. [Модификаторы доступа](../Topic/Access%20Modifiers%20\(C%23%20Programming%20Guide\).md).  
...
## См. также  
 [закрытый](../Topic/private%20\(C%23%20Reference\).md)