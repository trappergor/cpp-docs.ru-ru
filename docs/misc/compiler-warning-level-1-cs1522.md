...
Пустой блок switch  
 ...
 Компилятор обнаружил блок [switch](../Topic/switch%20\(C%23%20Reference\).md) без оператора **case** или **default**. Блок `switch` должен иметь хотя бы один оператор **case** или **default**.  
