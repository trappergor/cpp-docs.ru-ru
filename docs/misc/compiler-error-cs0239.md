...
"член": невозможно переопределить наследуемый член "наследуемый\_член", так как он запечатан  
 ...
 Член не может [переопределить](../Topic/override%20\(C%23%20Reference\).md)[запечатанный](../Topic/sealed%20\(C%23%20Reference\).md) наследуемый член. Для получения дополнительной информации см. [Checked и Unchecked](../Topic/Checked%20and%20Unchecked%20\(C%23%20Reference\).md).  
