...
Требуется объект с типом, который можно преобразовать в "тип"  
 ...
 Оператор return присутствует, но оператор не возвращает значение ожидаемого типа. Дополнительные сведения см. в разделе [Свойства](../Topic/Properties%20\(C%23%20Programming%20Guide\).md).  
