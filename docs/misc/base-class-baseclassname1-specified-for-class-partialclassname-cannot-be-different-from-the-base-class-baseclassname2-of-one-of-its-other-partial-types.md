...
Класс задается в двух или более частичных объявлениях, которые содержат несколько [Инструкция Inherits](../Topic/Inherits%20Statement.md), указывающих несколько базовых классов.  
