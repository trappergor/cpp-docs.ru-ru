...
"событие": событие в интерфейсе не может иметь инициализатора  
 ...
 Событие в интерфейсе не может иметь инициализатора. Для получения дополнительной информации см. [Интерфейсы](../Topic/Interfaces%20\(C%23%20Programming%20Guide\).md).  
