...
Не удается разрешить базовый класс или интерфейс "класс" в сборке "сборка", на которую ссылается тип "тип"  
 ...
 Дополнительные сведения см. в разделах [Add Reference Dialog Box](http://msdn.microsoft.com/ru-ru/2feb0fe2-0805-4cc9-8cba-b0315849dfb7) и [\/reference \(Import Metadata\)](../Topic/-reference%20\(C%23%20Compiler%20Options\).md).  
