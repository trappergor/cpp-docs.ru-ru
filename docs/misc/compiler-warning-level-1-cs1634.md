...
Требуется disable или restore  
 ...
 Эта ошибка возникает, если предложение \#pragma warning неправильно сформировано — например, если пропущено disable или restore. Дополнительные сведения см. в разделе [\#pragma warning](../Topic/%23pragma%20warning%20\(C%23%20Reference\).md).  
