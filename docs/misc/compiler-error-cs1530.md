...
Ключевое слово "new" не может использоваться для элементов, определенных в пространстве имен  
 ...
 Нет необходимости указывать ключевое слово [new](../Topic/new%20\(C%23%20Reference\).md) для любой конструкции внутри [пространства имен](../Topic/namespace%20\(C%23%20Reference\).md).  
