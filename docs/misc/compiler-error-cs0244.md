...
Ни "is", ни "as" недопустимы в типах указателей.  
 ...
 Ключевые слова [is](../Topic/is%20\(C%23%20Reference\).md) и [as](../Topic/as%20\(C%23%20Reference\).md) не разрешено использовать в типах указателей. Для получения дополнительной информации см. [Небезопасный код и указатели](../Topic/Unsafe%20Code%20and%20Pointers%20\(C%23%20Programming%20Guide\).md).  
