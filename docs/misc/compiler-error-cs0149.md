...
Требуется имя метода.  
 ...
 При создании [делегата](../Topic/delegate%20\(C%23%20Reference\).md) укажите метод. Дополнительные сведения см. в разделе [Делегаты](../Topic/Delegates%20\(C%23%20Programming%20Guide\).md).  
