---
title: "Предупреждение о соответствии спецификации CLS CLS03002 | Microsoft Docs"
ms.custom: ""
ms.date: "10/29/2016"
...
manager: "douge"
---
# Предупреждение о соответствии спецификации CLS CLS03002
Событие и его методы доступа должны иметь одинаковую доступность  
  
 Событие и его методы доступа не должны отличаться по доступности.  
 ...
 Следующий пример приводит к возникновению ошибки CLS03002:  
