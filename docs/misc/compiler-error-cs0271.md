...
Свойство или индексатор "свойство\/индексатор" не может использоваться в данном контексте, так как метод доступа get недоступен  
 ...
 Эта ошибка возникает при попытке получить доступ к недоступному методу доступа `get`. Чтобы устранить эту ошибку, повысьте уровень доступности метода доступа или измените расположение вызова. Дополнительные сведения см. в разделах [Доступность методов доступа](../Topic/Restricting%20Accessor%20Accessibility%20\(C%23%20Programming%20Guide\).md) и [Свойства](../Topic/Properties%20\(C%23%20Programming%20Guide\).md).  
