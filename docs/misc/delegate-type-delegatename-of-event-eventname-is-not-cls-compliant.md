...
Инструкция [Оператор Event](../Topic/Event%20Statement.md) использует делегат для указания его сигнатуры, но инструкция [Оператор Delegate](../Topic/Delegate%20Statement.md) помечена как `<CLSCompliant(False)>` или не помечена вообще.  
