...
Параметр params должен быть одномерным массивом.  
 ...
 При использовании ключевого слова [params](../Topic/params%20\(C%23%20Reference\).md) необходимо указать одномерный массив типа данных. Дополнительные сведения см. в разделе [Методы](../Topic/Methods%20\(C%23%20Programming%20Guide\).md).  
