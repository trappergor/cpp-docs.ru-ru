...
Требуется указать значение поля const.  
 ...
 Необходимо инициализировать переменную [const](../Topic/const%20\(C%23%20Reference\).md). Для получения дополнительной информации см. [Константы](../Topic/Constants%20\(C%23%20Programming%20Guide\).md).  
