...
> [!NOTE]
>  В C\# 2.0 компилятор автоматически создает свойство Current и метод MoveNext. Дополнительные сведения см. в примере кода в разделе [Универсальные интерфейсы](../Topic/Generic%20Interfaces%20\(C%23%20Programming%20Guide\).md).  
