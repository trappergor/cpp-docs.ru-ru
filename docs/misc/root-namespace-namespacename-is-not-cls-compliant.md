...
## См. также  
 [Оператор Namespace](../Topic/Namespace%20Statement.md)   
 [Пространства имен в Visual Basic](../Topic/Namespaces%20in%20Visual%20Basic.md)   
