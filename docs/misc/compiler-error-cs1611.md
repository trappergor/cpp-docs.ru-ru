...
Параметр params не может объявляться как параметр с ключевым словом ref или out.  
 ...
 Ключевые слова [ref](../Topic/ref%20\(C%23%20Reference\).md) или [out](../Topic/out%20\(C%23%20Reference\).md) не могут использоваться с ключевым словом [params](../Topic/params%20\(C%23%20Reference\).md).  
