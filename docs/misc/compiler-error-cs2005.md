...
Не задан файл для параметра "параметр"  
 ...
 [Параметр компилятора](../Topic/C%23%20Compiler%20Options.md) указан только частично.  
  
 Например, при использовании [\/recurse](../Topic/-recurse%20\(C%23%20Compiler%20Options\).md) необходимо указать искомый файл: **\/recurse:***имя\_файла***.cs**.  
