...
Указатель должен быть проиндексирован только по одному значению.  
 ...
 Указатель не может иметь несколько индексов. Дополнительные сведения см. в разделе [Типы указателей](../Topic/Pointer%20types%20\(C%23%20Programming%20Guide\).md).  
