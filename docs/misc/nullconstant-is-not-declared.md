...
2.  Используйте ключевое слово [Nothing](../Topic/Nothing%20\(Visual%20Basic\).md) в операторах присваивания и сравнения, в которых участвуют объектные переменные. В следующем примере это показано.  
