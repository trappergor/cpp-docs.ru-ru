...
При указателях на объекты неизвестного типа данная операция не определена.  
 ...
 Увеличение указателя типа void не разрешено. Дополнительные сведения см. в разделе [Небезопасный код и указатели](../Topic/Unsafe%20Code%20and%20Pointers%20\(C%23%20Programming%20Guide\).md).  
