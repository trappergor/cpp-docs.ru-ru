...
-   Если параметры не требуются или требуется более двух параметров, необходимо использовать [Оператор Function](../Topic/Function%20Statement%20\(Visual%20Basic\).md), чтобы определить процедуру `Function` вместо оператора.  
