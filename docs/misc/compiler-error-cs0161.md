...
"метод": не все пути кода возвращают значение  
 ...
 Метод, возвращающий значение, должен иметь оператор `return` во всех путях кода. Для получения дополнительной информации см. [Методы](../Topic/Methods%20\(C%23%20Programming%20Guide\).md).  
