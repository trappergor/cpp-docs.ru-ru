...
Использование ключевого слова "base" в этом контексте не допускается.  
 ...
 Для указания определенного члена базового класса необходимо использовать ключевое слово [базовые](../Topic/base%20\(C%23%20Reference\).md). Для получения дополнительной информации см. [Конструкторы](../Topic/Constructors%20\(C%23%20Programming%20Guide\).md).  
