...
На дочерний XML\-элемент имеется ссылка в объекте, который не относится к типу <xref:System.Xml.Linq.XElement>, <xref:System.Xml.Linq.XDocument> или `IEnumerable(Of XElement)`. Дополнительные сведения см. в разделе [Свойство дочерней оси XML](../Topic/XML%20Descendant%20Axis%20Property%20\(Visual%20Basic\).md).  
...
## См. также  
 [Свойство дочерней оси XML](../Topic/XML%20Descendant%20Axis%20Property%20\(Visual%20Basic\).md)   
