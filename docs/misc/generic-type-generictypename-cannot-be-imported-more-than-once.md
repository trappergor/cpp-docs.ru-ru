...
Инструкция [Оператор Imports \(пространство имен .NET и тип\)](../Topic/Imports%20Statement%20\(.NET%20Namespace%20and%20Type\).md) указывает универсальный тип, который уже был импортирован с параметризацией другого типа.  
