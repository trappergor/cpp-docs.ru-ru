...
"конструктор": статический конструктор не должен иметь параметры  
 ...
 [Статический](../Topic/static%20\(C%23%20Reference\).md) конструктор не может объявляться с одним или несколькими параметрами. Для получения дополнительной информации см. [Конструкторы](../Topic/Constructors%20\(C%23%20Programming%20Guide\).md).  
