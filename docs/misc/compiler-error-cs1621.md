...
## См. также  
 ...
 [Лямбда\-выражения](../Topic/Lambda%20Expressions%20\(C%23%20Programming%20Guide\).md)   
 [Анонимные методы](../Topic/Anonymous%20Methods%20\(C%23%20Programming%20Guide\).md)