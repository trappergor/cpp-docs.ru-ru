...
Невозможно преобразовать тип "тип" в "тип"  
 ...
 Необходимо предоставить подпрограммы преобразования для поддержки перегрузки определенных операторов. Для получения дополнительной информации см. [Операторы преобразования](../Topic/Conversion%20Operators%20\(C%23%20Programming%20Guide\).md).  
