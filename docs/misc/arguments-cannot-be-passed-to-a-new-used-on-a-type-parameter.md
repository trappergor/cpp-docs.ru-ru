...
Оператор объявления или присваивания вызывает универсальный тип и предоставляет аргументы конструктора для параметра типа, имеющего ограничение [Оператор New](../Topic/New%20Operator%20\(Visual%20Basic\).md).  
