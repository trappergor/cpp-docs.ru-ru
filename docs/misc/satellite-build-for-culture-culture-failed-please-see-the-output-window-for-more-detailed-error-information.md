...
Вспомогательная сборка для указанного языка и региональных параметров не может быть построена. Расширенные сведения об ошибке \(stderr из ALINK.EXE\) выводится в области вывода.  
