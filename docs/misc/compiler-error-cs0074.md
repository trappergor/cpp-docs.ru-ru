...
"событие": абстрактное событие не может иметь инициализатор  
 ...
 Если [событие](../Topic/event%20\(C%23%20Reference\).md) помечено как **абстрактное**, оно не может быть инициализировано. Для получения дополнительной информации см. [События](../Topic/Events%20\(C%23%20Programming%20Guide\).md).  
