...
Тип "тип" в списке интерфейсов не является интерфейсом  
 ...
 [Структура](../Topic/struct%20\(C%23%20Reference\).md) или [интерфейс](../Topic/interface%20\(C%23%20Reference\).md) могут наследовать от другого интерфейса, но не от любого другого типа.  
