...
Не удается создать экземпляр абстрактного класса или интерфейса "интерфейс"  
 ...
 Нельзя создать экземпляр [абстрактного](../Topic/abstract%20\(C%23%20Reference\).md) класса или [интерфейса](../Topic/interface%20\(C%23%20Reference\).md). Дополнительные сведения см. в разделе [Интерфейсы](../Topic/Interfaces%20\(C%23%20Programming%20Guide\).md).  
