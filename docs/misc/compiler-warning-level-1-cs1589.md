...
Не удалось включить XML\-фрагмент "фрагмент" файла "файл" — причина.  
 ...
 Синтаксис \(*фрагмент*\) тега [\<include\>](../Topic/%3Cinclude%3E%20\(C%23%20Programming%20Guide\).md), который ссылается на файл \(`file`\), был неправильным по указанной ***причине***.  
