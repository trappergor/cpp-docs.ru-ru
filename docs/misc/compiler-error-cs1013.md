...
Недопустимое число  
 ...
 Компилятор обнаружил некорректное число. Дополнительные сведения о целых типах см. в разделе [Таблица целых типов](../Topic/Integral%20Types%20Table%20\(C%23%20Reference\).md).  
