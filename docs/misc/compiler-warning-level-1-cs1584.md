...
XML\-комментарий в члене "член" имеет синтаксически недопустимый атрибут cref "недопустимый\_синтаксис"  
 ...
 Один из параметров, переданных в тег для комментариев документации, имеет недопустимый синтаксис. Для получения дополнительной информации см. [Рекомендуемые теги для комментариев документации](../Topic/Recommended%20Tags%20for%20Documentation%20Comments%20\(C%23%20Programming%20Guide\).md).  
