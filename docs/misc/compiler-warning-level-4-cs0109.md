...
Член "член" не скрывает унаследованный член. Новое ключевое слово не требуется  
 ...
 Объявление класса включает ключевое слово [new](../Topic/new%20\(C%23%20Reference\).md), хотя это объявление не переопределяет существующее определение в базовом классе. Вы можете удалить ключевое слово **new**.  
