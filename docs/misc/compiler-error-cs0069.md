...
Событие в интерфейсе не может иметь методы доступа add и remove.  
 ...
 Нельзя определить функции доступа к событию в [интерфейсе](../Topic/interface%20\(C%23%20Reference\).md). Дополнительные сведения см. в разделах [События](../Topic/Events%20\(C%23%20Programming%20Guide\).md) и [Интерфейсы](../Topic/Interfaces%20\(C%23%20Programming%20Guide\).md).  
