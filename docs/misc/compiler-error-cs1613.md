...
-   Добавьте ссылку на сборку, которая содержит кокласс \(в большинстве случаев интерфейс и кокласс должны находиться в одной сборке\). Дополнительные сведения см. в разделе [\/reference](../Topic/-reference%20\(C%23%20Compiler%20Options\).md) или [Диалоговое окно "Добавление ссылки"](http://msdn.microsoft.com/ru-ru/2feb0fe2-0805-4cc9-8cba-b0315849dfb7).  
