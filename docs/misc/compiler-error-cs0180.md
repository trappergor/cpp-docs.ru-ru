...
"член" не может одновременно быть внешним и абстрактным  
 ...
 Ключевые слова [abstract](../Topic/abstract%20\(C%23%20Reference\).md) и [extern](../Topic/extern%20\(C%23%20Reference\).md) являются взаимоисключающими. Ключевое слово `extern` означает, что член определен за пределами файла, а ключевое слово **abstract** указывает на то, что реализация предоставлена в производном классе. Дополнительные сведения см. в разделе [Методы](../Topic/Methods%20\(C%23%20Programming%20Guide\).md).  
