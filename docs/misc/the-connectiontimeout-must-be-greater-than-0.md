...
При отправке и загрузке файлов с помощью [Объект My.Computer.Network](../Topic/My.Computer.Network%20Object.md) необходимо указать `connectionTimeout` больше `0`.  
