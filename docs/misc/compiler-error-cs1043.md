...
Требуется "{" или ";".  
 ...
 Неправильно объявлен метод доступа к свойству. Для получения дополнительной информации см. [Использование свойств](../Topic/Using%20Properties%20\(C%23%20Programming%20Guide\).md).  
