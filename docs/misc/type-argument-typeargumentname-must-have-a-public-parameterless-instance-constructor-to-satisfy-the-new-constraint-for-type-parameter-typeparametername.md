...
Аргумент типа предоставляет в параметр типа с ограничением [Оператор New](../Topic/New%20Operator%20\(Visual%20Basic\).md) тип без доступного конструктора без параметров.  
