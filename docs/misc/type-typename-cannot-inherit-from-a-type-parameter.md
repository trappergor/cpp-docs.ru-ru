...
Класс или интерфейс включает [Инструкция Inherits](../Topic/Inherits%20Statement.md), указывающую параметр универсального типа.  
...
-   Если базовый тип должен быть представлен параметром универсального типа, никакой другой тип не может наследовать от него. Удалите параметр [Инструкция Inherits](../Topic/Inherits%20Statement.md).  
