...
Событие "событие" может находиться только в левой части операции \+\= или \-\=  
 ...
 [Событие](../Topic/event%20\(C%23%20Reference\).md) было вызвано неправильно. Дополнительные сведения см. в разделах [События](../Topic/Events%20\(C%23%20Programming%20Guide\).md) и [Делегаты](../Topic/Delegates%20\(C%23%20Programming%20Guide\).md).  
