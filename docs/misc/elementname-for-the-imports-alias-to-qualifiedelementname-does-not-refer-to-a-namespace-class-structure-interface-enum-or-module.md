...
Инструкция [Оператор Imports \(пространство имен .NET и тип\)](../Topic/Imports%20Statement%20\(.NET%20Namespace%20and%20Type\).md) указывает программный элемент, который не может быть импортирован.  
