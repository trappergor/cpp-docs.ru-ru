...
Имя члена типа конфликтует с именем члена, неявно объявленного во всех перечислениях.  
 ...
 Компилятор [!INCLUDE[vbprvb](../dotnet/includes/vbprvb_md.md)] создает неявные члены, соответствующие определенным программным элементам, которые вы объявляете. Перечисления неявно объявляют элемент `value__member`.  
...
## См. также  
 ...
 [Общие сведения о перечислениях](../Topic/Enumerations%20Overview%20\(Visual%20Basic\).md)   
