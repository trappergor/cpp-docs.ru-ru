...
```  
 ...
 По умолчанию данное сообщение является предупреждением. Дополнительные сведения о том, как скрыть предупреждения или как рассматривать предупреждения как ошибки, см. в разделе [Настройка предупреждений в Visual Basic](../Topic/Configuring%20Warnings%20in%20Visual%20Basic.md).  
...
## См. также  
 ...
 [Вывод локального типа](../Topic/Local%20Type%20Inference%20\(Visual%20Basic\).md)   
 [Option Infer \- оператор](../Topic/Option%20Infer%20Statement.md)   
