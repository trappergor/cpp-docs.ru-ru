...
Выражение, используемое для аргумента атрибута, приводится к типу данных, отличному от соответствующего параметра атрибута, но в [!INCLUDE[vbprvb](../dotnet/includes/vbprvb_md.md)] не допускается преобразование требуемого типа для аргументов атрибута.  
