...
Управление не может быть передано из тела предложения finally.  
 ...
 В предложении [finally](../Topic/try-catch-finally%20\(C%23%20Reference\).md) должны быть выполнены все операторы. Дополнительные сведения см. в разделах [Операторы обработки исключений](../Topic/Exception%20Handling%20Statements%20\(C%23%20Reference\).md) и [Исключения и обработка исключений](../Topic/Exceptions%20and%20Exception%20Handling%20\(C%23%20Programming%20Guide\).md).  
