...
Параметр params должен быть указан последним в списке формальных параметров.  
 ...
 Параметр [params](../Topic/params%20\(C%23%20Reference\).md) поддерживает переменное число аргументов и должен указываться после всех остальных параметров. Для получения дополнительной информации см. [Методы](../Topic/Methods%20\(C%23%20Programming%20Guide\).md).  
