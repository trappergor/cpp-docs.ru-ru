...
"член\_производного\_класса" скрывает наследуемый абстрактный член "член\_базового\_класса"  
 ...
 Метод базового [класса](../Topic/class%20\(C%23%20Reference\).md) скрыт. Проверьте правильность синтаксиса объявления.  
  
 Для получения дополнительной информации см. [базу](../Topic/base%20\(C%23%20Reference\).md).  
