...
Структурированная обработка исключений (SEH) является расширением Microsoft для C для корректной обработки определенных ситуациях код поддержки исключений, например, сбоев оборудования. Хотя Windows и Microsoft C++ поддерживают SEH, мы рекомендуем использовать стандарт ISO C++ обработка исключений, так как он делает код более переносимость и гибкость. Тем не менее чтобы сохранить существующий код или для программ определенных видов, вы по-прежнему может потребоваться использовать SEH.
