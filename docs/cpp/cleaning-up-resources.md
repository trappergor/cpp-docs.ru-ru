---
title: Очистка ресурсов | Документация Майкрософт
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-language
...
2.  В **__try** инструкции block, распределения ресурсов. Для дескрипторов устанавливается положительные значения по мере распределения ресурсов.  
  
3.  В **__finally** блок операторов, освободите все ресурсы, соответствующий дескриптор или переменная флага которых не равно нулю или not NULL.  
