...
Если выполняется сдвиг влево числа со знаком и при этом затрагивается бит знака, результат не определен. Следующий пример показывает, что происходит, когда бита 1 выполняется сдвиг влево в позицию бита знака.
...
> [!IMPORTANT]
> Результат сдвига вправо отрицательного числа со знаком зависит от реализации. Несмотря на то что Microsoft C++ компилятор использует бит знака для заполнения освобожденных позиций битов, нет никакой гарантии, что другие реализации также выполняют это.
