...
![Размер в байтах созданных&#45;в типах](../cpp/media/built-intypesizes.png "встроенные размер в байтах&#45;в типах")
...
|без знака&nbsp;char|1 байт|В C++ нет встроенного типа `byte`.  Для представления байтовых значений используйте тип unsigned char.|
