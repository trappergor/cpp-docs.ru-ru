...
![Simulated обед&#45;объекта строки](../cpp/media/vc38xp2.gif "Simulated обед&#45;объекта строки") <br/>
...
![Simulated обед&#45;объекта строки, виртуальные базовые классы](../cpp/media/vc38xp3.gif "Simulated обед&#45;объекта строки, виртуальные базовые классы") <br/>
Имитируемый объект с виртуальными базовыми классами
...
![Виртуальные и не&#45;виртуальных компонентов класса](../cpp/media/vc38xp4.gif "виртуальные и не&#45;виртуальные компоненты класса") <br/>
...
![Виртуальные и не&#45;виртуальное наследование в макете объектов](../cpp/media/vc38xp5.gif "виртуальные и не&#45;виртуальное наследование в макете объектов") <br/>
Структура объектов с наследованием виртуальных и невиртуальных
...
![Виртуальное наследование и не&#45;виртуальное наследование](../cpp/media/vc38xr1.gif "виртуальных наследование и не&#45;виртуальное наследование") <br/>
Виртуальное и невиртуальный наследования
