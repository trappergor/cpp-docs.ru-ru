...
Смоделированный граф Lunch-Line  
 ...
 ![Simulated обед&#45;объекта строки](../cpp/media/vc38xp2.gif "vc38XP2")  
 ...
 **Виртуального** ключевого слова гарантирует, что только одна копия подчиненного объекта `Queue` включено (см. следующий рисунок).  
 ...
 ![Simulated обед&#45;объекта строки, виртуальные базовые классы](../cpp/media/vc38xp3.gif "vc38XP3")  
