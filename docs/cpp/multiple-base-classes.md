...
При объявлении виртуального базового класса ключевое слово **Virtual** появляется в базовых списках производных классов.

Рассмотрим иерархию классов, представленную на следующем рисунке, на котором показана имитация графа Lunch-Line.

![График имитации линейки обедов](../cpp/media/vc38xp1.gif "Граф имитации очереди") <br/>
...
![Объект смоделированной&#45;линии обеда](../cpp/media/vc38xp2.gif "Объект смоделированной&#45;линии обеда") <br/>
...
Ключевое слово **Virtual** обеспечивает включение только одной копии вложенного объекта `Queue` (см. следующий рисунок).

![Смоделированный объект&#45;линий обеда, виртуальные базовые классы](../cpp/media/vc38xp3.gif "Смоделированный объект&#45;линий обеда, виртуальные базовые классы") <br/>
...
![Неоднозначное преобразование указателей на базовые классы](../cpp/media/vc38xt1.gif "Неоднозначное преобразование указателей в базовые классы") <br/>
...
![Виртуальный производный и&#45;не виртуальный производные](../cpp/media/vc38xr1.gif "Виртуальный производный и&#45;не виртуальный производные") <br/>
