...
![Структура памяти объекта даты](../cpp/media/vc38uq1.png "vc38UQ1") макета объекта для даты памяти
...
![Структура объекта даты с нулевым&#45;битовое поле длины](../cpp/media/vc38uq2.png "vc38UQ2") макета из объект Date с битовым полем нулевой длины
