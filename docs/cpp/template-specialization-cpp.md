---
title: "Частичная специализация шаблонов класса (C++) | Microsoft Docs"
ms.custom: ""
ms.date: "12/05/2016"
...
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "частичная сериализация шаблонов класса"
...
**3 87 8 100**    
## Пример  
 В следующем примере определяется шаблонный класс, который принимает пары из любых двух типов; затем определяется частичная специализация этого шаблонного класса для случая, когда один из типов является типом `int`.  Специализация определяет дополнительный метод сортировки, который реализует простую сортировку пузырьковым методом на основе целого числа.  
