...
Помимо ограничений, именованный объединений анонимные объединения могут иметь следующими дополнительными ограничениями:  
  
-   Они также должны объявляться как **статических** объявление в области видимости файла или пространства имен.  
