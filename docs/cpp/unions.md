---
title: "Объединения | Microsoft Docs"
ms.custom: ""
ms.date: "12/05/2016"
...
## Анонимные объединения  
 Анонимные объединения — это объединения, объявляемые без компонентов *имя\-класса* и *список\-деклараторов*.  
...
```  
 ...
 Помимо ограничений, перечисленных в разделе [Данные членов объединений](../Topic/Union%20Member%20Data.md), анонимные объединения могут иметь дополнительные ограничения.  
  
-   При объявлении в области видимости файла или пространства имен их необходимо также объявлять как **static**.  
  
-   Они могут иметь только открытые члены; закрытые и защищенные члены в анонимных объединениях приводят к ошибкам.  
