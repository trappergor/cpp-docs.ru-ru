...
Начните объявление объединения с помощью **`union`** ключевого слова и заключите список членов в фигурные скобки:
...
- Они также должны быть объявлены как **`static`** объявленные в области видимости файла или пространства имен.

- Они могут иметь только **`public`** члены, **`private`** а **`protected`** члены анонимных объединений создают ошибки.
