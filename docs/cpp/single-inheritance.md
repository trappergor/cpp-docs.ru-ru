---
title: "Одиночное наследование | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "базовые классы, косвенное обращение"
  - "производные классы, отдельный базовый класс"
  - "наследование, одиночный"
...
При единичном наследовании, самой распространенной форме наследования, каждый класс имеет только один базовый класс.  Рассмотрим пример взаимоотношений на следующем рисунке.  
 ...
 ![Простой граф однократного наследования](../cpp/media/vc38xj1.png "vc38XJ1")  
...
```  
 ...
 В приведенном выше примере используется спецификатор доступа **public**.  Значение типов наследования public, protected и private описывается в разделе [Управление доступом к членам](../cpp/member-access-control-cpp.md).  
  
 Один класс может быть базовым для нескольких более специализированных классов, как показано в следующем примере.  
  
 ![Прямой ацикличный граф](../cpp/media/vc38xj2.png "vc38XJ2")  
...
> [!NOTE]
>  Ориентированные ациклические графы могут описывать структуры не только с единичным,  но и с множественным наследованием.  Подробнее об этом говорится в разделе [Множественное наследование](http://msdn.microsoft.com/ru-ru/3b74185e-2beb-4e29-8684-441e51d2a2ca).  
...
> [!NOTE]
>  Такие функции, как `PrintNameOf`, не рекомендуется реализовывать в базовых классах.  Более эффективным средством для этого являются [виртуальные функции](../cpp/virtual-functions.md).  
  
## См. также  
 [Общие сведения о производных классах](../misc/overview-of-derived-classes.md)   
 [\(NOTINBUILD\) Multiple Inheritance](http://msdn.microsoft.com/ru-ru/3b74185e-2beb-4e29-8684-441e51d2a2ca)