...
![Базовый график наследования одного&#45;](../cpp/media/vc38xj1.gif "Базовый график наследования одного&#45;") <br/>
...
В предыдущем примере используется **общедоступный** спецификация доступа. Значение общественного, защищенного и частного наследства описано в [контроле доступа к членам.](../cpp/member-access-control-cpp.md)
...
> [!NOTE]
> Такие функции, как `PrintNameOf`, не рекомендуется реализовывать в базовых классах. [Виртуальные функции](../cpp/virtual-functions.md) предлагает другие альтернативы дизайна.
