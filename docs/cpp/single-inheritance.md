...
> [!NOTE]
>  Ориентированные ациклические графы могут описывать структуры не только с единичным, но и с множественным наследованием. В этом разделе рассматривается в [множественное наследование](https://msdn.microsoft.com/3b74185e-2beb-4e29-8684-441e51d2a2ca).  
