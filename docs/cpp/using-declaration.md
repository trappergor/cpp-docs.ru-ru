...
*неполное id*  
    Неполное идентификатор выражение, которое может иметь идентификатор, имя перегруженного оператора, определяемые пользователем литерал оператор или преобразование имени функции, имени деструктор класса или шаблона имя и список аргументов.  
  
*Список деклараторов*  
    Список с разделителями запятыми [**typename**] *вложенные name-specifier* *неполное идентификатор* деклараторов, при необходимости последующим многоточием.
