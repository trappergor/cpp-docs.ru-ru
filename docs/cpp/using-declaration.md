...
Имя, определенное **с помощью объявления using** , является псевдонимом для его исходного имени. Оно не влияет на тип, компоновку и другие атрибуты исходного объявления.
