---
title: "Тривиальный, стандартная раскладка и типы POD | Документы Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="trivial-standard-layout-and-pod-types"></a>Тривиальный, стандартная раскладка и типы POD
