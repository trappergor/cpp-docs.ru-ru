...
**Блок, относящийся только к системам Microsoft**  
 ...
 Для функций, объявленных с **с атрибутом naked** атрибут, компилятор создает код без кода пролога и эпилога. Эту возможность можно использовать, чтобы создавать свой собственный код на языке ассемблера и вставлять его в качестве пролога и эпилога. Функции с атрибутом naked особенно полезны для написания драйверов виртуальных устройств.  Обратите внимание, что **с атрибутом naked** атрибут допустим только для x86 и ARM и доступно не на [!INCLUDE[vcprx64](../assembler/inline/includes/vcprx64_md.md)].  
