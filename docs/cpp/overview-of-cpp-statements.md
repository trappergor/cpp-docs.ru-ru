...
В большинстве случаев синтаксис C++ инструкции идентичен стандарту ANSI C. Основное различие между ними заключается в том, что в C объявления допускаются только в начале блока. C++ добавляет *оператор объявления*, который фактически удаляет это ограничение. Это позволяет вводить переменные в том месте программы, в котором можно вычислить заранее рассчитанное значение инициализации.
...
|[значение по умолчанию](../cpp/switch-statement-cpp.md)|[__finally](../cpp/structured-exception-handling-c-cpp.md)|[switch](../cpp/switch-statement-cpp.md)||
|[do](../cpp/do-while-statement-cpp.md)|[if](../cpp/if-else-statement-cpp.md) (если);|[throw](../cpp/try-throw-and-catch-statements-cpp.md)||

## <a name="see-also"></a>См. также раздел

[Инструкции](../cpp/statements-cpp.md)
