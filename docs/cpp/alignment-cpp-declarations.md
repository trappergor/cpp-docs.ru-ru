...
C++ Стандартная библиотека предоставляет [класс aligned_storage](../standard-library/aligned-storage-class.md) для выделения памяти для структур данных с помощью настраиваемых выравниваний и [класс aligned_union](../standard-library/aligned-union-class.md) для указания выравнивания для объединения с нетривиальные конструкторы или деструкторы.
