...
-   [Выражения с явными преобразованиями типов](https://msdn.microsoft.com/060ad6b4-9592-4f3e-8509-a20ac84a85ae). Явные преобразования (приведения) типов могут использоваться в выражениях.  
