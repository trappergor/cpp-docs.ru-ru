---
title: Как выполнить Разработка с учетом безопасности исключений
ms.custom: how-to
ms.date: 11/04/2016
ms.topic: conceptual
...
ms.locfileid: "54220558"
---
# <a name="how-to-design-for-exception-safety"></a>Как выполнить Разработка с учетом безопасности исключений
