---
title: Auto (C++) | Документация Майкрософт
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-language
...
## <a name="type-deduction-with-braced-initializers-c14"></a>Выведение типа с инициализаторами фигурных скобках (C ++ 14)  
 Следующие exmample кода показано, как инициализировать переменную автоматически с помощью фигурных скобок. Обратите внимание на разницу между B и C, а также между A и E.  
