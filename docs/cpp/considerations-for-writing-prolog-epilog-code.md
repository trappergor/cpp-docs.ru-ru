...
ms.locfileid: "37942111"
---
# <a name="considerations-for-writing-prologepilog-code"></a>Особенности написания кода пролога и эпилога
## <a name="microsoft-specific"></a>Блок, относящийся только к системам Microsoft  
 Перед написанием собственных последовательностей кодов пролога и эпилога важно понимать, как размещается кадр стека. Это также полезно знать, как использовать __LOCAL_SIZE символа.  
...
```  
 ...
 В следующем примере функции с атрибутом naked, содержащей пользовательский пролога и эпилога последовательности используется __LOCAL_SIZE символа в последовательности пролога:  
