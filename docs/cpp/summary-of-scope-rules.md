...
## <a name="constructor-initializers"></a>Инициализаторы конструктора  
 Инициализаторы конструктора (описанные в [инициализация базовых классов и членов](http://msdn.microsoft.com/2f71377e-2b6b-49da-9a26-18e9b40226a1)) вычисляются в области видимости самого внешнего блока конструктора, для которого они указаны. Следовательно, они могут использовать имена параметров конструктора.  
