...
```  
 ...
 Реализация функций в contosodata.cpp следует использовать полное доменное имя, даже если вы поместите `using` директив в верхней части файла:  
