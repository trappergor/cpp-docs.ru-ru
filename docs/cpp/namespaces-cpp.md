---
title: Пространства имен (C++) | Документация Майкрософт
ms.custom: ''
ms.date: 08/30/2017
ms.technology:
- cpp-language
...
Реализация функций в contosodata.cpp следует использовать полное доменное имя, даже если вы поместите **с помощью** директив в верхней части файла:
