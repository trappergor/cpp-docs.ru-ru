...
```  
 ...
 В предыдущем выражении `func` — это основное выражение `func(1)` представляет собой Постфиксное выражение функции, `func(1)->GetData` представляет собой Постфиксное выражение, задающее член класса, `func(1)->GetData()` — это другое Постфиксное выражение функции и весь выражение — Постфиксное выражение, увеличивающее возвращаемое значение GetData.  Значение выражения в целом имеет следующий смысл: "вызовите функцию, передающую 1 в качестве аргумента, и получите указатель на класс в качестве возвращаемого значения.  Затем вызовите `GetValue()` для этого класса, затем увеличение возвращаемого значения.  
