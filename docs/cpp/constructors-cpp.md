---
title: Конструкторы (C++) | Документация Майкрософт
ms.custom: ''
ms.date: 04/06/2018
ms.technology:
- cpp-language
