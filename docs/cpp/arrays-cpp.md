...
> *спецификатор decl* *идентификатор* **\[** *константное_выражение* **]**<br/>
> *спецификатор decl* *идентификатор*  **\[]**<br/>
> *спецификатор decl* *идентификатор* **\[]\[** *константное_выражение* **]** . . .<br/>
> *спецификатор decl* *идентификатор* **\[** *константное_выражение* **]** **\[** *константное_выражение* **]** . . .
