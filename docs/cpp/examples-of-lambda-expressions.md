---
title: Примеры лямбда-выражений | Документация Майкрософт
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-language
...
**Visual Studio 2017 версии 15.3 и более поздние версии** (состав [/std: c ++ 17](../build/reference/std-specify-language-standard-version.md)): захват **это** по значению (`[*this]`) когда лямбда-выражение будет использоваться в асинхронные и параллельные операции там, где код может выполняться после исходного объекта выходит за пределы области.
...
##  <a name="managedLambdaExpressions"></a> Использование лямбда-выражения с управляемыми типами (C + +/ CLI)
