---
title: "Виртуальные функции | Microsoft Docs"
ms.custom: ""
ms.date: "12/05/2016"
...
```  
 ...
 Так как виртуальные функции вызываются только для объектов типов классов, глобальные или статические функции невозможно объявить как **виртуальные**.  
  
 Ключевое слово **virtual** можно использовать при объявлении переопределяющих функций в производном классе, но это не обязательно, поскольку переопределения виртуальных функций всегда виртуальные.  
  
 Виртуальные функции в базовом классе необходимо определить, если они не объявлены с помощью *pure\-specifier*.  \(Дополнительные сведения о чистых виртуальных функциях см. в разделе [Абстрактные классы](../cpp/abstract-classes-cpp.md).\)  
...
## См. также  
 [Доступ к виртуальным функциям](../misc/access-to-virtual-functions.md)