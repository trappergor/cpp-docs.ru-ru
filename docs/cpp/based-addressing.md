---
title: Базовые адреса | Документация Майкрософт
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-language
...
ms.locfileid: "39407797"
---
# <a name="based-addressing"></a>Базовые адреса
Этот раздел содержит следующие подразделы:  
  
-   [Грамматика выражения __based](../cpp/based-grammar.md)  
