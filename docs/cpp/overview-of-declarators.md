---
title: Общие сведения о деклараторах | Документация Майкрософт
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-language
...
```  
 ...
 может выглядеть как объявление **int** указатель и функции, возвращающей `int*`, но это не так.  Это связано с тем, что оператор * входит в декларатор `i`, а не `f`.  
