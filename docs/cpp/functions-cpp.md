...
Функция, объявленная с одним ключевым словом **void** в списке объявлений параметров, не принимает аргументов, если ключевое слово **void** является первым и единственным членом списка объявлений аргумента. Аргументы типа **void** в других местах в списке выдают ошибки. Пример:
...
##  <a name="type_deduction"></a>Вычисление типов в возвращаемых типах (C++ 14)
...
В следующем примере (на основе кода из [N3493](http://www.open-std.org/JTC1/SC22/WG21/docs/papers/2013/n3493.html)) показано, как использовать параметр **decltype (Auto)** , чтобы обеспечить точную пересылку аргументов функции в возвращаемый тип, который не известен до создания экземпляра шаблона.
...
## <a name="multi_val"></a>Возврат нескольких значений из функции
