...
Рекомендуется использовать **typedef** для объявления псевдонима для типа указателя функции при объявлении функции, возвращающей тип указателя функции.  Пример
