...
Ключевое слово **protected** определяет доступ к членам класса в *списке Members* до следующего спецификатора доступа (**открытый** или **частный**) или в конце определения класса. Члены класса, объявленные как **protected** , могут использоваться только следующим образом:
...
При предшествующем имени базового класса ключевое слово **protected** указывает, что открытые и защищенные члены базового класса являются защищенными членами его производных классов.

Защищенные члены не являются частными как **закрытые** члены, которые доступны только членам класса, в которых они объявляются, но не являются **общедоступными членами,** которые доступны в любой функции.

Защищенные члены, которые также объявлены как **статические** , доступны любому дружественному или функции-члену производного класса. Защищенные члены, не объявленные как **статические** , доступны для друзей и функций-членов в производном классе только через указатель на, ссылку на или объект производного класса.
