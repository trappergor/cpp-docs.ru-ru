...
Теперь доступны новые возможности записи и упаковки приложений C++ для универсальной платформы Windows и Магазина Windows: можно использовать инфраструктуру моста для классических приложений. Она позволяет упаковать существующее классическое приложение или СОМ-объект для развертывания с помощью Магазина Windows. Кроме того, можно загрузить неопубликованные приложения с использованием существующих каналов. Благодаря новым возможностям в Windows 10 можно добавлять функции UWP в классическое приложение различными способами. Дополнительные сведения см. в статье [Мост для классических приложений](/windows/uwp/porting/desktop-to-uwp-root).
