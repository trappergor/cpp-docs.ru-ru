---
title: _HEAP_MAXREQ | Документация Майкрософт
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
...
## <a name="remarks"></a>Примечания  
 Максимальный размер пользовательского запроса на выделение памяти, который может быть удовлетворен.  
