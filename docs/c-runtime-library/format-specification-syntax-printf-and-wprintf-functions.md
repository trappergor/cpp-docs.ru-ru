...
## <a name="flags"></a> Директивы флагов
...
## <a name="width"></a> Спецификация ширины
...
## <a name="precision"></a> Спецификация точности
