...
# [CAB-файлы, cabsf, cabsl](cabs-cabsf-cabsl.md)
# [setvbuf](setvbuf.md)
...
# [ABS, лабораторные занятия, llabs, _abs64](abs-labs-llabs-abs64.md)
...
# [Функция _creat, _wcreat](creat-wcreat.md)
...
# [блокировка](posix-locking.md)
# [sopen](sopen.md)
# [запись](posix-write.md)
