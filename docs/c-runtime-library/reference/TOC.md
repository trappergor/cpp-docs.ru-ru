# [Алфавитный указатель функций CRT](crt-alphabetical-function-reference.md)
## [abort](abort.md)
...
## [Макрос assert, _assert, _wassert](assert-macro-assert-wassert.md)
## [Макросы _ASSERT, _ASSERTE, _ASSERT_EXPR](assert-asserte-assert-expr-macros.md)
...
## [Функции Бесселя: _j0, _j1, _jn, _y0, _y1, _yn](bessel-functions-j0-j1-jn-y0-y1-yn.md)
## [bitand](bitand.md)
## [bitor](bitor.md)
## [bsearch](bsearch.md)
...
## [Макрос _countof](countof-macro.md)
...
## [Примитивы с плавающей запятой](floating-point-primitives.md)
...
## [not](not.md)
## [not_eq](not-eq.md)
## [Макрос offsetof](offsetof-macro.md)
...
## [Макросы _RPT, _RPTF, _RPTW, _RPTFW](rpt-rptf-rptw-rptfw-macros.md)
...
## [Макрос _STATIC_ASSERT](static-assert-macro.md)
