...
## <a name="remarks"></a>Примечания  
 Для извлечения типа и подтипа, возвращаемых функцией `_CrtReportBlockType`, примените к возвращаемому значению макросы **_BLOCK_TYPE** и **_BLOCK_SUBTYPE** (они оба определяются в файле Crtdbg.h).  
