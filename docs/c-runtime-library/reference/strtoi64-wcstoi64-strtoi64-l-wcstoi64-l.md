...
**_strtoi64** возвращает значение, представленное в строке *стрсаурце*, за исключением случаев, когда представление вызовет переполнение, в этом случае возвращается **_I64_MAX** или **_I64_MIN**. Функция возвращает 0, если преобразование не может быть выполнено. **_wcstoi64** возвращает значения по аналогии с **strtoi64**.
