...
|-------------|--------------------|---------------------------|
|**_ismbclower**|Строчные буквы|Возвращает ненулевое значение, только если *c* — это — однобайтовое представление английской буквы ASCII нижнего регистра: 0x61 < =*c*< = 0x7A.|
|**_ismbclower_l**|Строчные буквы|Возвращает ненулевое значение, только если *c* — это — однобайтовое представление английской буквы ASCII нижнего регистра: 0x61 < =*c*< = 0x7A.|
|**_ismbcupper**|Прописные буквы|Возвращает ненулевое значение, только если *c* — это — однобайтовое представление английской буквы ASCII верхнего регистра: 0x41 < =*c*< = 0x5A.|
|**_ismbcupper_l**|Прописные буквы|Возвращает ненулевое значение, только если *c* — это — однобайтовое представление английской буквы ASCII верхнего регистра: 0x41 < =*c*< = 0x5A.|
