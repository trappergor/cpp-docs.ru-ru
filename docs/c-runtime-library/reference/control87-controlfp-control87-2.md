...
**_Control87** функция возвращает и задает управляющее слово. Управляющее слово блока операций с плавающей запятой позволяет программе изменять режимы точности, округления и бесконечности в пакете математических операций с числами с плавающей запятой в зависимости от платформы. Можно также использовать **_control87** для маскирования и снять маску исключения с плавающей запятой. Если значение для *маска* равно 0, **_control87** получает управляющее слово. Если *маска* — не равно нулю, устанавливается новое значение управляющего слова: для любого включенного бита на (то есть равного 1) в *маска*, соответствующий бит в *новый* используется для обновления элемента управления Word. Другими словами **fpcntrl** = ((**fpcntrl** & ~*маска*) &#124; (*новый* & *маска*)) где **fpcntrl** — это слово с плавающей запятой.
