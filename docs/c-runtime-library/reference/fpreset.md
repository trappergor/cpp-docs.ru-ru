...
**_Fpreset** функция повторно инициализирует пакета вычисления с плавающей запятой. **_fpreset** обычно используется с **сигнала**, **системы**, или **_exec** или **_spawn** функции. Если программа перехватывает сигналы с плавающей запятой ошибки (**SIGFPE**) с **сигнала**, безопасно восстановления после ошибок с плавающей запятой с помощью вызова **_fpreset** и с помощью **longjmp**.
