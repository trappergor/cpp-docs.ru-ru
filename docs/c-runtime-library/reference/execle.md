...
Эта функция POSIX не рекомендуется.  Используйте вместо нее соответствующую стандарту ISO C\+\+ функцию [\_execle](../../c-runtime-library/reference/execle-wexecle.md).  
