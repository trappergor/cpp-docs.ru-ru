...
> [!NOTE]
> **_strncpy_l** и **_wcsncpy_l** не имеют зависимости от языкового стандарта; они предоставляются только для **_tcsncpy_l** и не предназначены для непосредственного вызова.
