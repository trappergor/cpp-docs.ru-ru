...
Если файл имеет заданный режим, все функции возвращают значение 0. Функция возвращает значение-1, если именованный файл не существует или не имеет заданного режима. в этом случае задается, `errno` как показано в следующей таблице.
...
**_waccess** — это версия **_access**для расширенных символов; Аргумент *path* для **_waccess** является строкой расширенных символов. в противном случае **_waccess** и **_access** ведут себя одинаково.
