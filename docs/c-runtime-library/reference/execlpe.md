...
Эта функция POSIX не рекомендуется.  Используйте вместо нее соответствующую стандарту ISO C\+\+ функцию [\_execlpe](../../c-runtime-library/reference/execlpe-wexeclpe.md).  
