...
Каждая из этих функций возвращает указатель на первое вхождение *c* в *str*, или значение NULL, если *c* не найден.
