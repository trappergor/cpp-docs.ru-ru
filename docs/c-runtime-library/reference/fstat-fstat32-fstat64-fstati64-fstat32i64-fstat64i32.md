...
**_fstat** эквивалентна **_fstat64i32**, а **Структура** **_stat** содержит 64-разрядное время. Это справедливо, если не определено **_USE_32BIT_TIME_T** , в этом случае действует старое поведение; **_fstat** использует 32-разрядное время, а **структура** **_stat** содержит 32-бит времени. То же справедливо для **_fstati64**.
...
|**_fstati64**|Не определено|64-разрядная версия|64-разрядная версия|
