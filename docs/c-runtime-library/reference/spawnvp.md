...
Не рекомендуется использовать эту функцию POSIX.  Вместо этого используйте соответствующую стандарту ISO C\+\+[\_spawnvp](../../c-runtime-library/reference/spawnvp-wspawnvp.md).  
