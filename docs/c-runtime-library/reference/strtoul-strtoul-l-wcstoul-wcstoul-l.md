...
Каждая из этих функций преобразует входную строку *стрсаурце* в Long **без знака** **long**.
