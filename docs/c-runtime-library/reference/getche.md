...
Не рекомендуется использовать эту функцию POSIX.  Вместо неё используйте соответствующую стандарту ISO C\+\+ функцию [\_getche](../../c-runtime-library/reference/getche-getwche.md).  
