...
Эта функция POSIX не рекомендуется.  Используйте вместо нее соответствующую стандарту ISO C\+\+ функцию [\_execlp](../../c-runtime-library/reference/execlp-wexeclp.md).  
