...
Не рекомендуется использовать эту функцию POSIX.  Вместо неё используйте соответствующую стандарту ISO C\+\+ функцию [\_ungetch](../../c-runtime-library/reference/ungetch-ungetwch-ungetch-nolock-ungetwch-nolock.md).  
