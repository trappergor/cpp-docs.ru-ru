...
## <a name="return-value"></a>Возвращаемое значение  
 Возвращает время в виде числа секунд, истекших после полуночи 1 января 1970 г., или значение "-1" в случае ошибки.  
...
|-------------|---------------------|  
|`time`, `_time32`, `_time64`|C: \<time.h>, C++: \<ctime> или \<time.h>|  
