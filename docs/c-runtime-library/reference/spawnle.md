...
Не рекомендуется использовать эту функцию POSIX.  Вместо этого используйте соответствующую стандарту ISO C\+\+ [\_spawnle](../../c-runtime-library/reference/spawnle-wspawnle.md).  
