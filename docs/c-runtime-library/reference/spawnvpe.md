---
title: "spawnvpe | Документы Майкрософт"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
Эта функция POSIX устарела. Используйте вместо нее соответствующую стандарту ISO C++ функцию [_spawnvpe](../../c-runtime-library/reference/spawnvpe-wspawnvpe.md).  
