...
Функция **_strtoui64** преобразует *стрсаурце* в **__int64** **без знака** . **_wcstoui64** — это версия **_strtoui64**для расширенных символов; его аргумент *стрсаурце* является строкой расширенных символов. В остальном эти функции работают одинаково.
