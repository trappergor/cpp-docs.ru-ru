...
Не рекомендуется использовать эту функцию POSIX.  Вместо неё используйте соответствующую стандарту ISO C\+\+ [\_execv](../../c-runtime-library/reference/execv-wexecv.md).  
