...
При определении **_DEBUG** и **_CRTDBG_MAP_ALLOC** вызовы методов **_getcwd** и **_wgetcwd** заменяются вызовами **_getcwd_dbg** и **_wgetcwd_dbg** для разрешения отладки выделения памяти. Дополнительные сведения см. в разделе [_getcwd_dbg, _wgetcwd_dbg](getcwd-dbg-wgetcwd-dbg.md).
