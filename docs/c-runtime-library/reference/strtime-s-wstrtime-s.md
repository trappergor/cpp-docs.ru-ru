...
Передача в недопустимом отличных**NULL** значение для буфера приводит к нарушению прав доступа, если *numberOfElements* параметра больше 9.
