...
Каждая функция возвращает значение **__int64** , полученное путем интерпретации входных символов в виде числа. Возвращаемое значение равно 0 для **_atoi64** , если входные данные не могут быть преобразованы в значение этого типа.
...
**_wtoi64** идентичен **_atoi64** , за исключением того, что в качестве параметра принимается строка расширенных символов.
