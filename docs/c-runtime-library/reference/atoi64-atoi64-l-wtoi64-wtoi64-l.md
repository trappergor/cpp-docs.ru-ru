...
Каждая функция возвращает **__int64** значение, порожденное методом интерпретации входных символов как числа. Возвращает значение 0 для **_atoi64** Если входные данные невозможно преобразовать в значение этого типа.
...
**_wtoi64** идентична **_atoi64** за исключением того, что он принимает строку расширенных символов в качестве параметра.
...
Эта программа показывает, как числа, сохраненные в виде строк можно преобразовать в числовые значения с помощью **_atoi64** функции.
