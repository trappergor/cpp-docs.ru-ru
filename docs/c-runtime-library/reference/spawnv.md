...
Не рекомендуется использовать эту функцию POSIX.  Вместо этого используйте соответствующую стандарту ISO C\+\+ [\_spawnv](../../c-runtime-library/reference/spawnv-wspawnv.md).  
