---
title: "Внутренние глобальные переменные и функции CRT | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
---
# Внутренние глобальные переменные и функции CRT
...
## Внутренние глобальные переменные и макросы значений CRT  
...
## Внутренние функции и макросы функций CRT  
 Следующие функции и макросы функций используются для реализации CRT и стандартной библиотеки C\+\+ \(STL\).  
