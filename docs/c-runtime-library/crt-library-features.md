...
description: Различные lib-файлы, составляющие библиотеки времени выполнения Microsoft C, а также связанные с ними параметры компилятора и директивы препроцессора.
ms.date: 08/20/2018
helpviewer_keywords:
- MSVCR71.dll
...
Эта версия CRT не полностью совместима со стандартом C99. В частности, \<tgmath.h> заголовок и макросы CX_LIMITED_RANGE/FP_CONTRACT pragma не поддерживаются. Некоторые элементы, такие как значения спецификаторов параметров в стандартных функциях ввода-вывода, по умолчанию используют интерпретации прежних версий. Можно использовать параметры согласованности компилятора/Zc и указать параметры компоновщика для управления некоторыми аспектами соответствия библиотеки.
