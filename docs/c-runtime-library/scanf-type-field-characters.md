...
|--------------------------|-----------------------|----------------------------------|
|один байт|`scanf` ;|`c`, `hc` или `hC`|
|один байт|`wscanf` ;|`C`, `hc` или `hC`|
|расширенный символ|`wscanf` ;|`c`, `lc` или `lC`|
|расширенный символ|`scanf` ;|`C`, `lc` или `lC`|
