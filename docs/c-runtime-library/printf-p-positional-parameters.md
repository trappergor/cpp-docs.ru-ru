---
title: "Позиционные параметры printf_p | Документы Майкрософт"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
С помощью `*n$` можно указать позиционный параметр в качестве описателя ширины или точности, где `n` обозначает позицию нужного параметра в списке параметров. Позиция для значения ширины или точности должна быть указана сразу после символа \*. Например:  
