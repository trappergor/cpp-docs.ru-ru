---
title: errno, _doserrno, _sys_errlist, and _sys_nerr | Документация Майкрософт
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
...
## <a name="see-also"></a>См. также  
 ...
 [errno Constants](../c-runtime-library/errno-constants.md)  (Константы errno)  
