...
-   **Лицензированные**: Добавляет к элементу управления для поддержки [лицензирования](http://msdn.microsoft.com/library/windows/desktop/ms690543). Лицензированные элементы управления можно размещать только в том случае, если на компьютере клиента соответствующей лицензией.  
