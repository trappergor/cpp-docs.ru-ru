...
Дополнительные сведения об этой структуре, включая список его элементов, см. в разделе [PROPSHEETPAGE](/windows/desktop/api/prsht/ns-prsht-propsheetpagea_v3) в пакете Windows SDK.
