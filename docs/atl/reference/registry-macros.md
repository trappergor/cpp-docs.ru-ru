...
*flags*<br/>
[in] DWORD, содержащее программы потоковой модели в реестре. Должен принимать одно из следующих значений: THREADFLAGS_APARTMENT THREADFLAGS_BOTH и AUTPRXFLAG.
