...
Помимо MESSAGE_HANDLER, можно использовать [COMMAND_HANDLER](#command_handler) и [NOTIFY_HANDLER](#notify_handler) для сопоставления [WM_COMMAND](/windows/desktop/menurc/wm-command) и [WM_NOTIFY](/windows/desktop/controls/wm-notify) сообщений , соответственно.
...
Аналогичную [NOTIFY_HANDLER](#notify_handler), но сопоставляет [WM_NOTIFY](/windows/desktop/controls/wm-notify) сообщения на основе только код уведомления.
...
Сопоставляет NOTIFY_HANDLER [WM_NOTIFY](/windows/desktop/controls/wm-notify) сообщение для указанного обработчика функции, в зависимости от кода уведомления и идентификатор элемента управления.
...
Аналогичную [NOTIFY_HANDLER](#notify_handler), но сопоставляет [WM_NOTIFY](/windows/desktop/controls/wm-notify) сообщения на основе только идентификатор элемента управления.
...
Аналогичную [NOTIFY_RANGE_HANDLER](#notify_range_handler), но сопоставляет [WM_NOTIFY](/windows/desktop/controls/wm-notify) сообщений с кодом уведомления из диапазона элементов управления к одному обработчику функции.
...
Аналогичную [NOTIFY_HANDLER](#notify_handler), но сопоставляет [WM_NOTIFY](/windows/desktop/controls/wm-notify) сообщений из диапазона элементов управления к одному обработчику функции.
