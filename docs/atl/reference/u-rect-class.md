---
title: "Класс _U_RECT | Документы Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
Этот класс адаптера аргумент позволяет либо `RECT` указатели или ссылки будет передан в функцию, которая реализуется в терминах указатели.  
