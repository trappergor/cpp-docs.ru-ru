...
## <a name="see-also"></a>См. также  
 ...
 [Строки подключения и связи данных (OLE DB)](https://msdn.microsoft.com/library/ms718376.aspx)
