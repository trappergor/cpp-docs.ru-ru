...
### <a name="parameters"></a>Параметры  
 *statusFlags*  
 [in] Просмотр СОСТОЯНИЯ флаги. См. в разделе [Просмотр СОСТОЯНИЯ](http://msdn.microsoft.com/library/windows/desktop/ms687201) список флагов.  
