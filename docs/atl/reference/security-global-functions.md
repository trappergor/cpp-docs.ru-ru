 ...
 *Тип объекта*  
 Указывает значение из [работать пример](http://msdn.microsoft.com/library/windows/desktop/aa379593) перечисление, указывающее тип объекта, идентифицируемое по *hObject* параметра.  
 ...
 *Тип объекта*  
 Указывает значение из [работать пример](http://msdn.microsoft.com/library/windows/desktop/aa379593) перечисление, указывающее тип объекта, идентифицируемое по *pszObjectName* параметра.  
