...
## <a name="aggregation-and-class-factory-macrosaggregation-and-class-factory-macrosmd"></a>[Статистическая обработка и макросов фабрики классов](aggregation-and-class-factory-macros.md)
## <a name="category-macroscategory-macrosmd"></a>[Макросы категории](category-macros.md)
## <a name="com-map-macroscom-map-macrosmd"></a>[Макросы сопоставления COM](com-map-macros.md)
## <a name="compiler-options-macroscompiler-options-macrosmd"></a>[Макросы параметров компилятора](compiler-options-macros.md)
## <a name="composite-control-macroscomposite-control-macrosmd"></a>[Макросы в составной элемент управления](composite-control-macros.md)
## <a name="connection-point-macrosconnection-point-macrosmd"></a>[Макросы точки подключения](connection-point-macros.md)
## <a name="debugging-and-error-reporting-macrosdebugging-and-error-reporting-macrosmd"></a>[Макросы отладки и сообщения об ошибках](debugging-and-error-reporting-macros.md)
## <a name="exception-handling-macrosexception-handling-macrosmd"></a>[Макросы обработки исключений](exception-handling-macros.md)
## <a name="message-map-macros-atlmessage-map-macros-atlmd"></a>[Макросы схемы сообщений (ATL)](message-map-macros-atl.md)
## <a name="object-map-macrosobject-map-macrosmd"></a>[Макросы схемы объекта](object-map-macros.md)
## <a name="object-status-macrosobject-status-macrosmd"></a>[Макросы состояния объекта](object-status-macros.md)
## <a name="property-map-macrosproperty-map-macrosmd"></a>[Макрос свойств карты](property-map-macros.md)
## <a name="registry-data-exchange-macrosregistry-data-exchange-macrosmd"></a>[Макросы Exchange данных реестра](registry-data-exchange-macros.md)
## <a name="registry-macrosregistry-macrosmd"></a>[Макросы реестра](registry-macros.md)
## <a name="service-map-macrosservice-map-macrosmd"></a>[Макросы схемы службы](service-map-macros.md)
## <a name="snap-in-object-macrossnap-in-object-macrosmd"></a>[Макросы объекта snap-In](snap-in-object-macros.md)
...
## <a name="ccombstr-classccombstr-classmd"></a>[CComBSTR-класс](ccombstr-class.md)
...
## <a name="ccommodule-classccommodule-classmd"></a>[CComModule-класс](ccommodule-class.md)
...
## <a name="ccomsafearray-classccomsafearray-classmd"></a>[Класс класса CComSafeArray](ccomsafearray-class.md)
...
## <a name="ccomvariant-classccomvariant-classmd"></a>[Класса CComVariant](ccomvariant-class.md)
...
## <a name="cdialogimpl-classcdialogimpl-classmd"></a>[CDialogImpl-класс](cdialogimpl-class.md)
...
## <a name="csid-classcsid-classmd"></a>[Идентификатор CSid класса](csid-class.md)
...
## <a name="curl-classcurl-classmd"></a>[Переворачивание класса](curl-class.md)
...
## <a name="iobjectwithsiteimpl-classiobjectwithsiteimpl-classmd"></a>[Интерфейс IObjectWithSiteImpl класса](iobjectwithsiteimpl-class.md)
...
# <a name="atl-functionsatl-functionsmd"></a>[Функции библиотеки ATL](atl-functions.md)
...
## <a name="atl-text-encoding-functionsatl-text-encoding-functionsmd"></a>[Кодировка функции текста ATL](atl-text-encoding-functions.md)
...
## <a name="composite-control-global-functionscomposite-control-global-functionsmd"></a>[Глобальные функции составного элемента управления](composite-control-global-functions.md)
## <a name="connection-point-global-functionsconnection-point-global-functionsmd"></a>[Точка подключения глобальные функции](connection-point-global-functions.md)
...
## <a name="debugging-and-error-reporting-global-functionsdebugging-and-error-reporting-global-functionsmd"></a>[Отладка и глобальные функции отчетов об ошибках](debugging-and-error-reporting-global-functions.md)
## <a name="event-handling-global-functionsevent-handling-global-functionsmd"></a>[Глобальные функции обработки событий](event-handling-global-functions.md)
## <a name="marshaling-global-functionsmarshaling-global-functionsmd"></a>[Маршалинг глобальные функции](marshaling-global-functions.md)
## <a name="pixel-himetric-conversion-global-functionspixel-himetric-conversion-global-functionsmd"></a>[Глобальные функции преобразования HIMETRIC пикселей](pixel-himetric-conversion-global-functions.md)
...
## <a name="security-identifier-global-functionssecurity-identifier-global-functionsmd"></a>[Глобальные функции идентификатор безопасности](security-identifier-global-functions.md)
## <a name="server-registration-global-functionsserver-registration-global-functionsmd"></a>[Глобальные функции регистрации сервера](server-registration-global-functions.md)
...
## <a name="worker-archetypeworker-archetypemd"></a>[Рабочий Архетипе](worker-archetype.md)
# <a name="atl-wizards-and-dialog-boxesatl-wizards-and-dialog-boxesmd"></a>[ATL мастерами и диалоговыми окнами](atl-wizards-and-dialog-boxes.md)
## <a name="creating-an-atl-projectcreating-an-atl-projectmd"></a>[Создание проекта библиотеки ATL](creating-an-atl-project.md)
### <a name="atl-project-wizardatl-project-wizardmd"></a>[Мастер проекта ATL](atl-project-wizard.md)
#### <a name="application-settings-atl-project-wizardapplication-settings-atl-project-wizardmd"></a>[Параметры приложения, мастер проекта ATL](application-settings-atl-project-wizard.md)
### <a name="default-atl-project-configurationsdefault-atl-project-configurationsmd"></a>[Конфигурации проекта ATL по умолчанию](default-atl-project-configurations.md)
### <a name="mfc-support-in-atl-projectsmfc-support-in-atl-projectsmd"></a>[Поддержка MFC в проекты ATL](mfc-support-in-atl-projects.md)
...
### <a name="specifying-compiler-optimization-for-an-atl-projectspecifying-compiler-optimization-for-an-atl-projectmd"></a>[Задание оптимизации компилятора для проекта ATL](specifying-compiler-optimization-for-an-atl-project.md)
...
### <a name="making-an-atl-object-noncreatablemaking-an-atl-object-noncreatablemd"></a>[Делая Noncreatable объекта ATL](making-an-atl-object-noncreatable.md)
...
### <a name="atl-simple-object-wizardatl-simple-object-wizardmd"></a>[Мастер создания простого объекта ATL](atl-simple-object-wizard.md)
#### <a name="options-atl-simple-object-wizardoptions-atl-simple-object-wizardmd"></a>[Параметры, мастер создания простого объекта ATL](options-atl-simple-object-wizard.md)
...
### <a name="atl-property-page-wizardatl-property-page-wizardmd"></a>[Мастер создания страниц свойств ATL](atl-property-page-wizard.md)
#### <a name="options-atl-property-page-wizardoptions-atl-property-page-wizardmd"></a>[Параметры, мастер страниц свойств ATL](options-atl-property-page-wizard.md)
#### <a name="strings-atl-property-page-wizardstrings-atl-property-page-wizardmd"></a>[Строки, мастер страниц свойств ATL](strings-atl-property-page-wizard.md)
## <a name="adding-an-atl-ole-db-provideradding-an-atl-ole-db-providermd"></a>[Добавление поставщика ATL OLE DB](adding-an-atl-ole-db-provider.md)
### <a name="atl-ole-db-provider-wizardatl-ole-db-provider-wizardmd"></a>[Мастер поставщика ATL OLE DB](atl-ole-db-provider-wizard.md)
## <a name="adding-an-atl-ole-db-consumeradding-an-atl-ole-db-consumermd"></a>[Добавление потребителя ATL OLE DB](adding-an-atl-ole-db-consumer.md)
### <a name="atl-ole-db-consumer-wizardatl-ole-db-consumer-wizardmd"></a>[Мастер потребителей ATL OLE DB](atl-ole-db-consumer-wizard.md)
...
## <a name="adding-an-atl-com-10-componentadding-an-atl-com-plus-1-0-componentmd"></a>[Добавление компонента ATL COM + 1.0](adding-an-atl-com-plus-1-0-component.md)
### <a name="atl-com-10-component-wizardatl-com-plus-1-0-component-wizardmd"></a>[ATL COM + 1.0 компонент мастера](atl-com-plus-1-0-component-wizard.md)
...
## <a name="adding-an-atl-active-server-page-componentadding-an-atl-active-server-page-componentmd"></a>[Добавление ATL ASP-компонента](adding-an-atl-active-server-page-component.md)
### <a name="atl-active-server-page-component-wizardatl-active-server-page-component-wizardmd"></a>[Мастер компонент активного сервера ATL](atl-active-server-page-component-wizard.md)
### <a name="options-atl-active-server-page-component-wizardoptions-atl-active-server-page-component-wizardmd"></a>[Параметры мастера компонент активного сервера ATL](options-atl-active-server-page-component-wizard.md)
### <a name="asp-atl-active-server-page-component-wizardasp-atl-active-server-page-component-wizardmd"></a>[ASP, мастер компонент активного сервера ATL](asp-atl-active-server-page-component-wizard.md)
