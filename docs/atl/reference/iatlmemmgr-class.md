...
|[Бесплатная](#free)|Этот метод используется для освобождения блока памяти.|  
|[GetSize](#getsize)|Этот метод используется для определения размера выделенного блока памяти.|  
|[Перераспределение](#reallocate)|Этот метод вызывается для перераспределение блока памяти.|  
...
### <a name="remarks"></a>Примечания  
 Вызов [IAtlMemMgr::Free](#free) или [IAtlMemMgr::Reallocate](#reallocate) для освобождения памяти, выделенной с помощью данного метода.  
  
### <a name="example"></a>Пример  
 Например, в разделе [IAtlMemMgr Обзор](../../atl/reference/iatlmemmgr-class.md).  
  
##  <a name="a-namefreea--iatlmemmgrfree"></a><a name="free"></a>IAtlMemMgr::Free  
 Этот метод используется для освобождения блока памяти.  
...
### <a name="remarks"></a>Примечания  
 Этот метод используется для освобождения памяти, полученных [IAtlMemMgr::Allocate](#allocate) или [IAtlMemMgr::Reallocate](#reallocate).  
  
### <a name="example"></a>Пример  
 Например, в разделе [IAtlMemMgr Обзор](../../atl/reference/iatlmemmgr-class.md).  
  
##  <a name="a-namegetsizea--iatlmemmgrgetsize"></a><a name="getsize"></a>IAtlMemMgr::GetSize  
 Этот метод используется для определения размера выделенного блока памяти.  
...
### <a name="remarks"></a>Примечания  
 ...
 Концептуально этот метод освобождает память, существующие и выделяет новый блок памяти. На самом деле имеющейся памяти может расширять или в противном случае повторно.  
...
### <a name="remarks"></a>Примечания  
 ...
 Создание лицензированный элемент управления ActiveX, в разделе [IAxWinHostWindowLic::CreateControlLic](#createcontrollicex).  
...
### <a name="remarks"></a>Примечания  
 ...
 Создание лицензированный элемент управления ActiveX, в разделе [IAxWinHostWindowLic::CreateControlLicEx](#createcontrollicex).  
