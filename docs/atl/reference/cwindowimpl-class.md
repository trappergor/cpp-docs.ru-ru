...
*rect*<br/>
[in] Объект [RECT](/previous-versions/dd162897\(v=vs.85\)) структуры, указывающий положение окна. `RECT` Могут передаваться, указателем или по ссылке.
