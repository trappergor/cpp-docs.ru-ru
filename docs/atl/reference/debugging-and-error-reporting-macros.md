...
*exp*<br/>
[in] Строка и переменные для отправки в окне вывода или любого приложения, который перехватывает эти сообщения.
...
*exp*<br/>
[in] Строка, для отправки в окне вывода или любого приложения, который перехватывает эти сообщения.
