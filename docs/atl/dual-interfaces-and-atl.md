---
title: Сдвоенные интерфейсы и ATL
ms.date: 11/04/2016
helpviewer_keywords:
- COM, and ATL
- ATL, dual interfaces
...
ms.locfileid: "62234843"
---
# <a name="dual-interfaces-and-atl"></a>Сдвоенные интерфейсы и ATL

Сдвоенный интерфейс позволяет его методам должен осуществляться как методы disp-интерфейс или как методы vtable. В этом разделе рассматриваются некоторые из особенностей сдвоенные интерфейсы с точки зрения ATL.
