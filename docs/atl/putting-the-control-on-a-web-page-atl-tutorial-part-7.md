...
На этом шаге вы включит в скрипт для реагирования на события веб-страницы. Вы также измените элемент управления, позволит узнать, что элемент управления безопасен для скриптов в Internet Explorer.
...
Создание элемента управления. После завершения сборки откройте PolyCtl.htm в представлении браузера еще раз. В данном случае веб-страницы должен отображаться непосредственно без диалогового окна предупреждения безопасности. Щелкните внутри многоугольника; число его сторон увеличится на единицу. Щелкните за пределами полигона, чтобы уменьшить число сторон. Если вы пытаетесь снизить число сторон меньше трех, появится сообщение об ошибке, заданное.
