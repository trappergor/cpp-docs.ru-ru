...
ms.locfileid: "62262142"
---
# <a name="event-handling-and-atl"></a>Обработка событий и ATL

В этом разделе показано, как в приемник событий с помощью ATL. Рассматриваются принципы обработки событий COM и особенности прием событий с помощью поддержки, обеспечиваемой ATL.

Сведения о том, как для порождения событий и реализации точек подключения [точки подключения ATL](../atl/atl-connection-points.md).
