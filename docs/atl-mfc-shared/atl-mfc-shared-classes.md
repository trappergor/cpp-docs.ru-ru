---
title: Общие классы ATL-MFC | Документация Майкрософт
...
Эти служебные классы можно использовать в любом собственном проекте C++ без необходимости любой библиотеки DLL MFC.
