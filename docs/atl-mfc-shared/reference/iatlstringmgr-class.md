...
|[Клон](#clone)|Вызовите этот метод для возврата указателя на новый диспетчер строку для использования с другим экземпляром `CSimpleStringT`.|  
