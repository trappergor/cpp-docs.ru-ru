...
*pointDest*<br/>
Ссылка на структуру [POINT,](/previous-versions/dd162805\(v=vs.85\)) которая идентифицирует верхний левый угол прямоугольника назначения, в логических единицах.
...
*rectDest*<br/>
Ссылка на структуру [RECT,](/previous-versions/dd162897\(v=vs.85\)) определяющую пункт назначения.
...
*pointDest*<br/>
Структура [POINT,](/previous-versions/dd162805\(v=vs.85\)) указывающая на верхний левый угол прямоугольника назначения.
...
*rectDest*<br/>
Структура [RECT,](/previous-versions/dd162897\(v=vs.85\)) указывающая прямоугольник назначения.
...
Бит на пиксель обычно 1, 4, 8, 16, 24 или 32. Подробнее `biBitCount` об этом значении можно получить у участника [BITMAPINFOHEADER](/previous-versions//dd183376\(v=vs.85\)) в SDK для Windows.
...
*rectSrc*<br/>
Ссылка на структуру [RECT,](/previous-versions/dd162897\(v=vs.85\)) определяющую координаты прямоугольника источника.

*pointMask*<br/>
Структура [POINT,](/previous-versions/dd162805\(v=vs.85\)) указывающая на верхний левый угол бик-карты маски.
