...
В этом разделе предполагается, что вы прочитали статью [Средства CMake для Visual Studio](../build/cmake-projects-in-visual-studio.md). 
