...
description: Описание свойств отладчика C++ (Linux) в Microsoft Visual Studio.
ms.date: 06/07/2019
...
| GDB Path (Путь к GDB) | **Visual Studio 2019 версии 16.9:** позволяет указать путь к исполняемому файлу GDB, который будет использоваться Visual Studio. |
