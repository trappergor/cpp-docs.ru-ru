...
При компиляции исходного файла с помощью определенной версии файлов заголовков библиотек C++ Visual Studio (заголовки включаются посредством #including) полученный объектный файл должен быть скомпонован с использованием той же версии библиотек. Например, при компиляции файла исходного кода с использованием \<immintrin.h> Visual Studio 2017 необходимо выполнить компоновку с библиотекой vcruntime Visual Studio 2017. Аналогичным образом, если файл исходного кода компилируется с помощью \<iostream> Visual Studio 2017, нужно осуществлять компоновку со стандартной библиотекой C++ Visual Studio 2017 — msvcprt. Комбинирование по своему усмотрению не поддерживается.
