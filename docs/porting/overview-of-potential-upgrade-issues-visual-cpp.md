...
При компоновке с библиотекой импорта любые более поздние версии библиотек распространяемых компонентов Visual Studio, которые сохраняют совместимость с ABI, можно использовать во время выполнения. Например, если приложение скомпилировано и скомпоновано с помощью набора инструментов Visual Studio 2015 с обновлением 3, вы можете использовать любой распространяемый компонент Visual Studio 2017 или Visual Studio 2019, так как библиотеки 2015, 2017 и 2019 сохранили обратную совместимость двоичного кода. Обратная совместимость невозможна: вы не можете использовать распространяемый компонент для версии набора инструментов, предшествующей той, которую вы использовали для создания кода, даже если он содержал совместимый ABI.
