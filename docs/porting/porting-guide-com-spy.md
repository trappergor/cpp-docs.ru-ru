---
title: 'Руководство по переносу: COM Spy | Документы Майкрософт'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-language
...
```  
 ...
 Аналогичное изменение выполняется для IPersistStreamInit_Load.  
