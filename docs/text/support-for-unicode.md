...
Расширенный символ — это двухбайтовый многоязыковой код символа. Десятки тысяч символов, включающие почти все символы, используемые в современных вычислениях по всему миру, включая технические символы и специальные символы публикации, могут быть представлены в соответствии со спецификацией Юникода в виде одного расширенного символа, закодированного использование UTF-16. Символы, которые не могут быть представлены только в одном расширенном символе, можно представить в паре Юникода с помощью суррогатной пары Юникода. Поскольку почти каждый символ в общем использовании представлен в кодировке UTF-16 в одном 16-разрядном расширенном символе, использование расширенных символов упрощает программирование с использованием международных наборов символов. Широкие символы, закодированные с помощью UTF-16LE (для прямого порядка байтов), являются собственными символьными форматами для Windows.

Строка расширенных символов представляется как массив `wchar_t[]`, и на нее указывает указатель `wchar_t*`. Любой символ ASCII может быть представлен как расширенный символ путем добавления к нему префикса "L". Например, L ' \ 0 ' является завершающим (16-разрядным) нулевым символом. Подобным образом все строковые литералы, составленные из символов ASCII, могут быть представлены как строковые литералы из расширенных символов путем добавления к литералу ASCII префикса "L" (L"Hello").
...
- [Включение Юникода в моей программе](../text/international-enabling.md)

- [Включение Юникода и MBCS в программе](../text/internationalization-strategies.md)

- [Использование Юникода для создания международных программ](../text/unicode-programming-summary.md)

- [Узнайте о преимуществах Юникода](../text/benefits-of-character-set-portability.md)

- [Использование wmain для передачи аргументов расширенных символов в мою программу](../text/support-for-using-wmain.md)

- [См. сводку по программированию в Юникоде](../text/unicode-programming-summary.md)

- [Сведения о сопоставлениях универсального текста для переносимости по ширине байтов](../text/generic-text-mappings-in-tchar-h.md)
