...
*_Func(Type)* объект функции для применения к каждому элементу операнда valarray.

*_Func(const Type&)* объект функции для константы, применяемый к каждому элементу операнда valarray.
