...
Функция – член вызывает [basic_ios:: swap](../standard-library/basic-ios-class.md#swap) `(right)` для обмена содержимым этого объекта по содержимому *right*.
