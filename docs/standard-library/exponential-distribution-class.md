---
title: "Класс exponential_distribution | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
helpviewer_keywords: 
  ...
  - "exponential_distribution - класс [TR1]"
...
---
# Класс exponential_distribution
...
|`exponential_distribution::operator()`||[exponential\_distribution::param\_type](../Topic/exponential_distribution::param_type.md)|  
 ...
 Функция свойства `lambda()` возвращает значение для хранимого параметра распределения `lambda`.  
