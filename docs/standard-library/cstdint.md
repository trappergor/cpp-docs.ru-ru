---
title: '&lt;cstdint&gt; | Документы Майкрософт'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
...
ms.locfileid: "33844488"
---
# <a name="ltcstdintgt"></a>&lt;cstdint&gt;

Включает заголовок \<stdint.h> стандартной библиотеки C и добавляет связанные имена в пространство имен `std`.
