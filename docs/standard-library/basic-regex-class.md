...
`right` Копируемый источник регулярного выражения.

`ptr` Указатель на начало последовательности для копирования.

`flags` Флаги вариантов синтаксиса, добавляемые при копировании.

`len/TD>` Длина последовательности для копирования.

`str` Строка для копирования.

`first` Начало последовательности для копирования.

`last` Конец последовательности для копирования.
...
`right` Объект регулярного выражения для замены.
