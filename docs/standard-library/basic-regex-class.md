...
*STtraits* класс признаков для источника строки.

*STalloc* класс распределителя для источника строки.

*InIt* тип итератора ввода для источника диапазона.

*правом* копируемый источник регулярного выражения.

*PTR* указатель на начало последовательности для копирования.

*флаги* флаги вариантов синтаксиса, добавляемые при копировании.

*Len/TD >* длину последовательности для копирования.

*STR* строка для копирования.

*Первый* начало последовательности для копирования.

*последний* конец последовательности для копирования.
...
*правом* объект регулярного выражения для замены.
