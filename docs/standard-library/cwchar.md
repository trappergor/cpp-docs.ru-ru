---
title: '&lt;cwchar&gt; | Документы Майкрософт'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
...
ms.locfileid: "33841854"
---
# <a name="ltcwchargt"></a>&lt;cwchar&gt;

Включает заголовок \<wchar.h> стандартной библиотеки C и добавляет связанные имена в пространство имен `std`.
