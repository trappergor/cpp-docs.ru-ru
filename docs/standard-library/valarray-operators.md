...
||||  
|-|-|-|  
|[оператор!=](#operator_neq)|[оператор%](#operator_mod)|[оператор&amp;](#operator_amp_)|  
|[оператор&amp;&amp;](#operator_amp__amp_)|[оператор&gt;](#operator_gt_)|[operator&gt;&gt;](#operator_gt__gt_)|  
|[operator&gt;=](#operator_gt__eq)|[оператор&lt;](#operator_lt_)|[operator&lt;&lt;](#operator_lt__lt_)|  
|[оператор&lt;=](#operator_lt__eq)|[оператор*](#operator_star)|[оператор+](#operator_add)|  
|[оператор-](#operator-)|[оператор/](#operator_)|[оператор==](#operator_eq_eq)|  
|[оператор^](#operator_xor)|[оператор|](#operator_or)|[оператор||](#operator_lor)|  
...
### <a name="remarks"></a>Примечания  
 Первый оператор шаблона возвращает объект класса [valarray\<bool>](../standard-library/valarray-bool-class.md), каждый из элементов которого `I` представляет собой ` left`[ `I`] != ` right`[ `I`].  
  
 Второй оператор шаблона сохраняет элемент *I  left*[ `I`] != _ *Right*.  
...
### <a name="return-value"></a>Возвращаемое значение  
 Объект valarray, каждый элемент которого представляет собой остаток от деления ` left` на ` right.`  
...
### <a name="parameters"></a>Параметры  
 ` left`  
 Первый из двух объектов valarray, элементы которого объединяются с помощью операции "побитовое **И**", или указанное значение типа элемента, которое объединяется с помощью операции "побитовое И" с каждым элементом объекта valarray.  
  
 ` right`  
 Второй из двух объектов valarray, элементы которого объединяются с помощью операции "побитовое **И**", или указанное значение типа элемента, которое объединяется с помощью операции "побитовое И" с каждым элементом объекта valarray.  
  
### <a name="return-value"></a>Возвращаемое значение  
 Объект valarray, каждый элемент которого представляет собой объединение ` left` и ` right.` с помощью "побитового И"  
...
### <a name="remarks"></a>Примечания  
 ...
 Побитовое **И** имеет ту же таблицу истинности, что и логическое **И** , но применяется к типам данных на уровне отдельных битов. Оператор [operator&&](../standard-library/valarray-operators.md#operator_amp__amp_) применяется на уровне элемента, интерпретируя все ненулевые значения как true. Результатом является объект valarray из логических значений. Применение оператора побитового "И" **operator&**, напротив, может привести к появлению в объекте valarray значений, отличных от 0 или 1, в зависимости от результата побитовой операции.  
...
##  <a name="a-nameoperatorampampa--operatorampamp"></a><a name="operator_amp__amp_"></a>  оператор&amp;&amp;  
...
### <a name="parameters"></a>Параметры  
 ` left`  
 Первый из двух объектов valarray, элементы которого объединяются с помощью операции "логическое **И**", или указанное значение типа элемента, которое объединяется с помощью операции "логическое И" с каждым элементом объекта valarray.  
  
 ` right`  
 Второй из двух объектов valarray, элементы которого объединяются с помощью операции "логическое **И**", или указанное значение типа элемента, которое объединяется с помощью операции "логическое И" с каждым элементом объекта valarray.  
  
### <a name="return-value"></a>Возвращаемое значение  
 Объект valarray, каждый элемент которого имеет логический тип и представляет собой объединение ` left` и ` right.` с помощью логического **И**  
  
### <a name="remarks"></a>Примечания  
 Оператор логическое "И" (**operator&&**) применяется на уровне элемента, интерпретируя все ненулевые значения как true. Результатом является объект valarray из логических значений. Применение оператора побитового **И** ([operator&](../standard-library/valarray-operators.md#operator_amp_)), напротив, может привести к появлению в объекте valarray значений, отличных от 0 или 1, в зависимости от результата побитовой операции.  
...
### <a name="return-value"></a>Возвращаемое значение  
 Объект valarray, каждый элемент которого представляет собой произведение ` left` и ` right.`  
...
##  <a name="a-nameoperatoradda--operator"></a><a name="operator_add"></a>  оператор+  
...
### <a name="return-value"></a>Возвращаемое значение  
 Объект valarray, каждый элемент которого представляет собой сумму ` left` и ` right.`  
...
### <a name="return-value"></a>Возвращаемое значение  
 Объект valarray, каждый элемент которого представляет собой разность ` left` и ` right.`  
...
##  <a name="a-nameoperatora--operator"></a><a name="operator_"></a>  оператор/  
...
### <a name="return-value"></a>Возвращаемое значение  
 Объект valarray, каждый элемент которого представляет собой частное от деления ` left` на ` right.`  
...
### <a name="remarks"></a>Примечания  
 Первый оператор шаблона возвращает объект класса [valarray\<bool>](../standard-library/valarray-bool-class.md), каждый из элементов которого `I` представляет собой *Left*[ `I`] == \_ *Right*[ `I`]. Второй оператор шаблона сохраняет элемент `I`` left`[ `I`] == \_ *Right*. Третий оператор шаблона сохраняет элемент `I`` left` == ` right`[ `I`].  
...
##  <a name="a-nameoperatorxora--operator"></a><a name="operator_xor"></a>  оператор^  
...
### <a name="return-value"></a>Возвращаемое значение  
 Объект valarray, каждый элемент которого представляет собой объединение ` left` и ` right.` с помощью исключающего **ИЛИ**  
...
##  <a name="a-nameoperatorora--operator124"></a><a name="operator_or"></a>  оператор|  
...
### <a name="return-value"></a>Возвращаемое значение  
 Объект valarray, каждый элемент которого представляет собой объединение ` left` и ` right.` с помощью операции побитового `OR`  
  
### <a name="remarks"></a>Примечания  
 Побитовые операции могут использоваться только с типами данных `char` и `int` и их разновидностями и не могут использоваться с типами **float**, **double**, **longdouble**, `void`, `bool` или другими, более сложными типами данных.  
  
 Побитовое "ИЛИ" имеет ту же таблицу истинности, что и логическое `OR` , но применяется к типам данных на уровне отдельных битов. Если взять биты *b*1 и *b*2, то*b*1 `OR` *b*2 имеет значение **true**, если хотя бы один из битов имеет значение true, и имеет значение **false**, если оба бита имеют значение false. Оператор логическое `OR`[(operator||)](../standard-library/valarray-operators.md#operator_lor) применяется на уровне элемента, интерпретируя все ненулевые значения как **true**. Результатом является объект valarray из логических значений. Применение оператора побитового "ИЛИ" `operator|`, напротив, может привести к появлению в объекте valarray значений, отличных от 0 или 1, в зависимости от результата побитовой операции.  
...
##  <a name="a-nameoperatorlora--operator124124"></a><a name="operator_lor"></a>  оператор||  
...
### <a name="return-value"></a>Возвращаемое значение  
 Объект valarray, каждый элемент которого имеет тип `bool` и представляет собой объединение ` left` и ` right.` с помощью логического "ИЛИ"  
  
### <a name="remarks"></a>Примечания  
 Логическое `OR``operator||` применяется на уровне элемента, интерпретируя все ненулевые значения как **true**. Результатом является объект valarray из логических значений. Применение оператора побитового `OR`, [operator|](../standard-library/valarray-operators.md#operator_or), напротив, может привести к появлению в объекте valarray значений, отличных от 0 или 1, в зависимости от результата побитовой операции.  
