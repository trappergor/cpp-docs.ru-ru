...
|||  
|-|-|  
|[Перечисление errc](#errc_enumeration)|[Перечисление io_errc](#io_errc_enumeration)|  
  
##  <a name="a-nameerrcenumerationa--errc-enumeration"></a><a name="errc_enumeration"></a>  Перечисление errc  
...
##  <a name="a-nameioerrcenumerationa--ioerrc-enumeration"></a><a name="io_errc_enumeration"></a>  Перечисление io_errc  
 Предоставляет символьные имена для условий ошибок в \<iostream>. Можно использовать для создания объектов [error_condition](../standard-library/error-condition-class.md), сравниваемых со значением, которое возвращается функцией [ios_base::failure](../standard-library/ios-base-class.md#ios_base__failure)`code()`.  
