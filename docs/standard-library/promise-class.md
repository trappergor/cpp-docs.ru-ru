...
`Exc` [Exception_ptr](../standard-library/exception-typedefs.md#exception_ptr) , хранящегося с помощью данного метода в результате исключения.
