...
`_RealVal` Значение типа **long double** реальные части конструируемого комплексного числа.

`_ImagVal` Значение типа `long double` для мнимой части конструируемого комплексного числа.

`complexNum` Комплексное число типа **двойные** или типа **float** , вещественной и мнимой части которого используются для инициализации комплексное число типа `long double` конструируемого.
