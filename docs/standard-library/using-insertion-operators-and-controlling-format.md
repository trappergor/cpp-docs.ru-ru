...
##  <a name="a-namevclrfoutputwidthanchor3a-output-width"></a><a name="vclrfoutputwidthanchor3"></a> Ширина выходных данных  
...
##  <a name="a-namevclrfalignmentanchor4a-alignment"></a><a name="vclrfalignmentanchor4"></a> Выравнивание  
...
##  <a name="a-namevclrfprecisionanchor5a-precision"></a><a name="vclrfprecisionanchor5"></a> Точность  
...
##  <a name="a-namevclrfradixanchor6a-radix"></a><a name="vclrfradixanchor6"></a> Основание системы счисления  
...
```  
 ...
 Разделители присутствуют только в объекте потока. Их нет в извлеченной строке, но они есть в строке, возвращаемой функцией [basic_stringstream::str](../standard-library/basic-stringstream-class.md#basic_stringstream__str)().  
