...
`Extent`\
 Число элементов в диапазоне, если оно указано во время компиляции. В противном случае  `std::dynamic_extent` , если число элементов будет указано во время выполнения.
