...
`Loc` Язык, который необходимо проверить на наличие аспекта.
...
`Ch` Буквенно-цифровые элемент, который необходимо проверить.

`Loc` Языковой стандарт, содержащей буквенно-цифровые элемент для тестирования.
...
`Ch` Элемент, который требуется проверить.

`Loc` Языковой стандарт, содержащего буквенные элемент для тестирования.
...
`Loc` Языковой стандарт, содержащей элемент, на которое необходимо проверить.
...
`Loc` Языковой стандарт, содержащие символ для преобразования.
...
`Loc` Const языкового стандарта, содержащий тип аспекта приведена ссылка.
