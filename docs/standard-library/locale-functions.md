...
*Loc* языковой стандарт, проверяемый на наличие аспекта.
...
*CH* буквенно-цифровой элемент для проверки.

*Loc* языковой стандарт, содержащий буквенно-цифровой элемент для проверки.
...
*Loc* языковой стандарт, содержащий буквенный элемент проверяется.
...
*Loc* языковой стандарт, содержащий элемент для проверки.
...
*Loc* языковой стандарт, содержащий символ для преобразования.
...
*Loc* const языковой стандарт, содержащий тип аспекта, на которую ссылается.
