...
Другие специализации класса `ctype<CharType>`шаблона:

- Преобразование значения *CH* типа *CharType* в значение типа **char** с помощью выражения `(char)ch`.

- Преобразует значение *Byte* типа **char** в значение типа *CharType* с помощью выражения `CharType(byte)`.
...
|[do_narrow](#do_narrow)|Виртуальная функция, вызываемая для преобразования символа `CharType` типа, используемого локальным языком, в соответствующий символ типа **char** в собственной кодировке.|
...
Виртуальная функция, вызываемая для преобразования символа `CharType` типа, используемого локальным языком, в соответствующий символ типа **char** в собственной кодировке.
...
*параметры*\
Значение по умолчанию, присваиваемое функцией члена символам типа `CharType` , не имеющим символов аналогового типа **char**.
...
Защищенная функция-член возвращает наименьший `ptr` указатель в диапазоне [ `first`, `last`), для [](#do_is)которого do_is `maskVal`( \* , `ptr`) имеет значение true.
...
Защищенная функция-член возвращает наименьший `ptr` указатель в диапазоне [ `first`, `last`), для [](#do_is)которого do_is `maskVal`( \* , `ptr`) имеет значение false.
...
Вторая Защищенная функция-шаблон элемента заменяет каждый `first` элемент `I`[] для `I` в интервале [0, `last`  -  `first`) `do_tolower`на ( `first` [ `I`]).
...
Вторая Защищенная функция-шаблон элемента заменяет каждый `first` элемент `I`[] для `I` в интервале [0, `last`  -  `first`) `do_toupper`на ( `first` [ `I`]).
...
Вторая Защищенная функция-член возвращает указатель на целевой диапазон символов типа `CharType` , используемого языковым стандартом, преобразованный из собственных символов типа **char**.
...
Вторая функция-член возвращает указатель на целевой диапазон символов типа `CharType` , используемого языковым стандартом, преобразованный из собственных символов типа **char**.
