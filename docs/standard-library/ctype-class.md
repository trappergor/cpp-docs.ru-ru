...
Защищенная функция-член возвращает наименьший `ptr` указатель в диапазоне [ `first`, `last`), для которого [do_is](#do_is) (`maskVal`, \* `ptr`) имеет значение true.
...
Защищенная функция-член возвращает наименьший `ptr` указатель в диапазоне [ `first`, `last`), для которого [do_is](#do_is) (`maskVal`, \* `ptr`) имеет значение false.
