...
- `ctype<char>`, явная специализация, отличия которой описаны отдельно. Дополнительные сведения см. в разделе [ctype&lt;char&gt; класс](../standard-library/ctype-char-class.md).
...
- Преобразовать значение *байтов* типа **char** значение типа *CharType* с выражением `CharType(byte)`.
...
*default*<br/>
 Значение по умолчанию могут быть назначены функцией-членом символам типа `CharType` , не имеющих эквивалентных символов типа **char**.
