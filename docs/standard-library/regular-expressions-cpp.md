...
##  <a name="a-nameregexgrammara-regular-expression-grammar"></a><a name="regexgrammar"></a> Грамматика регулярных выражений  
...
-   "a+" соответствует целевой последовательности "a", целевой последовательности "aa" и т.д., но не целевой последовательности "".  
 ...
 В `ECMAScript` за числом повторений в любом формате может следовать символ ", указывающий *"нежадное" повторение*.  
...
##  <a name="a-namegrammarsummarya-grammar-summary"></a><a name="grammarsummary"></a> Сводка по грамматике  
...
##  <a name="a-namesemanticdetailsa-semantic-details"></a><a name="semanticdetails"></a> Семантические подробности  
...
##  <a name="a-namematchingandsearchinga-matching-and-searching"></a><a name="matchingandsearching"></a> Соответствие и поиск  
...
##  <a name="a-nameformatflagsa-format-flags"></a><a name="formatflags"></a> Флаги формата  
