...
- Объект *группа незахвата* формы "(?: *часть выражения* )». Соответствует последовательности символов в целевой последовательности, которой соответствует шаблон между разделителями.
...
- «{2,}"соответствует целевой последовательности «aa», целевой последовательности «aaa» и так далее, но не соответствует целевой последовательности «».
