...
Объявляет передние ссылки на несколько шаблонных классов, используемых во всех iostreams.  Все такие классы\-шаблоны определены в других стандартных заголовках.  Необходимо указать этот заголовок явно только при необходимости одного из своих объявлений, но не его определение.  
...
## Передние объявления\/классы\-шаблоны  
