...
*слева* комплексное число или объект типа его параметра, проверяемый на предмет их неравенства.

*правом* комплексное число или объект типа его параметра, проверяемый на предмет их неравенства.
...
*слева* первое из двух комплексных чисел или число, имеющее тип параметра для комплексного числа, которое будет умножено с * операции.

*правом* второй из двух комплексных чисел или число, имеющее тип параметра для комплексного числа, которое будет умножено с * операции.
...
*слева* первое из двух комплексных чисел или число, имеющее тип параметра для комплексного числа, которое нужно добавить по операции +.

*правом* второй из двух комплексных чисел или число, имеющее тип параметра для комплексного числа, которое нужно добавить по операции +.
...
Эта операция является перегруженной, так что простые арифметические операции могут выполняться без преобразования данных в определенный формат. Возвращает унарный оператор *левой*.
...
*слева* первое из двух комплексных чисел или число, имеющее тип параметра для комплексного числа, для выполнения вычитания с помощью операции –.

*правом* второй из двух комплексных чисел или число, имеющее тип параметра для комплексного числа, для выполнения вычитания с помощью операции –.

### <a name="return-value"></a>Возвращаемое значение

Комплексное число, полученный в результате вычитания *правой* из *левой*, два числа, значения которых задаются входными данными параметров.
...
*слева* комплексное число или число, имеющее тип параметра для комплексного числа, которое является делимым для быть деления на делитель с / операции.

*правом* комплексное число или число, имеющее тип параметра для комплексного числа, которое является делителем для деления делимого с помощью / операции.
...
*Ostr* в выходной поток, в которое вводится комплексного числа.

*правом* комплексное число для ввода в выходной поток
...
*правом* комплексное число, которое извлекается из входного потока.

### <a name="return-value"></a>Возвращаемое значение

Считывает значение указанного комплексного числа из *Istr* и возвращает его в *правой*.
