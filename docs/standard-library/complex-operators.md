...
`right` Комплексное число или число, которое имеет тип параметра для комплексного числа, знаменатель, который будет использоваться для разделения числитель с или операции.
