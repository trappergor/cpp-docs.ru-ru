...
*Left*<br/>
Левый операнд в операции взятия остатка. Неспециализированный шаблон принимает ссылочный аргумент lvalue типа *type*. Специализированный шаблон выполняет точную передачу lvalue и rvalue ссылочных аргументов выводимого типа *T*.

*Right*<br/>
Правый операнд в операции взятия остатка. Неспециализированный шаблон принимает ссылочный аргумент lvalue типа *type*. Специализированный шаблон выполняет точную передачу lvalue и rvalue ссылочных аргументов выводимого типа *U*.
