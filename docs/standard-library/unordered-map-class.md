...
|[begin](#cbegin)|Задает начало управляемой последовательности.|
...
минимальное число контейнеров — это аргумент *Bucket_count*, если он есть; в противном случае это значение по умолчанию, описываемое здесь как значение, определенное реализацией `N0`.
