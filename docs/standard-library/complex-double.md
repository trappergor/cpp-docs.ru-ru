...
`RealVal` Значение типа **двойные** реальные части конструируемого комплексного числа.

`ImagVal` Значение типа **двойные** для мнимой части конструируемого комплексного числа.

`complexNum` Комплексное число типа **float** или типа `long double` , вещественной и мнимой части которого используются для инициализации комплексное число типа **двойные** конструируемого.
