---
title: '&lt;climits&gt; | Документы Майкрософт'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
...
ms.locfileid: "33841106"
---
# <a name="ltclimitsgt"></a>&lt;climits&gt;

Включает заголовок \<limits.h> стандартной библиотеки C и добавляет связанные имена в пространство имен `std`.
