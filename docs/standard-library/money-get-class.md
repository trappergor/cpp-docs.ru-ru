...
*Первый* входной итератор, адресующий начало последовательности для преобразования.

*последний* входной итератор, адресующий конец преобразуемой последовательности.

*Intl* логическое значение, указывающее тип символа валюты, ожидаемого в последовательности: **true** международного, **false** внутреннего.

*Iosbase* флаг формата, который, будучи установленным, указывает, что символ валюты не обязателен; в противном случае он необходим.

*Состояние* устанавливает нужные элементы битовой маски для состояния потока согласно успешно ли операции или нет.

*Val* строка, хранящая преобразованную последовательность.
...
*Iosbase* флаг формата, который, будучи установленным, указывает, что символ валюты не обязателен; в противном случае он является обязательным

*Состояние* устанавливает нужные элементы битовой маски для состояния потока в соответствии с того, успешно ли операции.
