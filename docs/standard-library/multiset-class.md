...
*Ключ* тип данных элемента для сохранения в мультинаборе.

*Сравнение* тип, предоставляющий объект функции, который может сравнить два значения элементов как ключи сортировки для определения их относительного порядка в мультинаборе. Значение по умолчанию — бинарный предикат **less**\<Key>.
...
*Распределитель* тип, представляющий сохраненный объект распределителя, инкапсулирующий сведения о выделении и освобождении памяти мультинабора. Значение по умолчанию — **распределителя***\<ключа >.*
...
*ключ* ключ элементов для сопоставления из multiset.
...
*ключ* ключ-аргумент для сравнения с ключом сортировки элемента из мультинабора в котором выполняется поиск.
...
*ключ* значение ключа для сравнения с ключом сортировки элемента из мультинабора в котором выполняется поиск.
...
*правом* аргумент мультинабор, предоставляющий элементы для обмена местами с элементами целевого мультинабора.
...
[\<Задайте > члены](http://msdn.microsoft.com/0c2d57c0-173f-4204-b579-c5f06aad8b95)<br/>
