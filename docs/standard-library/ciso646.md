---
title: '&lt;ciso646&gt; | Документы Майкрософт'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
...
ms.locfileid: "33840844"
---
# <a name="ltciso646gt"></a>&lt;ciso646&gt;

Включает заголовок \<iso646.h> стандартной библиотеки C и добавляет связанные имена в пространство имен `std`.
