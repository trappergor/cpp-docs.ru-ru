---
title: '&lt;языковой стандарт&gt; | Документы Microsoft'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
...
|[codecvt_base](../standard-library/codecvt-base-class.md)|Базовый класс для класса codecvt, используемый для определения типа перечисления с именем **result**, который применяется в качестве типа возвращаемого значения для функций-членов аспекта, чтобы показать результат преобразования.|
...
|[moneypunct](../standard-library/moneypunct-class.md)|Класс шаблона, описывающий объект, который можно использовать в качестве аспекта языкового стандарта для описания последовательностей типа **CharType** используется для представления полей для ввода или вывода денежных значений.|
