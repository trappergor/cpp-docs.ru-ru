---
title: '&lt;cerrno&gt; | Документы Майкрософт'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
...
ms.locfileid: "33842036"
---
# <a name="ltcerrnogt"></a>&lt;cerrno&gt;

Включает заголовок \<errno.h> стандартной библиотеки C и добавляет связанные имена в пространство имен `std`.
