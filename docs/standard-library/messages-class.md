...
*_Catval* значение идентификации, указывающее каталог сообщений для поиска.

*_Выбрать* первый идентификатор используется для поиска сообщения в каталоге сообщений.

*_Message* второй идентификатор используется для поиска сообщения в каталоге сообщений.

*_Dfault* строка возвращается в случае сбоя.
...
*_Catname* имя каталога для поиска.

*_Loc* языкового стандарта, который ищется в каталоге.
