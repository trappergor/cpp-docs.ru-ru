...
В противном случае выполняется несколько назначений элементов и вызовов конструктора, пропорциональное количеству элементов в двух управляемых последовательностях.
