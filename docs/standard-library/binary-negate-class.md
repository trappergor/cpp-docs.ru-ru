...
`Func` Двоичный функция, должен быть инвертирован.

`left` Левый операнд бинарной функции к должен быть инвертирован.

`right` Правый операнд бинарной функции к должен быть инвертирован.
