...
### <a name="remarks"></a>Примечания  
 ...
 Для последовательности значений **1, **2, **3, в диапазоне ввода вторая функция-шаблон хранит последовательных частичных сумм в диапазоне назначения, где элемент i-ой предоставленные ((( **1 `binary_op` **2) `binary_op` **(3) **я).  
