...
## <a name="discrete_distributiondiscrete_distribution"></a><a name="discrete_distribution"></a>discrete_distribution::discrete-распределение
...
Конструктор списка инициализаторов, который имеет параметр *весового списка,* строит объект распределения с весами из списка инициализаторов. *weightlist*
...
- Если *число* > 0, **n** = *число*. При условии, **d** q *(высокий* - *низкий*) / **n** больше, чем ноль, используя **d** однородные субранги, каждый вес присваивается следующим образом: `weight[k] = weightfunc(x)`, где x **низкий** = *low* + **к** * **д** + **д** / 2, для **k** q 0, ..., **n** - 1.
...
## <a name="discrete_distributionparam_type"></a><a name="param_type"></a>discrete_distribution::pараматип
