...
|[IsReference](#reference)|Тип, предоставляющий ссылку на тип объекта, управляемого распределителем.|
...
Шаблон класса Member определяет тип other. Его единственная цель — предоставить распределитель имени типа с **allocator** \<_ **Other**> учетом имени типа **распределителя** \< **Type**> .
