...
`first1` Указатель на первый элемент в первую последовательность для сравнения.

`last1` Указатель на последний элемент в первую последовательность для сравнения.
...
`first` Указатель на первый символ в последовательности, в которой имеет значение — определить.

`last` Указатель на последний символ в последовательности, в которой имеет значение — определить.
...
`first` Указатель на первый символ в последовательности для преобразования.

`last` Указатель на последний символ в последовательности для преобразования.
