...
##  <a name="nth_element"></a>  nth_element  
 Разделяет диапазон элементов, правильно находя  *n* -ый элемент последовательности в диапазоне, чтобы все элементы перед ним были меньше или равны ему, а также все элементы, следующие за ней в последовательности RE больше или равны ему.  
