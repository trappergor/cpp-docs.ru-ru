...
*Alloc* тип распределителя, используемую для управления хранилищем.
...
*OutIt* тип итератора вывода.

*out* в выходной поток для записи.
...
*Sub* индекс подстроки соответствия.
...
*Alloc* объект распределителя для сохранения.

*правом* объект match_results для копирования.
...
*n* индекс подстроки соответствия.
...
*правом* объект match_results для замены.
