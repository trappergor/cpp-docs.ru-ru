...
*правый* объекта или диапазона для вставки.
...
`off` Позиция доступа к элементу.
...
правый контейнер для копирования.
...
`right` Массив для обмена содержимым.
