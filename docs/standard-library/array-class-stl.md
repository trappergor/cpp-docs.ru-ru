...
|-|-|
|[Массива](#array)|Создает объект массива.|
|[Назначить](#assign)|(Устаревший. Использование `fill`.) Заменяет все элементы.|
|[В](#at)|Обращается к элементу в указанной позиции.|
...
|[данные](#data)|Получает адрес первого элемента.|
|[Пустой](#empty)|Проверяет наличие элементов.|
|[end](#end)|Задает конец управляемой последовательности.|
|[Заполнить](#fill)|Заменяет все элементы указанным значением.|
|[Перед](#front)|Обращается к первому элементу.|
...
|Оператор|Описание|
|-|-|
|[массив:оператор](#op_eq)|Заменяет управляемую последовательность.|
|[массив:оператор\[\]](#op_at)|Обращается к элементу в указанной позиции.|
...
Конструктор копии `array(const array& right)` инициализирует контролируемую последовательность с последовательностью ,*право*`.begin()`, *право*`.end()`). Он используется для указания начальной управляемой последовательности, которая является копией последовательности, управляемой объектом массива *right*.
...
## <a name="arrayassign"></a><a name="assign"></a>массив:назначить
...
Функции участника возвращают ссылку на элемент контролируемой последовательности в *положении выключенного.* Если эта позиция недопустима, функция выдает объект класса `out_of_range`.
...
## <a name="arraybegin"></a><a name="begin"></a>массив:начало
...
## <a name="arraydata"></a><a name="data"></a>массив::dата
...
## <a name="arraydifference_type"></a><a name="difference_type"></a>массив::difference
...
## <a name="arrayempty"></a><a name="empty"></a>массив:пустой
...
## <a name="arrayend"></a><a name="end"></a>массив:конец
...
## <a name="arrayfill"></a><a name="fill"></a>массив:заполнение
...
|Параметр|Описание|
|-|-|
|*Валь*|Значение элемента, вставляемого в массив.|
...
## <a name="arrayfront"></a><a name="front"></a>массив:фронт
...
## <a name="arrayiterator"></a><a name="iterator"></a>массив:iterator
...
## <a name="arrayoperator"></a><a name="op_at"></a>массив:оператор
...
Функции участника возвращают ссылку на элемент контролируемой последовательности в *положении выключенного.* Если эта позиция недопустима, поведение станет неопределенным.

Существует также не член [получить](array-functions.md#get) функцию, доступную, чтобы получить ссылку на элемент **массива**.
...
## <a name="arrayoperator"></a><a name="op_eq"></a>массив:оператор
...
Оператор-член присваивает каждому элементу *права* соответствующий `*this`элемент контролируемой последовательности, а затем возвращается. Вы используете его, чтобы заменить контролируемую последовательность с копией контролируемой последовательности в *правой*.
...
## <a name="arraypointer"></a><a name="pointer"></a>массив::pоинтер
...
## <a name="arrayreference"></a><a name="reference"></a>массив:ссылка
...
## <a name="arraysize"></a><a name="size"></a>массив:размер
...
Функция члена меняет контролируемые последовательности между `*this` и *правыми.* Он выполняет присваивания элементов и вызовы конструктора у количестве, пропорционально пропорциональном `N`.

Существует также функция [своп,](array-functions.md#swap) не являющегося членом, для замены двух экземпляров **массива.**
