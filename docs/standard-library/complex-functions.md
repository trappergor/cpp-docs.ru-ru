...
`complexNum` Комплексное число, модуль будет определяться.
...
`complexNum` Комплексное число, аргумент которого определяется.
...
`complexNum` Комплексное число, комплексно-сопряженное которого возвращается.
...
`complexNum` Комплексное число, действительная часть которого извлекается.
...
`complexNum` Определяется которого натуральный логарифм комплексного числа.
...
`complexNum` Комплексное число нормы которого определяется.
...
*_Modulus* модуль вводом комплексного числа.

*_Argument* аргумент вводом комплексного числа.
...
`_Base` Комплексное число или число, которое имеет тип параметра для комплексного числа, который является базовым для возведения в степень функцией-членом.

*_Power* целое число со знаком или комплексное число или число, которое комплексное число, которое степень для возведения функцией-членом, базовый тип параметра.
