...
*complexNum* комплексное число, модуль которого требуется определить.
...
*complexNum* комплексное число, аргумент которого нужно определить.
...
*Аргумент* — это угол, который образует вектор комплексного числа с положительной осью на комплексной плоскости. Для комплексного числа *a + bi*, аргумент равен arctan (*b / a*). Угол имеет положительное направление при измерении против часовой стрелки от положительной оси и отрицательное направление при измерении по часовой стрелке. Главные значения больше - pi и меньше чем или равны + пи.
...
*complexNum* комплексное число, возвращается сопряженная.
...
Сопряженную величину комплексного числа *a + bi* — *bi*. Произведение комплексного числа и его сопряженной величины является нормой числа *a*2 + *b*2.
...
*complexNum* комплексное число, косинус которого требуется определить.
...
*complexNum* комплексное число, гиперболический косинус которого требуется определить.
...
*complexNum* комплексное число, экспоненциального требуется определить.
...
*complexNum* комплексное число, Вещественная часть должно быть извлечено.
...
*complexNum* комплексное число, натуральный логарифм которого требуется определить.
...
*complexNum* комплексное число, десятичный логарифм которого требуется определить.
...
*complexNum* комплексное число, норму которого нужно определить.
...
*_Modulus* модуль вводимого комплексного числа.

*_Argument* аргумент вводимого комплексного числа.
...
Тригонометрическая форма комплексного числа предоставляет модуль *r* и аргумент *p*, где эти параметры связаны с вещественной и мнимой декартовых компонентов *a* и *b* по уравнениях *a* = r \* cos *p* и *b* = *r* \* sin *p*.
...
*_Базовому* комплексное число или число, имеющее тип параметра для комплексного числа, который является базовым для возведения в степень функцией-членом.

*_Power* целое число или комплексное число или число, имеющее тип параметра для комплексного числа, представляющее степень, базовый возводимое функцией-членом.
...
*complexNum* комплексное число, синус которого требуется определить.
...
*complexNum* комплексное число, гиперболический синус которого требуется определить.
...
*complexNum* комплексное число, квадратный корень которого требуется найти.
...
*complexNum* комплексное число, тангенс которого требуется определить.
...
*complexNum* комплексное число, гиперболический тангенс которого требуется определить.
