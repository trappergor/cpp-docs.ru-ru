...
|[итераци](#iterator)|Тип, предоставляющий итератор для прямого списка.|
...
|[открытым](#clear)|Удаляет все элементы прямого списка.|
...
|[конце](#end)|Возвращает итератор, адресующий расположение после последнего элемента в прямом списке.|
