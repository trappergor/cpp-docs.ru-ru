...
*Где* позиция в целевой объект forward_list, после которого следует вставить.

*Источник* исходного объекта forward_list, который должен быть вставлен в целевой forward_list.

*Iter* элемент, который будет вставлен из исходного объекта forward_list.

*Первый* первого элемента в диапазоне, который будет вставлен из исходного объекта forward_list.

*Последний* первое положение после диапазона, который будет вставлен из исходного объекта forward_list.
