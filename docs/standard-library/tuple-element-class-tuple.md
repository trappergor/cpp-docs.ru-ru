...
*Индекс* индекс указанного элемента.

*Кортеж* тип кортежа.

*Elem* тип элемента массива.

*Размер* размер массива.

*T1* Тип первого элемента в паре.

*T2* тип второго элемента в паре.
...
**Заголовок:** \<кортежа > **заголовка:** \<массива > (для специализации массива) **заголовка:** \<программа > (для специализации пары)  **Пространство имен:** std
