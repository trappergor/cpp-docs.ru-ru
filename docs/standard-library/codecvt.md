...
ms.locfileid: "68458591"
---
# <a name="ltcodecvtgt"></a>&lt;codecvt&gt;

Определяет несколько классов шаблонов, которые описывают объекты на основе класса шаблона [codecvt](../standard-library/codecvt-class.md). Эти объекты могут служить [аспектами языкового стандарта](../standard-library/locale-class.md#facet_class) , которые управляют преобразованиями между последовательностями `Elem` значений типа и последовательностью значений типа **char**.
...
Для потоковых потоков (хранящихся в файле, передается в виде последовательности байтов или хранится в программе в массиве **символов**):
