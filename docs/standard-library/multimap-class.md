...
|||  
|-|-|  
|[multimap](#multimap__multimap)|Создает контейнер `multimap`, который является пустым или копией части или целого другого контейнера `multimap`.|  
  
### <a name="typedefs"></a>Typedefs  
  
|||  
|-|-|  
|[allocator_type](#multimap__allocator_type)|Тип, представляющий класс `allocator` для объекта `multimap`.|  
|[const_iterator](#multimap__const_iterator)|Тип, предоставляющий двунаправленный итератор, который может считывать тот или иной элемент `const` в контейнере `multimap`.|  
|[const_pointer](#multimap__const_pointer)|Тип, предоставляющий указатель на элемент `const` в контейнере `multimap`.|  
|[const_reference](#multimap__const_reference)|Тип, предоставляющий ссылку на элемент `const`, сохраненный в контейнере `multimap` для чтения и выполнения операций `const`.|  
|[const_reverse_iterator](#multimap__const_reverse_iterator)|Тип, предоставляющий двунаправленный итератор, который может считывать любой элемент `const` в контейнере `multimap`.|  
|[difference_type](#multimap__difference_type)|Тип целого числа со знаком, пригодный для представления количества элементов в контейнере `multimap` в диапазоне между элементами, на которые указывают итераторы.|  
|[iterator](#multimap__iterator)|Тип, который предоставляет различие между&2; итераторами, относящимися к элементам в одном контейнере `multimap`.|  
|[key_compare](#multimap__key_compare)|Тип, предоставляющий объект функции, который может сравнить два ключа сортировки для определения относительного порядка двух элементов в контейнере `multimap`.|  
|[key_type](#multimap__key_type)|Тип, описывающий объект ключа сортировки, составляющий каждый элемент контейнера `multimap`.|  
|[mapped_type](#multimap__mapped_type)|Тип, который представляет тип данных, хранящийся в контейнере `multimap`.|  
|[pointer](#multimap__pointer)|Тип, предоставляющий указатель на элемент `const` в контейнере `multimap`.|  
|[reference](#multimap__reference)|Тип, предоставляющий ссылку на элемент, хранящийся в контейнере `multimap`.|  
|[reverse_iterator](#multimap__reverse_iterator)|Тип, предоставляющий двунаправленный итератор, который может считывать или изменять элемент в обращенном контейнере `multimap`.|  
|[size_type](#multimap__size_type)|Тип целого числа без знака, предоставляющий указатель на элемент `const` в контейнере `multimap`.|  
|[value_type](#multimap__value_type)|Тип, предоставляющий объект функции, который может сравнить два элемента в качестве ключей сортировки для определения их относительного порядка в контейнере `multimap`.|  
  
### <a name="member-functions"></a>Функции-члены  
  
|||  
|-|-|  
|[begin](#multimap__begin)|Возвращает итератор, обращающийся к первый элемент в контейнере `multimap`.|  
|[begin](#multimap__cbegin)|Возвращает итератор const, обращающийся к первому элементу в `multimap`.|  
|[cend](#multimap__cend)|Возвращает итератор const, который обращается к месту, следующему за последним элементом в `multimap`.|  
|[clear](#multimap__clear)|Стирает все элементы в `multimap`.|  
|[count](#multimap__count)|Возвращает число элементов в контейнере `multimap`, ключи которых соответствуют ключу, заданному параметром.|  
|[crbegin](#multimap__crbegin)|Возвращает итератор const, который обращается к первому элементу в обращенном контейнере `multimap`.|  
|[crend](#multimap__crend)|Возвращает итератор const, который обращается к месту, следующему за последним элементом в обращенном контейнере `multimap`.|  
|[emplace](#multimap__emplace)|Вставляет созданный на месте элемент в `multimap`.|  
|[emplace_hint](#multimap__emplace_hint)|Вставляет созданный на месте элемент в `multimap` с подсказкой о размещении|  
|[empty](#multimap__empty)|Проверяет, пуст ли `multimap`.|  
|[end](#multimap__end)|Возвращает итератор, который обращается к месту, следующему за последним элементом в контейнере `multimap`.|  
|[equal_range](#multimap__equal_range)|Находит диапазон элементов, где ключ элемента соответствует заданному значению.|  
|[erase](#multimap__erase)|Удаляет элемент или диапазон элементов в `multimap` с заданных позиций или удаляет элементы, соответствующие заданному ключу.|  
|[find](#multimap__find)|Возвращает итератор, который обращается к первому местоположению элемента в контейнере `multimap` с ключом, эквивалентным указанному ключу.|  
|[get_allocator](#multimap__get_allocator)|Возвращает копию объекта `allocator`, который используется для создания контейнера `multimap`.|  
|[insert](#multimap__insert)|Вставляет элемент или диапазон элементов в `multimap`.|  
|[key_comp](#multimap__key_comp)|Извлекает копию объекта сравнения, который используется для упорядочивания ключей в контейнере `multimap`.|  
|[lower_bound](#multimap__lower_bound)|Возвращает итератор, указывающий на первый элемент в контейнере `multimap` с ключом, который больше или равен указанному ключу.|  
|[max_size](#multimap__max_size)|Возвращает максимальную длину `multimap`.|  
|[rbegin](#multimap__rbegin)|Возвращает итератор, который обращается к первому элементу в обращенном контейнере `multimap`.|  
|[rend](#multimap__rend)|Возвращает итератор, который обращается к месту, следующему за последним элементом в обращенном контейнере `multimap`.|  
|[size](#multimap__size)|Возвращает количество элементов в контейнере `multimap`.|  
|[swap](#multimap__swap)|Выполняет обмен элементами между двумя объектами `multimap`.|  
|[upper_bound](#multimap__upper_bound)|Возвращает итератор, указывающий на первый элемент в контейнере `multimap` с ключом, который больше указанного ключа.|  
|[value_comp](#multimap__value_comp)|Функция-член возвращает объект функции, который определяет порядок элементов в `multimap` путем сравнения значения ключа.|  
  
### <a name="operators"></a>Операторы  
  
|||  
|-|-|  
|[operator=](#multimap__operator_eq)|Заменяет элементы `multimap` копией другого `multimap`.|  
...
### <a name="example"></a>Пример  
  См. пример для [get_allocator](#multimap__get_allocator) в качестве примера и использования `allocator_type`.  
...
### <a name="remarks"></a>Примечания  
 ...
 `const_iterator`, определенный мультиотображением, указывает на объекты [value_type](#multimap__value_type) типа `pair`*\<***const Key**, **Type***>*. Значение ключа доступно через первый член пары, а значение сопоставленного элемента доступно через второй член пары.  
  
 Для разыменования `const_iterator``cIter`, указывающего на элемент в мультиотображении, используйте оператор **->**.  
...
### <a name="example"></a>Пример  
  См. пример для [begin](#multimap__begin) в качестве примера использования `const_iterator`.  
...
### <a name="remarks"></a>Примечания  
 ...
 В большинстве случаев для доступа к элементам в объекте-мультиотображении следует использовать [iterator](#multimap__iterator).  
...
### <a name="remarks"></a>Примечания  
 ...
 `const_reverse_iterator`, определенный мультиотображением, указывает на объекты [value_type](#multimap__value_type) типа `pair`*\<***const Key**, **Type***>*. Значение ключа доступно через первый член пары, а значение сопоставленного элемента доступно через второй член пары.  
  
 Для разыменования `const_reverse_iterator``crIter`, указывающего на элемент в мультиотображении, используйте оператор **->**.  
...
### <a name="example"></a>Пример  
  См. пример для [rend](#multimap__rend) в качестве примера объявления и использования `const_reverse_iterator`.  
...
### <a name="remarks"></a>Примечания  
 `crbegin` используется с обратным `multimap` так же, как [begin](#multimap__begin) используется с обычным `multimap`.  
...
### <a name="remarks"></a>Примечания  
 `crend` используется с обратным `multimap` так же, как [multimap::end](#multimap__end) используется с обычным `multimap`.  
...
### <a name="remarks"></a>Примечания  
 ...
 [value_type](../standard-library/map-class.md#map__value_type) элемента — это pair, поэтому значением элемента будет упорядоченная пара, первый компонент которой равен значению ключа, а второй — значению данных элемента.  
 ...
 **end** используется для проверки, прошел ли итератор конец своего мультиотображения.  
 ...
 Пример кода см. в разделе [multimap::find](#multimap__find).  
...
### <a name="return-value"></a>Возвращаемое значение  
 Пара итераторов, первый из которых является [lower_bound](#multimap__lower_bound) ключа, а второй — [upper_bound](#multimap__upper_bound) ключа.  
...
|`Where`|Место начала поиска правильной точки вставки. (Если эта точка находится непосредственно перед `Where`, вставка может быть выполнена в постоянном времени с поправкой на амортизацию, а не в логарифмическом времени.)|  
|`ValTy`|Параметр-шаблон, определяющий тип аргумента, с помощью которого сопоставление формирует элемент типа [value_type`Val` и точно пересылает ](../standard-library/map-class.md#map__value_type) в качестве аргумента.|  
...
### <a name="remarks"></a>Примечания  
 ...
 Для вставки элемента, созданного на месте (то есть без операций копирования или перемещения), см. разделы [multimap::emplace](#multimap__emplace) и [multimap::emplace_hint](#multimap__emplace_hint).  
...
### <a name="remarks"></a>Примечания  
 **Итератор**, определенный мультиотображением, указывает на объекты [value_type](#multimap__value_type) типа `pair`*\<***const Key**, **Type***>*. Значение ключа доступно через первый член пары, а значение сопоставленного элемента доступно через второй член пары.  
...
### <a name="example"></a>Пример  
  См. пример для [begin](#multimap__begin) в качестве примера объявления и использования **iterator**.  
...
### <a name="example"></a>Пример  
  См. пример для [key_comp](#multimap__key_comp) в качестве примера объявления и использования `key_compare`.  
...
### <a name="example"></a>Пример  
  См. пример для [value_type](#multimap__value_type) в качестве примера объявления и использования `key_type`.  
...
### <a name="remarks"></a>Примечания  
 Все конструкторы сохраняют тип объекта-распределителя, управляющего памятью для мультиотображения. Затем его можно получить путем вызова [get_allocator](#multimap__get_allocator). Параметр-распределитель часто не указывается в объявлениях класса и в макросах предварительной обработки, используемых для замены альтернативных распределителей.  
  
 Все конструкторы инициализируют свои мультиотображения.  
  
 Все конструкторы сохраняют объект-функцию типа `Traits`, используемую для установления порядка ключей мультиотображения. Затем эту функцию можно получить путем вызова [key_comp](#multimap__key_comp).  
...
### <a name="remarks"></a>Примечания  
 `rbegin` используется с обратным мультиотображением так же, как [begin](#multimap__begin) используется с прямым мультиотображением.  
...
### <a name="remarks"></a>Примечания  
 `rend` используется с обратным мультиотображением так же, как [end](../standard-library/map-class.md#map__end) используется с обычным мультиотображением.  
...
### <a name="remarks"></a>Примечания  
 ...
 `reverse_iterator`, определенный мультиотображением, указывает на объекты [value_type](#multimap__value_type) типа `pair`*\<***const Key**, **Type***>*. Значение ключа доступно через первый член пары, а значение сопоставленного элемента доступно через второй член пары.  
  
 Для разыменования `reverse_iterator``rIter`, указывающего на элемент мультиотображения, используйте оператор ->.  
...
### <a name="example"></a>Пример  
  См. пример для [rbegin](#multimap__rbegin) в качестве примера объявления и использования `reverse_iterator`.  
...
### <a name="example"></a>Пример  
  См. пример для [size](#multimap__size) в качестве примера объявления и использования `size_type`  
