...
*_Num* число элементов, которые будут назначаться значения.
...
*_Num* число элементов в строках для сравнения.
...
*_В* элемент в начале строки или массива символов, предназначенный для получения скопированной последовательности символов.

*_На основе* элемент в начале исходной строки или массива символов для копирования.
...
*dest* строку или массив символов, предназначенный для получения скопированной последовательности символов.

*dest_size* размер *dest*. Если `char_type` — **char**, то это размер в байтах. Если `char_type` — **wchar_t**, то это размер в словах.

*_На основе* источника строку или массив символов для копирования.

*число* число копируемых элементов.
...
*_Ch1* первый из двух символов, для проверки на равенство.

*_Ch2* второй из двух символов для проверки на равенство.
...
*_Ch1* первым из двух символов для проверки на равенство как `int_type`s.

*_Ch2* второй из двух символов для проверки на равенство как `int_type`s.
...
*STR* первого символа в строке поиска.

*_Num* количество позиций, отсчитываемых от первой, в диапазоне для поиска.
...
*_Ch1* первый из двух символов для проверки меньше.

*_Ch2* второй из двух символов для проверки меньше.
...
*_Num* число элементов для копирования из исходной строки.
...
*dest* элемент в начале строки или массива символов, предназначенный для получения скопированной последовательности символов.

*dest_size* размер *dest*. Если `char_type` — **char**, то это размер в байтах. Если `char_type` — **wchar_t**, то это размер в словах.

*_На основе* элемент в начале исходной строки или массива символов для копирования.

*число* число элементов для копирования из исходной строки.
...
*_Ch* символ, представленный как `int_type` проверяется, является ли он символом конца файла или нет.
