---
title: Класс insert_iterator | Документы Майкрософт
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
...
`_Cont` Контейнер, в который `insert_iterator` — для вставки элементов.
