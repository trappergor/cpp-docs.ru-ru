...
`left` Входного valarray, элементы которого должны быть выполнена функция-член.
...
`left` Константа числовые данные типа или ввода valarray, элементы которого укажите значения для координаты y арктангенс аргумента.

`right` Константа числовые данные типа или ввода valarray, элементы предоставляют значения для координаты x арктангенс аргумента.
...
`left` Входного valarray, элементы которого укажите основание системы счисления для каждого элемента в exponentiated.

`right` Входного valarray, элементы которого питания для каждого элемента быть exponentiated.
