...
|[do_encoding](#do_encoding)|Виртуальная функция, которая проверяет, зависит ли кодировка `Byte`ного потока от состояния, независимо от того, какое отношение между используемыми значениями `Byte` и `CharType`ными значениями является константой, и, если это так, определяет значение этого отношения.|
...
|[do_length](#do_length)|Виртуальная функция, определяющая, сколько `Byte` значений из заданной последовательности внешних `Byte` значений не превышает заданное количество внутренних `CharType` значений и возвращает это число `Byte` значений.|
...
|[encoding](#encoding)|Проверяет, зависит ли кодировка `Byte`ного потока от состояния, независимо от того, какое отношение между используемыми значениями `Byte` и `CharType`ными значениями является константой, и, если это так, определяет значение этого отношения.|
...
|[length](#length)|Определяет, сколько `Byte` значений из заданной последовательности внешних `Byte` значений не превышает заданное количество внутренних `CharType` значений и возвращает это число `Byte` значений.|
|[max_length](#max_length)|Возвращает максимальное количество внешних `Byte` значений, необходимых для создания одной внутренней `CharType`.|
...
Логическое значение, равное **true** , если не требуется выполнять преобразования. **значение false** , если необходимо выполнить хотя бы одну операцию.
...
Конструктор инициализирует свой `locale::facet` базового объекта с помощью [языка:: facet](../standard-library/locale-class.md#facet_class)`(refs)`.
...
Виртуальная функция, которая проверяет, зависит ли кодировка `Byte`ного потока от состояния, независимо от того, какое отношение между используемыми значениями `Byte` и `CharType`ными значениями является константой и, если это так, определяет значение этого соотношения.
...
Виртуальная функция, определяющая, сколько `Byte` значений из заданной последовательности внешних `Byte` значений не превышает заданное количество внутренних `CharType` значений и возвращает это число `Byte` значений.
...
*len2*\
Максимальное число `Byte` значений, которые могут быть возвращены функцией члена.
...
Защищенная виртуальная функция-член фактически вызывает `do_in( state, first1, last1, next1, buf, buf + len2, next2)` для *состояния* (копия состояния), некоторые `buf`буфера и указатели `next1` и `next2`.
...
Виртуальная функция, возвращающая максимальное количество внешних `Byte` значений, необходимых для создания одной внутренней `CharType`.
...
Максимальное количество `Byte` значений, необходимых для создания одного `CharType`.

### <a name="remarks"></a>Заметки

Защищенная виртуальная функция Member возвращает максимальное допустимое значение, которое может возвращаться [do_length](#do_length)`( first1, last1, 1)` для произвольных допустимых значений *first1* и *last1*.
...
Проверяет, зависит ли кодировка `Byte`ного потока от состояния, независимо от того, какое отношение между используемыми значениями `Byte` и `CharType`ными значениями является константой, и, если это так, определяет значение этого отношения.
...
Определяет, сколько `Byte` значений из заданной последовательности внешних `Byte` значений не превышает заданное количество внутренних `CharType` значений и возвращает это число `Byte` значений.
...
Возвращает максимальное количество внешних `Byte` значений, необходимых для создания одной внутренней `CharType`.
