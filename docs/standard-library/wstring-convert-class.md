...
|*Освобождаемой*|Строка [byte_string](#byte_string) для преобразования.|
|*началь*|Первый символ в диапазоне символов для преобразования.|
|*Последняя*|Последний символ в диапазоне символов для преобразования.|
...
|*вптр*|Последовательность в стиле C, оканчивающаяся нулем, начинающаяся с `wptr`, для преобразования.|
