...
> [!NOTE]
> Библиотека \<алгоритм > также использует инструкцию `#include <initializer_list>`.
...
- Суффикс `_if` указывает, что алгоритм используется с объектами-функциями, работающими со значениями элементов, а не с самими элементами. Алгоритм `find_if` выполняет поиск элементов, значения которых удовлетворяют критерию, заданному объектом функции, а алгоритм `find` ищет определенное значение.
...
|[all_of](../standard-library/algorithm-functions.md#all_of)|Возвращает **значение true** при наличии условия для каждого элемента в заданном диапазоне.|
|[any_of](../standard-library/algorithm-functions.md#any_of)|Возвращает **значение true** , если условие представлено хотя бы один раз в указанном диапазоне элементов.|
...
|[фиксаци](../standard-library/algorithm-functions.md#clamp)||
...
|[copy_if](../standard-library/algorithm-functions.md#copy_if)|Копировать все элементы в заданном диапазоне, которые проверяют **истинность** для указанного условия|
...
|[is_partitioned](../standard-library/algorithm-functions.md#is_partitioned)|Возвращает **значение true** , если все элементы в заданном диапазоне, которые проверяют **истинность** условия, предшествуют элементам, которые проверяют **значение false**.|
...
|[is_sorted](../standard-library/algorithm-functions.md#is_sorted)|Возвращает **значение true** , если элементы в указанном диапазоне находятся в отсортированном порядке.|
|[is_sorted_until](../standard-library/algorithm-functions.md#is_sorted_until)|Возвращает **значение true** , если элементы в указанном диапазоне находятся в отсортированном порядке.|
...
|[none_of](../standard-library/algorithm-functions.md#none_of)|Возвращает **значение true** , если условие никогда не представлено между элементами в заданном диапазоне.|
...
|[partition_copy](../standard-library/algorithm-functions.md#partition_copy)|Копирует элементы, для которых условие имеет **значение true** , в одно назначение, для которого условие имеет **значение false** . Эти элементы должны поступать из указанного диапазона.|
...
|[Следующий](../standard-library/algorithm-functions.md#sample)||
