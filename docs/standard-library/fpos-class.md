...
ms.locfileid: "72689673"
---
# <a name="fpos-class"></a>Класс fpos

Шаблон класса описывает объект, который может хранить всю информацию, необходимую для восстановления произвольного индикатора положения файла в любом потоке. Объект класса fpos \< **St** фактически хранит по крайней мере два объекта-члена:
...
Первая функция – член возвращает значение, хранящееся в объекте члена `St`. Вторая функция – член сохраняет *_State* в объекте члена `St`.
