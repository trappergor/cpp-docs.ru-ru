...
|[begin](#cbegin)|Возвращает итератор const, обращающийся к первому элементу в наборе.|
...
@No__t_0 или `const_iterator`, который обращается к расположению элемента в наборе, который имеет ключ, превышающий ключ, или который обращается к расположению, следующему за последним элементом в наборе, если совпадение для ключа не найдено.
