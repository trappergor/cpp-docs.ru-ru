...
- Имена функций в стандартной библиотеке C могут иметь внешнююC++или внешнюю компоновку "c". Включайте соответствующий заголовок стандартного C, а не объявляйте встроенную сущность библиотеки.
