...
*_Intl*<br/>
Значение **true** Если манипулятор должен использовать международный формат **false** противном случае.
...
*str*<br/>
Std::string, char\*, строковый литерал или необработанный строковый литерал или двухбайтовая версия любого из них (например, std::wstring, wchar_t\*).
