...
> [!NOTE]
> Вы можете избежать явного использования итераторов с помощью циклов range-for. Дополнительные сведения см. в разделе [на основе диапазонов для инструкции](../cpp/range-based-for-statement-cpp.md).
