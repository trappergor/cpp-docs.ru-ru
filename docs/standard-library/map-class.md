...
|[const_reverse_iterator](#const_reverse_iterator)|Тип, предоставляющий двунаправленный итератор, который может читать любой **`const`** элемент в сопоставлении.|
...
|[вид](#pointer)|Typedef для указателя на **`const`** элемент в сопоставлении.|
...
|[начале](#begin)|Возврат итератора, указывающего на первый элемент в сопоставлении.|
...
|[открытым](#clear)|Стирает все элементы в сопоставлении.|
...
|[empty](#empty)|Возвращает значение, **`true`** Если схема пуста.|
