...
Виртуальная функция-член преобразует и пропускает один или несколько входных элементов в диапазоне`first`[ `last`,) для определения значений, хранящихся в `*pt`одном или нескольких членах. Ошибка преобразования задает `ios_base::failbit` в `state` и возвращает значение *First*. В противном случае функция возвращает итератор, назначающий первый непреобразованный элемент.
...
Виртуальная защищенная функция-член пытается сопоставить последовательные элементы, начиная с первого в последовательности [`first`, `last`), пока не распознает полное, непустое целочисленное поле ввода даты. В случае успеха оно преобразует это поле в эквивалентное значение в виде компонентов **TM:: TM\_Пн**, **TM:: TM\_Day**и **TM:: TM\_year**, а результаты сохраняются в `ptm->tm_mon`, `ptm->tm_day`, и `ptm->tm_year`соответственно. Она возвращает итератор, обозначающий первый элемент после поля ввода даты. В противном случае функция `iosbase::failbit` задается в *состоянии*. Она возвращает итератор, обозначающий первый элемент после любого префикса допустимого поля ввода даты. В любом случае, если возвращаемое значение равно *Last*, функция задается `ios_base::eofbit` в *состоянии*.
...
Виртуальная защищенная функция-член пытается сопоставить последовательные элементы, начиная с первого в последовательности [`first`, `last`), пока не распознает полное, непустое целочисленное поле ввода месяца. В случае успеха оно преобразует это поле в эквивалентное значение в виде компонента **TM:: TM\_Пн**и сохраняет результат в. `ptm->tm_mon` Она возвращает итератор, обозначающий первый элемент после поля ввода месяца. В противном случае функция `ios_base::failbit` задается в *состоянии*. Она возвращает итератор, обозначающий первый элемент после любого префикса допустимого поля ввода месяца. В любом случае, если возвращаемое значение равно *Last*, функция задается `ios_base::eofbit` в *состоянии*.
...
Виртуальная защищенная функция-член пытается сопоставить последовательные элементы, начиная с первого в последовательности [`first`, `last`), пока не распознает полное, непустое целочисленное поле ввода времени. В случае успешного выполнения он преобразует это поле в эквивалентное значение в виде `tm::tm_hour`компонентов `tm::tm_min`, и `tm::tm_sec`, и сохраняет результаты в `ptm->tm_hour`, `ptm->tm_min`и `ptm->tm_sec`соответственно. Она возвращает итератор, обозначающий первый элемент после поля ввода даты. В противном случае функция `ios_base::failbit` задается в *состоянии*. Она возвращает итератор, обозначающий первый элемент после любого префикса допустимого поля ввода времени. В любом случае, если возвращаемое значение равно *Last*, функция задается `ios_base::eofbit` в *состоянии*.
...
Виртуальная Защищенная функция-член пытается сопоставить последовательные элементы, начиная с *первого* в `first`последовательности `last`[,), пока не распознает полное, непустое поле ввода дня недели. В случае успеха оно преобразует это поле в эквивалентное значение в виде компонента **TM:: TM\_вдай**и сохраняет результат в. `ptm->tm_wday` Она возвращает итератор, обозначающий первый элемент после поля ввода дня недели. В противном случае функция `ios_base::failbit` задается в *состоянии*. Она возвращает итератор, обозначающий первый элемент после любого префикса допустимого поля ввода дня недели. В любом случае, если возвращаемое значение равно *Last*, функция задается `ios_base::eofbit` в *состоянии*.
...
Виртуальная Защищенная функция-член пытается сопоставить последовательные элементы, начиная с *первого* в `first`последовательности `last`[,), пока не распознает полное, непустое поле ввода года. В случае успеха оно преобразует это поле в эквивалентное значение в качестве компонента **TM:: TM\_year**и сохраняет результат в. `ptm->tm_year` Она возвращает итератор, обозначающий первый элемент после поля ввода года. В противном случае функция `ios_base::failbit` задается в *состоянии*. Она возвращает итератор, обозначающий первый элемент после любого префикса допустимого поля ввода года. В любом случае, если возвращаемое значение равно *Last*, функция задается `ios_base::eofbit` в *состоянии*.
...
Возвращает итератор на первый символ после данных, которые использовались для назначения структуры `*ptm`времени.
