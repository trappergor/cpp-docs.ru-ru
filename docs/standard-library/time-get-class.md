...
*Первый* входной итератор, который указывает на начало преобразуемой последовательности.

*последний* входной итератор, который указывает на конец последовательности.

*iosbase* объект потока.

*состояние* полем iosbase, где задаются соответствующие элементы битовой маски для указания ошибок.
