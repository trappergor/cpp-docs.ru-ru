...
Класс шаблона описывает распределение Вейбулла, которое формирует значения указанного пользователем типа с плавающей запятой или типа `double`, если тип не указан. В следующей таблице представлены ссылки на статьи об отдельных членах.  
...
Подробные сведения о распределении Вейбулла см. в статье [Распределение Вейбулла](http://go.microsoft.com/fwlink/LinkId=401115) в Wolfram MathWorld.  
