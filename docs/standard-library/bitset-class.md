...
|||  
|-|-|  
|[bitset](#bitset__bitset)|Создает объект класса `bitset\<N>` и инициализирует биты с нулевым значением до определенного указанного значения или до значений, полученных из символов в строке.|  
  
### <a name="typedefs"></a>Typedefs  
  
|||  
|-|-|  
|[element_type](#bitset__element_type)|Тип, который служит синонимом типа данных `bool` и может использоваться для ссылки на биты элементов в `bitset`.|  
  
### <a name="member-functions"></a>Функции-члены  
  
|||  
|-|-|  
|[all](#bitset__all)|Проверяет все биты в этом объекте `bitset`, чтобы определить, имеют ли они все значение `true`.|  
|[any](#bitset__any)|Функция-член проверяет, равен ли какой-либо бит в последовательности 1.|  
|[count](#bitset__count)|Эта функция-член возвращает количество бит, заданных в последовательности бит.|  
|[flip](#bitset__flip)|Инвертирует все биты в `bitset` или инвертирует один бит в указанной позиции.|  
|[none](#bitset__none)|Проверяет, присвоено ли хотя бы одному биту в объекте `bitset` значение 1.|  
|[reset](#bitset__reset)|Сбрасывает все биты в `bitset` в значение 0 или сбрасывает бит в указанной позиции в 0.|  
|[set](#bitset__set)|Присваивает всем битам в `bitset` значение 1 или присваивает биту в указанной позиции значение 1.|  
|[size](#bitset__size)|Возвращает количество бит в объекте `bitset`.|  
|[test](#bitset__test)|Проверяет, присвоено ли биту в указанной позиции в `bitset` значение 1.|  
|[to_string](#bitset__to_string)|Преобразует объект `bitset` в строковое представление.|  
|[to_ullong](#bitset__to_ullong)|Возвращает сумму значений бит в `bitset` как `unsigned long long`.|  
|[to_ulong](#bitset__to_ulong)|Преобразует объект `bitset` в `unsigned long`, чтобы получить последовательность его битов, если используется для инициализации `bitset`.|  
  
### <a name="member-classes"></a>Классы-члены  
  
|||  
|-|-|  
|[reference](#bitset__reference)|Прокси-класс, который предоставляет ссылки на биты в объекте `bitset`, используемые для доступа к отдельным битам и их обработки в качестве вспомогательного класса для `operator[]` класса `bitset`.|  
  
### <a name="operators"></a>Операторы  
  
|||  
|-|-|  
|[оператор!=](#bitset__operator_neq)|Проверяет целевой объект `bitset` на неравенство относительно указанного объекта `bitset`.|  
|[оператор&=](#bitset__operator_and_eq)|Выполняет побитовое сочетание битовых массивов с использованием логической операции `AND`.|  
|[оператор<<](#bitset__operator_lshift)|Сдвигает биты в `bitset` влево на указанное число позиций и возвращает результат в новом объекте `bitset`.|  
|[оператор<<=](#bitset__operator_lshift_eq)|Сдвигает биты в `bitset` влево на указанное число позиций и возвращает результат в целевом объекте `bitset`.|  
|[оператор==](#bitset__operator_eq_eq)|Проверяет целевой объект `bitset` на равенство относительно указанного объекта `bitset`.|  
|[оператор>>](#bitset__operator_rshift)|Сдвигает биты в `bitset` вправо на указанное число позиций и возвращает результат в новом объекте `bitset`.|  
|[оператор>>=](#bitset__operator_rshift_eq)|Сдвигает биты в `bitset` вправо на указанное число позиций и возвращает результат в целевом объекте `bitset`.|  
|[оператор&#91;&#93;](#bitset__operator_at)|Возвращает ссылку на бит в указанной позиции в `bitset`, если `bitset` может быть изменен; в противном случае возвращается значение бита в этой позиции.|  
|[оператор^=](#bitset__operator_xor_eq)|Выполняет побитовое сочетание битовых массивов с использованием эксклюзивной операции `OR`.|  
|[оператор&#124;=](#bitset__operator_or_eq')|Выполняет побитовое сочетание битовых массивов с использованием инклюзивной операции `OR`.|  
|[оператор~](#bitset__operator_dtor)|Инвертирует все биты в целевом объекте `bitset` и возвращает результат.|  
...
### <a name="remarks"></a>Примечания  
 Функция оператора-члена возвращает **bitset**(**\*this**) **<<= pos,** где [<<=](#bitset__operator_lshift_eq) сдвигает биты в битовом массиве влево на указанное число позиций и возвращает результат в целевой битовый массив.  
