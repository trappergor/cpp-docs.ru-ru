...
*N* указывает на количество битов в битовом массиве в виде ненулевого целого типа **size_t** , должно быть известно во время компиляции.
...
`val` Целое число без знака, двум основным представление используется для инициализации битов в битовом массиве конструируемого.

`str` Строка и нули используются для инициализации значений бит битовом массиве.

`_CStr` Строка C-стиле и нули используются для инициализации значений бит битовом массиве.

`_Pos` Позиция символа в строке, считая слева направо и начинается с нуля, используемый для инициализации первого бит в битовом массиве.

`count` Число символов в строке, которая используется для предоставления начальные значения для битов в битовом массиве.

`_Zero` Символ, который используется для представления ноль. Значение по умолчанию — 0.

`_One` Символ, который используется для представления один. Значение по умолчанию — 1.
...
`_Pos` Позиция разряда, значение которого является обратные.
...
`right` Bitset, сравниваемое bitset целевой на неравенство.
...
`right` Bitset, побитового объединяться с целевой bitset.
...
`_Pos` Количество позиций слева, сдвиг битов в битовом массиве.
...
`_Pos` Количество позиций слева пребывание сдвиг битов в битовом массиве.
...
`right` Bitset, сравниваемое bitset целевой на равенство.
...
`_Pos` Количество позиций вправо, что сдвиг битов в битовом массиве.
...
`_Pos` Позиция, поиск бит в битовом массиве.
...
`val` Значение объекта типа `bool` должен назначаться бит в битовом массиве.
...
`_Pos` Позиция бит в битовом массиве, чтобы присвоить значение 0.
...
`_Pos` Положение бит в битовом массиве, чтобы присвоить значение присвоено значение.

`val` Значение, присваиваемое бита в указанной позиции.
...
`_Pos` Позиция бит в битовом массиве, чтобы проверить его значение.
