...
*N* указывает количество битов в объекте bitset в виде ненулевого целого типа `size_t` , должно быть известно во время компиляции.
...
*Val* целое число без знака, которого представление с основанием 2 используется для инициализации битов в конструируемом битовом массиве.

*STR* строка из нулей и единиц используется для инициализации значений битов в битовом массиве.

*_CStr* строка C-стиля из нулей и единиц используется для инициализации значений битов в битовом массиве.

*_Pos* положение символа в строке, считая слева направо и начиная с нуля, используемый для инициализации первого бита в битовом массиве.

*число* число символов в строку, которая используется для предоставления начальных значений битам в битовом массиве.

*_Zero* символ, который используется для представления нуля. Значение по умолчанию — 0.

*_Одно* символ, который используется для представления единицы. Значение по умолчанию — 1.
...
*_Pos* позиции бита, значение которого равно следует Инвертировать.
...
*правом* битовый массив, который должен сравниваться с целевым битовым массивом на неравенство.
...
*правом* битовый массив для побитового сочетания с целевым битовым массивом.
...
*_Pos* количество позиций, биты в битовом массиве должны сдвигаться влево.
...
*_Pos* число позиций влево биты в битовом массиве, должны сдвигаться.
...
*правом* битовый массив, который должен сравниваться с целевым битовым массивом на равенство.
...
*_Pos* число позиций вправо биты в битовом массиве, должны сдвигаться.
...
*_Pos* позиция расположения бита в битовом массиве.
...
*Val* значение объекта типа **bool** присвоить бита в битовом массиве.

*_Bitref* ссылка в формате *x [i]* бит в позиции *я* в битовом массиве *x*.
...
*_Pos* позиция бита в битовом массиве, чтобы присвоить значение 0.
...
*_Pos* позиция бита в битовом массиве будет присвоено присвоено значение.

*Val* значение, присваиваемое биту в указанной позиции.
...
*_Pos* позиция бита в битовом массиве, необходимо проверить его значение.
