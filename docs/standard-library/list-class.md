...
ms.locfileid: "81377324"
---
# <a name="list-class"></a>Класс list

Класс стандартных библиотек и посевных элементов представляет собой классовый шаблон контейнеров последовательности, который поддерживает свои элементы в линейном расположении и позволяет эффективно вставлять и удалять в любом месте в последовательности. Последовательность сохраняется в виде двунаправленного связанного списка элементов, каждый из которых содержит член какого-либо типа *Type*.
...
*Распределителя*\
Тип, представляющий сохраненный объект распределителя, содержащий сведения о распределении списка и отмене распределения памяти. Этот аргумент является необязательным, и значение по умолчанию является>*типа* **разлесть.**\<
...
Включите стандартный список \<заголовков Стандартной библиотеки> для определения списка шаблонов класса [контейнеров](../standard-library/stl-containers.md) и нескольких вспомогательных шаблонов.
...
|[const_iterator](#const_iterator)|Тип, предоставляющий двунаправленный итератор, который может читать элемент **const** в списке.|
|[const_pointer](#const_pointer)|Тип, который предоставляет указатель к **конст** элемента в списке.|
|[const_reference](#const_reference)|Тип, предоставляющий ссылку на элемент **const**, хранящийся в списке, для чтения и выполнения операций **const**.|
|[const_reverse_iterator](#const_reverse_iterator)|Тип, предоставляющий двунаправленный итератор, который может читать любой элемент **const** в списке.|
...
|[Итератор](#iterator)|Тип, предоставляющий двунаправленный итератор, который может читать или изменять любой элемент в списке.|
|[указатель](#pointer)|Тип, предоставляющий указатель на элемент в списке.|
|[Ссылки](#reference)|Тип, предоставляющий ссылку на элемент **const**, хранящийся в списке, для чтения и выполнения операций **const**.|
...
|||
|-|-|
|[Назначить](#assign)|Удаляет элементы из списка и копирует новый набор элементов в список назначения.|
|[Назад](#back)|Возвращает ссылку на последний элемент в списке.|
|[Начать](#begin)|Возвращает итератор, адресующий первый элемент в списке.|
...
|[Ясно](#clear)|Удаляет все элементы списка.|
...
|[Пустой](#empty)|Проверяет, пуст ли список.|
...
|[Перед](#front)|Возвращает ссылку на первый элемент в списке.|
|[get_allocator](#get_allocator)|Возвращает копию объекта объекта `allocator`, использованного для создания списка.|
|[Вставить](#insert)|Вставляет элемент или количество элементов или диапазон элементов в указанное положение в списке.|
|[max_size](#max_size)|Возвращает максимальную длину списка.|
|[Объединить](#merge)|Удаляет элементы из списка аргументов, вставляет их в список назначения и сортирует новый объединенный набор элементов по возрастанию или в ином указанном порядке.|
...
|[удаление](#remove)|Удаляет из списка элементы, совпадающие с заданным значением.|
...
|[Изменения размера](#resize)|Указывает новый размер списка.|
|[Обратный](#reverse)|Изменяет порядок следования элементов в списке на обратный.|
|[Размер](#size)|Возвращает количество элементов в списке.|
|[Сортировки](#sort)|Упорядочивает элементы списка по возрастанию или в другом порядке.|
|[splice](#splice)|Удаляет элементы из списка аргументов и вставляет их в список назначения.|
|[Своп](#swap)|Меняет местами элементы двух списков.|
|[Уникальный](#unique)|Удаляет из списка повторяющиеся соседние элементы или соседние элементы, удовлетворяющие условию какого-либо другого двоичного предиката.|

### <a name="operators"></a>Операторы

|||
|-|-|
|[оператора](#op_eq)|Заменяет элементы списка копией другого списка.|
...
## <a name="assign"></a><a name="assign"></a>Назначить
...
Если значение `begin` возврата назначено объекту, `const_iterator`элементы объекта списка не могут быть изменены. Если значение `begin` возврата назначено объекту, `iterator`элементы объекта списка могут быть изменены.
...
Обеспечивает указатель на **конст** элемент в списке.
...
*Где*\
Положение в целевом [списке,](../standard-library/list-class.md) где вставляется первый элемент.
...
*Валь*\
Элемент, добавленный в конец [списка.](../standard-library/list-class.md)
...
*Валь*\
Элемент, добавленный к началу [списка.](../standard-library/list-class.md)
...
`end`используется для проверки того, достиг ли итерататор конца своего списка.
...
## <a name="erase"></a><a name="erase"></a>Стереть
...
## <a name="insert"></a><a name="insert"></a>Вставить
...
## <a name="iterator"></a><a name="iterator"></a>Итератор
...
Все конструкторы хранят объект-разллетку *(Al)* и инициализируют список.

[get_allocator](#get_allocator) возвращает копию объекта-распределителя, использовавшегося для создания списка.

Первые два конструктора указывают пустой первоначальный список, второй - тип разлесть *(Al)* для использования.

Третий конструктор определяет повторение указанного числа *(Count*) элементов значения `Type`по умолчанию для класса.

Четвертый и пятый конструкторы указывают повторение *(Граф*) элементы значения *Val*.

Шестой конструктор указывает копию списка *право*.
...
## <a name="merge"></a><a name="merge"></a>Объединить
...
*Право* списка аргументов объединено с целевым списком.

И список аргументов, и список назначения должны быть упорядочены с использованием того же отношения сравнения, по которому должно быть упорядочена готовая последовательность. По умолчанию для первой функции-члена используется порядок по возрастанию. Функция второго члена накладывает на *comp* пользовательскую `Traits`операцию сравнения comp класса.
...
После стирания любых `list`существующих элементов в , оператор либо копирует или перемещает содержимое *справа* в `list`.
...
## <a name="reference"></a><a name="reference"></a>Ссылки
...
## <a name="resize"></a><a name="resize"></a>Изменения размера
...
Если размер списка меньше запрашиваемого размера, *_Newsize*элементы добавляются в список до тех пор, пока он не достигнет запрашиваемого размера.

Если размер списка больше запрашиваемого размера, элементы, расположенные ближе всего к концу списка, удаляются до тех пор, пока список не достигнет размера *_Newsize.*
...
## <a name="reverse"></a><a name="reverse"></a>Обратный
...
Функция шаблона пользователя заказывает элементы в соответствии `Traits`с пользовательским *интерфейсом* операции сравнения класса.
...
Первая пара функций участника вставляет все элементы в списке исходных источников в список назначения до позиции, на которую ссылается *Where,* и удаляет все элементы из списка исходных. (не`&Source` должен `this`равняться .)

Вторая пара функций членов вставляет элемент, на который ссылается *Итер,* перед положением в списке назначения, на который ссылается *Where,* и удаляет *Iter* из списка исходных источников. (Если `Where == Iter || Where == ++Iter`, изменения не происходят.)

Третья пара функций членов вставляет диапазон, обозначенный з `First`, `Last`до элемента в списке назначения, на который ссылается *Where,* и удаляет этот диапазон элементов из списка исходных источников. (Если `&Source == this`диапазон `[First, Last)` не должен включать элемент, на который указывает *Where*.)
...
*Правильно*\
Список, предусматривающий обмен элементами, или список, элементы которого должны быть обменены с теми из списка *слева*.

*Левой*\
Список элементов, элементы которого должны быть обменяны с теми из списка *право*.
...
## <a name="unique"></a><a name="unique"></a>Уникальный
...
Функция второго члена удаляет каждый элемент, удовлетворяющий *предикатной* функции pred по сравнению с предыдущим элементом. Вы можете использовать любой из бинарных объектов функции, заявленных в функциональном \<> заголовок для аргумента *pred* или вы можете создать свой собственный.
