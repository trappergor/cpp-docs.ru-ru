---
title: Класс контейнера::empty | Документы Майкрософт
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
...
ms.locfileid: "33841984"
---
# <a name="container-classempty"></a>Класс контейнера::empty
...
Возвращает значение **true** для пустой управляемой последовательности.
