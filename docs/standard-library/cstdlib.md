---
title: '&lt;cstdlib&gt; | Документы Майкрософт'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
...
ms.locfileid: "33841733"
---
# <a name="ltcstdlibgt"></a>&lt;cstdlib&gt;

Включает заголовок \<stdlib.h> стандартной библиотеки C и добавляет связанные имена в пространство имен `std`.
