...
*_Iosbase* указывает поток, который содержит языковой стандарт с аспектом numpunct, используемым для расстановки знаков препинания вывода и флагами для форматирования вывода.

*_Fill* символ, который применяется для интервала.

*Val* числовой или логический тип, который должен быть выходные данные.
...
*dest* итератор, адресующий первый элемент вставляемой строке.
