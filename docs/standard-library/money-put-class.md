...
*OutputIterator* тип итератора, к которому денежном выражении поместите функции записывают свои выходные данные.
...
*Далее* итератор, адресующий первый элемент вставляемой строке.

*_Intl* логическое значение, указывающее тип символа валюты, ожидаемого в последовательности: **true** международного, **false** внутреннего.

*_Iosbase* флаг формата, который, будучи установленным, указывает, что символ валюты не обязателен; в противном случае он является обязательным

*_Fill* символ, используемый для пробелов.

*Val* строковый объект для преобразования.
