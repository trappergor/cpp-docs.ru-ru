...
`Type` Тип объекта должно быть извлечено из входного потока.

`CharType` Тип, представляющий тип символа для `istream_iterator`. Этот аргумент является необязательным, и значением по умолчанию является `char`.

`Traits` Тип, представляющий тип символа для `istream_iterator`. Этот аргумент является необязательным, и в качестве значения по умолчанию используется `char_traits`< `CharType`>.

`Distance` Целочисленный тип, представляющий тип отличия для со знаком `istream_iterator`. Этот аргумент является необязательным, и значением по умолчанию является `ptrdiff_t`.
