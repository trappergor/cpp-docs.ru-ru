...
`left` Один из объектов для проверки на неравенство.

`right` Один из объектов для проверки на неравенство.

`Ty1` Тип, управляемый левым общим указателем.

`Ty2` Тип, управляемый правым общим указателем.
...
`left` Один из объектов, которое необходимо проверить на равенство.

`right` Один из объектов, которое необходимо проверить на равенство.
...
`left` Один из сравниваемых объектов.

`right` Один из сравниваемых объектов.
...
`Tr` Тип элемента признаки потока.
