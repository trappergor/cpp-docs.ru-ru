...
1. Выполните повторную сборку проекта. Стандартные предбыстрые проверки должны выполняться для всех файлов. Поскольку средство C++ проверки основных правил не включено по умолчанию, оно должно выполняться только в том файле, который настроен для использования.
