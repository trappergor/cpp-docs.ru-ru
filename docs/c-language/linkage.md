---
title: "Компоновка | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
helpviewer_keywords: 
  - "компоновка [C++]"
  - "компоновка [C++], имена и область идентификаторов"
