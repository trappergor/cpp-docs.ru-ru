...
В объявлениях переменных на внешнем уровне (т. е. вне любых функций) можно использовать описатель класса хранения **static** или `extern`, либо полностью опустить описатель класса хранения. Использовать терминалы *storage-class-specifier* **auto** и **register** на внешнем уровне невозможно.
