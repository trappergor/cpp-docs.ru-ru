---
title: Тип перечисления | Документация Майкрософт
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-language
...
ms.locfileid: "32382761"
---
# <a name="enum-type"></a>Тип enum
**ANSI 3.5.2.2** Целочисленный тип, выбранный для представлений значений типа перечисления  
