...
|Обозначение1|Тип операции|ассоциативностью|  
|-------------|-----------------------|-------------------|  
|**[ ] ( ) . ->** постфиксный `++` и постфиксный **--**|Выражение|Слева направо|  
|префиксный `++` и префиксный **-- sizeof &   \*   + - ~ !**|Унарный|Справа налево|  
...
|**= \*= /= %=**<br /><br /> **+= -= <\<= >>=&=**<br /><br /> **^= &#124;=**|Простое и составное присваивание2|Справа налево|  
