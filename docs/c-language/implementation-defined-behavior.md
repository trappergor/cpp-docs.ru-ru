---
title: Поведение, определяемое реализацией
ms.date: 11/04/2016
helpviewer_keywords:
...
ms.locfileid: "81334561"
---
# <a name="implementation-defined-behavior"></a>Поведение, определяемое реализацией

ANSI X3.159-1989, *Американский национальный стандарт для информационных систем* - *Программирование Язык* - *C*, содержит раздел под названием "Вопросы переносимости". В разделе ANSI перечислены области языка C, которые в стандарте ANSI оставлены открытыми для конкретной реализации. В этом разделе описывается, как в Microsoft C обрабатываются эти области языка C, определяемые его реализацией.
...
[C Языковая ссылка](../c-language/c-language-reference.md)
