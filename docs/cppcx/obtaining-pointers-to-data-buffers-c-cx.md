---
title: "Получение указателей на буферы данных (C + +/ CX) | Документы Microsoft"
ms.custom: 
ms.date: 12/30/2016
...
1.  Добавить новый компонент среды выполнения Windows на C++ в существующее решение и назовите его `ImageManipCPP`. Добавьте ссылку на него в проект C#, щелкнув этот проект правой кнопкой мыши в **Обозревателе решений** и выбрав **Добавить**, **Ссылка**.  
