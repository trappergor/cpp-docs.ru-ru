---
title: Классы и структуры ссылки (C + +/ CX) | Документация Майкрософт
ms.custom: ''
ms.date: 01/22/2017
...
## <a name="inheritance"></a>Наследование  
 ...
 Класс ссылки, имеющий открытый или защищенный конструктор в C + +/ CX должен быть объявлен как запечатанный. Это ограничение означает, что не существует способа для классов, написанных на других языках, например C# или Visual Basic наследовать от типов, объявленных в компоненте среды выполнения Windows, которая написана на C + +/ CX.  
...
## <a name="see-also"></a>См. также  
 ...
 [Классы и структуры значения](../cppcx/value-classes-and-structs-c-cx.md)   
