...
## Возвращаемое значение  
 ...
 Тип возвращаемого значения фактически является скрытым внутренним типом. Удобный способ сохранения возвращаемого значения — присвоить это значение переменной, объявленной с помощью ключевого слова вывода типа [auto](~/cpp/auto-cpp.md). Например, `auto x = myAgileTvariable->Get();`.  
