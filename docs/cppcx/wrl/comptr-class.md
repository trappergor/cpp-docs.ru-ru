...
Дополнительные сведения о смарт-указателях см. в подразделе "интеллектуальные указатели COM" статьи [рекомендации по кодированию com](/windows/desktop/LearnWin32/com-coding-practices) в библиотеке MSDN.
