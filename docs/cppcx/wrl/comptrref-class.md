...
[ComPtrRef::operator T *](#operator-t-star)                               | Возвращает значение [ptr_](comptrrefbase-class.md#ptr) данными-членом текущим объектом ComPtrRef.
...
Возвращает значение [ptr_](comptrrefbase-class.md#ptr) данными-членом текущего `ComPtrRef` объекта.
