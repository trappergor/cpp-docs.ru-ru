...
4. Инициализируйте переменную [Microsoft:: WRL:: оболочки:: HString](hstring-class.md) , которая представляет универсальный `"http://www.microsoft.com"`код ресурса (URI).
