...
> [!NOTE]
> Теперь заменяется WRL C++/WinRT, C ++ 17 проекция стандартного для API среды выполнения Windows. C++/ WinRT доступна в пакете SDK для Windows 10 версии 1803 и далее. C++/ WinRT реализуется полностью в файлах заголовков и предоставляющая с первоклассный доступ к современных API Windows.
>
...
C++/CX является высокого уровня, на основе языка способ использования компонентов среды выполнения Windows. Среда Windows C++ библиотеки шаблонов и C++/CX упростить написание кода для среды выполнения Windows путем автоматического выполнения задач обслуживания от вашего имени.

Среда выполнения Windows C++ библиотеки шаблонов и C++/CX предоставляют различные преимущества. Ниже приведены некоторые причины, вы можете использовать среду выполнения Windows C++ библиотека шаблонов вместо C++/CX:
...
Показано, как использовать среду выполнения Windows C++ библиотека шаблонов для создания внутрипроцессного компонента библиотеки DLL и использовать ее C++/CX, JavaScript, и C#.
...
|[Краткий справочник (среда выполнения Windows и Visual C++)](../../cppcx/quick-reference-c-cx.md)|Краткое описание C++/CX функций, которые поддерживают среды выполнения Windows.|
|[Использование компонентов среды выполнения Windows в Visual C++](/windows/uwp/winrt-components/walkthrough-creating-a-basic-windows-runtime-component-in-cpp-and-calling-it-from-javascript-or-csharp)|Демонстрируется использование C++/CX для создания базового компонента среды выполнения Windows.|
