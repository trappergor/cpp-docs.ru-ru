...
|-------------|--------------------|------------------------------------------------------------------|-------------|
|Фундаментальные типы|Базовые типы C++.|C++/CX базовые типы, которые реализуют базовые типы, которые определены в среде выполнения Windows.|`default` Пространство имен содержит C++/CX встроенные базовые типы. Компилятор неявно сопоставляет C++/CX фундаментальные типы стандарту C++ типов.<br /><br /> `Platform` Семейства пространств имен содержит типы, которые реализуют базовые типы среды выполнения Windows.|
