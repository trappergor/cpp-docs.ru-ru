...
## Заметки  
 ...
 Используйте оператор [typeid](http://msdn.microsoft.com/library/e9706cae-e7c4-4d6d-b474-646d73df3e70), чтобы вернуть объект `Platform::Type` для имени класса, например при переходе между страницами XAML.  
