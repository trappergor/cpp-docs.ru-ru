---
title: "Функции CRT не поддерживаются в приложениях универсальной платформы Windows | Документы Microsoft"
ms.custom: 
ms.date: 12/30/2016
