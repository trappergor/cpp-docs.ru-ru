---
title: 'по умолчанию:: (имя_типа):: GetHashCode-метод | Документация Майкрософт'
ms.custom: ''
ms.date: 12/30/2016
...
ms.locfileid: "44107153"
---
# <a name="defaulttypenamegethashcode-method"></a>Метод default::(имя_типа)::GetHashCode
