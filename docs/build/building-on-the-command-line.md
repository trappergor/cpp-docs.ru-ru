...
Приложениям C и C++ в командной строке можно создавать с помощью средств, включенных в Visual Studio. Также можно загрузить набор инструментов компилятора в виде изолированного пакета из [Build Tools для Visual Studio 2017](https://go.microsoft.com/fwlink/p/?linkid=875721).
