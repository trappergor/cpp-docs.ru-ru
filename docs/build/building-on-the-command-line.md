...
|**vcvarsall.bat**| Используйте параметры для задания узла и целевых архитектур, а также настроить параметры пакета SDK и платформы. Список поддерживаемых параметров, вызовите с помощью **/help** параметра.|
...
|*architecture*|Компилятор|Архитектура компьютера узла|Архитектура выходных данных (целевой) сборки|
|----------------------------|--------------|----------------------------------|-------------------------------|
