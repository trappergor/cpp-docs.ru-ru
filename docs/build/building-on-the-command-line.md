...
Если вы уже установили [Build Tools для Visual Studio 2017 г](https://go.microsoft.com/fwlink/?linkid=840931) или [построения набор средств Visual C++ 2015](http://landinghub.visualstudio.com/visual-cpp-build-tools) edition, может быть только определенные машинный код или между Сервис, параметры командной строки разработчика. 
...
[Ссылка](../build/reference/linking.md)  
...
[Набор переменных пути и среды для построения из командной строки](../build/setting-the-path-and-environment-variables-for-command-line-builds.md)  
