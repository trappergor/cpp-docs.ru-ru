---
title: Создание библиотек DLL на C/C++ в Visual Studio
ms.date: 05/06/2019
helpviewer_keywords:
- executable files [C++]
- dynamic linking [C++]
...
ms.locfileid: "65220756"
---
# <a name="create-cc-dlls-in-visual-studio"></a>Создание библиотек DLL на C/C++ в Visual Studio
...
Следующие разделы предоставляют подробные сведения о создании C /C++ библиотек DLL в Visual Studio.
...
[Вопросы и ответы по библиотекам DLL](dll-frequently-asked-questions.md)<br/>
...
[Вызов функций библиотек DLL из приложений Visual Basic](calling-dll-functions-from-visual-basic-applications.md)<br/>
