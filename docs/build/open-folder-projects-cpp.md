...
Вы можете использовать средства CMake для Visual Studio, чтобы ориентироваться на Qt при создании проектов Qt, либо использовать [расширение Qt Visual Studio](https://download.qt.io/development_releases/vsaddin/) для Visual Studio 2015 или Visual Studio 2017.
