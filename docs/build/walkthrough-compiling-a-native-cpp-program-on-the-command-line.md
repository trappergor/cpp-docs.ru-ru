---
title: Пошаговое руководство. Компиляция собственной C++ программы в командной строке
...
ms.locfileid: "71960717"
---
# <a name="walkthrough-compiling-a-native-c-program-on-the-command-line"></a>Пошаговое руководство. Компиляция собственной C++ программы в командной строке
...
В этом пошаговом руководстве вы создадите программу в стиле C++ "обычный", "Привет, мир", используя текстовый редактор, а затем компилируете ее в командной строке. Если вы хотите попробовать использовать интегрированную среду разработки Visual Studio вместо использования командной строки, см. раздел [Walkthrough: Работа с проектами и решениямиC++() ](../ide/walkthrough-working-with-projects-and-solutions-cpp.md) или [Использование интегрированной среды разработки C++ Visual Studio для разработки классических приложений](../ide/using-the-visual-studio-ide-for-cpp-desktop-development.md).
