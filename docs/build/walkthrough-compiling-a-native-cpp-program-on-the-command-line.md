...
## <a name="prerequisites"></a>Предварительные требования  
 Для выполнения данного пошагового руководства, необходимо установить Visual Studio и необязательный разработки настольных приложений с рабочей нагрузкой, C++ или средства командной строки сборки для Visual Studio.  
