...
2. После данных об исключении (если *E* бит в заголовке было присвоено значение 0) — это список сведений об областях эпилога, которые упакованы в слова и хранятся в порядке увеличения начального смещения. Каждая область содержит следующие поля.
