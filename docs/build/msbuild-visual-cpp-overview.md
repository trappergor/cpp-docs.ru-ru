...
> [!NOTE] 
> В Visual Studio 2017 г C++ проектов поддержка **xsd** устаревшие файлы. Вы можете продолжать использовать **Microsoft.VisualC.CppCodeProvider** путем добавления **CppCodeProvider.dll** вручную в глобальном кэше СБОРОК.
