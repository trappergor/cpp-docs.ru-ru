...
\*\*\* Нет соответствующей инструкции для `mov r29, sp` присутствует в эпилога. Упакованные очистки данных нельзя использовать, если для функции требуется восстановление sp из r29.
