...
Чтобы указать генератор Visual Studio в Visual Studio 2017, в главном меню выберите **CMake | Изменить параметры CMake**. Удалите слово "Ninja" и введите букву "V". Это активирует IntelliSense, позволяя выбрать нужный генератор.
