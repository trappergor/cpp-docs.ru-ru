...
Чтобы настроить проект Visual Studio для использования Clang, щелкните правой кнопкой мыши узел проекта в **Обозреватель решений** и выберите пункт **свойства**. Как правило, сначала следует выбрать **все конфигурации** в верхней части диалогового окна. Затем в разделе **General** > Platform Tools (общий**набор инструментов платформы** **) выберите LLVM (Clang-CL)** и нажмите **кнопку ОК**.
...
При использовании настраиваемой установки Clang можно изменить**Свойства** >  **проекта** >  > **каталоги VC + +** **Свойства** > конфигурации**исполняемые файлы Каталоги** путем добавления пользовательской корневой установки Clang в качестве первого каталога или изменения значения `LLVMInstallDir` свойства. Дополнительные сведения см. [в разделе Установка пользовательского расположения LLVM](#custom_llvm_location) .
...
В Linux в Visual Studio по умолчанию используется первое Clang расположение, которое встречается в свойстве среды PATH. При использовании настраиваемой `LLVMInstallDir` установки Clang необходимо изменить значение свойства или заменить путь в разделе**Свойства** >  **проекта** > **каталоги**  >   **VC + +. Свойства конфигурации исполняемые** **каталоги.**  >  Дополнительные сведения см. [в разделе Установка пользовательского расположения LLVM](#custom_llvm_location) .

## <a name="custom_llvm_location"></a>Задание пользовательского расположения LLVM
