...
Чтобы отобразить **Диспетчер свойств**, в строке меню выберите **View** > **диспетчер свойств** или **View** > другие > **Windows** Диспетчер свойств в **Property Manager**зависимости от параметров.
