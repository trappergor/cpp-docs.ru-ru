...
Чтобы отобразить **Диспетчер свойств**, в строке меню выберите **представление** > **Диспетчер свойств** или **Просмотрите** > **другие** > **Диспетчер свойств**Windows в зависимости от параметров.
...
1. В строке меню выберите **Просмотреть** > **Диспетчер свойств** или **Просмотреть** > **другие** > **Диспетчер свойств**Windows. Открывается диалоговое окно **Диспетчер свойств**.
