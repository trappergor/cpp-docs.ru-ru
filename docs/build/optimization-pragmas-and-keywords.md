---
title: Директивы pragma и ключевые слова оптимизации
ms.date: 11/04/2016
helpviewer_keywords:
...
Некоторые прагмы и ключевые слова, используемые в коде C или C++, влияют на оптимизацию:

- [__asm](../assembler/inline/asm.md)

- [__assume](../intrinsics/assume.md)

- [inline, __inline или \__forceinline](../cpp/inline-functions-cpp.md)
