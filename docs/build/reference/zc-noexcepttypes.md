...
description: 'Сведения о параметре компилятора Microsoft C++/Zc: noexceptTypes для согласования или ослабления C++ 17, Кроме совместимости исходного кода.'
ms.date: 06/04/2020
f1_keywords:
- /Zc:noexceptTypes
helpviewer_keywords:
