...
| **/errorreport** [ **нет** &#124; &#124; **Отправка** **очереди** **запросов** &#124; ] | Устаревшее. Параметры управления отчетами [отчеты об ошибках Windows (WER)](/windows/win32/wer/windows-error-reporting) . |
