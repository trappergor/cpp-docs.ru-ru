...
# [Проекты С++. Справочник по MSBuild](msbuild-reference-cpp.md)
## [Проекты С++. Внутренние компоненты MSBuild](msbuild-visual-cpp-overview.md)
## [Стандартные макросы для команд и свойств сборки](common-macros-for-build-commands-and-properties.md)
## [Типы файлов, используемые в проектах С++](file-types-created-for-visual-cpp-projects.md)
### [Файлы проекта и решения](project-and-solution-files.md)
### [Шаблоны проектов С++](visual-cpp-project-types.md)
### [Новые шаблоны элементов C++](using-visual-cpp-add-new-item-templates.md)
...
### [Файлы справки HTML](help-files-html-help.md)
### [Файлы справки WinHelp](help-files-winhelp.md)
### [Файлы указаний для IntelliSense](hint-files.md)
...
## [Справочник по свойствам проектов С++](property-pages-visual-cpp.md)
### [Страница свойств "Общие"](general-property-page-project.md)
### [Страница свойств "Общие"](general-property-page-file.md)
...
# [Справочник по компилятору MSVC](compiling-a-c-cpp-program.md)
...
##### [Оптимизация операций с плавающей запятой MSVC](floating-point-optimization.md)
...
### [/CETCOMPAT (совместимость с Control-flow Enforcement Technology)](cetcompat.md)
...
# [Дополнительные средства сборки MSVC](c-cpp-build-tools.md)
## [Справочник по программе NMAKE](nmake-reference.md)
### [Проекты NMAKE в Visual Studio](creating-a-makefile-project.md)
...
# [Ошибки компилятора и средств сборки](../../error-messages/)
# [Документация по XML для C++](xml-documentation-visual-cpp.md)
## [Рекомендуемые теги для комментариев документации по С++](recommended-tags-for-documentation-comments-visual-cpp.md)
### [<c>](c-visual-cpp.md)
...
## [Разделители для тегов документации по C++](delimiters-for-visual-cpp-documentation-tags.md)
