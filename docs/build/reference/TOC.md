...
#### [-await (включить поддержку соподпрограмм)](await-enable-coroutine-support.md)
...
#### [-constexpr (управлять вычислением constexpr)](constexpr-control-constexpr-evaluation.md)
...
##### [-Zc:referenceBinding (принудительно применять правила привязки ссылок)](zc-referencebinding-enforce-reference-binding-rules.md)
...
##### [-Zc:threadSafeInit ( включение потокобезопасной локальной статичной инициализации)](zc-threadsafeinit-thread-safe-local-static-initialization.md)
##### [-Zc:throwingNew (предполагать новые вызовы оператора при сбое)](zc-throwingnew-assume-operator-new-throws.md)
...
### [-FILEALIGN (выравнивание участков в файлах)](filealign.md)
...
### [-NATVIS (Добавление файла NATVIS в PDB-файл)](natvis-add-natvis-to-pdb.md)
