---
title: "Соглашения о вызове, параметры и тип возвращаемого значения | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "соглашения при вызове, вспомогательные функции"
  - "вспомогательные функции, соглашения при вызове"
  - "вспомогательные функции, возвращаемые типы"
...
```  
 ...
 Определение структуры `PCImgDelayDescr` см. в статье [Определение структуры и константы](../../build/reference/structure-and-constant-definitions.md).  
