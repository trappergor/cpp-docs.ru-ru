...
Для вспомогательной функции используется соглашение о вызовах `__stdcall`. Тип возвращаемого значения не важен, поэтому используется ФАРПРОК. Для этой функции используется компоновка C.
