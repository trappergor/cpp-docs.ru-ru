...
**PogoSafeMode и VCPROFILE_ALLOC_SCALE переменные среды являются устаревшими, начиная с Visual Studio 2015.** Параметры компоновщика [/genprofile или/fastgenprofile](genprofile-fastgenprofile-generate-profiling-instrumented-build.md) и [/useprofile](useprofile.md) определяют аналогичное поведение компоновщика, как эти переменные среды.
...
> **Задайте VCPROFILE_ALLOC_SCALE**[__=__*scale_value*]
