...
|[Ключей](c-preserve-comments-during-preprocessing.md)|Сохраняет комментарии на этапе предварительной обработки.|
|[ключей](c-compile-without-linking.md)|Задает компиляцию без компоновки.|
...
|[Ключа](f-set-stack-size.md)|Задает размер стека.|
...
|[#B1](fo-object-file-name.md)|Создает объектный файл.|
...
|[/Headers](gl-whole-program-optimization.md)|Включает оптимизацию всей программы.|
...
|[/Guard: ехконт](guard-enable-eh-continuation-metadata.md)|Включает метаданные продолжения EH.|
...
|[/жмк](jmc.md)|Поддерживает отладку в машинном коде C++ Только мой код.|
...
|[/Qvec-report (автоматический уровень отчетов векторизатора)](qvec-report-auto-vectorizer-reporting-level.md)|Включает уровни отчетов для автоматической векторизации.|
...
|[ТР](tc-tp-tc-tp-specify-source-file-type.md)|Указывает исходный файл на языке C++.|
|[ТР](tc-tp-tc-tp-specify-source-file-type.md)|Указывает, что все исходные файлы имеют язык C++.|
