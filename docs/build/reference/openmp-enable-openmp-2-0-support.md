...
## <a name="remarks"></a>Примечания  
 ...
 Приложение, скомпилированное с **/OpenMP** и с помощью [библиотеки](../../parallel/openmp/reference/openmp-libraries.md) могут выполняться только на Windows 2000 или более поздних операционных системах.  
