---
title: Страницы свойств ресурсов
ms.date: 11/04/2016
f1_keywords:
...
Сведения о том, как получить доступ к **ресурсы** страницы свойств, см. в разделе [свойств компилятора и собранной задать C++ в Visual Studio](../working-with-project-properties.md).
