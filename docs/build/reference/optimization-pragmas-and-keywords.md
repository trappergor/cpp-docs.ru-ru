---
title: "Оптимизации директивы pragma и ключевые слова | Документы Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
Некоторые ключевые слова и директивы pragma, которые можно использовать в коде C или C++ влияют на оптимизацию:  
  
-   [__asm](../../assembler/inline/asm.md)  
  
-   [__assume](../../intrinsics/assume.md)  
  
-   [Встроенная _inline, или \__forceinline](../../cpp/inline-functions-cpp.md)  
...
-   [Register-ключевое слово](../../cpp/storage-classes-cpp.md#register)  
