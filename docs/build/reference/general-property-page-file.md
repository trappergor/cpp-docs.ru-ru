...
- **Средство**
   ...
   Средство, которое будет использоваться для сборки этого файла. Дополнительные сведения см. в разделе [Задание пользовательских средств сборки](../specifying-custom-build-tools.md).
...
Сведения о том, как получить доступ к **Общие** страница свойств под **свойства конфигурации** узла, см. в разделе [свойств компилятора и собранной задать C++ в Visual Studio](../working-with-project-properties.md).
