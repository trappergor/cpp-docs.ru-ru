---
title: HEAPSIZE | Документация Майкрософт
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-tools
...
ms.locfileid: "45717669"
---
# <a name="heapsize"></a>HEAPSIZE

Предоставляет те же функции, как [/HEAP](../../build/reference/heap-set-heap-size.md) параметр компоновщика.
