---
title: HEAPSIZE | Документы Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-tools
...
ms.locfileid: "32370951"
---
# <a name="heapsize"></a>HEAPSIZE
Предоставляет те же функциональные возможности, как [/HEAP](../../build/reference/heap-set-heap-size.md) компоновщика.  
