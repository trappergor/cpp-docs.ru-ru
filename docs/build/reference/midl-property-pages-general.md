---
title: 'Страницы свойств MIDL: Общие'
ms.date: 11/04/2016
f1_keywords:
...
ms.locfileid: "62321167"
---
# <a name="midl-property-pages-general"></a>Страницы свойств MIDL: Общие
...
Сведения о том, как получить доступ к **Общие** страницы свойств в **MIDL** папки, см. в разделе [свойств компилятора и собранной задать C++ в Visual Studio](../working-with-project-properties.md).
