---
title: -ENTRY (символ точки входа) | Документация Майкрософт
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-tools
...
|**Функция _DllMainCRTStartup**|БИБЛИОТЕКИ DLL; вызовы `DllMain` если он существует, который должен быть определен для использования `__stdcall`|
