...
- **Visual Studio 2017 и более поздних версий**: Используйте **открыть папку** функции для редактирования и сборки проекта makefile как-без участия системы MSBuild. Дополнительные сведения см. в разделе [открыть папку проектов для C++](../open-folder-projects-cpp.md).
