---
title: "-LOADCONFIG | Документы Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
## <a name="remarks"></a>Примечания  
 Этот параметр выводит структуре IMAGE_LOAD_CONFIG_DIRECTORY необязательно структуру используемые загрузчик Windows NT и определенную в файле WINNT. З.  
