...
Соглашения о декорированных именах были изменены в различных версиях Visual Studio, также могут различаться на различных целевых архитектурах. Для правильной компоновки с исходными файлами, созданными с помощью Visual Studio, C и C++ библиотек DLL и библиотек должны быть скомпилированы с помощью одинаковых наборов инструментов компилятора, флагов и целевой архитектуры. 

> [!NOTE]
> Библиотеки, созданных с помощью Visual Studio 2015 могут использоваться приложениями, созданных с помощью Visual Studio 2017 или Visual Studio 2019.
