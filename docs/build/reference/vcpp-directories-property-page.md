...
Если вы не знакомы с *свойствами проекта* в Visual Studio, может оказаться полезным сначала прочитать [свойства Set C++ Compiler и Build в Visual Studio](../working-with-project-properties.md).
...
Примечание. Список заполняется по мере ввода. Не нажимайте клавишу **ВВОД**.

Дополнительные сведения о макросах и их использовании вместо жестко заданных путей, когда это возможно, см. [в C++ разделе Установка компилятора и свойств сборки в Visual Studio](../working-with-project-properties.md).
...
Дополнительные сведения см. в следующих записях блога: [Каталоги VC + +](https://blogs.msdn.com/b/vsproject/archive/2009/07/07/vc-directories.aspx), [наследуемые свойства и страницы свойств](https://blogs.msdn.com/b/vsproject/archive/2009/06/23/inherited-properties-and-property-sheets.aspx), а в [Visual Studio 2010 C++ — Обзор обновления проекта](https://devblogs.microsoft.com/cppblog/visual-studio-2010-c-project-upgrade-guide/).
