...
**/ Permissive-** наборы параметров [/Zc: strictstrings](zc-conformance.md) и [/Zc: rvaluecast](zc-conformance.md) параметры соответствующих поведение. Они по умолчанию несоответствующее поведение. Вы можете передавать параметры определенного **/Zc** параметры после **/ permissive-** в командной строке, чтобы переопределить это поведение.
