...
В версиях начиная компилятора в Visual Studio 2017 г. версия 15,3 **/ разрешительным-** параметр наборы **/Zc:ternary** параметр. Компилятор реализует несколько требований для подстановки двухфазной имя. Когда **/ разрешительным-** параметр задан, компилятор анализирует функций и классов определения шаблонов, идентификация зависимых и не зависит от имен, используемых в шаблонах. В этом выпуске выполняется анализ зависимостей только имя.
