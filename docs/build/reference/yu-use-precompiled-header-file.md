...
1. Укажите [/Yc (создать предкомпилированный заголовочный файл)](../../build/reference/yc-create-precompiled-header-file.md) в CPP-файл в проекте.
...
Можно использовать [/Fp (имя. PCH-файл)](../../build/reference/fp-name-dot-pch-file.md) с параметром **/Yu** параметр, чтобы указать имя PCH-файл, если имя отличается от имени аргумент файла для **/Yc** или базовое имя исходного файла, как и в следующие:
