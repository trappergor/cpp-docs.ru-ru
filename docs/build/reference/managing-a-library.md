...
**/ LIBPATH:** *dir*<br/>
Переопределяет путь к библиотеке среды. Дополнительные сведения см. в описании ссылки [/LIBPATH](libpath-additional-libpath.md) параметр.
...
**/NODEFAULTLIB**<br/>
Удаляет один или несколько стандартных библиотек из списка библиотек, в которой выполняется поиск при разрешении внешних ссылок. См. в разделе [/NODEFAULTLIB](nodefaultlib-ignore-libraries.md) Дополнительные сведения.
...
Указывает операционной системе, как запустить программу, созданную путем связывания с выходной библиотеке. Дополнительные сведения см. в описании ссылки [/SUBSYSTEM](subsystem-specify-subsystem.md) параметр.
