---
title: 'Страницы свойств MIDL: Вывод'
ms.date: 11/04/2016
f1_keywords:
...
ms.locfileid: "57826247"
---
# <a name="midl-property-pages-output"></a>Страницы свойств MIDL: Вывод
...
Сведения о том, как получить доступ к **вывода** страницы свойств в **MIDL** папки, см. в разделе [свойств компилятора и собранной задать C++ в Visual Studio](../working-with-project-properties.md).
