...
|VCXITEMS|Проект|Проект общих элементов для совместного использования файлов кода в нескольких проектах C++. См. в разделе [файлы проекта и решения](project-and-solution-files.md) Дополнительные сведения.|
|VCXPROJ|Проект|Файл проекта Visual Studio. См. в разделе [файлы проекта и решения](project-and-solution-files.md) Дополнительные сведения.|
