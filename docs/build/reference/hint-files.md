...
>
> - В версиях перед Visual Studio 2017 версия 15.6: Удалить файл .sdf и / или VC.db файл в решении для всех изменений.
> - В Visual Studio 2017 версия 15.6 и позже: Закройте и вновь откройте решение после добавления новых файлов подсказки.
...
![Выделено Макро.](media/hint-squiggle-and-actions.png "Подсказка squiggle и быстрые действия")
...
![Общие и проектные&#45;конкретные каталоги файлов подсказочными файлами.](media/hintfile.png "Подсказка")
...
[Директива #define (К/СЗ)](../../preprocessor/hash-define-directive-c-cpp.md)<br>
[Директива #undef (К/СЗ)](../../preprocessor/hash-undef-directive-c-cpp.md)<br>
[Примечания SAL](../../c-runtime-library/sal-annotations.md)<br>
