...
1. Введите **/genprofile** или **/fastgenprofile** параметры и аргументы в **Дополнительные параметры** поле. Выберите **ОК** для сохранения внесенных изменений.
