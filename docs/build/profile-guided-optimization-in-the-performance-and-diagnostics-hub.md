...
## <a name="walkthrough-using-the-pgo-plug-in-to-optimize-an-app"></a>Пошаговое руководство. Используя подключаемый модуль профильной Оптимизации для оптимизации приложения
...
1. В **Configuration Manager** диалоговое окно, выберите **активная конфигурация решения** кнопку раскрывающегося списка и выберите **выпуска**. Щелкните кнопку **Закрыть** .
...
![Профильная Оптимизация в концентраторе производительности и диагностики](media/pgofig0hub.png "Профильная Оптимизация в концентраторе производительности и диагностики")
...
![Вводная страница профильной Оптимизации](media/pgofig1start.png "Вводная страница профильной Оптимизации")
...
![Страница инструментирования профильной Оптимизации](media/pgofig2instrument.png "страница инструментирования профильной Оптимизации")
...
![Страница инструментированной сборки профильной Оптимизации](media/pgofig3build.PNG "страница инструментированной сборки профильной Оптимизации")
...
![Страница обучения профильной Оптимизации](media/pgofig4training.PNG "страница обучения профильной Оптимизации")
...
![Страница анализа профильной Оптимизации](media/pgofig5analyze.png "страница анализа профильной Оптимизации")
...
![Файл данных профильной Оптимизации в обозревателе решений](media/pgofig6data.png "файл данных профильной Оптимизации в обозревателе решений")
...
![PGO выходных данных диагностики](media/pgofig7diagnostics.png "профильной Оптимизации выходных данных диагностики")
