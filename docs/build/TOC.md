...
## [Создание изолированных приложений C-C++](building-c-cpp-isolated-applications.md)
## [Создание параллельных сборок C-C++](building-c-cpp-side-by-side-assemblies.md)
...
## [Основные сведения о создании манифестов для программ C-C++](understanding-manifest-generation-for-c-cpp-programs.md)
...
# [Настройка программ для процессоров ARM (Visual C++)](configuring-programs-for-arm-processors-visual-cpp.md)
...
## [Преимущества использования библиотек DLL](advantages-of-using-dlls.md)
...
### [Обычные библиотеки DLL, динамически компонуемые с MFC](regular-dlls-dynamically-linked-to-mfc.md)
### [Общие сведения о библиотеках DLL расширения](extension-dlls-overview.md)
...
### [Неявное связывание](linking-implicitly.md)
### [Явное связывание](linking-explicitly.md)
## [Инициализация библиотеки DLL](initializing-a-dll.md)
### [Инициализация обычных библиотек DLL](initializing-regular-dlls.md)
### [Инициализация библиотек DLL расширения](initializing-extension-dlls.md)
### [Инициализация библиотек DLL, не использующих MFC](initializing-non-mfc-dlls.md)
...
# [Сборка из командной строки](building-on-the-command-line.md)
...
## [Задание пути и переменных среды для сборки из командной строки](setting-the-path-and-environment-variables-for-command-line-builds.md)
