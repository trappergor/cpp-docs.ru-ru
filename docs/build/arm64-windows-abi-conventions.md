...
| - | - | - |
| x0 | Временный | Параметр или вспомогательный регистр 1, регистр результатов |
| x1 — 120x7x1 | Временный | Регистр параметров и временных файлов 2-8 |
| x8-X15 | Временный | Временных регистров |
| x16-x17 | Временный | Временных регистров вызова внутри процедуры |
...
| Регистровое | Переменный? | Role |
| - | - | - |
| v0 | Временный | Параметр или вспомогательный регистр 1, регистр результатов |
| v1 — версии 7 | Временный | Реестр параметров и временных файлов 2-8 |
| V8 — версия 15 | Неизменяемый | Временные регистры (только младшие 64 бита не поддерживаются) |
| v16-v31 | Временный | Временных регистров |
