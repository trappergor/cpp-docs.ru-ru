...
Типы, возвращаемые по значению, обрабатываются по-разному в зависимости от наличия у них определенных свойств. Рассмотрим тип со следующими свойствами:
...
Для такого типа используется следующий формат возврата:
