...
В интегрированной среде разработки все сведения, необходимые для сборки проекта, представлены в виде *свойств*. Эти сведения включают в себя имя приложения, расширение (например, DLL, EXE, LIB), параметры компилятора, параметры компоновщика, параметры отладчика, настраиваемые этапы сборки и многие другие компоненты. Как правило, для просмотра и изменения этих свойств используются *страницы свойств* . Для доступа к страницам свойств выберите свойства **проекта** >  **_имяПроекта_** в главном меню или щелкните правой кнопкой мыши узел проекта в **Обозреватель решений** и выберите пункт **Свойства**.
...
![Значения по&#43; &#43; умолчанию для проекта Visual C](media/visual-c---project-defaults.png "Значения C++ по умолчанию для Visual Project")
...
![Страницы свойств&#43; &#43; Visual C, отображающие активную конфигурацию](media/visual-c---property-pages-showing-active-configuration.png "Страницы C++ свойств визуального элемента, отображающие активную конфигурацию")
...
![Страницы свойств&#43; &#43; Visual C, отображающие конфигурацию выпуска](media/visual-c---property-pages-showing-release-config.png "Страницы C++ свойств Visual, демонстрирующие конфигурацию выпуска")
...
На следующем рисунке показаны страницы свойств для проекта Visual Studio C++ . В левой области выбрано *правило* " **каталоги VC + +** ", а на правой панели перечислены свойства, связанные с этим правилом. `$(...)` значения называются *макросами*. *Макрос* является константой времени компиляции, которая может ссылаться на значение, определенное Visual Studio или системой MSBuild, или пользовательское значение. Использование макросов вместо жестко заданных значений, таких как пути к каталогам, упрощает совместное использование параметров свойств между компьютерами и различными версиями Visual Studio. Кроме того, можно обеспечить правильную работу параметров проекта в [наследовании свойств](project-property-inheritance.md).
...
1. Откройте окно **Диспетчер свойств** . (В строке меню выберите **View** > **диспетчер свойств** или **View** > другие > **Диспетчер свойств** **Windows** .) Откройте контекстное меню для страницы свойств (ее имя оканчивается на. User) и выберите пункт **Свойства**. Откроется диалоговое окно **Страницы свойств** для данной страницы свойств.
...
![Раскрывающийся список редактора свойств&#95;&#95;](media/property_editor_dropdown.png "Property_Editor_Dropdown")
...
![Редактор свойств, Visual C&#43;&#43;](media/propertyeditorvc.png "пропертедиторвк")
