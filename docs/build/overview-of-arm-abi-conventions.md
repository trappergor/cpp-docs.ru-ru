...
|Регистровое|Переменный?|Role|
|--------------|---------------|----------|
|r0|Временный|Параметр, результат, оперативный регистр 1|
|r1|Временный|Параметр, результат, оперативный регистр 2|
|r2|Временный|Параметр, оперативный регистр 3|
|r3|Временный|Параметр, оперативный регистр 4|
|r4|Неизменяемый||
|r5|Неизменяемый||
|r6|Неизменяемый||
|r7|Неизменяемый||
...
|r12|Временный|Оперативный регистр для вызова внутри процедуры|
...
|Одиночные|Двойные|Счетверенные|Переменный?|Role|
|-------------|-------------|-----------|---------------|----------|
|s0—s3|d0—d1|q0|Временный|Параметры, результат, оперативный регистр|
|s4—s7|d2—d3|q1|Временный|Параметры, оперативный регистр|
|s8—s11|d4—d5|q2|Временный|Параметры, оперативный регистр|
|s12—s15|d6—d7|q3|Временный|Параметры, оперативный регистр|
...
||d16—d31|q8—q15|Временный||

В следующей таблице представлены битовые поля регистра управления и состояний для операций с плавающей точкой (FPSCR).

|Bits|Значение|Переменный?|Role|
|----------|-------------|---------------|----------|
|31—28|NZCV|Временный|Флаги состояния|
|27|QC|Временный|Совокупное насыщение|
...
|7, 4—0|IDC, IXC и т. п.|Временный|Совокупные флаги исключения|
