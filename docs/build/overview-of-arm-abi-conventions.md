---
title: "Обзор соглашений ABI ARM | Microsoft Docs"
ms.custom: ""
ms.date: "12/05/2016"
...
Двоичный интерфейс приложения \(ABI\) для кода, скомпилированного для Windows на процессорах ARM, основан на стандартном встроенном двоичном интерфейсе приложения ARM.  В этой статье указаны различия между системой Windows на устройствах ARM и стандартной системой.  Дополнительные сведения о стандартном встроенном двоичном интерфейсе приложения ARM см. в разделе [Двоичный интерфейс приложения для архитектуры ARM](http://infocenter.arm.com/help/index.jsp?topic=/com.arm.doc.subset.swdev.abi/index.html).  
