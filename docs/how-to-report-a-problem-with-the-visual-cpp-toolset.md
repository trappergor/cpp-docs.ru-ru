...
## <a name="how-to-report-a-c-product-issue"></a>Как сообщить о проблеме с продуктом C++
...
> [!TIP]
> Для проблем других типов, которые могут возникать в Visual Studio и не связаны с набором инструментов (таких как проблемы с пользовательским интерфейсом, неправильная работа интегрированной среды разработки или сбои общего характера), инструмент **Сообщить о проблеме** может быть особенно удобным благодаря возможностям создания снимков экрана и записи действий в пользовательском интерфейсе, которые приводят к возникновению проблемы. Также об этих ошибках можно сообщить на сайте [Сообщества разработчиков](https://developercommunity.visualstudio.com/). Сообщать о таких ошибках на адрес электронной почты compilercrash@microsoft.com не следует.
