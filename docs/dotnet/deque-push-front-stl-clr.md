...
## Заметки  
 Функция\-член вставляет элемент со значением `val` в начале контролируемой последовательности.  Он используется для вставки в начале другой элемент. deque.  
