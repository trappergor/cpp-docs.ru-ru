---
title: C + +/ CLI задач | Документация Майкрософт
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-cli
...
ms.locfileid: "46414749"
---
# <a name="ccli-tasks"></a>Задачи C++/CLI

Статьи в этом разделе документации показано, как использовать различные функции C + +/ CLI.

## <a name="in-this-section"></a>В этом разделе

- [Практическое руководство. Создание пустых проектов CLR](../dotnet/how-to-create-clr-empty-projects.md)
- [Практическое руководство. Создание консольного приложения CLR (C++/CLI)](../dotnet/how-to-create-clr-console-applications-cpp-cli.md)
...
- [Практическое руководство. Определение и использование перечислений в C++/CLI](../dotnet/how-to-define-and-consume-enums-in-cpp-cli.md)
- [Практическое руководство. Использование событий в C++/CLI](../dotnet/how-to-use-events-in-cpp-cli.md)
- [Практическое руководство. Определение статического конструктора интерфейса (C++/CLI)](../dotnet/how-to-define-an-interface-static-constructor-cpp-cli.md)
- [Практическое руководство. Объявление спецификаторов переопределения в компиляциях в машинный код (C++/CLI)](../dotnet/how-to-declare-override-specifiers-in-native-compilations-cpp-cli.md)
