...
## Заметки  
 Функция\-член возвращает значение true для пустой контролируемой последовательности.  Он эквивалентен [multimap::size](../Topic/multimap::size%20\(STL-CLR\).md)`() == 0`.  Он используется для выполнения ли multimap пусто.  
