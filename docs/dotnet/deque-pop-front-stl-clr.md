...
## Заметки  
 Функция\-член удаляет первый элемент контролируемой последовательности, которая должна быть непустой.  Он используется для сокращения deque одним элементом в начале.  
