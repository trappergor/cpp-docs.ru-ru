...
Дополнительные сведения о преобразованиях см. в разделе [упаковки-преобразования](../extensions/boxing-cpp-component-extensions.md) и [стандартные преобразования](../cpp/standard-conversions.md).
