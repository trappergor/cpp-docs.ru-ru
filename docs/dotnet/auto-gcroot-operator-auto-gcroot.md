...
Присвойте подходящую роль оператора между `auto_gcroot` и совместимыми типами.  
...
## Возвращаемое значение  
 Текущее `auto_gcroot` привоженное в `auto_gcroot<_other_type>`.  
