...
|[operator< (pair) (STL/CLR)](../dotnet/operator-less-than-pair-stl-clr.md)|Пара меньше, чем сравнения.|  
|[оператор\<= (пару) (STL/CLR)](../dotnet/operator-less-or-equal-pair-stl-clr.md)|Меньше или равно пары сравнения.|  
