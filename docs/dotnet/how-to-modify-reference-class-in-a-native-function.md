---
title: 'Как: изменение ссылочного класса в собственной функции | Документы Microsoft'
...
Можно передать с массивом среды CLR ссылочного класса в неуправляемую функцию и изменить класс, с помощью службы PInvoke.  
