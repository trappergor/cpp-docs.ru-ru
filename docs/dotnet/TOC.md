...
## [Пошаговое руководство: Компиляция программы C++/CLI, предназначенной для среды CLR](walkthrough-compiling-a-cpp-program-that-targets-the-clr-in-visual-studio.md)
## [Задачи C++/CLI](cpp-cli-tasks.md)
### [Практическое руководство. Создание пустых проектов CLR](how-to-create-clr-empty-projects.md)
### [Практическое руководство. Создание консольных приложений CLR](how-to-create-clr-console-applications-cpp-cli.md)
...
### [Практическое руководство. Определение и использование классов и структур](how-to-define-and-consume-classes-and-structs-cpp-cli.md)
### [Семантика стека C++ для ссылочных типов](cpp-stack-semantics-for-reference-types.md)
### [Определяемые пользователем операторы](user-defined-operators-cpp-cli.md)
### [Пользовательские преобразования](user-defined-conversions-cpp-cli.md)
### [initonly](initonly-cpp-cli.md)
### [Практическое руководство. Определение и использование делегатов](how-to-define-and-use-delegates-cpp-cli.md)
...
### [Практическое руководство. Определение статического конструктора интерфейса](how-to-define-an-interface-static-constructor-cpp-cli.md)
### [Практическое руководство. Объявление описателей переопределения при компиляциях в машинный код](how-to-declare-override-specifiers-in-native-compilations-cpp-cli.md)
...
### [Регулярные выражения](regular-expressions-cpp-cli.md)
### [Работа с файлами и операции ввода-вывода](file-handling-and-i-o-cpp-cli.md)
### [Работа с графикой](graphics-operations-cpp-cli.md)
### [Операции Windows](windows-operations-cpp-cli.md)
### [Доступ к данным с помощью ADO.NET](data-access-using-adonet-cpp-cli.md)
## [Взаимодействие исходного кода и платформы.NET](native-and-dotnet-interoperability.md)
### [Совместимость с другими языками .NET](interoperability-with-other-dotnet-languages-cpp-cli.md)
...
## [Чистый и проверяемый код](pure-and-verifiable-code-cpp-cli.md)
### [Практическое руководство. Создание проверяемых проектов C++](how-to-create-verifiable-cpp-projects-cpp-cli.md)
### [Использование проверяемых сборок с SQL Server](using-verifiable-assemblies-with-sql-server-cpp-cli.md)
...
## [Сериализация](serialization-cpp-cli.md)
## [Дружественные сборки (C++)](friend-assemblies-cpp.md)
## [Управляемые типы](managed-types-cpp-cli.md)
## [Отражение](reflection-cpp-cli.md)
## [Сборки со строгими именами (подписывание сборок)](strong-name-assemblies-assembly-signing-cpp-cli.md)
## [Класс Debug](debug-class-cpp-cli.md)
...
## [Упаковка-преобразование](boxing-cpp-cli.md)
