...
1. Теперь управляемого кода можно передать на управляемую версию структуры в неуправляемые функции, как будто они являются управляемыми. Эти структуры могут передаваться по значению или по ссылке, как показано в следующем примере.
