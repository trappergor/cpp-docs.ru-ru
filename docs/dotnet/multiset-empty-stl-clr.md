...
## Заметки  
 Функция\-член возвращает значение true для пустой контролируемой последовательности.  Он эквивалентен [multiset::size](../dotnet/multiset-size-stl-clr.md)`() == 0`.  Он используется для выполнения ли multiset пуст.  
