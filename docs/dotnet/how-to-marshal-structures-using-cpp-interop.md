---
title: 'Практическое: маршалирование структур с помощью взаимодействия C++ | Документация Майкрософт'
...
## <a name="example"></a>Пример  
 Ниже приведен пример, передача структуры из неуправляемой для управляемой функции, по значению и по ссылке. Так как структура в этом примере содержит только простые встроенные типы данных (см. в разделе [непреобразуемые и преобразуемые типы](https://msdn.microsoft.com/Library/d03b050e-2916-49a0-99ba-f19316e5c1b3)), специального маршалирования не требуется. Непреобразуемые структур, например те, которые содержат указатели, см. в разделе [как: маршалинг внедренных указателей с помощью взаимодействия C++](../dotnet/how-to-marshal-embedded-pointers-using-cpp-interop.md).  
