---
title: Lock::Release | Документы Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-cli
...
## <a name="remarks"></a>Примечания  
 ...
 Нет необходимости эта функция вызывается явным образом; Когда `lock` объект выходит за пределы области, ее вызовы деструктора `release`.  
