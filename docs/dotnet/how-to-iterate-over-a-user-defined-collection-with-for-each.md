---
title: 'Практическое: перебор определенной пользователем коллекции с помощью for each | Документация Майкрософт'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-cli
...
Класс может быть управляемой коллекции ему неконфиденциальные GetEnumerator функцию, которая возвращает дескриптор класс перечислителя или интерфейс.  Класс перечислителя может содержать объявление функцию нестатических MoveNext и свойство Current.

## <a name="example"></a>Пример

Простые пользовательские коллекции со ссылочными типами.
