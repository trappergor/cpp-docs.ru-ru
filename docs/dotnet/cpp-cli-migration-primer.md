...
Это руководство по переносу ваших программ Visual C++ из управляемых расширений для C++ к Visual C++. Перечень изменений в синтаксисе представлен в разделе [(NOTINBUILD) управляемых расширений для C++ синтаксис Upgrade Checklist](http://msdn.microsoft.com/en-us/edbded88-7ef3-4757-bd9d-b8f48ac2aada).  
