...
|Функция|Описание:|  
|--------------|-----------------|  
|[adjacent_find (STL/CLR)](#adjacent_find)|Поиск двух соседних элементов, которые равны.|  
|[binary_search (STL/CLR)](#binary_search)|Проверяет, является ли заданное значение содержит упорядоченную последовательность.|  
|[copy (STL/CLR)](#copy)|Копирует значения из исходного диапазона в диапазон назначения, прохода в прямом направлении.|  
|[copy_backward (STL/CLR)](#copy_backward)|Копирует значения из исходного диапазона в диапазон назначения, прохода в обратном направлении.|  
...
|[equal_range (STL/CLR)](#equal_range)|Выполняет упорядоченный набор значений и возвращает две позиции разделители для последовательности значений, которые равны указанному элементу.|  
...
|[find_end (STL/CLR)](#find_end)|Возвращает последний подпоследовательности в диапазоне, который совпадает с заданной последовательностью.|  
...
|[for_each (STL/CLR)](#for_each)|Применяет заданный объект функции к каждому элементу в последовательности значений и возвращает объект функции.|  
...
|[generate_n (STL/CLR)](#generate_n)|Присваивает значения, создаваемые объектом функции, на указанное число элементов.|  
|[includes (STL/CLR)](#includes)|Проверяет, содержит ли один отсортированный диапазон все элементы во втором отсортированном диапазоне.|  
...
|[lexicographical_compare (STL/CLR)](#lexicographical_compare)|Сравнивает две последовательности поэлементно, определяющее, какие последовательности, равно меньшему из двух.|  
|[lower_bound (STL/CLR)](#lower_bound)|Находит позицию первого элемента в упорядоченную последовательность значений, которая имеет значение больше или равно заданному значению.|  
|[make_heap (STL/CLR)](#make_heap)|Преобразует элементы из указанного диапазона в кучу, в которой первый элемент в куче — самое большое.|  
...
|[min (STL/CLR)](#min)|Сравнивает два объекта и возвращает меньший из них.|  
...
|[next_permutation (STL/CLR)](#next_permutation)|Изменяет порядок элементов в диапазоне, чтобы исходный порядок был заменен перестановкой лексикографически Следующий больший, если он существует.|  
|[nth_element (STL/CLR)](#nth_element)|Разделяет последовательность элементов, правильно находя `n`-ый элемент последовательности, чтобы все элементы перед ним были меньше или равно к нему и все элементы, следующие за его, больше или равны ему.|  
|[partial_sort (STL/CLR)](#partial_sort)|Упорядочивает указанный число меньших элементов в диапазоне в не нисходящем порядке.|  
|[partial_sort_copy (STL/CLR)](#partial_sort_copy)|Копирует элементы из исходного диапазона в диапазон назначения, таким образом, что все элементы из исходного диапазона упорядочены.|  
|[partition (STL/CLR)](#partition)|Упорядочивает элементы в диапазоне, таким образом, что эти элементы, удовлетворяющие унарному предикату, расположены перед те, которые ему не удовлетворяют.|  
...
|[prev_permutation (STL/CLR)](#prev_permutation)|Изменяет порядок элементов последовательности, чтобы исходный порядок был заменен перестановкой лексикографически предыдущих больше, если он существует.|  
...
|[random_shuffle (STL/CLR)](#random_shuffle)|Изменяет последовательность `N` элементов в диапазоне в одном из `N`! возможных порядков, выбранном случайным образом.|  
|[remove (STL/CLR)](#remove)|Удаляет указанное значение из заданного диапазона без нарушения порядка остальных элементов и возвращает конец нового диапазона после удаления указанного значения.|  
|[remove_copy (STL/CLR)](#remove_copy)|Копирует элементы из исходного диапазона в диапазон назначения за исключением того, что элементы с заданным значением не копируются, не нарушая порядок остальных элементов.|  
|[remove_copy_if (STL/CLR)](#remove_copy_if)|Копирует элементы из исходного диапазона в диапазон назначения за исключением тех, которые удовлетворяют предикату, не нарушая порядок остальных элементов.|  
|[remove_if (STL/CLR)](#remove_if)|Удаляет элементы, соответствующие предикату, из заданного диапазона без нарушения порядка остальных элементов. .|  
|[replace (STL/CLR)](#replace)|Заменяет элементы в диапазоне, которые соответствуют заданному значению с новым значением.|  
|[replace_copy (STL/CLR)](#replace_copy)|Копирует элементы из исходного диапазона в диапазон назначения, заменив элементы, которые соответствуют заданному значению с новым значением.|  
...
### <a name="remarks"></a>Примечания  
 Эта функция работает так же, как функция стандартной библиотеки C++ `equal`. Дополнительные сведения см. в разделе [равно](../standard-library/algorithm-functions.md#equal).  
...
## <a name="generate"></a> Создание (STL/CLR)
...
## <a name="includes"></a> включает (STL/CLR)
...
### <a name="remarks"></a>Примечания  
 Эта функция работает так же, как функция стандартной библиотеки C++ `max_element`. Дополнительные сведения см. в разделе [max_element](../standard-library/algorithm-functions.md#max_element).  
...
## <a name="partial_sort_copy"></a> partial_sort_copy использования (STL/CLR)
...
### <a name="remarks"></a>Примечания  
 Эта функция работает так же, как функция стандартной библиотеки C++ `reverse`. Дополнительные сведения см. в разделе [обратного](../standard-library/algorithm-functions.md#reverse).  
...
### <a name="remarks"></a>Примечания  
 Эта функция работает так же, как функция стандартной библиотеки C++ `stable_sort`. Дополнительные сведения см. в разделе [stable_sort](../standard-library/algorithm-functions.md#stable_sort).  
...
### <a name="remarks"></a>Примечания  
 Эта функция работает так же, как функция стандартной библиотеки C++ `swap`. Дополнительные сведения см. в разделе [swap](http://msdn.microsoft.com/Library/b471a2de-035e-4aff-b1c7-345d85d93972).  
