...
|[binary_delegate_noreturn (STL/CLR)](#binary_delegate_noreturn)|Делегат с двумя аргументами возвращает **значение void**.|
|[unary_delegate (STL/CLR)](#unary_delegate)|Делегат с одним аргументом.|
|[unary_delegate_noreturn (STL/CLR)](#unary_delegate_noreturn)|Делегат с одним аргументом, возвращающий **значение void**.|
...
Класс женереик описывает делегат с двумя аргументами, который возвращает **значение void**. Он используется для указания делегата в терминах своего аргумента.
...
Делегат женереик описывает функцию с двумя аргументами, которая возвращает **значение void**.
...
|--------------|-----------------|
|Оператор ()|Вычисление требуемой функции.|
|Оператор delegate_type ^ ()|Приводит функтор к делегату.|

### <a name="remarks"></a>Remarks

Класс шаблона описывает функтор с двумя аргументами, в котором хранится еще два аргумента функтор. Он определяет оператор-член `operator()` таким образом, что при вызове объекта в качестве функции он возвращает логическое не из хранимого функтор, вызываемого с двумя аргументами.
...
Класс шаблона описывает функтор с одним аргументом, в котором хранится функтор с двумя аргументами и первый аргумент. Он определяет оператор-член `operator()` таким образом, что при вызове объекта в качестве функции он возвращает результат вызова хранимого функтор с хранимым первым аргументом и переданным вторым аргументом.
...
Класс шаблона описывает функтор с одним аргументом, в котором хранится функтор с двумя аргументами и вторым аргументом. Он определяет оператор-член `operator()` таким образом, что при вызове объекта в качестве функции он возвращает результат вызова хранимого функтор с заданным первым аргументом и хранимым вторым аргументом.
...
Класс шаблона описывает функтор с двумя аргументами. Он определяет оператор-член `operator()` таким образом, что при вызове объекта в качестве функции он возвращает первый аргумент, деленный на второй.
...
Класс шаблона описывает функтор с двумя аргументами. Он определяет оператор-член `operator()` таким образом, что при вызове объекта в качестве функции он возвращает значение true, только если первый аргумент равен второму.
...
Класс шаблона описывает функтор с двумя аргументами. Он определяет оператор-член `operator()` таким образом, что при вызове объекта в качестве функции он возвращает значение true, только если первый аргумент больше второго.
...
Класс шаблона описывает функтор с двумя аргументами. Он определяет оператор-член `operator()` таким образом, что при вызове объекта в качестве функции он возвращает значение true, только если первый аргумент больше или равен второму.
...
Класс шаблона описывает функтор с двумя аргументами. Он определяет оператор-член `operator()` таким образом, что при вызове объекта в качестве функции он возвращает значение true, только если первый аргумент меньше второго.
...
Класс шаблона описывает функтор с двумя аргументами. Он определяет оператор-член `operator()` таким образом, что при вызове объекта в качестве функции он возвращает значение true, только если первый аргумент меньше второго или равен ему.
...
Класс шаблона описывает функтор с двумя аргументами. Он определяет оператор-член `operator()` таким образом, что при вызове объекта в качестве функции он возвращает значение true только в том случае, если оба аргумента и второй тест имеют значение true.
...
Класс шаблона описывает функтор с одним аргументом. Он определяет оператор-член `operator()` таким образом, что при вызове объекта в качестве функции он возвращает значение true, только если его аргумент имеет значение false.
...
Класс шаблона описывает функтор с двумя аргументами. Он определяет оператор-член `operator()` таким образом, что при вызове объекта в качестве функции он возвращает значение true только в том случае, если первый аргумент или второй из них равен true.
...
Класс шаблона описывает функтор с двумя аргументами. Он определяет оператор-член `operator()` таким образом, что при вызове объекта в качестве функции он возвращает первый аргумент минус второй.
...
Класс шаблона описывает функтор с двумя аргументами. Он определяет оператор-член `operator()` таким образом, что при вызове объекта в качестве функции он возвращает первый остаток от деления второго аргумента на второй.
...
Класс шаблона описывает функтор с двумя аргументами. Он определяет оператор-член, `operator()` таким образом, что при вызове объекта в качестве функции он возвращает первый аргумент времени второй.
...
Класс шаблона описывает функтор с одним аргументом. Он определяет оператор-член, `operator()` таким образом, что при вызове объекта в качестве функции он возвращает свой аргумент с противоположным.
...
Класс шаблона описывает функтор с двумя аргументами. Он определяет оператор-член `operator()` таким образом, что при вызове объекта в качестве функции он возвращает значение true, только если первый аргумент не равен второму.
...
Класс шаблона описывает функтор с двумя аргументами. Он определяет оператор-член `operator()` таким образом, что при вызове объекта в качестве функции он возвращает первый аргумент плюс второй.
...
Класс женереик описывает делегат с одним аргументом, который возвращает **значение void**. Он используется для указания делегата в терминах своего типа аргумента.
...
Делегат женереик описывает функцию с одним аргументом, которая возвращает **значение void**.
...
Класс шаблона описывает функтор с одним аргументом, в котором хранится другой функтор с одним аргументом. Он определяет оператор-член `operator()` таким образом, что при вызове объекта в качестве функции он возвращает логическое не из хранимого функтор, вызванного с аргументом.
