---
title: 'Практическое: использование отслеживаемых ссылок в C + +/ CLI | Документация Майкрософт'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-cli
...
В приведенном ниже примере показано, что получение адреса отслеживаемую ссылку возвращает [interior_ptr (C + +/ CLI)](../windows/interior-ptr-cpp-cli.md)и показано, как изменять и доступ к данным через отслеживаемую ссылку.
...
В этом примере показано простое упаковки-преобразования через отслеживаемую ссылку на тип значения:
...
Следующий пример показывает, что можно иметь отслеживаемых ссылок и собственных ссылок для типов значений.
...
В следующем примере показано, что можно использовать отслеживаемые ссылки, а также типы значений и собственные типы.
...
В этом примере показано, что можно привязать отслеживаемую ссылку на тип значения в куче сбора мусора:
...
## <a name="template-functions-that-take-native-value-or-reference-parameters"></a>Функции шаблонов, которые принимают собственные, значение или ссылочные параметры
