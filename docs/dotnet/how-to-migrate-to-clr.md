...
```  
 ...
 Наконец тогда как вызовы COM в языке C требуют явного использования v-таблицы и `this` указатель, не поддерживает C++:  
