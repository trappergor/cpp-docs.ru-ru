...
|-|-|-|-|-|
| /FP: не более             | на  | на  | автоном | на  |
| /FP: умеренный/FP: except- | на  | автоном | автоном | на  |
| /FP: точный            | на  | автоном | на  | автоном |
| /FP: точное/FP: except | на  | на  | на  | автоном |
| /FP: быстрый               | автоном | автоном | на  | автоном |
