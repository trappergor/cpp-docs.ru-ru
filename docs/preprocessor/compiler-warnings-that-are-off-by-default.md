...
|[C4746](../error-messages/compiler-warnings/compiler-warning-c4746.md)|независимый доступ к "*Expression*" подчиняется параметру/volatile:&#124;\<iso MS >. Рассмотрите возможность использования встроенных функций __iso_volatile_load/Store|
