...
- **&#95;&#95;DATE&#95;&#95;** Дата компиляции текущего файла исходного кода. Дата — строковой литерал постоянной длины в формате *ммм дд гггг*. Название месяца *ммм* совпадает со значением сокращенного названия месяца в датах, созданных функцией [asctime](../c-runtime-library/reference/asctime-wasctime.md) библиотеки времени выполнения C. Первый символ даты *дд* — это пробел, если значение меньше 10. Этот макрос определяется всегда.
