...
Все директивы условной компиляции, такие как **#if** и **#ifdef**, должны быть соответствующие закрывающие **#endif** директивы до конца файла; в противном случае — ошибка формируется сообщение. Если директивы условной компиляции содержатся во включаемых файлах, они должны удовлетворять одинаковым условиям: в конце включаемого файла не должно оставаться непарных директив условной компиляции.  
...
**Visual Studio 2017 версии 15.3 и более поздние версии**: Определяет, доступен ли заголовок библиотеки для включения:  
