...
Задает свойства в группе свойств **DBPROPSET\_SESSION**.  
...
#### Параметры  
 В разделе [ISessionProperties::SetProperties](https://msdn.microsoft.com/en-us/library/ms714405.aspx) справочника *программиста OLE DB*.  
