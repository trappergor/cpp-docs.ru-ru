---
title: IErrorRecordsImpl::GetRecordCount | Документы Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-data
...
#### <a name="parameters"></a>Параметры  
 В разделе [IErrorRecords::GetRecordCount](https://msdn.microsoft.com/en-us/library/ms722724.aspx) в *справочника программиста OLE DB*.  
