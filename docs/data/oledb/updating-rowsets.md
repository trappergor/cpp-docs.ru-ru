...
-   **DBPROPVAL_UP_INSERT** позволяет вставлять строки.  
  
-   **DBPROPVAL_UP_DELETE** позволяет удалять строки.  
...
## <a name="see-also"></a>См. также  
 [Работа с шаблоны потребителя OLE DB](../../data/oledb/working-with-ole-db-consumer-templates.md)   
