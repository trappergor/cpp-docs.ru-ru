...
Этот класс реализует интерфейс [IDBSchemaRowset](https://docs.microsoft.com/previous-versions/windows/desktop/ms713686(v=vs.85)) и шаблонизируемую функцию создателя [CreateSchemaRowset](../../data/oledb/idbschemarowsetimpl-createschemarowset.md).

OLE DB использует наборы строк схемы для возврата сведений о данных в поставщике. Такие данные часто называют метаданными. По умолчанию поставщик всегда должен поддерживать `DBSCHEMA_TABLES`, `DBSCHEMA_COLUMNS`, и `DBSCHEMA_PROVIDER_TYPES`, как описано в разделе [IDBSchemaRowset](https://docs.microsoft.com/previous-versions/windows/desktop/ms713686(v=vs.85)) в *Справочник программиста OLE DB по*. Наборы строк схемы назначаются в карте схемы. Сведения о карте записей схемы см. в разделе [SCHEMA_ENTRY](../../data/oledb/schema-entry.md).
...
Дополнительные сведения о наборах строк схемы см. в разделе [Наборы строк схемы](https://docs.microsoft.com/previous-versions/windows/desktop/ms712921(v=vs.85)) в *справочнике программиста OLE DB*.
...
Дополнительные сведения о наборах строк схемы см. в разделе [IDBSchemaRowset](https://docs.microsoft.com/previous-versions/windows/desktop/ms713686(v=vs.85)) в *Справочник программиста OLE DB по* в пакете Windows SDK.
...
*rgPropertySets*<br/>
[входные данные] Массив структур [DBPROPSET](https://docs.microsoft.com/previous-versions/windows/desktop/ms714367(v=vs.85)) , определяющих задаваемые свойства.
...
*rgPropertySets*<br/>
[входные/выходные данные] Массив структур [DBPROPSET](https://docs.microsoft.com/previous-versions/windows/desktop/ms714367(v=vs.85)) , задаваемых в созданном наборе строк схемы.
...
См. в разделе [IDBSchemaRowset::GetRowset](https://docs.microsoft.com/previous-versions/windows/desktop/ms722634(v=vs.85)) в Windows SDK.
...
Этот метод возвращает массив всех наборов строк схемы, поддерживаемых поставщиком. См. в разделе [IDBSchemaRowset::GetSchemas](https://docs.microsoft.com/previous-versions/windows/desktop/ms719605(v=vs.85)) в Windows SDK.
