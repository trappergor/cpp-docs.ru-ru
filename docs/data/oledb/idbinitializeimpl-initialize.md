---
title: IDBInitializeImpl::Initialize | Документы Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-data
...
ms.locfileid: "33100334"
---
# <a name="idbinitializeimplinitialize"></a>IDBInitializeImpl::Initialize
Инициализирует объект источника данных, Подготовка поддержку его свойств.  
...
## <a name="remarks"></a>Примечания  
 В разделе [IDBInitialize::Initialize](https://msdn.microsoft.com/en-us/library/ms718026.aspx) в *справочника программиста OLE DB*.  
