---
title: "Классы набора строк схемы и классы Typedef | Документы Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
Схема является коллекцией объектов базы данных, которые принадлежат либо были созданы, определенным пользователем. Каталог может содержать один или несколько схем, но всегда должен содержать схема с именем INFORMATION_SCHEMA, содержащей домены информационной схемы и представления. Сведения о схеме в OLE DB получаются с помощью предопределенные наборы строк схемы и включает типы, таблиц, столбцов, индексов, представлений, утверждения и ограничения, статистики, наборов символов, параметры сортировки и домены.  
  
 Наборы строк схемы — это предопределенные наборы строк, представляющих метаданные. Наборы строк схемы, обычно используются в динамическом программировании, когда структура базы данных не известен во время компиляции. Эти наборы строк схемы можно использовать для получения сведений о базе данных во время выполнения.  
  
 Используйте классы typedef для создания наборов строк схемы. Ниже перечислены соответствующего typedef и классы набора строк схемы. Необходимо вызвать [CRestrictions::Open](../../data/oledb/crestrictions-open.md) после создания экземпляра набора строк схемы. Этот метод возвращает результирующий набор, основанный на заданными ограничениями. В разделе [IDBSchemaRowset](https://msdn.microsoft.com/en-us/library/ms713686.aspx) сведения о столбцах ограничений, связанных с каждого набора строк схемы.  
  
 В следующей таблице показаны каждого строк схемы OLE DB и соответствующего typedef-класс шаблонов OLE DB и сведения о классе.  
  
|Набор строк схемы OLE DB|TypeDef-класс|Сведения о классе|  
|--------------------------|-------------------|----------------|  
|[УТВЕРЖДЕНИЯ](https://msdn.microsoft.com/en-us/library/ms719776.aspx)|[CAssertions](../../data/oledb/cassertions-cassertioninfo.md)|[CAssertionInfo](../../data/oledb/cassertions-cassertioninfo.md)|  
|[КАТАЛОГИ](https://msdn.microsoft.com/en-us/library/ms721241.aspx)|[CCatalogs](../../data/oledb/ccatalogs-ccataloginfo.md)|[CCatalogInfo](../../data/oledb/ccatalogs-ccataloginfo.md)|  
...
|[ПАРАМЕТРЫ СОРТИРОВКИ](https://msdn.microsoft.com/en-us/library/ms715783.aspx)|[CCollations](../../data/oledb/ccollations-ccollationinfo.md)|[CCollationInfo](../../data/oledb/ccollations-ccollationinfo.md)|  
...
|[СТОЛБЦЫ](https://msdn.microsoft.com/en-us/library/ms723052.aspx)|[CColumns](../../data/oledb/ccolumns-ccolumnsinfo.md)|[CColumnsInfo](../../data/oledb/ccolumns-ccolumnsinfo.md)|  
...
|[ИНДЕКСЫ](https://msdn.microsoft.com/en-us/library/ms709712.aspx)|[CIndexes](../../data/oledb/cindexes-cindexinfo.md)|[CIndexInfo](../../data/oledb/cindexes-cindexinfo.md)|  
...
|[ПРОЦЕДУРЫ](https://msdn.microsoft.com/en-us/library/ms724021.aspx)|[CProcedures](../../data/oledb/cprocedures-cprocedureinfo.md)|[CProcedureInfo](../../data/oledb/cprocedures-cprocedureinfo.md)|  
...
|[СХЕМЫ](https://msdn.microsoft.com/en-us/library/ms716887.aspx)|[CSchemata](../../data/oledb/cschemata-cschematainfo.md)|[CSchemataInfo](../../data/oledb/cschemata-cschematainfo.md)|  
...
|[СТАТИСТИКА](https://msdn.microsoft.com/en-us/library/ms715957.aspx)|[CStatistics](../../data/oledb/cstatistics-cstatisticinfo.md)|[CStatisticInfo](../../data/oledb/cstatistics-cstatisticinfo.md)|  
...
|[ТАБЛИЦЫ](https://msdn.microsoft.com/en-us/library/ms716980.aspx)|[CTables](../../data/oledb/ctables-ctableinfo.md)|[CTableInfo](../../data/oledb/ctables-ctableinfo.md)|  
...
|[ПЕРЕВОДЫ](https://msdn.microsoft.com/en-us/library/ms725365.aspx)|[CTranslations](../../data/oledb/ctranslations-ctranslationinfo.md)|[CTranslationInfo](../../data/oledb/ctranslations-ctranslationinfo.md)|  
...
|[ПРЕДСТАВЛЕНИЯ](https://msdn.microsoft.com/en-us/library/ms723122.aspx)|[CViews](../../data/oledb/cviews-cviewinfo.md)|[CViewInfo](../../data/oledb/cviews-cviewinfo.md)|  
