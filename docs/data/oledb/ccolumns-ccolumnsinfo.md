...
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "CColumns typedef - класс"
  - "CColumnsInfo - класс параметров"
  - "CHARACTER_MAXIMUM_LENGTH"
  - "CHARACTER_OCTET_LENGTH"
  - "CHARACTER_SET_CATALOG"
  - "CHARACTER_SET_NAME"
...
Вызовите **CColumns** класс typedef для реализации его класс **CColumnsInfo** параметра.  
...
## Заметки  
 ...
 Этот класс определяет столбцы таблиц, указанный в каталоге, которые доступны для данного пользователя.  
  
 В следующей таблице перечислены элементы данных класса и соответствующие столбцы OLE DB.  В разделе [Набор строк СТОЛБЦОВ](https://msdn.microsoft.com/en-us/library/ms723052.aspx) справочника *программиста OLE DB* дополнительные сведения о схеме и столбцам.  
