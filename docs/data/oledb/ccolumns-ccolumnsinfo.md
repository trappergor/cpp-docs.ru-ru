---
title: CColumns, CColumnsInfo | Документы Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-data
...
ms.locfileid: "33090787"
---
# <a name="ccolumns-ccolumnsinfo"></a>CColumns, CColumnsInfo
Вызовите typedef-класс **CColumns** реализации класса своего параметра **CColumnsInfo**.  
...
## <a name="remarks"></a>Примечания  
 ...
 Этот класс определяет столбцы таблиц, определенные в каталоге, доступных данному пользователю.  
  
 В следующей таблице перечислены данные-члены класса и их соответствующие OLE DB столбцы. В разделе [набор строк COLUMNS](https://msdn.microsoft.com/en-us/library/ms723052.aspx) в *Справочник программиста OLE DB* Дополнительные сведения о схеме и столбцы.  
