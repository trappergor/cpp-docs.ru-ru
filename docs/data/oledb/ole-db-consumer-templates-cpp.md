---
title: "Шаблоны потребителей OLE DB (C++) | Microsoft Docs"
ms.custom: ""
ms.date: "12/05/2016"
...
helpviewer_keywords: 
  ...
  - "потребители OLE DB [C++], доступ к данным"
  - "шаблоны потребителей OLE DB [C++]"
  - "базы данных [C++], потребители"
...
## См. также  
 ...
 [Документация по OLE DB SDK](https://msdn.microsoft.com/en-us/library/ms722784.aspx)   
