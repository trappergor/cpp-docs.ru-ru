---
title: "BEGIN_PARAM_MAP | Документы Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
## <a name="remarks"></a>Примечания  
 Используются параметры [команды](https://msdn.microsoft.com/en-us/library/ms724608.aspx).  
  
## <a name="example"></a>Пример  
 Далее приведен пример [BEGIN_COLUMN_MAP](../../data/oledb/begin-column-map.md) макрос.  
