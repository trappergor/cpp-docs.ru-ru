...
Сведения об альтернативах, для сериализации и альтернативное использует для сериализации, см. в разделе [сериализации: Сериализация или Базы данных ввода вывода](../mfc/serialization-serialization-vs-database-input-output.md).
