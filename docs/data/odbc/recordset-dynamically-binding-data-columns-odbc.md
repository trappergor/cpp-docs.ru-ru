...
1. Вместе со списком "Столбцы для динамической привязки" создайте список "Значения из динамических столбцов", в котором будут содержаться значения из каждого столбца.
   ...
   Например, на рисунке показаны динамические значения столбцов (список 4) с одним элементом: объект `CString`, содержащий фактический номер телефона для текущей записи: "555-1212".
