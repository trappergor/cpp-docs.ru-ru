...
2.  Установите для параметра объекта [m_strFilter](../../mfc/reference/crecordset-class.md#m_strfilter) элемент данных.  
...
3.  Задайте другие параметры, необходимые, например, порядок сортировки, режим блокировки или параметры. Указание параметра особенно полезно. Сведения о параметризации фильтра см. в разделе [набор записей: Параметризация набора записей (ODBC)](../../data/odbc/recordset-parameterizing-a-recordset-odbc.md).  
  
4.  Вызовите `Open` для нового объекта (или `Requery` для уже открытого объекта).  
...
## <a name="see-also"></a>См. также  
 ...
 [: Как записей (ODBC)](../../data/odbc/recordset-how-recordsets-update-records-odbc.md)   
