---
title: Разработка и создание приложений баз данных ODBC
ms.date: 11/04/2016
helpviewer_keywords:
...
ms.locfileid: "80213269"
---
# <a name="design-and-create-an-odbc-database-application"></a>Разработка и создание приложений баз данных ODBC

Эти разделы содержат справочные сведения по проектированию и настройке приложения базы данных ODBC.
