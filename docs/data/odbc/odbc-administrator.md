...
2.  Нажмите кнопку **Далее** в каждом диалоговом окне, пока не дойдете до **параметры установки** диалоговое окно. Выберите **Custom**, а затем нажмите кнопку **Далее**.  
  
3.  Снимите все флажки в **Установка Microsoft Visual C++** диалоговое окно, за исключением **параметры базы данных** флажок и нажмите кнопку **сведения** для отображения **Параметры базы данных** диалоговое окно.  
  
4.  Очистить **объектах доступа к данным Microsoft** , флажок **драйверы ODBC Майкрософт** флажок и нажмите кнопку **сведения**.  
...
6.  Нажмите кнопку **Далее** на остальных диалоговых, чтобы начать установку. Программа установки сообщит о запуске установки.  
