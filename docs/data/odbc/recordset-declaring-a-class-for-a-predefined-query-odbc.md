...
> [!NOTE]
>  Этот раздел относится к объектам, производным от `CRecordset`, в которых пакетное получение строк не реализовано. Если реализовано пакетное получение строк, процесс очень похож. Сведения о различиях между наборами записей, которые реализуют пакетное получение строк, и теми, которые не реализуют, см. в разделе [Набор записей. Пакетное получение строк (ODBC)](../../data/odbc/recordset-fetching-records-in-bulk-odbc.md).
