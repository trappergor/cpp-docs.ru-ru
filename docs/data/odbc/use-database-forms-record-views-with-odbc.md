---
title: Использование форм баз данных (представления записей) с ODBC | Документация Майкрософт
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-data
...
ms.locfileid: "50060303"
---
# <a name="use-database-forms-record-views-with-odbc"></a>Использование форм баз данных (представления записей) с ODBC

Некоторые приложения, например ввода данных или просмотра данных, требуется форма, представления, используя элементы управления в стиле диалоговых окон.

## <a name="in-this-section"></a>В этом разделе

- [Отображение данных базы данных в форме](../../data/record-views-mfc-data-access.md)
