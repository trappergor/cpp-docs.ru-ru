---
title: Заполнение списка из второго набора записей (доступ к данным MFC) | Документация Майкрософт
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-data
...
2.  Получить указатель на [CComboBox](../mfc/reference/ccombobox-class.md) объект для элемента управления полем со списком.  
  
3.  Очистите поле со списком от любого предыдущего содержимого.  
  
4.  Перемещение по всем записям в наборе записей, вызов [CComboBox::AddString](../mfc/reference/ccombobox-class.md#addstring) для каждой строки из текущей записи, вы хотите добавить в поле со списком.  
