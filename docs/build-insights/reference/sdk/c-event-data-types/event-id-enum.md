...
description: В C++ пакете SDK для аналитики сборки EVENT_ID ссылка перечисления.
ms.date: 02/12/2020
helpviewer_keywords:
- C++ Build Insights
...
| `EVENT_ID_LINKER` | 18 (0x00000012) | [КОМПОНОВЩИКА](../event-table.md#linker) |
...
Эти значения используются с функциями пакета SDK C.
