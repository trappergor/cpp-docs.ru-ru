---
title: стопандрелогтраЦингсессиона
description: Справочник C++ по функциям SDK для Build Insights стопандрелогтраЦингсессиона.
ms.date: 02/12/2020
helpviewer_keywords:
- C++ Build Insights
...
ms.locfileid: "78334298"
---
# <a name="stopandrelogtracingsessiona"></a>стопандрелогтраЦингсессиона
...
*аналисисдескриптор*\
Указатель на объект [RELOG_DESCRIPTOR](../other-types/analysis-descriptor-struct.md) . Используйте этот объект для настройки сеанса повторного ведения журнала, который запускается `StopAndRelogTracingSessionA`.
