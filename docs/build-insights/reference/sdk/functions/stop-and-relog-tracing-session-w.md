...
description: Справочник по функции StopAndRelogTracingSessionW пакета SDK для C++ Build Insights.
ms.date: 02/12/2020
helpviewer_keywords:
- C++ Build Insights
...
*analysisDescriptor*\
Указатель на объект [RELOG_DESCRIPTOR](../other-types/analysis-descriptor-struct.md). Используйте этот объект для настройки сеанса повторной записи в журнал, запущенного `StopAndRelogTracingSessionW`.
