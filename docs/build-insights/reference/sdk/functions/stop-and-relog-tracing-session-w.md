---
title: СтопАндрелогТрейсингСессияW
description: Ссылка на функцию «СИ Тиз» построить исследования SDK StopAndRelogRacingSessionW.
ms.date: 02/12/2020
helpviewer_keywords:
- C++ Build Insights
...
ms.locfileid: "81323692"
---
# <a name="stopandrelogtracingsessionw"></a>СтопАндрелогТрейсингСессияW
...
*Статистика*\
Указатель на [TRACING_SESSION_STATISTICS](../other-types/tracing-session-statistics-struct.md) объект. `StopAndRelogTracingSessionW`записывает статистику сбора следов на этом объекте перед возвращением.

*анализДескриптор*\
Указатель на [RELOG_DESCRIPTOR](../other-types/analysis-descriptor-struct.md) объект. Используйте этот объект для настройки сеанса `StopAndRelogTracingSessionW`перезаписи, который начался с.
