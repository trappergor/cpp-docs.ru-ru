...
1. На первой странице **мастер приложений MFC**, нажмите кнопку **Далее**.

1. На **тип приложения** раздела **визуальный стиль и цвета**выберите **Office 2007 (синяя тема)**. Остальные параметры не изменяйте. Нажмите кнопку **Далее**.

1. На **поддержка составных документов** странице, убедитесь, что **None** выбран, а затем нажмите кнопку **Далее**.

1. На **свойства шаблона документа** странице **расширение файла** введите расширение имени файла для документов, создаваемых этим приложением, например, *mfcrbnapp*. Нажмите кнопку **Далее**.

1. На **Поддержка баз данных** странице, убедитесь, что **None** выбран, а затем нажмите кнопку **Далее**.

1. На **возможностей пользовательского интерфейса** странице, убедитесь, что **использовать ленту** выбран. Нажмите кнопку **Далее**.
