 ...
 **tbButton**  
 **TBBUTTON** структуру, содержащую сведения о кнопке панели инструментов, связанные с уведомлением.  
