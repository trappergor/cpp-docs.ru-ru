...
2.  Разграничение блоки catch:  
     ...
     С макросами **ПЕРЕХВАТЫВАТЬ** (с аргументов), начинаются первого блока catch; **AND_CATCH** макроса начинается блоках catch последующих и **END_CATCH** макрос завершает последовательность блоки catch.  
