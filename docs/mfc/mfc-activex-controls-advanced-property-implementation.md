...
7.  В **тип свойства** выберите соответствующего типа для свойства.  
  
8.  Если вы хотите только для чтения, снимите имя функции Set. Свойство только для записи, снимите имя функции Get.  
...
## <a name="see-also"></a>См. также  
 ...
 [Элементы ActiveX в MFC: методы](../mfc/mfc-activex-controls-methods.md)   
