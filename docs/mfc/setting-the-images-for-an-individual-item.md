...
2.  Эта структура вызова с [CComboBoxEx::GetItem](../mfc/reference/ccomboboxex-class.md#getitem).  
  
3.  Изменить *маска*, *iImage*, и *iSelectedImage* членами вновь возвращаемой структуры, используя соответствующие значения.  
