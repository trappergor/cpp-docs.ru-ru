...
Библиотеки Microsoft Foundation Class \(MFC\) переносит к классам и методам, которые основаны на символ юникода набор.  Следовательно, стали против версии ANSI нескольких методов MFC.  Использование юникода версии этих методов в будущих приложениях.  
  
 Начиная с версии 6.1 общих элементов управления Windows, которая поставляется в [!INCLUDE[windowsver](../Token/windowsver_md.md)], стали против следующие методы ANSI.  
...
## Класс CLinkCtrl  
 Весь класс выступан сопоставления.  
