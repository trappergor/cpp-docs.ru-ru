...
6.  В **внутреннее имя** введите имя функции внутреннего метода или использовать значение по умолчанию (в этом случае *PtInCircle*).  
  
7.  В **тип возвращаемого значения** выберите **VARIANT_BOOL** для возвращаемого типа метода.  
