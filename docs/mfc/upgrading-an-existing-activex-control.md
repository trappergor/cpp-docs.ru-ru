...
### <a name="creating-cab-files"></a>Создание CAB-файлов  
 ...
 Дополнительные сведения о том, как создать CAB-файл, см. в разделе [Создание файла CAB](http://msdn.microsoft.com/cc52fd09-bdf6-4410-a693-149a308f36a3).  
