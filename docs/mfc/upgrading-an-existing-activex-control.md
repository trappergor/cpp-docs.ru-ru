...
### <a name="the-version-tag"></a>Тег версии  
 ...
 В зависимости от того, указана версия можно выполнить принудительную загрузку элемента управления. Подробные спецификации для `OBJECT` включая тег *CODEBASE* параметра, см. в разделе W3C ссылка.  
