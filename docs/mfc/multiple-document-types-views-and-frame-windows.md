...
- [Окна Сплиттера](#_core_splitter_windows)
...
## <a name="multiple-views"></a><a name="_core_multiple_views"></a>Несколько просмотров
...
![Несколько пользовательских интерфейсов&#45;просмотра](../mfc/media/vc37a71.gif "Несколько пользовательских интерфейсов&#45;просмотра") <br/>
...
Дополнительные сведения о `UpdateAllViews`см. в разделе о классе [CView](../mfc/reference/cview-class.md) в *справочнике по библиотеке MFC* и в разделе [Пример Scribble](../overview/visual-cpp-samples.md).

## <a name="multiple-frame-windows"></a><a name="_core_multiple_frame_windows"></a>Несколько кадров Windows
...
## <a name="splitter-windows"></a><a name="_core_splitter_windows"></a>Сплиттер Окна
...
Дополнительные сведения см. в разделе о классе [CSplitterWnd](../mfc/reference/csplitterwnd-class.md) в *справочнике по библиотеке MFC* и в разделе [Примеры MFC](../overview/visual-cpp-samples.md#mfc-samples).
