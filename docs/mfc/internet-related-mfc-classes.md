---
title: "Классы MFC, связанные с Интернетом | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "MFC - библиотека, Интернет-классы"
...
Дополнительные сведения о для связанных классах и функциях см. в разделе:  
