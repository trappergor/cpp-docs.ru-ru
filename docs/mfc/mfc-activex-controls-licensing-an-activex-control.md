---
title: Элементы ActiveX в MFC. Лицензирование элемента управления ActiveX
ms.date: 11/19/2018
f1_keywords:
- COleObjectFactory
helpviewer_keywords:
...
![Лицензия управления ActiveX, проверяемый на этапе разработки](../mfc/media/vc374d1.gif "управления Лицензированные ActiveX, проверяемый на этапе разработки") <br/>
...
![Лицензия управления ActiveX, проверяемый на этапе выполнения](../mfc/media/vc374d2.gif "управления Лицензированные ActiveX, проверяемый на этапе выполнения") <br/>
