...
[Элементы управления ActiveX MFC. Использование изображений в элементе управления ActiveX](../mfc/mfc-activex-controls-using-pictures-in-an-activex-control.md)<br/>
