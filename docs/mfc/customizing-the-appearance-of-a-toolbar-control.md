...
-   **TBSTYLE_TOOLTIPS** создает всплывающая подсказка, приложение может использовать для отображения описательный текст для кнопок на панели инструментов.  
