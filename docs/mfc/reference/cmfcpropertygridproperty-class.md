...
|[CMFCPropertyGridProperty::AdjustButtonRect](#adjustbuttonrect)|Вызывается элементом управления списка свойств родительского определить свойство, чтобы изменить размер ограничивающего прямоугольника встроенной кнопке.|  
|[CMFCPropertyGridProperty::AdjustInPlaceEditRect](#adjustinplaceeditrect)|Получает границы текстового поля и необязательный счетчик-элемент управления, используемые для задания значения свойства.|  
|[CMFCPropertyGridProperty::AllowEdit](#allowedit)|Делает свойство для редактирования или только для чтения.|  
|[CMFCPropertyGridProperty::CreateInPlaceEdit](#createinplaceedit)|Вызывается платформой для создания элемента управления для редактирования свойства.|  
|[CMFCPropertyGridProperty::CreateSpinControl](#createspincontrol)|Вызывается платформой для создания редактируемой регулятор.|  
|[CMFCPropertyGridProperty::Enable](#enable)|Включает или отключает свойство.|  
|[CMFCPropertyGridProperty::EnableSpinControl](#enablespincontrol)|Включает или отключает регулятор, используемый для изменения значения свойства.|  
|[CMFCPropertyGridProperty::Expand](#expand)|Разворачивание или сворачивание свойство, содержащее подсвойства.|  
|[CMFCPropertyGridProperty::FormatProperty](#formatproperty)|Форматирует текстовое представление значения свойства.|  
|[CMFCPropertyGridProperty::GetData](#getdata)|Извлекает `DWORD` значение, связанное со свойством.|  
|[CMFCPropertyGridProperty::GetDescription](#getdescription)|Получает описание свойства.|  
|[CMFCPropertyGridProperty::GetExpandedSubItems](#getexpandedsubitems)|Извлекает число развернутые вложенные элементы.|  
...
|[CMFCPropertyGridProperty::GetNameTooltip](#getnametooltip)|Вызывается платформой для отображения имени свойства в виде всплывающей подсказки.|  
|[CMFCPropertyGridProperty::GetOption](#getoption)|Извлекает текст параметра, указанного с помощью индекса.|  
|[CMFCPropertyGridProperty::GetOptionCount](#getoptioncount)|Возвращает число параметров, которые принадлежат к свойству.|  
...
|[CMFCPropertyGridProperty::GetRect](#getrect)|Возвращает прямоугольник, ограничивающий свойства.|  
|[CMFCPropertyGridProperty::GetSubItem](#getsubitem)|Возвращает вложенные свойства, идентифицируемого по отсчитываемый от нуля индекс.|  
|[CMFCPropertyGridProperty::GetSubItemsCount](#getsubitemscount)|Извлекает число вложенных элементов.|  
...
|[CMFCPropertyGridProperty::GetValue](#getvalue)|Получает значение свойства.|  
|[CMFCPropertyGridProperty::GetValueTooltip](#getvaluetooltip)|Вызывается платформой для извлечения значения свойства, которое отображается во всплывающей подсказке текстовое представление.|  
|[CMFCPropertyGridProperty::HitTest](#hittest)|Указывает объект свойства, соответствующее элементу списка свойств, соответствует точке.|  
|[CMFCPropertyGridProperty::IsAllowEdit](#isallowedit)|Указывает, является ли свойство для редактирования.|  
...
|[CMFCPropertyGridProperty::IsGroup](#isgroup)|Указывает, является ли свойство current представляет группу.|  
|[CMFCPropertyGridProperty::IsInPlaceEditing](#isinplaceediting)|Указывает, является ли текущее свойство для редактирования.|  
|[CMFCPropertyGridProperty::IsModified](#ismodified)|Указывает, был ли изменен текущего свойства.|  
|[CMFCPropertyGridProperty::IsParentExpanded](#isparentexpanded)|Указывает, развернуты ли родительских элементов для текущего свойства.|  
...
|[CMFCPropertyGridProperty::OnClickName](#onclickname)|Вызывается родительским элементом управления списка свойств, когда пользователь щелкает поле имя свойства.|  
...
|[CMFCPropertyGridProperty::OnCloseCombo](#onclosecombo)|Вызывается инфраструктурой при закрытии списком, содержащийся в свойстве.|  
|[CMFCPropertyGridProperty::OnDblClk](#ondblclk)|Вызывается инфраструктурой при двойном щелчке свойство.|  
|[CMFCPropertyGridProperty::OnDrawButton](#ondrawbutton)|Вызывается платформой для отображения кнопки, содержащийся в свойстве.|  
|[CMFCPropertyGridProperty::OnDrawDescription](#ondrawdescription)|Вызывается платформой для отображения описания свойства.|  
|[CMFCPropertyGridProperty::OnDrawExpandBox](#ondrawexpandbox)|Вызывается платформой для рисования элемента развертывания поле рядом с свойство, содержащее подсвойства.|  
|[CMFCPropertyGridProperty::OnDrawName](#ondrawname)|Вызывается платформой для отображения имени свойства.|  
...
|[CMFCPropertyGridProperty::OnEndEdit](#onendedit)|Вызывается инфраструктурой при завершении пользователем изменение значения свойства.|  
|[CMFCPropertyGridProperty::OnKillSelection](#onkillselection)||  
|[CMFCPropertyGridProperty::OnPosSizeChanged](#onpossizechanged)||  
|[CMFCPropertyGridProperty::OnRClickName](#onrclickname)|Вызывается инфраструктурой при щелчке правой кнопкой мыши в области имя свойства.|  
|[CMFCPropertyGridProperty::OnRClickValue](#onrclickvalue)|Вызывается инфраструктурой при щелчке правой кнопкой мыши в области значений свойств.|  
...
|[CMFCPropertyGridProperty::OnSetCursor](#onsetcursor)|Вызывается инфраструктурой при перемещении указателя мыши на элемент свойства.|  
...
|[CMFCPropertyGridProperty::PushChar](#pushchar)|Вызывается в элементе управления списка свойств, когда выбрано свойство и пользователь вводит новый символ.|  
...
|[CMFCPropertyGridProperty::SetData](#setdata)|Связывает `DWORD` значение со свойством.|  
|[CMFCPropertyGridProperty::SetDescription](#setdescription)|Задает текст, описывающий свойство current.|  
...
|Имя|Описание|  
|----------|-----------------|  
|[CMFCPropertyGridProperty::CreateCombo](#createcombo)|Вызывается средой, чтобы добавить поле со списком к свойству.|  
|[CMFCPropertyGridProperty::HasButton](#hasbutton)|Указывает, содержит ли свойство кнопки.|  
|[CMFCPropertyGridProperty::Init](#init)|Вызывается платформой для инициализации свойств объекта.|  
|[CMFCPropertyGridProperty::IsSubItem](#issubitem)|Указывает, является ли указанное свойство является вложенным элементом текущего свойства.|  
|[CMFCPropertyGridProperty::IsValueChanged](#isvaluechanged)|Указывает, изменилось ли значение текущего свойства.|  
|[CMFCPropertyGridProperty::OnCtlColor](#onctlcolor)|Вызывается платформой, когда он должен получить кисти для заливки фона свойства.|  
|[CMFCPropertyGridProperty::OnDestroyWindow](#ondestroywindow)|Вызывается инфраструктурой при уничтожении свойство или по завершении редактирования.|  
...
## <a name="remarks"></a>Примечания  
 Используйте `CMFCPropertyGridProperty` объект для представления свойства, которое затем добавьте элемент управления списка свойств. Дополнительные сведения см. в разделе [CMFCPropertyGridCtrl класса](../../mfc/reference/cmfcpropertygridctrl-class.md).  
  
 Объект свойства может представлять типы данных, такие как строки, даты и логические или целочисленные значения. Он может содержать дочерние свойства, или он может содержать элемент управления, например поле со списком или элемент управления button.  
  
## <a name="example"></a>Пример  
 Следующий пример демонстрирует `CMFCPropertyGridProperty` объекта. В примере также показано, как использовать различные методы в `CMFCPropertyGridProperty` класса добавить вариант, добавить вложенный элемент, включить свойство и отобразить свойство. Этот пример является частью [пример создания новых элементов управления](../../visual-cpp-samples.md).  
...
### <a name="parameters"></a>Параметры  
 ...
 [in] `bInsertUnique`  
 `TRUE`Чтобы добавить в список элемент только в том случае, если он еще не существуют. в противном случае — `FALSE`. Значение по умолчанию — `TRUE`.  
  
### <a name="return-value"></a>Возвращаемое значение  
 `TRUE`, это означает, что добавляется элемент списка. В противном случае — `FALSE`, что означает, что элемент списка не добавлена, поскольку `bInsertUnique` параметр `TRUE` и указанный элемент в списке `lpszOption` параметр уже существует.  
...
### <a name="return-value"></a>Возвращаемое значение  
 `TRUE`Если указанное свойство успешно добавлен в качестве дочернего свойства. `FALSE`Если свойство не добавляются, поскольку он уже имеется свойство parent.  
  
### <a name="remarks"></a>Примечания  
 Используйте этот метод для создания иерархического списка родительских и дочерних свойств. После запуска дочерней добавляется свойство, свойство parent автоматически отображает элемента поле развертывания, который указывает знак плюс (+). Когда пользователь щелкает значок «плюс», свойство parent разворачивается и отображает свойства все дочерние элементы.  
  
##  <a name="adjustbuttonrect"></a>CMFCPropertyGridProperty::AdjustButtonRect  
 Вызывается элементом управления списка свойств родительского определить свойство, чтобы изменить размер ограничивающего прямоугольника встроенной кнопке.  
...
-   Корректирует ширину кнопки, равным Высота кнопки плюс 3 пикселя.  
  
-   Перемещает ограничивающий прямоугольник кнопки свойства к правому краю  
...
##  <a name="adjustinplaceeditrect"></a>CMFCPropertyGridProperty::AdjustInPlaceEditRect  
 Получает границы текстового поля и необязательный счетчик-элемент управления, используемые для задания значения свойства.  
...
### <a name="parameters"></a>Параметры  
 [выходной] `rectEdit`  
 При возвращении данного метода прямоугольник, который определяет границы текстового поля для значения свойства.  
  
 [выходной] `rectSpin`  
 При возвращении данного метода прямоугольник, который определяет границы регулятор для значения свойства. Или, если свойство не поддерживает счетчиком пустой прямоугольник.  
  
### <a name="remarks"></a>Примечания  
 Области значение свойства состоит из текстового поля и, возможно, *переключатель*, такие как регулятор. Этот метод вычисляет размеры кнопки и выборе параметра текст и затем возвращает эти значения в указанных параметров.  
...
### <a name="parameters"></a>Параметры  
 ...
 [in] `lpszEditMask`  
 Изменение маски, если свойство является элемент управления masked edit. Значение по умолчанию — `NULL`.  
  
 [in] `lpszEditTemplate`  
 Изменение шаблона, если свойство является элемент управления masked edit. Значение по умолчанию — `NULL`.  
...
##  <a name="createcombo"></a>CMFCPropertyGridProperty::CreateCombo  
 Вызывается средой, чтобы добавить поле со списком к свойству.  
...
### <a name="parameters"></a>Параметры  
 [in] `pWndParent`  
 Указатель на родительское окно со списком.  
  
 [in] `rect`  
 Ограничивающий прямоугольник поле со списком.  
  
### <a name="return-value"></a>Возвращаемое значение  
 Новый указатель [CComboBox](../../mfc/reference/ccombobox-class.md) объекта.  
...
### <a name="parameters"></a>Параметры  
 [in] `rectEdit`  
 Ограничивающий прямоугольник для редактирования элемента управления.  
  
 [in] `bDefaultFormat`  
 `TRUE`использовать формат свойства по умолчанию для задания текста для редактирования элемента управления; в противном случае — `FALSE`.  
  
### <a name="return-value"></a>Возвращаемое значение  
 Указатель на элемент управления для редактирования, если этот метод выполнен успешно; в противном случае — `NULL`.  
  
### <a name="remarks"></a>Примечания  
 Этот метод использует значения `varValue`, `lpszEditMask`, `lpszEditTemplate`, и `lpszValidChars` параметры, заданные в [CMFCPropertyGridProperty](../../mfc/reference/cmfcpropertygridproperty-class.md) конструктора класса. По умолчанию этот метод поддерживает `varValue` типов variant. This includes `VT_BSTR`, `VT_R4`, `VT_R8`, `VT_UI1`, `VT_I2`, `VT_INT`, `VT_UINT`, `VT_I4`, `VT_UI2`, `VT_UI4`, and `VT_BOOL`.  
  
 Этот метод создает [CMFCMaskedEdit](../../mfc/reference/cmfcmaskededit-class.md) управление, если один или несколько `lpszEditMask`, `lpszEditTemplate`, или `lpszValidChars` параметров; в противном случае создает [CEdit](../../mfc/reference/cedit-class.md) элемента управления.  
  
##  <a name="createspincontrol"></a>CMFCPropertyGridProperty::CreateSpinControl  
 Вызывается платформой для создания редактируемой регулятор.  
...
### <a name="parameters"></a>Параметры  
 [in] `rectSpin`  
 Прямоугольник, который определяет, где создается для редактирования регулятор.  
  
### <a name="return-value"></a>Возвращаемое значение  
 Указатель на новый [CMFCSpinButtonCtrl](../../mfc/reference/cmfcspinbuttonctrl-class.md) объект, который преобразуется в указатель на [CSpinButtonCtrl](../../mfc/reference/cspinbuttonctrl-class.md) объекта.  
  
### <a name="remarks"></a>Примечания  
 Вызов [CMFCPropertyGridProperty::EnableSpinControl](#enablespincontrol) метод для отображения редактируемых регулятор по правому краю свойства.  
...
### <a name="parameters"></a>Параметры  
 ...
 [in] `nMax`  
 Максимальное значение счетчик-элемент управления. Значение по умолчанию — 0.  
  
### <a name="remarks"></a>Примечания  
 Платформа автоматически создает регулятор при намерении изменить свойство.  
  
 Тип свойства, которое задается `varValue` параметр [CMFCPropertyGridProperty::CMFCPropertyGridProperty](#cmfcpropertygridproperty) конструктор, должен быть поддерживаемый тип variant. В противном случае — это метод подтверждает в режиме отладки. Поддерживаемые типы включают `VT_INT`, `VT_UINT`, `VT_I2`, `VT_I4`, `VT_UI2`, и `VT_UI4`.  
  
##  <a name="expand"></a>CMFCPropertyGridProperty::Expand  
 Разворачивание или сворачивание свойство, содержащее подсвойства.  
...
### <a name="parameters"></a>Параметры  
 [in] `bExpand`  
 `TRUE`Чтобы развернуть свойство; Значение FALSE, чтобы свернуть свойства. Значение по умолчанию — `TRUE`.  
...
### <a name="remarks"></a>Примечания  
 Этот метод вызывается инфраструктурой перед отображением значения свойства.  
...
### <a name="remarks"></a>Примечания  
 Возвращение данных имеет значение конкретного приложения, например число или указатель на другие данные. Укажите значение данных при создании свойства или при вызове [CMFCPropertyGridProperty::SetData](#setdata) метод.  
...
### <a name="remarks"></a>Примечания  
 Управления списком свойств также использует этот метод для отображения описания свойства.  
  
##  <a name="getexpandedsubitems"></a>CMFCPropertyGridProperty::GetExpandedSubItems  
 Извлекает число развернутые вложенные элементы.  
...
|Параметр|Описание|  
|---------------|-----------------|  
|[in] `bIncludeHidden`|`TRUE`Чтобы включить скрытые вложенные элементы в счетчик; в противном случае — `FALSE`. Значение по умолчанию — `TRUE`.|  
  
### <a name="return-value"></a>Возвращаемое значение  
 Количество развернутые вложенные элементы.  
...
### <a name="return-value"></a>Возвращаемое значение  
 Строка, содержащая имя свойства. По умолчанию возвращается пустая строка.  
...
### <a name="parameters"></a>Параметры  
 `nIndex`  
 Отсчитываемый от нуля индекс элемента списка свойство (параметр) для извлечения.  
...
##  <a name="getoptioncount"></a>CMFCPropertyGridProperty::GetOptionCount  
 Возвращает число параметров, которые принадлежат к свойству.  
...
### <a name="return-value"></a>Возвращаемое значение  
 Число элементов списка свойств (параметры), содержащиеся в элементе свойства.  
  
### <a name="remarks"></a>Примечания  
 Вызов [CMFCPropertyGridProperty::AddOption](#addoption) метод для добавления элементов в список свойств. Вызов [CMFCPropertyGridProperty::RemoveAllOptions](#removealloptions) метод для удаления всех элементов.  
...
### <a name="remarks"></a>Примечания  
 Этот метод можно используйте для отмены результатов операции редактирования, который изменяет значение текущего свойства.  
  
 Исходное значение текущего свойства задается [CMFCPropertyGridProperty::CMFCPropertyGridProperty](#cmfcpropertygridproperty) конструктор в изменяемом [CMFCPropertyGridProperty::SetOriginalValue](#setoriginalvalue) метод и сброс по [CMFCPropertyGridProperty::ResetOriginalValue](#resetoriginalvalue) метод.  
...
### <a name="return-value"></a>Возвращаемое значение  
 Указатель на родительский объект свойства, или `NULL` для свойства верхнего уровня.  
...
### <a name="return-value"></a>Возвращаемое значение  
 Объект [CRect](../../atl-mfc-shared/reference/crect-class.md) объект, который описывает ограничивающий прямоугольник.  
  
### <a name="remarks"></a>Примечания  
  
##  <a name="getsubitem"></a>CMFCPropertyGridProperty::GetSubItem  
 Возвращает вложенные свойства, идентифицируемого по отсчитываемый от нуля индекс.  
...
### <a name="parameters"></a>Параметры  
 [in] `nIndex`  
 Отсчитываемый от нуля индекс извлекаемого свойства. Этот параметр является недействительным, если оно меньше нуля или больше или равно числу подсвойства.  
...
### <a name="return-value"></a>Возвращаемое значение  
 ...
 В режиме retail `NULL` Если `nIndex` параметр недопустим. В режиме отладки этот метод подтверждает.  
  
### <a name="remarks"></a>Примечания  
  
##  <a name="getsubitemscount"></a>CMFCPropertyGridProperty::GetSubItemsCount  
 Извлекает число вложенных элементов.  
...
### <a name="return-value"></a>Возвращаемое значение  
 Значение типа variant, содержащее значение свойства.  
  
### <a name="remarks"></a>Примечания  
  
##  <a name="getvaluetooltip"></a>CMFCPropertyGridProperty::GetValueTooltip  
 Вызывается платформой для извлечения значения свойства, которое отображается во всплывающей подсказке текстовое представление.  
...
### <a name="return-value"></a>Возвращаемое значение  
 Объект `CString` объект, содержащий текстовое представление значения свойства. По умолчанию используется пустая строка.  
...
### <a name="return-value"></a>Возвращаемое значение  
 `TRUE`Если свойство содержит кнопки (или список свойств); в противном случае — `FALSE`.  
  
### <a name="remarks"></a>Примечания  
  
##  <a name="hittest"></a>CMFCPropertyGridProperty::HitTest  
 Указывает объект свойства, соответствующее элементу списка свойств, соответствует точке.  
...
### <a name="parameters"></a>Параметры  
 [in] `point`  
 Точка для проверки в клиентских координатах. Этот параметр обычно является текущего положения указателя мыши.  
  
 [in] `pt`  
 Точка для проверки в клиентских координатах.  
  
 [выходной] `pnArea`  
 При возвращении данного метода, указывает область, которая содержит заданную точку. Дополнительные сведения см. в разделе "Замечания". Значение по умолчанию — `NULL`.  
  
 [in] `bPropsOnly`  
 `TRUE`Чтобы проверить любой области в свойство элемента управления; `FALSE` для проверки только в области описания. Значение по умолчанию — `FALSE`.  
  
### <a name="return-value"></a>Возвращаемое значение  
 Указатель на объект свойства или `NULL`.  
  
### <a name="remarks"></a>Примечания  
 По умолчанию этот метод проверяет свойство вложенные элементы, если заданная точка не найден в любой из элементов свойства.  
  
 В следующей таблице перечислены значения, которые могут быть возвращены в `pnArea` параметр.  
...
##  <a name="init"></a>CMFCPropertyGridProperty::Init  
 Вызывается платформой для инициализации свойств объекта.  
...
##  <a name="isgroup"></a>CMFCPropertyGridProperty::IsGroup  
 Указывает, является ли свойство current представляет группу.  
...
### <a name="return-value"></a>Возвращаемое значение  
 `TRUE`Если текущее свойство доступно для редактирования; в противном случае — `FALSE`.  
...
##  <a name="isparentexpanded"></a>CMFCPropertyGridProperty::IsParentExpanded  
 Указывает, развернуты ли родительских элементов для текущего свойства.  
...
### <a name="return-value"></a>Возвращаемое значение  
 `TRUE`Если развернуты все родительские объекты для текущего свойства; `FALSE` Если свернуты свойства родительского объекта.  
...
##  <a name="issubitem"></a>CMFCPropertyGridProperty::IsSubItem  
 Указывает, является ли указанное свойство является вложенным элементом текущего свойства.  
...
### <a name="return-value"></a>Возвращаемое значение  
 `TRUE`Если указанный мыши сообщение обрабатывается методом; в противном случае — `FALSE`.  
  
### <a name="remarks"></a>Примечания  
 По умолчанию этот метод возвращает `FALSE` , если свойство current, недоступен для изменения. В противном случае, редактирования или счетчика, который связан с этим свойством обрабатывает сообщение мыши, и этот метод возвращает `TRUE`.  
  
##  <a name="onclosecombo"></a>CMFCPropertyGridProperty::OnCloseCombo  
 Вызывается инфраструктурой при закрытии списком, содержащийся в свойстве.  
...
##  <a name="onctlcolor"></a>CMFCPropertyGridProperty::OnCtlColor  
 Вызывается платформой, когда он должен получить кисти для заливки фона свойства.  
...
### <a name="return-value"></a>Возвращаемое значение  
 Дескриптор кисти, если этот метод выполнен успешно; в противном случае — `NULL`.  
  
### <a name="remarks"></a>Примечания  
  
##  <a name="ondblclk"></a>CMFCPropertyGridProperty::OnDblClk  
 Вызывается инфраструктурой при двойном щелчке свойство.  
...
##  <a name="ondestroywindow"></a>CMFCPropertyGridProperty::OnDestroyWindow  
 Вызывается инфраструктурой при уничтожении свойство или по завершении редактирования.  
...
### <a name="parameters"></a>Параметры  
 ...
 [in] `rectButton`  
 Ограничивающий прямоугольник, который определяет, где для отображения кнопки.  
  
### <a name="remarks"></a>Примечания  
  
##  <a name="ondrawdescription"></a>CMFCPropertyGridProperty::OnDrawDescription  
 Вызывается платформой для рисования описание свойства.  
...
### <a name="parameters"></a>Параметры  
 ...
 [in] `rect`  
 Ограничивающий прямоугольник, который определяет, где рисовать описание свойства.  
...
##  <a name="ondrawexpandbox"></a>CMFCPropertyGridProperty::OnDrawExpandBox  
 Вызывается платформой для рисования элемента развертывания поле рядом с свойство, содержащее подсвойства.  
...
### <a name="parameters"></a>Параметры  
 ...
 [in] `rectExpand`  
 Ограничивающий прямоугольник, указывающий, куда для рисования элемента управления полем развертывания.  
  
### <a name="remarks"></a>Примечания  
 Щелкните поле элемента развертывания, чтобы развернуть или свернуть список вложенных свойств. Элемент управления полем развернуть обозначается квадрат, который содержит знак «плюс» (+) или минус (-). Плюс указывает, что свойство может быть расширено для отображения списка подсвойства. Знак «минус» указывает, что список можно свернуть, чтобы отобразить только свойство.  
...
### <a name="parameters"></a>Параметры  
 ...
 [in] `rect`  
 Ограничивающий прямоугольник, который определяет, где рисовать имя свойства.  
...
### <a name="parameters"></a>Параметры  
 ...
 [in] `rect`  
 Ограничивающий прямоугольник, указывающий, куда извлекается значение свойства.  
...
##  <a name="onendedit"></a>CMFCPropertyGridProperty::OnEndEdit  
 Вызывается инфраструктурой при завершении пользователем изменение значения свойства.  
...
##  <a name="onrclickname"></a>CMFCPropertyGridProperty::OnRClickName  
 Вызывается инфраструктурой при щелчке правой кнопкой мыши в области имя свойства.  
...
##  <a name="onrclickvalue"></a>CMFCPropertyGridProperty::OnRClickValue  
 Вызывается инфраструктурой при щелчке правой кнопкой мыши в области значений свойств.  
...
### <a name="remarks"></a>Примечания  
 По умолчанию этот метод не выполняет никаких действий и `B` параметр не имеет предопределенные смысла.  
...
##  <a name="onsetcursor"></a>CMFCPropertyGridProperty::OnSetCursor  
 Вызывается инфраструктурой при перемещении указателя мыши на элемент свойства.  
...
### <a name="return-value"></a>Возвращаемое значение  
 `TRUE`Если текущее свойство типа variant или список значений, и этот метод загружает успешно курсор мыши вставки точки (i-образный); в противном случае — `FALSE`.  
...
##  <a name="pushchar"></a>CMFCPropertyGridProperty::PushChar  
 Вызывается в элементе управления списка свойств, когда выбрано свойство и пользователь вводит новый символ.  
...
### <a name="return-value"></a>Возвращаемое значение  
 `TRUE`Если операция редактирования продолжить; в противном случае — `FALSE`.  
...
### <a name="remarks"></a>Примечания  
 Укажите `FALSE` для `bDelete` параметр, если планируется переместить указанный вложенный элемент; то есть, удалить вложенный элемент и добавьте его в другом месте.  
...
### <a name="parameters"></a>Параметры  
 [in] `dwData`  
 Значение 32-разрядные приложения, например целое число или указатель на другие данные.  
...
##  <a name="setdescription"></a>CMFCPropertyGridProperty::SetDescription  
 Задает текст, описывающий свойство current.  
...
### <a name="parameters"></a>Параметры  
 [in] `strDescr`  
 Текст, описывающий свойство current.  
...
### <a name="parameters"></a>Параметры  
 [in] `bShow`  
 `TRUE`Чтобы отобразить текущее свойство и его вложенных элементов; `FALSE` , чтобы скрыть свойство current и его вложенные элементы. Значение по умолчанию — `TRUE`.  
  
 [in] `bAdjustLayout`  
 `TRUE`Пересчитать как нарисуйте метку и значение свойства, а затем свойство; `FALSE` использование существующих вычислений для рисования свойство. Значение по умолчанию — `TRUE`.  
