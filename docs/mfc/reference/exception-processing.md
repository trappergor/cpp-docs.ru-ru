...
### <a name="remarks"></a>Примечания  
 Версия, принимающая `HRESULT` как аргумент, код результата преобразует в соответствующий `SCODE`. Дополнительные сведения о `HRESULT` и `SCODE`, в разделе [структуры из кодов ошибок модели COM](http://msdn.microsoft.com/library/windows/desktop/ms690088) в [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Примечания  
 ...
 Сведения о **RETCODE** значения, определенном ODBC см «Получение состояния и сведения об ошибке,» в [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)]. Дополнительные сведения о MFC в этих кодов см. класс [CDBException](../../mfc/reference/cdbexception-class.md).  
