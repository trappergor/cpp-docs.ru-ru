...
В приведенном ниже примере демонстрируется использование различных методов класса `CMFCListCtrl` . В примере показано создание элемента управления списка, Вставка столбцов, вставлять элементы, задайте текст элемента и задание шрифта элемента управления списком. Этот фрагмент кода является частью [Visual Studio демонстрационного](../../overview/visual-cpp-samples.md).
...
*bMark*<br/>
[in] Логический параметр, который определяет, следует ли включить другой цвет фона.

*bRedraw*<br/>
[in] Логический параметр, который определяет, следует ли немедленно перерисовки элемента управления.
...
*iColumn*<br/>
[in] Индекс столбца, который этот метод является сортировка.
...
*nRow*<br/>
[in] Строка рассматриваемой ячейки.
...
*dwData*<br/>
[in] Определяемые пользователем данные. Реализация по умолчанию этот параметр не используется.
...
*bAdd*<br/>
[in] Логическое значение, указывающее, является ли этот метод добавляет столбец, указанный параметром *iColumn* в список столбцов сортировки.
