...
### <a name="requirements"></a>Требования  
  **Заголовок** afxdao.h  
  ...
  ## <a name="nameddxfieldslidera--ddxfieldslider"></a>Имя = «ddx_fieldslider» настроек</a> DDX_FieldSlider
