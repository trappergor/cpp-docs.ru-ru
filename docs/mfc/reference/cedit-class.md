...
### <a name="remarks"></a>Примечания  
 ...
 Этот метод отправляет [EM_GETPASSWORDCHAR](http://msdn.microsoft.com/library/windows/desktop/bb761594) сообщение, которое описано в [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
