...
##  <a name="dragenter"></a>  CImageList::DragEnter  
 При выполнении операции перетаскивания блокировки обновления окном, заданным параметром *pWndLock* и отображает изображение перетаскивания в позиции, указанной параметром *точки*.  
