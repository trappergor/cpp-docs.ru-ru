...
### <a name="parameters"></a>Параметры  
 ...
 Идентификатор списка маленьких изображений для категорию ленты.  
  
 [in] *uiLargeImagesResID*  
 Идентификатор ресурса для списка больших изображений для категорию ленты.  
  
 [in] *sizeSmallImage*  
 Задает размер изображений небольшого размера для категорию ленты.  
  
 [in] *sizeLargeImage*  
 Указывает размер больших изображений для категорию ленты.  
  
 [in] *nInsertAt*  
 Отсчитываемый от нуля индекс расположения категории.  
  
 [in] *pRTI*  
 Указатель на [класс CMFCRibbonCategory](../../mfc/reference/cmfcribboncategory-class.md) класс времени выполнения, чтобы динамически создать категорию ленты во время выполнения.  
...
### <a name="parameters"></a>Параметры  
 ...
 [in] *uiSmallImagesResID*  
 Идентификатор ресурса небольшое изображение категорию контекста.  
...
### <a name="parameters"></a>Параметры  
 ...
 [in] *uiSmallImagesResID*  
 Идентификатор ресурса для изображений небольшого размера.  
...
### <a name="parameters"></a>Параметры  
 ...
 Значение TRUE для панели ленты заменить заголовок окна главного фрейма; Значение FALSE, чтобы найти панель ленты в группе заголовок главного фрейма окна.  
...
### <a name="parameters"></a>Параметры  
 [in] *bSetFocus*  
 Значение TRUE, чтобы установить фокус на родительское окно панели ленты.  
...
### <a name="parameters"></a>Параметры  
 ...
 [in] *rectImage*  
 Прямоугольник отображаемого для кнопки меню.  
...
### <a name="parameters"></a>Параметры  
 [in] *bEnable*  
 Значение TRUE, чтобы включить функцию подсказки клавиш; Значение FALSE, чтобы отключить функцию Ключевые подсказки.  
...
### <a name="parameters"></a>Параметры  
 [in] *bEnable*  
 True, чтобы включить **Предварительный просмотр печати** компонентов; Значение FALSE, чтобы отключить **Предварительный просмотр печати** функции.  
...
### <a name="parameters"></a>Параметры  
 [in] *bEnable*  
 Значение TRUE, чтобы включить подсказки на панели ленты; Значение FALSE, чтобы отключить всплывающие подсказки на панели ленты.  
  
 [in] *bEnableDescr*  
 Значение TRUE, чтобы включить всплывающие описания на подсказку; Значение FALSE, чтобы отключить всплывающие описания на всплывающей подсказки.  
...
### <a name="parameters"></a>Параметры  
 ...
 [in] *bVisibleOnly*  
 Значение TRUE для поиска элементов видимым ленты. Значение FALSE, если для поиска всех элементов ленты.  
...
### <a name="parameters"></a>Параметры  
 ...
 [in] *bExcludeQAT*  
 Значение TRUE, чтобы исключить элементы панели инструментов быстрого доступа из поиска; в противном случае — значение FALSE.  
...
### <a name="parameters"></a>Параметры  
 [in] *nIndex*  
 Отсчитываемый от нуля индекс категории ленты в списке категорий ленты, содержащийся в панели ленты.  
...
### <a name="remarks"></a>Примечания  
 ...
 Лента свернута по вертикали и отображаются только вкладки категории, главной кнопки и панель быстрого доступа.  
...
### <a name="parameters"></a>Параметры  
 ...
 [in] *bHiddenOnly*  
 Значение TRUE, чтобы исключить элементы ленты, которые отображаются. Значение FALSE означает, что для включения всех элементов ленты в панели ленты.  
...
### <a name="return-value"></a>Возвращаемое значение  
 ...
 0  
 Отображаются подсказки клавиш.  
  
 1  
 Пользователь нажал отображаемых край подсказки клавиши.  
...
### <a name="parameters"></a>Параметры  
 ...
 Значение TRUE для поиска в активную категорию; Значение FALSE означает, что не следует выполнять поиск активной категории.  
  
 [in] *bCheckPanelCaption*  
 Значение TRUE, чтобы проверить заголовок панели ленты с точки, находящейся в ней; Значение FALSE, не для того, чтобы проверить заголовок панели ленты с точки, находящейся в нем. Дополнительные сведения см. в разделе "Примечания".  
...
### <a name="parameters"></a>Параметры  
 [in] *pFrameWnd*  
 Указатель на родительское окно главного фрейма панели ленты.  
  
 [in] *wParam*  
 Виртуальному коду клавиши нажатия клавиши.  
...
### <a name="parameters"></a>Параметры  
 ...
 [in] *wParam*  
 Виртуальному коду клавиши освобождаемой ключа.  
...
### <a name="parameters"></a>Параметры  
 [in] *nIndex*  
 Отсчитываемый от нуля индекс категории в списке категорий ленты, содержащийся в панели ленты.  
...
### <a name="parameters"></a>Параметры  
 [in] *pCategory*  
 Категории ленты, содержащийся в панели ленты.  
  
 [in] *bForceRestore*  
 Значение TRUE, чтобы развернуть панель ленты, если он свернут; Значение FALSE означает, что для отображения активной категории во всплывающем окне, если лента свернута.  
...
### <a name="parameters"></a>Параметры  
 [in] *pWnd*  
 Указатель на дочернего окна MDI.  
...
### <a name="parameters"></a>Параметры  
 ...
 [in] *bSetFocus*  
 Значение TRUE, чтобы установить фокус клавиатуры на панель ленты.  
...
### <a name="parameters"></a>Параметры  
 [in] *bMax*  
 Значение TRUE для отображения кнопок системы для дочернего окна MDI на ленте; Значение FALSE, чтобы удалять кнопки системы для дочернего окна MDI из панели ленты.  
  
 [in] *pWnd*  
 Указатель фрейма главного окна для панели ленты.  
...
### <a name="parameters"></a>Параметры  
 [in] *lstCommands*  
 Список команд, которые размещаются на панели быстрого доступа.  
  
 [in] *bRecalcLayout*  
 Значение TRUE, если необходимо перерисовывать ленты, после добавления элементов ленты; Значение FALSE в противном случае.  
...
### <a name="parameters"></a>Параметры  
 [in] *bOnTop*  
 Значение TRUE, чтобы изменить расположение панели инструментов быстрого доступа над панелью ленты; Значение FALSE, чтобы изменить расположение панели инструментов быстрого доступа ниже панели ленты.  
...
### <a name="parameters"></a>Параметры  
 [in] *nWidthRegular*  
 Ширина в пикселях регулярных фиксированной подсказки по размеру.  
...
### <a name="parameters"></a>Параметры  
 ...
 [in] *bShow*  
 Значение TRUE, если Показать категории ленты; в противном случае скрывайте категорию ленты.  
...
### <a name="parameters"></a>Параметры  
 ...
 [in] *bShow*  
 Значение TRUE, если Показать категории, которые имеют указанный идентификатор. в противном случае скрыть категории с указанным идентификатором.  
...
### <a name="parameters"></a>Параметры  
 [in] *nChar*  
 Код знака регистрации нажатия клавиш пользователем.  
