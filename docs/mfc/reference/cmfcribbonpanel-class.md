...
### <a name="parameters"></a>Параметры  
 ...
 [in] *uiColdResID*  
 Указывает идентификатор ресурса панели инструментов "холодных" изображений.  
  
 [in] *uiHotResID*  
 Указывает идентификатор ресурса панели инструментов наиболее часто используемыми изображениями.  
  
 [in] *uiDisabledResID*  
 Указывает идентификатор ресурса для отключенного изображения панели инструментов.  
...
### <a name="parameters"></a>Параметры  
 ...
 [in] *pPaletteButton*  
 Указатель на коллекции лент для панели ленты.  
...
### <a name="parameters"></a>Параметры  
 [out] *arElements*  
 Массив для заполнения всех элементов ленты, которые содержатся в панель ленты.  
...
### <a name="parameters"></a>Параметры  
 [out] *lstItems*  
 Список идентификаторов команд для элементов ленты, которые содержатся в панель ленты.  
...
### <a name="return-value"></a>Возвращаемое значение  
 Указатель на категорию ленты, содержащий этот панель ленты.  
...
### <a name="parameters"></a>Параметры  
 [in] *bHighlight*  
 Значение TRUE, чтобы выделить панель ленты. Значение FALSE, чтобы unhighlight панель ленты.  
...
### <a name="parameters"></a>Параметры  
 ...
 Значение TRUE, чтобы проверить заголовок панели ленты; в противном случае — значение FALSE.  
...
### <a name="parameters"></a>Параметры  
 ...
 [in] *nIndex*  
 Отсчитываемый от нуля значение от -1 до числа элементов ленты, которые содержатся в массиве.  
...
### <a name="parameters"></a>Параметры  
 [in] *nIndex*  
 Указывает отсчитываемый от нуля индекс, куда вставляется разделитель.  
...
##  <a name="ismainpanel"></a>  CMFCRibbonPanel::IsMainPanel  
 Указывает, является ли панель ленты на панели основных ленты.  
...
### <a name="parameters"></a>Параметры  
 [in] *nIndex*  
 Указывает отсчитываемый от нуля индекс элемента, который будет удален из панели ленты.  
  
 [in] *bDelete*  
 Значение TRUE, чтобы удалить элемент удаления; в противном случае — значение FALSE.  
...
### <a name="parameters"></a>Параметры  
 [in] *nIndex*  
 Указывает отсчитываемый от нуля индекс заменяемого элемента.  
  
 [in] [out] *pElem*  
 Допустимый указатель на элемент, который заменяет исходный элемент.  
...
### <a name="parameters"></a>Параметры  
 [in] *bSet*  
 Значение TRUE, чтобы центрировать по вертикали позиций элементов ленты в прямоугольник их отображения; Значение FALSE, чтобы отключить эту функцию.  
...
### <a name="parameters"></a>Параметры  
 [in] *dwData*  
 Задает определяемые пользователем данные для задания.  
...
### <a name="parameters"></a>Параметры  
 [in] *nIndex*  
 Указывает отсчитываемый от нуля индекс элемента ленты.  
...
### <a name="parameters"></a>Параметры  
 ...
 [in] [out] *pRTC*  
 Указатель на сведения о классе среды выполнения, связанный с элементом ленты, который добавляется на панель ленты.  
...
### <a name="parameters"></a>Параметры  
 [in] *bSet*  
 Значение TRUE, чтобы настроить ширину элементов ленты в одном столбце на ширину самого большого элемента ленты в столбце; Значение FALSE, чтобы отключить это изменение ширины.  
...
### <a name="parameters"></a>Параметры  
 [in] *lpszKeys*  
 Подсказки клавиши для кнопки по умолчанию на панели ленты.  
...
### <a name="remarks"></a>Примечания  
 Во всплывающем меню для панели ленты доступен только при сворачивании отображение панели ленты.  
