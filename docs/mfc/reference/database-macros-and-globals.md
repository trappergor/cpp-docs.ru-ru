...
### <a name="remarks"></a>Примечания  
 ...
 Перед вызовом `AFX_ODBC_CALL`, необходимо объявить переменную, `nRetCode`, RETCODE типа.  
...
### <a name="remarks"></a>Примечания  
 ...
 Перед вызовом метода `AFX_SQL_SYNC`, необходимо объявить переменную, `nRetCode`, RETCODE типа. Можно проверить значение `nRetCode` после вызова макроса.  
