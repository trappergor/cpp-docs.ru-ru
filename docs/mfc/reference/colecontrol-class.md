...
*pRect*<br/>
Указывает на [RECTL](/previous-versions/dd162907\(v=vs.85\)) структура прямоугольника, в котором должен быть нарисован объект. Этот параметр определяет расположение и Растягивание объекта.
