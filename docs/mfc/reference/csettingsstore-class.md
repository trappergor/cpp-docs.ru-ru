...
### <a name="parameters"></a>Параметры  
 ...
 [in] *bAdmin*  
 Переключатель, указывающий расположение удаляемого раздела.  
...
### <a name="parameters"></a>Параметры  
 [in] *pszKey*  
 Указатель на заканчивающуюся нулем строку, содержащую имя значения, которое необходимо считать из реестра.  
  
 [out] *iVal*  
 Ссылка на переменную integer, который получает значение, считанное из реестра.  
  
 [out] *dwVal*  
 Ссылка на переменную 32-разрядных двойное слово, который получает значение, считанное из реестра.  
 ...
 [out] *dwcArray*  
 Ссылка на переменную массива 32-разрядных двойное слово, который получает значение, считанное из реестра.  
  
 [out] *wcArray*  
 Ссылка на переменную массива 16-разрядное слово, который получает значение, считанное из реестра.  
  
 [out] *bcArray*  
 Ссылка на переменную массива байтов, которая получает значение, считанное из реестра.  
  
 [out] *lpPoint*  
 Ссылка на указатель на `POINT` структуры, который получает значение, чтение из реестра.  
  
 [out] *rect*  
 Ссылка на [CRect](../../atl-mfc-shared/reference/crect-class.md) переменную, которая получает значение, чтение из реестра.  
  
 [out] *ppData*  
 Указатель на указатель на данные, который получает значение, чтение из реестра.  
  
 [out] *pBytes*  
 Указатель на переменную целого числа без знака. Эта переменная принимает размер буфера, *ppData* указывает.  
  
 [out] *списка*  
 Ссылка на [CObList](../../mfc/reference/coblist-class.md) переменную, которая получает значение, чтение из реестра.  
  
 [out] *obj*  
 Ссылка на [CObject](../../mfc/reference/cobject-class.md) переменную, которая получает значение, чтение из реестра.  
  
 [out] *pObj*  
 Ссылка на указатель на `CObject` переменную, которая получает значение, чтение из реестра.  
...
### <a name="parameters"></a>Параметры  
 [in] *pszKey*  
 Указатель на строку, содержащую имя присваиваемое значение.  
  
 [in] *iVal*  
 Ссылка на целочисленную переменную, содержащий сохраняемые данные.  
  
 [in] *dwVal*  
 Ссылка на переменную 32-разрядных двойное слово, которая содержит сохраняемые данные.  
  
 [in] *pszVal*  
 Указатель на переменную заканчивающуюся нулем строку, содержащую данные для хранения.  
  
 [in] *scStringList*  
 Ссылка на [CStringList](../../mfc/reference/cstringlist-class.md) переменную, содержащую данные для хранения.  
  
 [in] *bcArray*  
 Ссылка на переменную массива байтов, содержащий сохраняемые данные.  
  
 [in] *scArray*  
 Ссылка на строковую переменную массива, содержащий сохраняемые данные.  
  
 [in] *dwcArray*  
 Ссылка на переменную массива 32-разрядных двойное слово, которая содержит сохраняемые данные.  
  
 [in] *wcArray*  
 Ссылка на переменную массива 16-разрядное слово, которая содержит сохраняемые данные.  
  
 [in] *rect*  
 Ссылка на [CRect](../../atl-mfc-shared/reference/crect-class.md) переменную, содержащую данные для хранения.  
  
 [in] *lpPoint*  
 Ссылка на указатель на `POINT` переменную, содержащую данные для хранения.  
  
 [in] *pData*  
 Указатель на буфер, который содержит сохраняемые данные.  
  
 [in] *nBytes*  
 Указывает размер в байтах данных, к которому *pData* указывает параметр.  
  
 [in] *списка*  
 Ссылка на [CObList](../../mfc/reference/coblist-class.md) переменную, содержащую данные для хранения.  
  
 [in] *obj*  
 Ссылка на [CObject](../../mfc/reference/cobject-class.md) переменную, содержащую данные для хранения.  
  
 [in] *pObj*  
 Указатель на указатель на `CObject` переменную, содержащую данные для хранения.  
