...
## <a name="remarks"></a>Примечания  
 После создания гиперссылки, добавьте его в панель путем вызова [CMFCRibbonPanel::Add](../../mfc/reference/cmfcribbonpanel-class.md#add).  
...
### <a name="parameters"></a>Параметры  
 [in] `nID`  
 Указывает команду, которая выполняется при щелчке элемента управления ссылки идентификатор команды.  
  
 [in] `lpszText`  
 Указывает метку для отображения элемента управления ссылки.  
  
 [in] `lpszLink`  
 Определяет гиперссылку, связанную с элементом управления link.  
  
### <a name="example"></a>Пример  
 Следующий пример демонстрирует использование конструктора `CMFCRibbonLinkCtrl` класса. Этот фрагмент кода является частью [пример мини-приложения ленты](../../visual-cpp-samples.md).  
...
### <a name="return-value"></a>Возвращаемое значение  
 `TRUE`Если соответствующая веб-страница была открыта успешно; в противном случае — `FALSE`.  
