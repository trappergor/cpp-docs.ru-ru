---
title: Класс CToolBarCtrl | Документация Майкрософт
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
4.  Добавьте структур кнопки панели инструментов, вызвав метод [AddButtons](#addbuttons).  
...
6.  Если требуется, чтобы пользователь имел возможность настроить панель инструментов, обрабатывать настройки уведомляющих сообщений в окно-владелец, как описано в разделе [обработка уведомлений о настройке](../../mfc/handling-customization-notifications.md).  
...
### <a name="parameters"></a>Параметры  
 [in] *nID*  
 Идентификатор команды нажатии и отпускании кнопки.  
  
 [in] *bPress*  
 Значение TRUE, чтобы нажмите указанную кнопку; Значение FALSE, чтобы освободить указанную кнопку. Значение по умолчанию — TRUE.  
...
### <a name="parameters"></a>Параметры  
 [in] *fAnchor*  
 Указывает, если выделение привязки включен или отключен. Если это значение имеет ненулевое значение, выделение привязка включена. Если это значение равно нулю, выделение привязки к отключении  
