...
|Name|Описание|
|----------|-----------------|
|[CTreeCtrl:: Create](#create)|Создает элемент управления иерархического представления и присоединяет его к объекту `CTreeCtrl`.|
...
|[CTreeCtrl:: Креатикс](#createex)|Создает элемент управления "дерево" с указанными расширенными стилями Windows и прикрепляет его к объекту `CTreeCtrl`.|
...
|[CTreeCtrl::GetCount](#getcount)|Возвращает число элементов дерева, связанных с элементом управления иерархического представления.|
|[CTreeCtrl::GetDropHilightItem](#getdrophilightitem)|Извлекает целевой объект операции перетаскивания.|
|[CTreeCtrl::GetEditControl](#geteditcontrol)|Получает маркер элемента управления "поле ввода", используемый для изменения указанного элемента представления в виде дерева.|
|[CTreeCtrl::GetExtendedStyle](#getextendedstyle)|Извлекает расширенные стили, которые использует текущий элемент управления "дерево-представление".|
...
|[CTreeCtrl::GetImageList](#getimagelist)|Извлекает маркер списка изображений, связанный с элементом управления иерархического представления.|
|[CTreeCtrl::GetIndent](#getindent)|Получает смещение (в пикселях) элемента представления в виде дерева от его родителя.|
...
|[CTreeCtrl::GetItem](#getitem)|Извлекает атрибуты указанного элемента представления в виде дерева.|
|[CTreeCtrl:: Жетитемдата](#getitemdata)|Возвращает зависящее от приложения значение, связанное с элементом.|
|[CTreeCtrl::GetItemExpandedImageIndex](#getitemexpandedimageindex)|Получает индекс изображения, отображаемого, когда указанный элемент текущего элемента управления "дерево" находится в развернутом состоянии.|
...
|[CTreeCtrl::GetItemRect](#getitemrect)|Извлекает ограничивающий прямоугольник элемента представления в виде дерева.|
|[CTreeCtrl::GetItemState](#getitemstate)|Возвращает состояние элемента.|
|[CTreeCtrl::GetItemStateEx](#getitemstateex)|Получает Расширенное состояние указанного элемента в текущем элементе управления "дерево-представление".|
...
|[CTreeCtrl::GetNextItem](#getnextitem)|Извлекает следующий элемент древовидного представления, соответствующий указанной связи.|
|[CTreeCtrl::GetNextSiblingItem](#getnextsiblingitem)|Извлекает следующий элемент того же уровня для указанного элемента представления в виде дерева.|
...
|[CTreeCtrl::GetRootItem](#getrootitem)|Возвращает корень указанного элемента представления в виде дерева.|
...
|[CTreeCtrl::GetSelectedCount](#getselectedcount)|Извлекает число выбранных элементов в текущем элементе управления "дерево-представление".|
...
|[CTreeCtrl::GetVisibleCount](#getvisiblecount)|Возвращает число видимых элементов дерева, связанных с элементом управления иерархического представления.|
|[CTreeCtrl::HitTest](#hittest)|Возвращает текущую позицию курсора, связанную с объектом `CTreeCtrl`.|
...
|[CTreeCtrl::SetExtendedStyle](#setextendedstyle)|Задает расширенные стили для текущего элемента управления "дерево-представление".|
|[CTreeCtrl::SetImageList](#setimagelist)|Задает маркер списка изображений, связанный с элементом управления иерархического представления.|
|[CTreeCtrl::SetIndent](#setindent)|Задает смещение (в пикселях) элемента представления в виде дерева от его родителя.|
|[CTreeCtrl::SetInsertMark](#setinsertmark)|Задает метку вставки в элементе управления иерархического представления.|
...
|[CTreeCtrl::SetItem](#setitem)|Задает атрибуты указанного элемента древовидного представления.|
|[CTreeCtrl::SetItemData](#setitemdata)|Задает зависящее от приложения значение, связанное с элементом.|
|[CTreeCtrl::SetItemExpandedImageIndex](#setitemexpandedimageindex)|Задает индекс изображения, отображаемого, когда указанный элемент текущего элемента управления "представление дерева" находится в развернутом состоянии.|
|[CTreeCtrl::SetItemHeight](#setitemheight)|Задает высоту элементов представления в виде дерева.|
|[CTreeCtrl::SetItemImage](#setitemimage)|Связывает изображения с элементом.|
|[CTreeCtrl::SetItemState](#setitemstate)|Задает состояние элемента.|
|[CTreeCtrl::SetItemStateEx](#setitemstateex)|Задает расширенное состояние указанного элемента в текущем элементе управления "дерево-представление".|
...
|[CTreeCtrl::ShowInfoTip](#showinfotip)|Отображает всплывающую подсказку для указанного элемента в текущем элементе управления "дерево-представление".|
...
Этот элемент управления (и, следовательно, класс `CTreeCtrl`) доступен только для программ, работающих под управлением Windows 98 и Windows NT версии 4 и более поздних версий.

Дополнительные сведения об использовании `CTreeCtrl`см. в следующих статьях:
...
*rect*<br/>
Задает размер и расположение элемента управления иерархического представления. Это может быть либо объект [крект](../../atl-mfc-shared/reference/crect-class.md) , либо структура [Rect](/previous-versions/dd162897\(v=vs.85\)) .
...
Если вы хотите создать элемент управления "дерево" как дочернее окно другого окна, используйте функцию-член `Create`. При создании элемента управления "дерево" с помощью `Create`необходимо передать его WS_VISIBLE в дополнение к другим стилям представления дерева.

Создание `CTreeCtrl` выполняется в два этапа. Сначала вызовите конструктор, а затем вызовите `Create`, который создает элемент управления иерархического представления и присоединяет его к объекту `CTreeCtrl`.
...
##  <a name="createex"></a>CTreeCtrl:: Креатикс

Вызовите эту функцию, чтобы создать элемент управления (дочернее окно) и связать его с объектом `CTreeCtrl`.
...
##  <a name="createdragimage"></a>CTreeCtrl:: Креатедрагимаже
...
Объект `CImageList` является постоянным, и его необходимо удалить по завершении. Например:
...
##  <a name="deleteallitems"></a>CTreeCtrl::D Елетеаллитемс
...
##  <a name="deleteitem"></a>CTreeCtrl::D Елетеитем
...
##  <a name="editlabel"></a>CTreeCtrl:: Едитлабел
...
##  <a name="endeditlabelnow"></a>CTreeCtrl:: Ендедитлабелнов
...
|Параметр|Описание|
|---------------|-----------------|
|*фканцелвисаутсаве*|окне Значение TRUE, чтобы отменить изменения в элементе представления дерева перед завершением операции изменения или FALSE, чтобы сохранить изменения в элементе представления дерева перед завершением операции.|
...
##  <a name="ensurevisible"></a>CTreeCtrl:: Енсуревисибле
...
##  <a name="getbkcolor"></a>CTreeCtrl:: Жетбкколор
...
Значение COLORREF, представляющее цвет фона текущего окна для элемента управления. Если это значение равно-1, то элемент управления использует цвет системного окна. В этом случае можно использовать `::GetSysColor(COLOR_WINDOW)`, чтобы получить текущий цвет системы, используемый элементом управления.

### <a name="example"></a>Пример

  См. пример для [CTreeCtrl:: сеттекстколор](#settextcolor).

##  <a name="getcheck"></a>CTreeCtrl:: Check
...
##  <a name="getchilditem"></a>CTreeCtrl:: Жетчилдитем
...
##  <a name="getcount"></a>CTreeCtrl:: NOCOUNT
...
##  <a name="getdrophilightitem"></a>CTreeCtrl:: Жетдрофилигхтитем
...
##  <a name="geteditcontrol"></a>CTreeCtrl:: Жетедитконтрол
...
##  <a name="getextendedstyle"></a>CTreeCtrl:: Жетекстендедстиле
...
##  <a name="getfirstvisibleitem"></a>CTreeCtrl:: Жетфирствисиблеитем
...
##  <a name="getimagelist"></a>CTreeCtrl::/ImageList
...
##  <a name="getindent"></a>CTreeCtrl:: Indent
...
##  <a name="getinsertmarkcolor"></a>CTreeCtrl:: Жетинсертмаркколор
...
##  <a name="getitem"></a>CTreeCtrl:: DataItem
...
##  <a name="getitemdata"></a>CTreeCtrl:: Жетитемдата
...
##  <a name="getitemexpandedimageindex"></a>CTreeCtrl:: Жетитемекспандедимажеиндекс
...
|Параметр|Описание|
|---------------|-----------------|
|*хитем*|окне Обработчик элемента управления древовидного представления.|
...
##  <a name="getitempartrect"></a>CTreeCtrl:: Жетитемпартрект
...
|---------------|-----------------|
|*хитем*|окне Обработчик элемента управления древовидного представления.|
|*нпарт*|окне Идентификатор части. Необходимо задать значение TVGIPR_BUTTON.|
|*лпрект*|заполняет Указатель на структуру [Rect](/previous-versions/dd162897\(v=vs.85\)) . Если этот метод выполнен успешно, структура получает координаты прямоугольника части, указанной в *хитем* и *нпарт*.|
...
##  <a name="getitemrect"></a>CTreeCtrl:: Жетитемрект
...
*лпрект*<br/>
Указатель на структуру [Rect](/previous-versions/dd162897\(v=vs.85\)) , которая получает ограничивающий прямоугольник. Координаты задаются относительно левого верхнего угла элемента управления иерархического представления.
...
##  <a name="getitemstate"></a>CTreeCtrl:: Жетитемстате
...
*нстатемаск*<br/>
Маска, указывающая одно или несколько состояний для извлечения. Дополнительные сведения о возможных значениях для *нстатемаск*см. в обсуждении `state` и `stateMask` элементов структуры [твитем](/windows/win32/api/commctrl/ns-commctrl-tvitemw) в Windows SDK.
...
Расширенное состояние элемента. Дополнительные сведения см. в описании `uStateEx` элемента структуры [твитемекс](/windows/win32/api/commctrl/ns-commctrl-tvitemexw) .

### <a name="remarks"></a>Заметки

Этот метод отправляет [TVM_GETITEM](/windows/win32/Controls/tvm-getitem) сообщение, описанное в Windows SDK. Это сообщение возвращает структуру [твитемекс](/windows/win32/api/commctrl/ns-commctrl-tvitemexw) , описывающую элемент управления "дерево-представление", и этот метод извлекает элемент `uStateEx` из этой структуры.
...
##  <a name="getlastvisibleitem"></a>CTreeCtrl:: Жетластвисиблеитем
...
##  <a name="getlinecolor"></a>CTreeCtrl:: Жетлинеколор
...
##  <a name="getparentitem"></a>CTreeCtrl:: Жетпарентитем
...
##  <a name="getprevsiblingitem"></a>CTreeCtrl:: Жетпревсиблингитем
...
##  <a name="getprevvisibleitem"></a>CTreeCtrl:: Жетпреввисиблеитем
...
##  <a name="getrootitem"></a>CTreeCtrl:: Жетрутитем
...
##  <a name="getscrolltime"></a>CTreeCtrl:: Жетскроллтиме
...
##  <a name="getselectedcount"></a>CTreeCtrl:: Жетселектедкаунт
...
##  <a name="getselecteditem"></a>CTreeCtrl:: Жетселектедитем
...
##  <a name="gettextcolor"></a>CTreeCtrl:: Жеттекстколор
...
##  <a name="gettooltips"></a>CTreeCtrl:: подсказки
...
Реализация `GetToolTips` MFC возвращает объект `CToolTipCtrl`, который используется элементом управления "дерево", а не маркером элемента управления ToolTip.

### <a name="example"></a>Пример

[!code-cpp[NVC_MFC_CTreeCtrl#25](../../mfc/reference/codesnippet/cpp/ctreectrl-class_28.cpp)]

##  <a name="getvisiblecount"></a>CTreeCtrl:: Жетвисиблекаунт
...
*пфлагс*<br/>
Указатель на целое число, получающее сведения о результатах проверки нажатия. Это может быть одно или несколько значений, перечисленных под элементом `flags` в разделе "Примечания".
...
При вызове этой функции параметр *PT* задает координаты проверяемой точки. Функция возвращает маркер элемента в указанной точке или значение NULL, если элемент не занимает точку. Кроме того, параметр *пфлагс* содержит значение, указывающее расположение указанной точки. Доступны следующие значения:
...
*нмаск*<br/>
Целое число, указывающее, какие атрибуты задаются. См. структуру `TVITEM` в Windows SDK.
...
*нстатемаск*<br/>
Указывает, какие состояния должны быть установлены. См. структуру `TVITEM` в Windows SDK.
...
##  <a name="itemhaschildren"></a>CTreeCtrl:: Итемхасчилдрен
...
##  <a name="mapaccidtoitem"></a>CTreeCtrl:: МапакЦидтоитем
...
|Параметр|Описание|
|---------------|-----------------|
|*уакЦид*|окне Идентификатор доступа для элемента в элементе представления дерева.|

### <a name="return-value"></a>Возвращаемое значение

Маркер элемента представления дерева (`HTREEITEM`), соответствующий параметру *уакЦид* . Дополнительные сведения см. в описании элемента *хитем* структуры [твитемекс](/windows/win32/api/commctrl/ns-commctrl-tvitemexw) .

### <a name="remarks"></a>Заметки

Специальные возможности — это приложения, которые помогают людям с ограниченными возможностями использовать компьютеры. Идентификатор доступа используется интерфейсом `IAccessible` для уникальной настройки элемента в окне. Дополнительные сведения об идентификаторах специальных возможностей см. в разделе "о поддержке Active Accessibility" в [сети разработчиков Майкрософт](https://go.microsoft.com/fwlink/p/?linkid=56322).
...
##  <a name="mapitemtoaccid"></a>CTreeCtrl:: МапитемтоакЦид
...
|Параметр|Описание|
|---------------|-----------------|
|*хитем*|окне Маркер элемента представления дерева в элементе управления. Дополнительные сведения см. в описании элемента *хитем* структуры [твитемекс](/windows/win32/api/commctrl/ns-commctrl-tvitemexw) .|
...
##  <a name="selectdroptarget"></a>CTreeCtrl:: Селектдроптаржет
...
##  <a name="selectitem"></a>CTreeCtrl:: Селектитем
...
##  <a name="selectsetfirstvisible"></a>CTreeCtrl:: Селектсетфирствисибле
...
##  <a name="setautoscrollinfo"></a>CTreeCtrl:: Сетаутоскроллинфо
...
|Параметр|Описание|
|---------------|-----------------|
|*упикселсперсек*|окне Число пикселей в секунду для прокрутки.|
|*уупдатетиме*|окне Интервал времени между обновлениями элемента управления.|
...
##  <a name="setbkcolor"></a>CTreeCtrl:: Сетбкколор
...
##  <a name="setcheck"></a>CTreeCtrl:: Сетчекк
...
##  <a name="setextendedstyle"></a>CTreeCtrl:: Сетекстендедстиле
...
|Параметр|Описание|
|---------------|-----------------|
|*двексмаск*|окне Битовая маска, указывающая, какие стили в текущем элементе управления "дерево" зависят от этого метода. Если этот параметр равен нулю, он игнорируется, и значение параметра *двексстилес* присваивается элементу управления "дерево-представление".<br /><br /> Укажите ноль или побитовое сочетание (или) стилей, описанных в разделе [Расширенные стили элемента управления "дерево-представление](/windows/win32/Controls/tree-view-control-window-extended-styles)".|
|*двексстилес*|окне Битовая маска, указывающая, какие стили в текущем элементе управления "дерево-представление" необходимо установить или очистить.<br /><br /> Чтобы задать сочетание стилей, укажите побитовое сочетание (или) стилей, описанных в разделе [Расширенные стили элемента управления "дерево-представление](/windows/win32/Controls/tree-view-control-window-extended-styles)". Чтобы очистить набор стилей, укажите ноль.|
...
##  <a name="setimagelist"></a>CTreeCtrl:: Сетимажелист
...
##  <a name="setindent"></a>CTreeCtrl:: Сетиндент
...
##  <a name="setinsertmark"></a>CTreeCtrl:: Сетинсертмарк
...
##  <a name="setinsertmarkcolor"></a>CTreeCtrl:: Сетинсертмаркколор
...
##  <a name="setitem"></a>CTreeCtrl:: Сетитем
...
*хитем*<br/>
Маркер элемента, атрибуты которого должны быть заданы. См. элемент `hItem` структуры `TVITEM` в Windows SDK.
...
В структуре `TVITEM` `hItem` элемент определяет элемент, а элемент `mask` указывает, какие атрибуты следует задать.

Если элемент `mask` или параметр *нмаск* указывает TVIF_TEXT значение, то `pszText` элемент или *лпсзитем* является адресом строки, завершающейся нулем, а элемент `cchTextMax` игнорируется. Если `mask` (или *нмаск*) указывает TVIF_STATE значение, элемент `stateMask` или параметр *нстатемаск* указывает, какие состояния элементов следует изменить, а параметр `state` элемент или *nсведения* содержит значения этих состояний.

### <a name="example"></a>Пример

[!code-cpp[NVC_MFC_CTreeCtrl#32](../../mfc/reference/codesnippet/cpp/ctreectrl-class_38.cpp)]

##  <a name="setitemdata"></a>CTreeCtrl:: Сетитемдата
...
##  <a name="setitemexpandedimageindex"></a>CTreeCtrl:: Сетитемекспандедимажеиндекс
...
|---------------|-----------------|
|*хитем*|окне Обработчик элемента управления древовидного представления.|
|*иекспандедимаже*|окне Индекс изображения, отображаемого, когда указанный элемент находится в развернутом состоянии.|
...
Этот метод отправляет [TVM_SETITEM](/windows/win32/Controls/tvm-setitem) сообщение, описанное в Windows SDK. Этот метод присваивает параметр *иекспандедимаже* элементу `iExpandedImage` структуры [твитемекс](/windows/win32/api/commctrl/ns-commctrl-tvitemexw) , а затем использует эту структуру в сообщении.
...
##  <a name="setitemimage"></a>CTreeCtrl:: Сетитемимаже
...
##  <a name="setitemstate"></a>CTreeCtrl:: Сетитемстате
...
|---------------|-----------------|
|*хитем*|окне Обработчик элемента управления древовидного представления.|
|*устатикс*|окне Расширенное состояние элемента. Дополнительные сведения см. в описании `uStateEx` элемента структуры [твитемекс](/windows/win32/api/commctrl/ns-commctrl-tvitemexw) .|
...
Этот метод отправляет [TVM_SETITEM](/windows/win32/Controls/tvm-setitem) сообщение, описанное в Windows SDK. Этот метод присваивает параметр *устатикс* элементу `uStateEx` структуры [твитемекс](/windows/win32/api/commctrl/ns-commctrl-tvitemexw) , а затем использует эту структуру в сообщении.
...
##  <a name="setlinecolor"></a>CTreeCtrl:: Сетлинеколор
...
##  <a name="setscrolltime"></a>CTreeCtrl:: Сетскроллтиме
...
##  <a name="settooltips"></a>CTreeCtrl:: Сеттултипс
...
Чтобы использовать подсказки, укажите стиль TVS_NOTOOLTIPS при создании объекта `CTreeCtrl`.
...
|Параметр|Описание|
|---------------|-----------------|
|*хитем*|окне Маркер элемента представления дерева в элементе управления. Дополнительные сведения см. в описании `hItem` элемента структуры [твитемекс](/windows/win32/api/commctrl/ns-commctrl-tvitemexw) .|
...
##  <a name="sortchildren"></a>CTreeCtrl:: Сортчилдрен
...
`SortChildren` не будет рекурсировать через дерево; будут отсортированы только непосредственные дочерние элементы *хитем* .

### <a name="example"></a>Пример

[!code-cpp[NVC_MFC_CTreeCtrl#37](../../mfc/reference/codesnippet/cpp/ctreectrl-class_45.cpp)]

##  <a name="sortchildrencb"></a>CTreeCtrl:: Сортчилдренкб
...
Параметры *lParam1* и *lParam2* соответствуют элементу `lParam` структуры [твитем](/windows/win32/api/commctrl/ns-commctrl-tvitemw) для двух сравниваемых элементов. Параметр *лпарамсорт* соответствует элементу `lParam` структуры `TV_SORTCB`.
