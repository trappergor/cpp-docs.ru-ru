...
*rect*<br/>
Ссылка на объект [CRect](../../atl-mfc-shared/reference/crect-class.md) или структуру [RECT,](/windows/win32/api/windef/ns-windef-rect) которая является положением и размером управления арматром.
...
*Кнр*<br/>
Указатель на структуру [RECT,](/windows/win32/api/windef/ns-windef-rect) которая получит границы арматорной полосы.
