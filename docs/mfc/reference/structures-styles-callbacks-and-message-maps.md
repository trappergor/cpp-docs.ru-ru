...
ms.locfileid: "33371104"
---
# <a name="structures-styles-callbacks-and-message-maps"></a>Структуры, стили, обратные вызовы и схемы сообщений
В данном разделе описываются структуры, стили и функции обратного вызова, используемый в библиотеке Microsoft Foundation Class и схемы сообщений MFC.  
...
## <a name="in-this-section"></a>В этом разделе  
 ...
 Ссылки на функции обратного вызова, в библиотеке MFC.  
  
 [Схемы сообщений](../../mfc/reference/message-maps-mfc.md)  
 Описывает макросы сопоставления сообщений и `CWnd` записей карты сообщений.  
