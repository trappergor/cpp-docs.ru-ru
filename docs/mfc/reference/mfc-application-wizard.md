...
- [Тип приложения, мастер приложений MFC](../../mfc/reference/application-type-mfc-application-wizard.md)
   ...
   - Проект использует MFC в общей DLL. Дополнительные сведения см. в разделе [создать C /C++ библиотек DLL в Visual Studio](../../build/dlls-in-visual-cpp.md).
