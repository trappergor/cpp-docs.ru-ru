...
Следующий пример демонстрирует, как использовать `CMFCVisualManagerOfficeXP`. Этот фрагмент кода является частью [Desktop оповещения демонстрационного](../../visual-cpp-samples.md).
