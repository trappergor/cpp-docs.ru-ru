...
|[in] *x*|Горизонтальная координата экрана для расположения кадра в раскрывающемся списке.|  
|[in] *y*|Вертикальная координата экрана для расположения кадра в раскрывающемся списке.|  
...
### <a name="parameters"></a>Параметры  
 [in] *bAutoDestroy*  
 Значение TRUE, чтобы автоматически уничтожить окно соответствующей раскрывающемся списке панели инструментов; в противном случае — значение FALSE.  
