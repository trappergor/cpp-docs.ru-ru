...
### <a name="remarks"></a>Примечания  
 Можно поместить вызов `Create` внутри конструктора или вызов после конструктора вызове.  
  
 Две формы `Create` функции-члена предоставляются для доступа к ресурсу шаблона диалогового окна имя шаблона или шаблон Идентификационный номер (например, IDD_DIALOG1).  
 ...
 `Create` Функция-член возвращает сразу после его создает диалоговое окно.  
 ...
 Используйте `CWnd::DestroyWindow` функции для уничтожения диалоговое окно, созданные `Create` функции.  
