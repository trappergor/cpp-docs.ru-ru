...
##  <a name="getnextdoc"></a>  CDocTemplate::GetNextDoc  
 Извлекает список элемент, идентифицируемый *важности*, затем устанавливает *важности* для **ПОЗИЦИИ** значение на следующую запись в списке.  
...
### <a name="remarks"></a>Примечания  
 Если полученный элемент является последним в списке, то новое значение *важности* равно **NULL**.  
...
### <a name="remarks"></a>Примечания  
 ...
 Если файл, указанный параметром *lpszPathName* еще открыт, эта функция возвращает **CDocTemplate::yesAlreadyOpen** и копирует файл **CDocument** объекта в объект в *rpDocMatch*.  
