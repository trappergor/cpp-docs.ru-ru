...
-   Откройте существующую рабочую область в коллекции рабочих областей.  
 ...
 Завершение сеанса рабочей области, закрыв рабочей области с [закрыть](#close) функции-члена. **Закрыть** закрывает все базы данных, не закрыт ранее, выполняется откат всех незафиксированных транзакций.  
