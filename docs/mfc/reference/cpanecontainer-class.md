...
## <a name="example"></a>Пример  
 Ниже приведен пример, как создать экземпляр `CPaneContainer` класса. Этот фрагмент кода является частью [образце задайте размер области](../../visual-cpp-samples.md).  
