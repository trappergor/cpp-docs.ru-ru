...
*rect*<br/>
Указывает поле контрольного списка размер и положение. Может быть либо [CRect](../../atl-mfc-shared/reference/crect-class.md) объекта или [RECT](/windows/desktop/api/windef/ns-windef-tagrect) структуры.
