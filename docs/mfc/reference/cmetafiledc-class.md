...
## <a name="remarks"></a>Примечания  
 ...
 После отправки нужные команды в метафайл вызовите `Close` функция-член, закрывает контексты устройств метафайла, и возвращает дескриптор метафайла. Затем `CMetaFileDC` объекта.  
