...
### <a name="parameters"></a>Параметры  
 [in] `bSimple`  
 Флаг тип отображения. Если этот параметр имеет `TRUE`, элемент управления отображает простой текст; Если это `FALSE`, он отображает несколько частей.  
