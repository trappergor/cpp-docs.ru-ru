---
title: Класс CStatusBarCtrl | Документация Майкрософт
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
### <a name="parameters"></a>Параметры  
 [in] *bSimple*  
 Флаг тип отображения. Если этот параметр имеет значение TRUE, элемент управления отображает простой текст; Если он имеет значение FALSE, выводится из нескольких частей.  
