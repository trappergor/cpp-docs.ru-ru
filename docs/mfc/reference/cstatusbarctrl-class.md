...
|Имя|Description|
|----------|-----------------|
|[CStatusBarCtrl:: Create](#create)|Создает элемент управления "строка состояния" и прикрепляет его к объекту `CStatusBarCtrl`.|
|[CStatusBarCtrl:: Креатикс](#createex)|Создает элемент управления "строка состояния" с указанными расширенными стилями Windows и прикрепляет его к объекту `CStatusBarCtrl`.|
...
Этот элемент управления (и, следовательно, класс `CStatusBarCtrl`) доступен только для программ, работающих под управлением Windows 95/98 и Windows NT версии 3,51 и более поздних версий.
...
Создает элемент управления "строка состояния" и прикрепляет его к объекту `CStatusBarCtrl`.
...
Создание `CStatusBarCtrl` выполняется в два этапа. Сначала вызовите конструктор, а затем вызовите `Create`, который создает элемент управления "строка состояния" и присоединяет его к объекту `CStatusBarCtrl`.
...
Создает элемент управления (дочернее окно) и связывает его с объектом `CStatusBarCtrl`.
