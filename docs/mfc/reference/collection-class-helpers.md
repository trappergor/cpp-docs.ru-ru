...
### <a name="remarks"></a>Примечания  
 ...
 Реализация по умолчанию создает хэш-значения путем перехода *ключ* вправо на четыре позиции. Переопределите эту функцию, чтобы он возвращал хэш-значения подходящий для вашего приложения.  
