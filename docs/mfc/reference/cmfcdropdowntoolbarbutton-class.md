---
title: Класс CMFCDropDownToolbarButton | Документация Майкрософт
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
### <a name="parameters"></a>Параметры  
 [in] *pWnd*  
 Родительское окно фрейма раскрывающегося списка, или значение NULL для использования родительского окна, кнопки раскрывающегося списка на панели инструментов.  
