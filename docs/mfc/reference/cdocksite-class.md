...
[in] [out] *pBarToDock* указатель на панели, чтобы закрепить слева от *pTargetBar*.

[in] [out] *pTargetBar* указатель на целевой области.
...
[in] [out] *pBar* указатель на панели, чтобы отображать и скрывать.
