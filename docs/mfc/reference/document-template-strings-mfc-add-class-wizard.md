 ...
 **Короткое имя создаваемого файла**  
 Задает имя, отображаемое в окнах Стандартная **создать** диалоговое окно, если в проекте имеется несколько шаблонов документов. Если приложение является [сервера автоматизации](../../mfc/automation-servers.md), это имя используется в качестве краткого имени объекта автоматизации. По умолчанию это имя основано на имени класса.  
