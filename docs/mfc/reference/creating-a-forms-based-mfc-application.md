...
3.  Выберите **одного документа**, **несколько документов**, или **несколько документов верхнего уровня**.  
...
4.  Задайте другие необходимые параметры проекта на других страницах мастера.  
  
5.  Нажмите кнопку **Готово** создать общую схему приложения.  
...
## <a name="see-also"></a>См. также  
 ...
 [Создание приложения MFC в стиле проводника файлов](../../mfc/reference/creating-a-file-explorer-style-mfc-application.md)   
