...
[in] [out] *pWndOwner* владелец окно оповещения. Этот владелец будет получать все уведомления для окно оповещения. Это значение не может иметь значение NULL.
