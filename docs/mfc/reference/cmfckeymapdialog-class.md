---
title: Класс CMFCKeyMapDialog | Документация Майкрософт
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
### <a name="parameters"></a>Параметры  
 ...
 [in] *bEnablePrint*  
 Значение TRUE, если можно напечатать список сочетаний клавиш; в противном случае — значение FALSE. Значение по умолчанию — FALSE.  
  
### <a name="remarks"></a>Примечания  
  
### <a name="example"></a>Пример  
 Следующий пример демонстрирует создание объекта класса `CMFCKeyMapDialog` класса. Этот пример является частью [Visual Studio демонстрационного](../../visual-cpp-samples.md).  
...
### <a name="parameters"></a>Параметры  
 [in] *pButton*  
 Указатель на кнопку панели инструментов, которая используется для сопоставления ключа сочетание клавиш для команды имя и описание. Элемент карты ключей хранится в элементе управления внутренний список.  
...
### <a name="parameters"></a>Параметры  
 ...
 [in] *y*  
 Вертикальное смещение между верхней частью страницы и положение элемента.  
  
 [in] *cx*  
 Горизонтальное смещение между левой части страницы и положение элемента.  
  
 [in] *bCalcHeight*  
 Значение TRUE, чтобы рассчитать высоту рекомендации для печати элемента; Значение FALSE, чтобы усечь элемент печати, так, чтобы по умолчанию пустое пространство.  
