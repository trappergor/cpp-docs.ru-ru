...
### <a name="parameters"></a>Параметры  
 *dwTimeout*  
 Указывает количество времени в миллисекундах для ожидания объекта синхронизации доступны (сигнал). Если бесконечно, `Lock` ожидает сигнала перед возвращением объекта.  
