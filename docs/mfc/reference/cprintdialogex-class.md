...
INT_PTR возвращаемое значение — фактически значение HRESULT. См. в разделе возвращают значения в [PrintDlgEx](https://msdn.microsoft.com/library/windows/desktop/ms646942) в пакете Windows SDK.
