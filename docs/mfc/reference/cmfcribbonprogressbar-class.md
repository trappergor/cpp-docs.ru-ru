...
### <a name="parameters"></a>Параметры  
 ...
 [in] *nWidth*  
 Задает ширину в пикселях индикатора хода выполнения на ленте.  
  
 [in] *nHeight*  
 Указывает высоту в пикселях индикатора хода выполнения на ленте.  
...
### <a name="parameters"></a>Параметры  
 [in] *bSet*  
 Значение TRUE, чтобы указать, что индикатор хода выполнения в режиме бесконечного; в противном случае — значение FALSE.  
...
### <a name="parameters"></a>Параметры  
 [in] *nPos*  
 Задает позицию, к которой имеет значение индикатора выполнения.  
  
 [in] *bRedraw*  
 Указывает, должны быть перерисованы индикатор хода выполнения.  
