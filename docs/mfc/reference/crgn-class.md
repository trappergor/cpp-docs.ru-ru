 ...
 *Точка*  
 Координата по оси x *точки* указывает число единиц для перемещения влево или вправо. Координата по оси y *точки* указывает количество единиц для перемещения вверх или вниз. *Точки* параметр может быть либо **ТОЧКИ** структуры или `CPoint` объекта.  
 ...
 *Точка*  
 X-y координаты и *точки* укажите x и y координаты точки для проверки значения. *Точки* параметра может быть **ТОЧКИ** структуры или `CPoint` объекта.  
