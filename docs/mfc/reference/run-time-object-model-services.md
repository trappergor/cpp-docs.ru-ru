...
### <a name="see-also"></a>См. также  
 [Изоляция общих MFC управляет библиотеки](../isolation-of-the-mfc-common-controls-library.md) [AFX_COMCTL32_IF_EXISTS2](#afx_comctl32_if_exists2)
...
### <a name="see-also"></a>См. также  
 [Изоляция общих MFC управляет библиотеки](../isolation-of-the-mfc-common-controls-library.md) [AFX_COMCTL32_IF_EXISTS](#afx_comctl32_if_exists)
