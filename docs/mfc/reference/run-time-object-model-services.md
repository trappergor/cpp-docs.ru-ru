...
##  <a name="implement_olecreate"></a>IMPLEMENT_OLECREATE  
 Либо этот макрос или [IMPLEMENT_OLECREATE_FLAGS](http://msdn.microsoft.com/library/d1589f6a-5a69-4742-b07c-4c621cfd040d) должен быть указан в файле реализации для любого класса, который использует `DECLARE_OLECREATE`.  
