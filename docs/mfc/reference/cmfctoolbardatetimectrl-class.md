...
Следующий пример демонстрирует создание объекта класса `CMFCToolBarDateTimeCtrl` класса. Этот фрагмент кода является частью [пример Выбор инструментов даты / времени](../../overview/visual-cpp-samples.md).
