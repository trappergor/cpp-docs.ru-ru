...
*ptd*<br/>
Указатель на `DVTARGETDEVICE` структуру данных, которая содержит сведения о новом устройстве печати. Допускается значение NULL.

*PPD*<br/>
Указатель на `PRINTDLG` структуру данных, которая содержит сведения о новом устройстве печати. Допускается значение NULL.
