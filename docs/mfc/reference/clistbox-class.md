...
## <a name="remarks"></a>Примечания  
 ...
 Построение может быть задачей в классе, производном от `CListBox`. Создание конструктора для производного класса и вызове `Create` из внутри конструктора.  
...
### <a name="remarks"></a>Примечания  
 Создании `CListBox` объекта в два этапа. Во-первых, вызовите конструктор `ClistBox` и затем вызвать `Create`, который инициализирует списка Windows и прикрепляет его к `CListBox`.  
...
### <a name="remarks"></a>Примечания  
 Создании `CListBox` объекта в два этапа. Во-первых, вызовите конструктор, а затем вызвать `Create`, который инициализирует списка Windows и прикрепляет его к `CListBox` объекта.  
...
### <a name="parameters"></a>Параметры  
 *attr*  
 Может быть любым сочетанием **перечисления** значений описано в **CFile::GetStatu**[s](../../mfc/reference/cfile-class.md#getstatus), или любое сочетание следующих значений:  
...
### <a name="parameters"></a>Параметры  
 *Выберите*  
 Задает отсчитываемый от нуля индекс строки для выбора. Если *выберите* равно -1, имеет значение списка выбора не имеют.  
