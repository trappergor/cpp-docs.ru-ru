---
title: Класс CVSListBox | Документация Майкрософт
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
### <a name="parameters"></a>Параметры  
 ...
 [in] *dwData*  
 Значение 32-разрядных конкретного приложения, связанный со строкой. Значение по умолчанию — 0.  
  
 [in] *iIndex*  
 Отсчитываемый от нуля индекс позиции, которая будет содержать строки. Если *iIndex* параметр имеет значение -1, строка добавляется в конец списка. Значение по умолчанию — -1.  
...
### <a name="parameters"></a>Параметры  
 [in] *iIndex*  
 Отсчитываемый от нуля индекс редактируемого элемента управления элемента списка.  
