...
### <a name="parameters"></a>Параметры  
 ...
 [in] *iIndex*  
 Отсчитываемый от нуля индекс позиции, которые будут храниться в строке. Если *iIndex* параметра равно -1, строка добавляется в конец списка. Значение по умолчанию — -1.  
