...
- `AFX_DAO_ALL_INFO` Основной и дополнительной информации, а также: Значение по умолчанию правила, текст проверки проверки
...
- `AFX_DAO_SECONDARY_INFO` Сведения об основном, а также: Первичной, уникальным, кластеризованным, игнорировать значения NULL, требуется, внешние
...
|Exchange|«Exchange;<br /><br /> MAPILEVEL= *folderpath*;<br /><br /> [TABLETYPE={ 0 &#124; 1 };]<br /><br /> [PROFILE= *profile*;]<br /><br /> [PWD = *пароль*;]<br /><br /> [DATABASE = `database`;]»|*«диск*:\\\ *путь*\\\ *filename*. MDB»|
