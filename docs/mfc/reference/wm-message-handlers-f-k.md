---
title: Обработчики сообщений WM_ F — K | Документация Майкрософт
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
|ON_WM_GETDLGCODE()|целое число без знака afx_msg [OnGetDlgCode](../../mfc/reference/cwnd-class.md#ongetdlgcode)();|
...
|ON_WM_HOTKEY()|afx_msg void [OnHotKey](../../mfc/reference/cwnd-class.md#onhotkey)(целое число без знака, целое число без знака, целое число без знака);|
