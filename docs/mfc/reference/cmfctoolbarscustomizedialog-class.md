...
|name|Описание|
|----------|-----------------|
|[Кмфктулбарскустомизедиалог:: Кмфктулбарскустомизедиалог](#cmfctoolbarscustomizedialog)|Создает объект `CMFCToolBarsCustomizeDialog`.|
...
|name|Описание|
|----------|-----------------|
|`CMFCToolBarsCustomizeDialog::`[Кмфктулбарскустомизедиалог:: AddButton](#addbutton)|Вставляет кнопку панели инструментов в список команд на странице **команды** .|
|`CMFCToolBarsCustomizeDialog::`[Кмфктулбарскустомизедиалог:: ДобавитьМеню](#addmenu)|Загружает меню из ресурсов и вызывает [кмфктулбарскустомизедиалог:: аддменукоммандс](#addmenucommands) , чтобы добавить это меню в список команд на странице **команды** .|
|`CMFCToolBarsCustomizeDialog::`[Кмфктулбарскустомизедиалог:: аддменукоммандс](#addmenucommands)|Загружает меню из ресурсов и вызывает [кмфктулбарскустомизедиалог:: аддменукоммандс](#addmenucommands) , чтобы добавить это меню в список команд на странице **команды** .|
|`CMFCToolBarsCustomizeDialog::`[Кмфктулбарскустомизедиалог:: аддтулбар](#addtoolbar)|Загружает панель инструментов из ресурсов. Затем для каждой команды в меню вызывается метод [кмфктулбарскустомизедиалог:: AddButton](#addbutton) для вставки кнопки в список команд на странице **команды** в указанной категории.|
|`CMFCToolBarsCustomizeDialog::`[Кмфктулбарскустомизедиалог:: Create](#create)|Отображает диалоговое окно **Настройка** .|
|`CMFCToolBarsCustomizeDialog::EnableTools`|Зарезервировано для будущего использования.|
|`CMFCToolBarsCustomizeDialog::`[Кмфктулбарскустомизедиалог:: енаблеусердефинедтулбарс](#enableuserdefinedtoolbars)|Включает или отключает создание новых панелей инструментов с помощью диалогового окна " **Настройка** ".|
...
|`CMFCToolBarsCustomizeDialog::`[Кмфктулбарскустомизедиалог:: онедиттулбарменуимаже](#onedittoolbarmenuimage)|Запускает редактор изображений, чтобы пользователь мог настроить кнопку панели инструментов или значок пункта меню.|
...
|`CMFCToolBarsCustomizeDialog::`[Кмфктулбарскустомизедиалог:: ремовебуттон](#removebutton)|Удаляет кнопку с указанным ИДЕНТИФИКАТОРом команды из указанной категории или из всех категорий.|
|`CMFCToolBarsCustomizeDialog::`[Кмфктулбарскустомизедиалог:: ренамекатегори](#renamecategory)|Переименовывает категорию в списке категорий на вкладке **команды** .|
|`CMFCToolBarsCustomizeDialog::`[Кмфктулбарскустомизедиалог:: реплацебуттон](#replacebutton)|Заменяет кнопку в списке команд на вкладке **команды** на новый объект кнопки панели инструментов.|
|`CMFCToolBarsCustomizeDialog::`[Кмфктулбарскустомизедиалог:: сетусеркатегори](#setusercategory)|Добавляет категорию в список категорий, которые будут отображаться на вкладке **команды** .|

### <a name="protected-methods"></a>Защищенные методы

|name|Описание|
|----------|-----------------|
|`CMFCToolBarsCustomizeDialog::`[Кмфктулбарскустомизедиалог:: чекктулсвалидити](#checktoolsvalidity)|Вызывается платформой для определения того, является ли список определяемых пользователем средств допустимым.|
|`CMFCToolBarsCustomizeDialog::`[Кмфктулбарскустомизедиалог:: онафтерчанжетул](#onafterchangetool)|Вызывается структурой при изменении свойств определяемого пользователем средства.|
|`CMFCToolBarsCustomizeDialog::`[Кмфктулбарскустомизедиалог:: онассигнкэй](#onassignkey)|Определяет, можно ли назначить конкретному действию указанное сочетание клавиш.|
|`CMFCToolBarsCustomizeDialog::`[Кмфктулбарскустомизедиалог:: онбефоречанжетул](#onbeforechangetool)|Определяет, можно ли изменить определяемое пользователем средство.|
|`CMFCToolBarsCustomizeDialog::`[Кмфктулбарскустомизедиалог:: ониниттулспаже](#oninittoolspage)|Вызывается платформой, когда пользователь выбирает вкладку " **средства** ".|
...
##  <a name="addbutton"></a>Кмфктулбарскустомизедиалог:: AddButton
...
Метод игнорирует кнопки, имеющие стандартные идентификаторы команд (например, ID_FILE_MRU_FILE1), недопустимые команды (см. раздел [CMFCToolBar:: искоммандпермиттед](../../mfc/reference/cmfctoolbar-class.md#iscommandpermitted)) и фиктивные кнопки. `AddButton`

Этот метод создает новый объект того же типа, что `button` и (обычно [Класс CMFCToolBarButton](../../mfc/reference/cmfctoolbarbutton-class.md)), используя класс среды выполнения кнопки. Затем он вызывает [CMFCToolBarButton:: CopyFrom](../../mfc/reference/cmfctoolbarbutton-class.md#copyfrom) для копирования элементов данных кнопки и вставляет копию в указанную категорию.
...
В следующем примере показано, `AddButton` как использовать метод `CMFCToolBarsCustomizeDialog` класса. Этот фрагмент кода является частью [образца Slider](../../overview/visual-cpp-samples.md).

[!code-cpp[NVC_MFC_Slider#1](../../mfc/reference/codesnippet/cpp/cmfctoolbarscustomizedialog-class_2.cpp)]

##  <a name="addmenu"></a>Кмфктулбарскустомизедиалог:: ДобавитьМеню
...
##  <a name="addmenucommands"></a>Кмфктулбарскустомизедиалог:: Аддменукоммандс
...
Метод выполняет перебор всех пунктов меню пмену. `AddMenuCommands` Для каждого пункта меню, не содержащего подменю, этот метод создает объект [класса CMFCToolBarButton](../../mfc/reference/cmfctoolbarbutton-class.md) и вызывает метод [Кмфктулбарскустомизедиалог:: AddButton](#addbutton) , чтобы добавить пункт меню в качестве кнопки на панели инструментов в список команд вСтраница "команды". В этом процессе разделители не учитываются.
...
##  <a name="addtoolbar"></a>Кмфктулбарскустомизедиалог:: Аддтулбар
...
В следующем примере показано, `AddToolBar` как использовать метод `CMFCToolBarsCustomizeDialog` в классе. Этот фрагмент кода входит в состав [примера Word Pad](../../overview/visual-cpp-samples.md).
...
##  <a name="checktoolsvalidity"></a>Кмфктулбарскустомизедиалог:: Чекктулсвалидити
...
Переопределите `CMFCToolBarsCustomizeDialog` метод в классе, производном от, если требуется проверить пользовательские инструменты до того, как пользователь закроет диалоговое окно. `CheckToolsValidity` Если этот метод возвращает значение FALSE, когда пользователь нажимает кнопку " **Закрыть** " в правом верхнем углу диалогового окна или кнопку, обозначенную как " **Закрыть** " в правом нижнем углу диалогового окна, в диалоговом окне отображается вкладка " **средства** ", а не склад. Если этот метод возвращает значение FALSE, когда пользователь щелкает вкладку для выхода с вкладки **средства** , навигация не выполняется. Следует отобразить соответствующее окно сообщения, чтобы сообщить пользователю о проблеме, вызвавшей сбой проверки.

##  <a name="cmfctoolbarscustomizedialog"></a>Кмфктулбарскустомизедиалог:: Кмфктулбарскустомизедиалог
...
##  <a name="create"></a>Кмфктулбарскустомизедиалог:: Create
...
##  <a name="enableuserdefinedtoolbars"></a>Кмфктулбарскустомизедиалог:: Енаблеусердефинедтулбарс
...
##  <a name="fillallcommandslist"></a>Кмфктулбарскустомизедиалог:: Филлаллкоммандслист
...
##  <a name="fillcategoriescombobox"></a>Кмфктулбарскустомизедиалог:: Филлкатегориескомбобокс
...
Этот метод похож на метод [кмфктулбарскустомизедиалог:: филлкатегориеслистбокс](#fillcategorieslistbox) , за исключением того, что этот `CComboBox` метод работает с объектом.
...
Классы `CMFCToolBarsKeyboardPropertyPage` и`CMFCKeyMapDialog` используют этот метод для категоризации назначений клавиш.

##  <a name="fillcategorieslistbox"></a>Кмфктулбарскустомизедиалог:: Филлкатегориеслистбокс
...
Этот метод похож на метод [кмфктулбарскустомизедиалог:: филлкатегориескомбобокс](#fillcategoriescombobox) , за исключением того, что этот `CListBox` метод работает с объектом.
...
##  <a name="getcommandname"></a>Кмфктулбарскустомизедиалог:: Жеткомманднаме
...
##  <a name="getcountincategory"></a>Кмфктулбарскустомизедиалог:: Жеткаунтинкатегори
...
##  <a name="getflags"></a>Флаги Кмфктулбарскустомизедиалог:: "
...
##  <a name="onafterchangetool"></a>Кмфктулбарскустомизедиалог:: Онафтерчанжетул
...
##  <a name="onassignkey"></a>Кмфктулбарскустомизедиалог:: Онассигнкэй
...
##  <a name="onbeforechangetool"></a>Кмфктулбарскустомизедиалог:: Онбефоречанжетул
...
Этот метод вызывается платформой при изменении свойств определяемого пользователем средства. Реализация по умолчанию не выполняет никаких действий. Переопределите `CMFCToolBarsCustomizeDialog` метод в классе, производном от, если необходимо выполнить обработку перед изменением пользовательского средства, например освобождение ресурсов, используемых *пселтул.* `OnBeforeChangeTool`

##  <a name="onedittoolbarmenuimage"></a>Кмфктулбарскустомизедиалог:: Онедиттулбарменуимаже
...
##  <a name="oninitdialog"></a>Кмфктулбарскустомизедиалог:: Онинитдиалог
...
##  <a name="oninittoolspage"></a>Кмфктулбарскустомизедиалог:: Ониниттулспаже
...
##  <a name="postncdestroy"></a>Кмфктулбарскустомизедиалог::P Остнкдестрой
...
Этот метод расширяет реализацию `CPropertySheet::PostNcDestroy`базового класса путем восстановления приложения в предыдущем режиме.
...
##  <a name="removebutton"></a>Кмфктулбарскустомизедиалог:: Ремовебуттон
...
##  <a name="renamecategory"></a>Кмфктулбарскустомизедиалог:: Ренамекатегори
...
##  <a name="replacebutton"></a>Кмфктулбарскустомизедиалог:: Реплацебуттон
...
*переключатель*<br/>
окне **Константная** ссылка на объект кнопки панели инструментов, заменяющий старую кнопку.

### <a name="remarks"></a>Примечания

Когда [кмфктулбарскустомизедиалог:: ДобавитьМеню](#addmenu), [Кмфктулбарскустомизедиалог:: аддменукоммандс](#addmenucommands)или [кмфктулбарскустомизедиалог:: AddToolBar](#addtoolbar) добавляет команду на страницу **Commands** , эта команда имеет форму [ Объект класса CMFCToolBarButton](../../mfc/reference/cmfctoolbarbutton-class.md) (или объект [класса кмфктулбарменубуттон](../../mfc/reference/cmfctoolbarmenubutton-class.md) для элемента меню, содержащего подменю, `AddMenuCommands`добавленное). Платформа также вызывает эти три метода для автоматического добавления команд. Если вы хотите, чтобы команда была представлена производным типом, вызовите `ReplaceButton` и передайте кнопку производного типа.

### <a name="example"></a>Пример

В следующем примере показано, `ReplaceButton` как использовать метод `CMFCToolBarsCustomizeDialog` в классе. Этот фрагмент кода является частью [демонстрационного примера Visual Studio](../../overview/visual-cpp-samples.md).

[!code-cpp[NVC_MFC_VisualStudioDemo#34](../../mfc/codesnippet/cpp/cmfctoolbarscustomizedialog-class_5.cpp)]

##  <a name="setusercategory"></a>Кмфктулбарскустомизедиалог:: Сетусеркатегори
