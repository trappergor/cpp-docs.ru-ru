...
2.  При обработке сообщений WM_CREATE, вызовите `Create` метод. Вы можете использовать регулярные [CControlBar](../../mfc/reference/ccontrolbar-class.md) стили. Дополнительные сведения см. в разделе `CControlBar::Create`.  
  
3.  Вызовите [CMFCTasksPane::AddGroup](#addgroup) метод для добавления различных групп.  
  
4.  Вызовите [CMFCTasksPane::AddTask](#addtask), [CMFCTasksPane::AddLabel](#addlabel) или [CMFCTasksPane::AddMRUFilesList](#addmrufileslist) функции-члены для добавления новых элементов (задач) для каждой группы.  
  
5.  Вызовите [CMFCTasksPane::EnableGroupCollapse](#enablegroupcollapse) для указания того, можно ли свернуть группы элементов.  
...
### <a name="parameters"></a>Параметры  
 ...
 [in] *bBottomLocation*  
 Значение TRUE, чтобы создать группу в нижней части элемента управления области задач; в противном случае — значение FALSE.  
  
 [in] *bSpecial*  
 Значение TRUE, чтобы пометить эту группу как *специальные* группы; в противном случае — значение FALSE. Дополнительные сведения о специальных группах, см. в разделе "Примечания" `CMFCTasksPane`.  
...
### <a name="parameters"></a>Параметры  
 ...
 [in] *nTaskIcon*  
 Указывает значок, отображаемый рядом с меткой. Framework хранит значки в списке изображений. Этот параметр является индексом в списке.  
  
 [in] *bIsBold*  
 Значение TRUE, чтобы отобразить метку полужирным шрифтом; в противном случае — значение FALSE.  
...
### <a name="parameters"></a>Параметры  
 [in] *ировать*  
 Указывает индекс группы. Этот метод добавляет список последних Использованных файлов к группе, указанной в этом параметре.  
...
### <a name="parameters"></a>Параметры  
 [in] *ировать*  
 Указывает индекс группы, где добавляется задача.  
  
 [in] *lpszTaskName*  
 Задает имя задачи.  
  
 [in] *nTaskIcon*  
 Указывает значок, отображаемый рядом с задачей. Framework хранит значки в списке изображений. Этот параметр является индексом в списке.  
  
 [in] *uiCommandID*  
 Указывает идентификатор команды команда для выполнения, когда пользователь щелкает задачу. Задача рассматривается как метка *uiCommandID* равно 0.  
  
 [in] *dwUserData*  
 Задает определяемые пользователем данные, связываемые с задачей.  
...
### <a name="parameters"></a>Параметры  
 ...
 Значение TRUE, чтобы уничтожить окно при удалении задачи; в противном случае — значение FALSE.  
...
### <a name="parameters"></a>Параметры  
 ...
 [in] *bCollapse*  
 Значение TRUE, чтобы свернуть группу; Значение FALSE, чтобы развернуть группу.  
  
 [in] *ировать*  
 Указывает отсчитываемый от нуля индекс группы, чтобы свернуть во внутреннем списке групп.  
...
### <a name="parameters"></a>Параметры  
 [in] *bEnable*  
 Значение TRUE, чтобы включить анимацию, которая возникает, когда группа задач разворачивает или сворачивает; в противном случае — значение FALSE.  
...
### <a name="parameters"></a>Параметры  
 [in] *bEnable*  
 Значение TRUE, если пользователи могут сворачивать группы задач; в противном случае — значение FALSE.  
...
### <a name="parameters"></a>Параметры  
 [in] *bEnable*  
 Значение true, чтобы включить раскрывающихся меню на **Далее** и **Назад** кнопки навигации; в противном случае — значение FALSE.  
...
### <a name="parameters"></a>Параметры  
 [in] *bEnable*  
 Значение TRUE, чтобы включить панели инструментов; в противном случае — значение FALSE.  
...
### <a name="parameters"></a>Параметры  
 [in] *bEnable*  
 Значение TRUE для отображения кнопки прокрутки в области задач, а не полосы прокрутки; в противном случае — значение FALSE.  
...
### <a name="parameters"></a>Параметры  
 [in] *bEnable*  
 Значение true для переноса по словам текста меток, которые отображаются на панели задач; в противном случае — значение FALSE.  
...
### <a name="parameters"></a>Параметры  
 [in] *bEnable*  
 Значение TRUE, программы-оболочки для задачи в области задач; в противном случае — значение FALSE.  
...
### <a name="parameters"></a>Параметры  
 [in] *pGroup*  
 Указывает группу задач, местоположение которого извлекается.  
...
### <a name="parameters"></a>Параметры  
 [in] *ировать*  
 Указывает отсчитываемый от нуля индекс группы задач.  
...
### <a name="parameters"></a>Параметры  
 [in] *ировать*  
 Указывает отсчитываемый от нуля индекс, содержащий задачу.  
  
 [in] *nTask*  
 Указывает отсчитываемый от нуля индекс задачи в списке определяется посредством *разгруппировать*.  
...
### <a name="parameters"></a>Параметры  
 [in] *ировать*  
 Указывает отсчитываемый от нуля индекс получаемой группы.  
...
### <a name="remarks"></a>Примечания  
 При нажатии кнопки «Назад», платформа отображает на предыдущую страницу задач.  
...
### <a name="return-value"></a>Возвращаемое значение  
 Значение TRUE, если включена панели навигации. в противном случае — значение FALSE.  
...
### <a name="parameters"></a>Параметры  
 [in] *nGroupNumber*  
 Указывает отсчитываемый от нуля индекс, содержащий задачи, которую щелкнул пользователь.  
  
 [in] *nTaskNumber*  
 Указывает отсчитываемый от нуля индекс выбранной задачи.  
  
 [in] *uiCommandID*  
 Указывает идентификатор команды, связанные с задачей.  
  
 [in] *dwUserData*  
 Содержит определяемые пользователем данные, связанные с выбранной задачей.  
  
### <a name="remarks"></a>Примечания  
 Этот метод вызывается платформой, когда пользователь щелкает задачу. По умолчанию платформа проверяет идентификатор команды, связанные с выбранной задачей и, если оно не равно нулю, отправляется сообщение WM_COMMAND владельцем элемента управления области задач.  
...
### <a name="parameters"></a>Параметры  
 [in] *nPageIdx*  
 Указывает отсчитываемый от нуля индекс страницы.  
...
### <a name="parameters"></a>Параметры  
 [in] *ировать*  
 Указывает отсчитываемый от нуля индекс группы.  
...
### <a name="parameters"></a>Параметры  
 [in] *ировать*  
 Указывает отсчитываемый от нуля индекс группы для удаления.  
...
### <a name="parameters"></a>Параметры  
 [in] *nPageIdx*  
 Указывает отсчитываемый от нуля индекс, которую требуется удалить.  
...
### <a name="parameters"></a>Параметры  
 [in] *ировать*  
 Указывает отсчитываемый от нуля индекс, содержащий задачу для удаления группы задач.  
  
 [in] *nTask*  
 Указывает отсчитываемый от нуля индекс задачи для удаления.  
  
 [in] *bRedraw*  
 Значение TRUE, если перерисовка области задач; в противном случае — значение FALSE.  
...
### <a name="parameters"></a>Параметры  
 [in] *nPageIdx*  
 Указывает отсчитываемый от нуля индекс отображаемой страницы.  
...
### <a name="remarks"></a>Примечания  
 Вызовите этот метод для настройки поля элементами области задач.  
...
### <a name="parameters"></a>Параметры  
 [in] *n*  
 Указывает горизонтальное смещение заголовка группы.  
...
### <a name="parameters"></a>Параметры  
 ...
 [in] *nTask*  
 Указывает отсчитываемый от нуля индекс задачи.  
...
### <a name="parameters"></a>Параметры  
 [in] *ировать*  
 Указывает отсчитываемый от нуля индекс группы задач, который содержит задачу.  
...
### <a name="parameters"></a>Параметры  
 [in] *ировать*  
 Указывает отсчитываемый от нуля индекс, содержащий элемент управления окна.  
  
 [in] *hwndTask*  
 Указывает дескриптор окна элемента управления.  
  
 [in] *nWndHeight*  
 Указывает устанавливаемую высоту.  
...
### <a name="parameters"></a>Параметры  
 ...
 [in] *nTask*  
 Указывает отсчитываемый от нуля индекс задачи, чтобы показать или скрыть.  
  
 [in] *bShow*  
 Значение TRUE для отображения задачи; Значение FALSE, чтобы скрыть задачу.  
