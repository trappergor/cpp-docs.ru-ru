...
|[CMFCTasksPane::EnableHistoryMenuButtons](#enablehistorymenubuttons)|Включает или отключает раскрывающиеся меню в **Далее** и **Назад** кнопок навигации.|  
...
|[CMFCTasksPane::IsHistoryMenuButtonsEnabled](#ishistorymenubuttonsenabled)|Указывает, является ли **Далее** и **Назад** кнопки навигации имеют раскрывающихся меню.|  
...
4.  Вызовите [CMFCTasksPane::AddTask](#addtask), [CMFCTasksPane::AddLabel](#addlabel) или [CMFCTasksPane::AddMRUFilesList](#addmrufileslist) функции-члены для добавления новых элементов (задач) в каждой группе.  
  
5.  Вызовите [CMFCTasksPane::EnableGroupCollapse](#enablegroupcollapse) , чтобы определить возможность свертывания групп элементов.  
...
## <a name="example"></a>Пример  
 В этом примере демонстрируется создание объекта `CMFCTasksPane` и использование различных методов класса `CMFCTasksPane`. В примере показано для включения свертывания групп задач, и включите раскрывающихся меню **Далее** и **Назад** кнопки навигации включить кнопок прокрутки вместо полосы прокрутки, включите слово Перенос для текста метки, задайте имя заголовка области задач, цвета текста заголовка группы и установите горизонтальные и вертикальные поля.  
...
### <a name="return-value"></a>Возвращаемое значение  
 Отсчитываемый от нуля индекс группы в списке внутренних групп, которые поддерживает класс.  
  
### <a name="remarks"></a>Примечания  
 Этот метод для создания группы задач и добавить эту группу управления области задач.  
...
### <a name="remarks"></a>Примечания  
 Панель навигации имеет панель инструментов, платформа отображает в верхней части области задач. Панель навигации содержит **обратно**, **вперед**, и **Главная** кнопок навигации и кнопки меню, содержащее список доступных страниц.  
...
### <a name="return-value"></a>Возвращаемое значение  
 Вертикальная поле между областью задач и краями клиентской области.  
...
### <a name="remarks"></a>Примечания  
 По умолчанию, платформа отображает страницу, где пользователь просматривает перед нажатием кнопки **обратно** кнопки.  
...
### <a name="remarks"></a>Примечания  
 Этот метод удаляет одну группу. Чтобы удалить все группы, вызовите [CMFCTasksPane::RemoveAllGroups](#removeallgroups) вместо него.  
...
### <a name="remarks"></a>Примечания  
 Поля по горизонтали — это расстояние между областью задач и верхней или нижней границей клиентской области.  
...
### <a name="remarks"></a>Примечания  
 Платформа хранит значки в списке изображений. Задачи, связанные со значками, которые хранятся в этом списке.  
...
### <a name="remarks"></a>Примечания  
 Этот метод обновляет заголовка области задач, настраивает полосы прокрутки, перемещает все задачи и перерисовывает все элементы управления области задач.  
  
 Переопределите этот метод в производном классе для выполнения пользовательского кода, когда платформа обновляет область задач.  
