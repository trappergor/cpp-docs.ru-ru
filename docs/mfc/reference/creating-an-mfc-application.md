---
title: Создание приложения MFC | Документация Майкрософт
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
2.  В **новый проект** выберите **приложения MFC** в области «Шаблоны», чтобы открыть мастер.  
