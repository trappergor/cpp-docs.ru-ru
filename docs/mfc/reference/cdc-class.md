...
|name|Описание|
|----------|-----------------|
|[CDC::AbortDoc](#abortdoc)|Завершает текущее задание печати, удаляя все, что приложение записало на устройство с момента последнего вызова `StartDoc` функции члена.|
|[CDC::AbortPath](#abortpath)|Закрывает и удаляет все пути в контексте устройства.|
|[CDC::AddMetaFileComment](#addmetafilecomment)|Копирует комментарий из буфера в заданный метафайл расширенного формата.|
|[CDC::AlphaBlend](#alphablend)|Отображает растровые изображения, имеющие прозрачные или полупрозрачные пиксели.|
|[CDC::AngleArc](#anglearc)|Рисует сегмент линии и дугу и перемещает текущую позицию в конечную точку дуги.|
|[CDC::Arc](#arc)|Рисование эллиптической дуги.|
|[CDC::ArcTo](#arcto)|Рисование эллиптической дуги. Эта функция аналогична `Arc`функции, за исключением того, что текущая позицией обновляется.|
|[CDC::Attach](#attach)|Присоединяет контекст устройства Windows к этому `CDC` объекту.|
|[CDC::BeginPath](#beginpath)|Открывает скобку пути в контексте устройства.|
|[CDC::BitBlt](#bitblt)|Копирует растровое изображение из указанного контекста устройства.|
|[CDC::Chord](#chord)|Рисование аккорда (замкнутая фигура, ограниченная пересечением эллипса и сегмента линии).|
|[CDC:: Клосефигуре](#closefigure)|Закрывает открытую фигуру в контуре.|
|[CDC::CreateCompatibleDC](#createcompatibledc)|Создает контекст устройства памяти, совместимый с другим контекстом устройства. Его можно использовать для подготовки образов в памяти.|
|[CDC::CreateDC](#createdc)|Создает контекст устройства для конкретного устройства.|
|[CDC::CreateIC](#createic)|Создает информационный контекст для конкретного устройства. Это обеспечивает быстрый способ получения сведений об устройстве без создания контекста устройства.|
|[CDC::DeleteDC](#deletedc)|Удаляет контекст устройства Windows, связанный с этим `CDC` объектом.|
|[CDC::DeleteTempMap](#deletetempmap)|Вызывается обработчиком времени `CDC` `FromHandle` простоядляудалениялюбоговременногообъекта`CWinApp` , созданного. Также отсоединяет контекст устройства.|
...
|[CDC::DPtoLP](#dptolp)|Преобразует единицы устройства в логические устройства.|
...
|[CDC::DrawFrameControl](#drawframecontrol)|Нарисуйте элемент управления Frame.|
...
|[CDC::DrawTextEx](#drawtextex)|Рисует форматированный текст в указанном прямоугольнике, используя дополнительные форматы.|
|[CDC::Ellipse](#ellipse)|Рисование эллипса.|
|[CDC::EndDoc](#enddoc)|Завершает задание печати, `StartDoc` запущенное функцией-членом.|
|[CDC::EndPage](#endpage)|Информирует драйвер устройства о том, что страница заканчивается.|
|[CDC::EndPath](#endpath)|Закрывает скобку пути и выбирает путь, определенный скобкой, в контекст устройства.|
|[CDC::EnumObjects](#enumobjects)|Перечисляет перья и кисти, доступные в контексте устройства.|
...
|[CDC::ExcludeClipRect](#excludecliprect)|Создает новую область отсечения, состоящую из существующей области отсечения, за вычетом указанного прямоугольника.|
|[CDC::ExcludeUpdateRgn](#excludeupdatergn)|Запрещает прорисовку в недопустимых областях окна, исключая обновленную область в окне из вырезанной области.|
|[CDC::ExtFloodFill](#extfloodfill)|Заполняет область текущей кистью. Обеспечивает большую гибкость, чем функция члена [CDC:: флудфилл](#floodfill) .|
|[CDC::ExtTextOut](#exttextout)|Записывает строку символов в прямоугольной области, используя выбранный в данный момент шрифт.|
|[CDC::FillPath](#fillpath)|Закрывает все открытые фигуры в текущем контуре и заполняет внутреннюю часть пути, используя текущую кисть и режим заливки многоугольников.|
|[CDC::FillRect](#fillrect)|Заполняет заданный прямоугольник с помощью определенной кисти.|
...
|[CDC::FlattenPath](#flattenpath)|Преобразует все кривые в пути, выбранном в текущий контекст устройства, и превращает каждую кривую в последовательность строк.|
|[CDC::FloodFill](#floodfill)|Заполняет область текущей кистью.|
...
|[CDC::GetAspectRatioFilter](#getaspectratiofilter)|Извлекает параметр для текущего фильтра пропорций.|
|[CDC::GetBkColor](#getbkcolor)|Извлекает текущий цвет фона.|
|[CDC::GetBkMode](#getbkmode)|Возвращает фоновый режим.|
|[CDC::GetBoundsRect](#getboundsrect)|Возвращает текущий накопленный ограничивающий прямоугольник для указанного контекста устройства.|
|[CDC::GetBrushOrg](#getbrushorg)|Извлекает источник текущей кисти.|
|[CDC::GetCharABCWidths](#getcharabcwidths)|Получает значения ширины (в логических единицах) последовательных символов в заданном диапазоне от текущего шрифта.|
|[CDC::GetCharABCWidthsI](#getcharabcwidthsi)|Извлекает ширину в логических единицах последовательных индексов глифов в указанном диапазоне из текущего шрифта TrueType.|
|[CDC::GetCharacterPlacement](#getcharacterplacement)|Извлекает различные типы данных в символьной строке.|
|[CDC::GetCharWidth](#getcharwidth)|Получает дробную ширину последовательных символов в заданном диапазоне от текущего шрифта.|
|[CDC::GetCharWidthI](#getcharwidthi)|Получает значения ширины (в логических координатах) последовательных индексов глифов в указанном диапазоне из текущего шрифта.|
|[CDC::GetClipBox](#getclipbox)|Получает размеры ограничивающего прямоугольника вокруг текущей границы обрезки.|
|[CDC::GetColorAdjustment](#getcoloradjustment)|Получает значения коррекции цвета для контекста устройства.|
|[CDC::GetCurrentBitmap](#getcurrentbitmap)|Возвращает указатель на текущий выбранный `CBitmap` объект.|
|[CDC::GetCurrentBrush](#getcurrentbrush)|Возвращает указатель на текущий выбранный `CBrush` объект.|
|[CDC::GetCurrentFont](#getcurrentfont)|Возвращает указатель на текущий выбранный `CFont` объект.|
|[CDC::GetCurrentPalette](#getcurrentpalette)|Возвращает указатель на текущий выбранный `CPalette` объект.|
|[CDC::GetCurrentPen](#getcurrentpen)|Возвращает указатель на текущий выбранный `CPen` объект.|
|[CDC::GetCurrentPosition](#getcurrentposition)|Извлекает текущую точку пера (в логических координатах).|
...
|[CDC::GetDeviceCaps](#getdevicecaps)|Извлекает указанные сведения о конкретных возможностях устройства для конкретного устройства.|
|[CDC::GetFontData](#getfontdata)|Получает сведения о метриках шрифта из масштабируемого файла шрифта. Сведения для извлечения определяются путем указания смещения в файле шрифта и длины возвращаемых данных.|
|[CDC::GetFontLanguageInfo](#getfontlanguageinfo)|Возвращает сведения о выбранном в данный момент шрифте для указанного контекста вывода.|
|[CDC::GetGlyphOutline](#getglyphoutline)|Получает кривую или точечную карту для символа структуры в текущем шрифте.|
|[CDC::GetGraphicsMode](#getgraphicsmode)|Извлекает текущий графический режим для указанного контекста устройства.|
|[CDC::GetHalftoneBrush](#gethalftonebrush)|Извлекает полутоновую кисть.|
|[CDC::GetKerningPairs](#getkerningpairs)|Извлекает пары знаков кернинга для шрифта, выбранного в данный момент в указанном контексте устройства.|
|[CDC::GetLayout](#getlayout)|Извлекает макет контекста устройства (DC). Макет может принимать значение слева направо (по умолчанию) или справа налево (зеркальное отображение).|
|[CDC::GetMapMode](#getmapmode)|Возвращает текущий режим сопоставления.|
|[CDC::GetMiterLimit](#getmiterlimit)|Возвращает предел среза для контекста устройства.|
|[CDC::GetNearestColor](#getnearestcolor)|Получает ближайший логический цвет к указанному логическому цвету, который может представлять данное устройство.|
|[CDC::GetOutlineTextMetrics](#getoutlinetextmetrics)|Получает сведения о метрике шрифта для шрифтов TrueType.|
|[CDC::GetOutputCharWidth](#getoutputcharwidth)|Получает ширину отдельных символов в последовательных группах символов из текущего шрифта с помощью контекста выходного устройства.|
|[CDC::GetOutputTabbedTextExtent](#getoutputtabbedtextextent)|Вычисление ширины и высоты символьной строки в контексте устройства вывода.|
|[CDC::GetOutputTextExtent](#getoutputtextextent)|Вычисление ширины и высоты строки текста в контексте устройства вывода с использованием текущего шрифта для определения измерений.|
|[CDC::GetOutputTextMetrics](#getoutputtextmetrics)|Извлекает метрики для текущего шрифта из контекста выходного устройства.|
|[CDC::GetPath](#getpath)|Получает координаты, определяющие конечные точки линий и контрольные точки кривых, обнаруженные в пути, выбранном в контексте устройства.|
...
|[CDC::GetSafeHdc](#getsafehdc)|Возвращает [CDC:: m_hDC](#m_hdc), выходной контекст устройства.|
|[CDC::GetStretchBltMode](#getstretchbltmode)|Извлекает текущий режим растяжения растрового изображения.|
|[CDC::GetTabbedTextExtent](#gettabbedtextextent)|Вычисление ширины и высоты символьной строки в контексте устройства атрибута.|
|[CDC::GetTextAlign](#gettextalign)|Получает флаги выравнивания текста.|
|[CDC::GetTextCharacterExtra](#gettextcharacterextra)|Извлекает текущее значение для интервала между символами.|
|[CDC::GetTextColor](#gettextcolor)|Извлекает текущий цвет текста.|
|[CDC::GetTextExtent](#gettextextent)|Вычисление ширины и высоты строки текста в контексте устройства атрибута с использованием текущего шрифта для определения измерений.|
|[CDC::GetTextExtentExPointI](#gettextextentexpointi)|Извлекает количество символов в указанной строке, которые помещаются в указанном пространстве, и заполняет массив строкой текста для каждого из этих символов.|
|[CDC::GetTextExtentPointI](#gettextextentpointi)|Получает ширину и высоту указанного массива индексов глифа.|
|[CDC::GetTextFace](#gettextface)|Копирует имя гарнитуры текущего шрифта в буфер как строку, завершающуюся нулем.|
|[CDC::GetTextMetrics](#gettextmetrics)|Извлекает метрики для текущего шрифта из контекста устройства атрибута.|
|[CDC::GetViewportExt](#getviewportext)|Извлекает экстенты x и y окна просмотра.|
|[CDC::GetViewportOrg](#getviewportorg)|Получает координаты x и y источника окна просмотра.|
|[CDC::GetWindow](#getwindow)|Возвращает окно, связанное с контекстом дисплея устройства.|
|[CDC::GetWindowExt](#getwindowext)|Извлекает экстенты по оси x и y связанного окна.|
|[CDC::GetWindowOrg](#getwindoworg)|Получает координаты x и y источника связанного окна.|
|[CDC::GetWorldTransform](#getworldtransform)|Извлекает текущее мировое пространство для преобразования страничного пространства.|
|[CDC::GradientFill](#gradientfill)|Выполняет заливку прямоугольников и структур треугольников цветом градатинг.|
|[CDC::GrayString](#graystring)|Рисует затененный (серый) текст в заданном месте.|
|[CDC:: Химетриктодп](#himetrictodp)|Преобразует единицы HIMETRIC в единицы устройства.|
|[CDC::HIMETRICtoLP](#himetrictolp)|Преобразует единицы HIMETRIC в логические устройства.|
|[CDC::IntersectClipRect](#intersectcliprect)|Создает новую область обрезки, формируя пересечение текущей области и прямоугольника.|
...
|[CDC::OffsetClipRgn](#offsetcliprgn)|Перемещает область обрезки данного устройства.|
|[CDC::OffsetViewportOrg](#offsetviewportorg)|Изменяет источник окна просмотра относительно координат текущего источника окна просмотра.|
|[CDC::OffsetWindowOrg](#offsetwindoworg)|Изменяет начальное положение окна относительно координат текущего исходного окна.|
|[CDC::PaintRgn](#paintrgn)|Заполняет область выбранной кистью.|
|[CDC::PatBlt](#patblt)|Создает битовый шаблон.|
|[CDC::Pie](#pie)|Рисует сектор с круговой фигурой.|
|[CDC::PlayMetaFile](#playmetafile)|Воспроизводит содержимое указанного метафайла на заданном устройстве. В улучшенной версии `PlayMetaFile` отображается изображение, сохраненное в заданном метафайле расширенного формата. Метафайл может воспроизводиться любое количество раз.|
|[CDC::PlgBlt](#plgblt)|Выполняет побитовую блокировку битов данных цвета из указанного прямоугольника в контексте исходного устройства на заданный параллелограмм в данном контексте устройства.|
|[CDC::PolyBezier](#polybezier)|Рисует одну или несколько Бзиер линий. Текущая позицией не используется и не обновляется.|
|[CDC::PolyBezierTo](#polybezierto)|Рисует одну или несколько Бзиер сплайнов и перемещает текущую позицию в конечную точку последнего Бзиерного сплайна.|
|[CDC::PolyDraw](#polydraw)|Рисует набор сегментов линий и Бзиерных линий. Эта функция обновляет текущую точку.|
|[CDC::Polygon](#polygon)|Рисует многоугольник, состоящий из двух или более точек (вершин), Соединенных линиями.|
|[CDC::Polyline](#polyline)|Рисует набор сегментов линии, соединяющих указанные точки.|
|[CDC::PolylineTo](#polylineto)|Рисует одну или несколько прямых линий и перемещает текущую позицию в конечную точку последней строки.|
|[CDC::PolyPolygon](#polypolygon)|Создает два или более многоугольников, заполненных с помощью текущего режима заполнения многоугольников. Многоугольники могут быть несвязанными, или они могут перекрываться.|
|[CDC::PolyPolyline](#polypolyline)|Рисует несколько рядов Соединенных линейных сегментов. Текущая позицией не используется и не обновляется этой функцией.|
|[CDC::PtVisible](#ptvisible)|Указывает, находится ли заданная точка в области отсечения.|
|[CDC::RealizePalette](#realizepalette)|Сопоставляет записи палитры в текущей логической палитре с системной палитрой.|
...
|[CDC::ReleaseAttribDC](#releaseattribdc)|Выпуски `m_hAttribDC`— контекст устройства атрибута.|
|[CDC::ReleaseOutputDC](#releaseoutputdc)|Выпуски `m_hDC`, контекст выходного устройства.|
|[CDC::ResetDC](#resetdc)|Обновляет контекст `m_hAttribDC` устройства.|
|[CDC::RestoreDC](#restoredc)|Восстанавливает контекст устройства до предыдущего состояния, сохраненного с помощью `SaveDC`.|
|[CDC::RoundRect](#roundrect)|Рисование прямоугольника с закругленными углами с помощью текущего пера и заполнение с помощью текущей кисти.|
|[CDC::SaveDC](#savedc)|Сохраняет текущее состояние контекста устройства.|
|[CDC::ScaleViewportExt](#scaleviewportext)|Изменяет экстент окна просмотра относительно текущих значений.|
...
|[CDC::SelectClipPath](#selectclippath)|Выбирает текущий путь в качестве вырезанной области для контекста устройства, объединяя новый регион с любой существующей областью отсечения, используя указанный режим.|
|[CDC::SelectClipRgn](#selectcliprgn)|Объединяет заданную область с текущей вырезанной областью с использованием указанного режима.|
...
|[CDC::SetArcDirection](#setarcdirection)|Задает направление рисования, которое будет использоваться для функций дуги и Rectangle.|
|[CDC::SetAttribDC](#setattribdc)|Задает `m_hAttribDC`контекст устройства атрибута.|
|[CDC::SetBkColor](#setbkcolor)|Задает текущий цвет фона.|
|[CDC::SetBkMode](#setbkmode)|Задает фоновый режим.|
|[CDC::SetBoundsRect](#setboundsrect)|Управляет накоплением данных ограничивающего прямоугольника для указанного контекста устройства.|
|[CDC::SetBrushOrg](#setbrushorg)|Указывает источник для следующей кисти, выбранной в контексте устройства.|
|[CDC::SetColorAdjustment](#setcoloradjustment)|Задает значения коррекции цвета для контекста устройства, используя указанные значения.|
|[CDC::SetDCBrushColor](#setdcbrushcolor)|Задает текущий цвет кисти.|
|[CDC::SetDCPenColor](#setdcpencolor)|Задает текущий цвет пера.|
|[CDC::SetGraphicsMode](#setgraphicsmode)|Задает текущий графический режим для указанного контекста устройства.|
...
|[CDC::SetMapperFlags](#setmapperflags)|Изменяет алгоритм, используемый средством сопоставления шрифтов при сопоставлении логических шрифтов с физическими шрифтами.|
|[CDC::SetMiterLimit](#setmiterlimit)|Задает ограничение длины угловых соединений для контекста устройства.|
|[CDC::SetOutputDC](#setoutputdc)|Задает `m_hDC`контекст выходного устройства.|
|[CDC::SetPixel](#setpixel)|Устанавливает пиксел в указанной точке в ближайшее приближение указанного цвета.|
|[CDC::SetPixelV](#setpixelv)|Задает пиксель с заданными координатами до ближайшей аппроксимации указанного цвета. `SetPixelV`работает быстрее, `SetPixel` чем потому, что не требуется возвращать значение цвета, нарисованное точкой.|
...
|[CDC::SetStretchBltMode](#setstretchbltmode)|Задает режим растяжения растрового изображения.|
|[CDC::SetTextAlign](#settextalign)|Задает флаги выравнивания текста.|
|[CDC::SetTextCharacterExtra](#settextcharacterextra)|Задает расстояние между символами.|
|[CDC::SetTextColor](#settextcolor)|Задает цвет текста.|
|[CDC::SetTextJustification](#settextjustification)|Добавляет пробел к символам разрыва в строке.|
|[CDC::SetViewportExt](#setviewportext)|Задает экстенты x и y окна просмотра.|
|[CDC::SetViewportOrg](#setviewportorg)|Задает источник окна просмотра.|
|[CDC::SetWindowExt](#setwindowext)|Задает экстенты x и y связанного окна.|
|[CDC::SetWindowOrg](#setwindoworg)|Задает происхождение окна контекста устройства.|
|[CDC::SetWorldTransform](#setworldtransform)|Устанавливает текущее мировое пространство для преобразования страничного пространства.|
|[CDC::StartDoc](#startdoc)|Информирует драйвер устройства о запуске нового задания печати.|
|[CDC::StartPage](#startpage)|Информирует драйвер устройства о запуске новой страницы.|
|[CDC::StretchBlt](#stretchblt)|Перемещает растровое изображение из исходного прямоугольника и устройства в прямоугольник назначения, растягивание или сжатие растрового изображения, если это необходимо, чтобы вместить размеры прямоугольника назначения.|
|[CDC::StrokeAndFillPath](#strokeandfillpath)|Закрывает все открытые фигуры в контуре, разменяя контур контура, используя текущее перо, и заполняет внутреннюю часть с помощью текущей кисти.|
|[CDC::StrokePath](#strokepath)|Отображает указанный путь с помощью текущего пера.|
|[CDC::TabbedTextOut](#tabbedtextout)|Записывает строку символов в указанном месте, расширяя знаки табуляции на значения, указанные в массиве позиций табуляции.|
|[CDC::TextOut](#textout)|Записывает строку символов в указанном месте, используя текущий выбранный шрифт.|
|[CDC::TransparentBlt](#transparentblt)|Передает битовый блок данных о цвете из указанного исходного контекста устройства в контекст целевого устройства, выводит заданный цвет прозрачным цветом при передаче.|
|[CDC::UpdateColors](#updatecolors)|Обновляет клиентскую область контекста устройства, сопоставляя текущие цвета в клиентской области с системной палитрой в зависимости от пикселя.|
|[CDC::WidenPath](#widenpath)|Переопределяет текущий путь в качестве области, которая будет окрашена, если контур был штрих с использованием пера, выбранного в данный момент в контексте устройства.|
...
Все рисование с помощью функций- `CDC` членов объекта. Класс предоставляет функции-члены для операций контекста устройства, работы с инструментами рисования, выбора объектов GDI и работы с цветами и палитрами. Он также предоставляет функции элементов для получения и установки атрибутов рисования, сопоставления, работы с окном просмотра, работы с областью окна, преобразования координат, работы с регионами, обрезки, рисования линий и рисования простых фигур, эллипсов и многоугольников. Функции-члены также предоставляются для рисования текста, работы со шрифтами, использования escape-символов принтера, прокрутки и воспроизведения метафайлов.
...
Иногда может потребоваться информация о метриках из `m_hDC` контекстов устройств и. `m_hAttribDC` Эта возможность обеспечивается следующими парами функций:
...
- Общая ошибка SP_ERROR.

- SP_OUTOFDISK недостаточно места на диске для помещения в очередь, и больше не будет свободного места.
...
*Blend*<br/>
Задает структуру [блендфунктион](/windows/desktop/api/wingdi/ns-wingdi-blendfunction) .
...
Дополнительные сведения см. в разделе [алфабленд](/windows/desktop/api/wingdi/nf-wingdi-alphablend) в Windows SDK.
...
*птстарт*<br/>
Задает координаты x и y точки, определяющей начальную точку дуги (в логических единицах). Эта точка не обязательно должна находиться в точности на дуги. Для этого параметра можно передать либо структуру [Point](/windows/desktop/api/windef/ns-windef-tagpoint) , либо объект [CPoint](../../atl-mfc-shared/reference/cpoint-class.md) .

*птенд*<br/>
Задает координаты x и y точки, определяющей конечную точку дуги (в логических единицах). Эта точка не обязательно должна находиться в точности на дуги. Для этого параметра можно передать `POINT` либо структуру, `CPoint` либо объект.
...
*лпрект*<br/>
Задает ограничивающий прямоугольник (в логических устройствах). Для этого параметра можно передать либо указатель на структуру данных [Rect](/windows/desktop/api/windef/ns-windef-tagrect) , либо объект [крект](../../atl-mfc-shared/reference/crect-class.md) .

*птстарт*<br/>
Задает координаты x и y точки, определяющей начальную точку дуги (в логических единицах). Эта точка не обязательно должна находиться в точности на дуги. Для этого параметра можно передать либо структуру данных [Point](/windows/desktop/api/windef/ns-windef-tagpoint) , либо объект [CPoint](../../atl-mfc-shared/reference/cpoint-class.md) .

*птенд*<br/>
Задает координаты x и y точки, определяющей конечную точку дуги (в логических единицах). Эта точка не обязательно должна находиться в точности на дуги. Для этого параметра можно передать `POINT` либо структуру данных, `CPoint` либо объект.
...
Параметр *HDC* хранится как в контексте `m_hDC`устройства вывода, так и в `m_hAttribDC`контексте устройства атрибута.
...
После открытия скобки пути приложение может начать вызывать функции рисования GDI для определения точек, находящихся в пути. Приложение может закрыть открывающую скобку пути, вызвав `EndPath` функцию члена. При вызове `BeginPath`приложения все предыдущие пути отбрасываются.

Список функций рисования, определяющих точки в пути, см. в разделе [бегинпас](/windows/desktop/api/wingdi/nf-wingdi-beginpath) в Windows SDK.
...
*двроп*<br/>
Определяет подлежащую выполнению растровую операцию. Коды операций с растровыми операциями определяют, как GDI объединяет цвета в операциях вывода, в которых задействована текущая кисть, возможные исходные растровые изображения и точечные рисунки назначения. Список кодов растровых операций для *двроп* и их описание см. в разделе [BitBlt](/windows/desktop/api/wingdi/nf-wingdi-bitblt) в Windows SDK.

Полный список кодов операций с растровыми изображениями см. в разделе [о растровых кодах операций](/windows/desktop/gdi/raster-operation-codes) в Windows SDK.
...
`BitBlt` Когда функция преобразует монохромное растровое изображение в цвет, оно устанавливает белые биты (1) в цвет фона и черные биты (0) в цвет переднего плана. Используются цвет переднего плана и фона конечного контекста устройства. Чтобы преобразовать цвет в монохромный режим `BitBlt` , устанавливает Пиксели, соответствующие цвету фона, белым, и устанавливает все остальные Пиксели в черные. `BitBlt`использует цвета переднего плана и фона контекста цветового устройства для преобразования цвета в монохромный режим.

Обратите внимание, что не все контексты `BitBlt`устройств поддерживаются. Чтобы проверить, поддерживает `BitBlt`ли данный контекст устройства, `GetDeviceCaps` используйте функцию-член и укажите индекс растеркапс.
...
*птстарт*<br/>
Задает координаты x и y точки, определяющей начальную точку аккорда (в логических единицах). Эта точка не обязательно должна находиться точно в соответствии с аккордом. Для этого параметра можно передать `POINT` либо структуру, `CPoint` либо объект.

*птенд*<br/>
Задает координаты x и y точки, определяющей конечную точку аккорда (в логических единицах). Эта точка не обязательно должна находиться точно в соответствии с аккордом. Для этого параметра можно передать либо структуру [Point](/windows/desktop/api/windef/ns-windef-tagpoint) , либо объект [CPoint](../../atl-mfc-shared/reference/cpoint-class.md) .
...
##  <a name="closefigure"></a>CDC:: Клосефигуре
...
Функция закрывает рисунок, рисуя линию от текущей позиции до первой точки фигуры (обычно это точка, заданная в последнем вызове `MoveTo` функции-члена), и соединяет линии с помощью стиля соединения линий. Если фигура закрыта с помощью `LineTo` функции-члена `CloseFigure`, а не, то для создания угла вместо объединения используются конечные точки. `CloseFigure`должен вызываться только в том случае, если в контексте устройства есть открывающая скобка пути.

Рисунок в пути открыт, если он явно не закрыт с помощью этой функции. (Фигура может быть открыта, даже если текущая и начальная точки фигуры совпадают.) Любая линия или кривая, добавленная в `CloseFigure` путь после начала новой фигуры.
...
Эта функция может использоваться только для создания совместимых контекстов устройств для устройств, поддерживающих растровые операции. Сведения о передаче битовых блоков между контекстами устройств см. в описании функции-члена [CDC:: BitBlt](#bitblt) . Чтобы определить, поддерживает ли контекст устройства растровые операции, см. раздел RC_BITBLT растровой возможности в `CDC::GetDeviceCaps`функции-члене.
...
*лпсздривернаме*<br/>
Указывает на строку, завершающуюся нулем, которая указывает имя файла (без расширения) драйвера устройства (например, "EPSON"). Для этого параметра можно `CString` передать объект.

*лпсздевиценаме*<br/>
Указывает на строку, завершающуюся нулем, которая указывает имя конкретного устройства, которое должно поддерживаться (например, "EPSON FX-80"). Параметр *лпсздевиценаме* используется, если модуль поддерживает более одного устройства. Для этого параметра можно `CString` передать объект.

*лпсзаутпут*<br/>
Указывает на строку, завершающуюся нулем, которая указывает имя файла или устройства для физического выходного носителя (файла или порта). Для этого параметра можно `CString` передать объект.
...
Функция члена удаляет контексты устройств Windows, связанные с `m_hDC` текущим `CDC` объектом. `DeleteDC` Если этот `CDC` объект является последним активным контекстом устройства для данного устройства, устройство получает уведомления, а все системные ресурсы, используемые устройством, освобождаются.
...
Вызывается автоматически `CWinApp` обработчиком времени простоя, `DeleteTempMap` удаляет `FromHandle`все временные `CDC` объекты, созданные, но не уничтожает дескрипторы `hDC`контекста устройства, которые временно связаны с `CDC` объекты.

```
static void PASCAL DeleteTempMap();
```

##  <a name="detach"></a>CDC::D етач

Вызовите эту функцию, `m_hDC` чтобы отсоединить (контекст устройства вывода) `CDC` от объекта и установить `m_hDC` оба `m_hAttribDC` параметра и в NULL.
...
##  <a name="dptohimetric"></a>CDC::D Птохиметрик
...
*лпсизе*<br/>
Указывает на структуру [размера](/windows/desktop/api/windef/ns-windef-tagsize) или объект [ксизе](../../atl-mfc-shared/reference/csize-class.md) .
...
*лппоинтс*<br/>
Указывает на массив структур [точек](/windows/desktop/api/windef/ns-windef-tagpoint) или объектов [CPoint](../../atl-mfc-shared/reference/cpoint-class.md) .

*нкаунт*<br/>
Количество точек в массиве.

*лпрект*<br/>
Указывает на структуру [Rect](/windows/desktop/api/windef/ns-windef-tagrect) или объект [крект](../../atl-mfc-shared/reference/crect-class.md) . Этот параметр используется для простого преобразования одного прямоугольника из точек устройства в логические точки.
...
*лпрект*<br/>
Задает ограничивающий прямоугольник (в логических устройствах). Для этого параметра можно передать либо указатель на структуру [Rect](/windows/desktop/api/windef/ns-windef-tagrect) , либо объект [крект](../../atl-mfc-shared/reference/crect-class.md) .
...
##  <a name="drawdragrect"></a>CDC::D Равдрагрект
...
*лпрект*<br/>
Указывает на структуру [Rect](/windows/desktop/api/windef/ns-windef-tagrect) или объект [крект](../../atl-mfc-shared/reference/crect-class.md) , указывающий логические координаты прямоугольника — в данном случае конечную точку перерисовки прямоугольника.
...
*лпректласт*<br/>
Указывает на структуру [Rect](/windows/desktop/api/windef/ns-windef-tagrect) или объект [крект](../../atl-mfc-shared/reference/crect-class.md) , указывающий логические координаты позиции прямоугольника (в данном случае — исходное расположение прямоугольника, который перерисовывается).
...
##  <a name="drawedge"></a>CDC::D Раведже
...
*недже*<br/>
Указывает тип внутреннего и внешнего краев для рисования. Этот параметр должен быть сочетанием одного флага внутренней границы и одного флага внешней границы. См. раздел [драведже](/windows/desktop/api/winuser/nf-winuser-drawedge) в Windows SDK для таблицы типов параметра.
...
##  <a name="drawescape"></a>CDC::D Равескапе
...
##  <a name="drawfocusrect"></a>CDC::D Равфокусрект
...
*лпрект*<br/>
Указывает на структуру [Rect](/windows/desktop/api/windef/ns-windef-tagrect) или объект [крект](../../atl-mfc-shared/reference/crect-class.md) , указывающий логические координаты прямоугольника для рисования.

### <a name="remarks"></a>Примечания

Поскольку это логическая функция XOR, вызов этой функции во второй раз с тем же прямоугольником удаляет прямоугольник из экрана. Невозможно прокрутить прямоугольник, нарисованный этой функцией. Для прокрутки области, содержащей прямоугольник, рисуемый этой функцией, `DrawFocusRect` сначала необходимо вызвать метод, чтобы удалить прямоугольник из отображения, затем прокрутить область `DrawFocusRect` и затем вызвать еще раз, чтобы нарисовать прямоугольник в новой должности.
...
*Nуведомления*<br/>
Задает тип элемента управления фрейма для рисования. Список возможных значений этого параметра см. в параметре *утипе* в [дравфрамеконтрол](/windows/desktop/api/winuser/nf-winuser-drawframecontrol) в Windows SDK.

*Nсведения*<br/>
Задает начальное состояние элемента управления Frame. Может быть одним или несколькими значениями, описанными для `DrawFrameControl` параметра *устате* в в Windows SDK. Используйте значение *NСВЕДЕНИЯ* DFCS_ADJUSTRECT для настройки ограничивающего прямоугольника, чтобы исключить окружающую границу кнопки.
...
- DFC_BUTTON
    ...
    - Кнопка с тремя состояниями DFCS_BUTTON3STATE
    ...
    - Изображение DFCS_BUTTONRADIOIMAGE для переключателя (изображение с неквадратными требованиями)

    - DFCS_BUTTONRADIOMASK mask для переключателя (неквадратная маска необходимости)

- DFC_CAPTION

    - Кнопка закрытия DFCS_CAPTIONCLOSE

    - Кнопка "Справка" DFCS_CAPTIONHELP

    - Кнопка развертывания DFCS_CAPTIONMAX

    - Кнопка сворачивания DFCS_CAPTIONMIN
...
- DFC_SCROLL
    ...
    - DFCS_SCROLLDOWN стрелка вниз на полосе прокрутки

    - DFCS_SCROLLLEFT стрелка влево на полосе прокрутки

    - Стрелка вправо DFCS_SCROLLRIGHT полосы прокрутки

    - Захват размера DFCS_SCROLLSIZEGRIP в правом нижнем углу окна

    - DFCS_SCROLLUP стрелка вверх на полосе прокрутки
...
*point*<br/>
Задает логические координаты x и y верхнего левого угла значка. Для этого параметра можно передать структуру [точек](/windows/desktop/api/windef/ns-windef-tagpoint) или объект [CPoint](../../atl-mfc-shared/reference/cpoint-class.md) .
...
Ресурс значка должен быть ранее загружен с помощью функций `CWinApp::LoadIcon`, `CWinApp::LoadStandardIcon`или `CWinApp::LoadOEMIcon`. Перед использованием этой функции необходимо выбрать режим сопоставления.`MM_TEXT`

### <a name="example"></a>Пример

  См. пример для [CWnd:: «Icon](../../mfc/reference/cwnd-class.md#isiconic)».

##  <a name="drawstate"></a>CDC::D Равстате
...
*нфлагс*<br/>
Флаги, указывающие тип и состояние изображения. Возможные типы и состояния *нфлагс* см. в разделе [дравстате](/windows/desktop/api/winuser/nf-winuser-drawstatea) в Windows SDK.
...
*нкаунт*<br/>
Указывает число символов в строке. Если *нкаунт* имеет значение-1, то предполагается, что *лпсзстринг* является длинным указателем на строку, завершающуюся `DrawText` нулем, и автоматически подсчитывает число символов.

*лпрект*<br/>
Указывает на структуру [Rect](/windows/desktop/api/windef/ns-windef-tagrect) или объект [крект](../../atl-mfc-shared/reference/crect-class.md) , содержащий прямоугольник (в логических координатах), в котором должен быть отформатирован текст.

*str*<br/>
Объект [CString](../../atl-mfc-shared/reference/cstringt-class.md) , содержащий указанные символы для рисования.

*нформат*<br/>
Задает метод форматирования текста. Это может быть любое сочетание значений, описанных для параметра *UFormat* в [DrawText](/windows/desktop/api/winuser/nf-winuser-drawtext) в Windows SDK. (объединение с использованием побитового оператора OR):

> [!NOTE]
>  Некоторые сочетания флагов *UFormat* могут привести к изменению передаваемой строки. Использование DT_MODIFYSTRING с DT_END_ELLIPSIS или DT_PATH_ELLIPSIS может привести к изменению строки, что приведет к утверждению в `CString` переопределении. Значения DT_CALCRECT, DT_EXTERNALLEADING, DT_INTERNAL, DT_NOCLIP и DT_NOPREFIX не могут использоваться со значением DT_TABSTOP.
...
Если установлен флаг выравнивания текста TA_UPDATECP (см. раздел [CDC:: сеттексталигн](#settextalign)), `DrawText` текст будет отображаться начиная с текущей позиции, а не слева от данного прямоугольника. `DrawText`не будет переносить текст, если установлен флаг TA_UPDATECP (т. е. флаг DT_WORDBREAK не будет оказывать никакого влияния).
...
*лпдтпарамс*<br/>
Указатель на структуру [дравтекстпарамс](/windows/desktop/api/winuser/ns-winuser-tagdrawtextparams) , указывающую дополнительные параметры форматирования. Этот параметр может иметь значение NULL.

### <a name="remarks"></a>Примечания

Он форматирует текст путем расширения табуляции в соответствующие пробелы, выравнивание текста по левому краю, правому или центру данного прямоугольника, а также разбиение текста на строки, попадающие в пределах данного прямоугольника. Тип форматирования задается *нформат* и *лпдтпарамс*. Дополнительные сведения см. в разделе [CDC::D равтекст](#drawtext) и [дравтекстекс](/windows/desktop/api/winuser/nf-winuser-drawtextexa) в Windows SDK.
...
Если приложение сталкивается с ошибкой печати или отмененной операцией печати, она не должна пытаться завершить операцию с помощью `EndDoc` либо или [абортдок](#abortdoc). GDI автоматически прерывает операцию, прежде чем возвращать значение ошибки.
...
##  <a name="enumobjects"></a>CDC:: Енумобжектс
...
Обратите внимание, что новые возможности C++ Microsoft Visual позволяют использовать обычную функцию в качестве функции, передаваемой в `EnumObjects`. Адрес, переданный `EnumObjects` в, является указателем на функцию, экспортированную с помощью **экспорта** , и с соглашением о вызовах Pascal. В приложениях, защищенных в режиме защиты, не нужно создавать эту функцию с помощью функции Windows МакепроЦинстанце или освобождать функцию после использования с функцией ФрипроЦинстанце Windows.
...
Для компиляции программ Microsoft Foundation обычно используются параметры компилятора/GA и/жес. Параметр компилятора/GW не используется с классами Microsoft Foundation. (Если вы используете функцию `MakeProcInstance`Windows, необходимо явным образом привести возвращаемый указатель функции из фарпрок к типу, который требуется в этом API.) Интерфейсы регистрации обратного вызова теперь являются типобезопасными (необходимо передать указатель на функцию, указывающий на правильный тип функции для конкретного обратного вызова).
...
Полный список escape-функций см. в разделе [escape](/windows/desktop/api/wingdi/nf-wingdi-escape) в Windows SDK.
...
Для программирования в `CDC` Win32 теперь предоставляет шесть функций-членов, которые заменяют соответствующие escape-последовательности принтера:
...
Кроме того, [CDC:: жетдевицекапс](#getdevicecaps) поддерживает индексы Win32, заменяющие другие escape-последовательности принтера. Дополнительные сведения см. в разделе [жетдевицекапс](/windows/desktop/api/wingdi/nf-wingdi-getdevicecaps) в Windows SDK.

Эта функция-член позволяет приложениям получать доступ к отдельным устройствам, которые недоступны напрямую через GDI.

Используйте первую версию, если приложение использует предопределенные escape-значения. Используйте вторую версию, если приложение определяет закрытые escape-значения. Дополнительные сведения о второй версии см. в разделе [екстескапе](/windows/desktop/api/wingdi/nf-wingdi-extescape) в Windows SDK.

##  <a name="excludecliprect"></a>CDC:: Ексклудеклипрект
...
Задает тип новой области отсечения. Может принимать любое из следующих значений:
...
##  <a name="excludeupdatergn"></a>CDC:: Ексклудеупдатергн

Запрещает прорисовку в недопустимых областях окна, исключая обновленную область в окне из области обрезки, `CDC` связанной с объектом.
...
- ФЛУДФИЛЛБОРДЕР область заливки ограничена цветом, заданным параметром *крколор*. Этот стиль идентичен заполнению, `FloodFill`выполняемому.
...
Только контексты устройств памяти и устройства, поддерживающие поддержку `ExtFloodFill`технологии растрового изображения. Дополнительные сведения см. в описании функции члена [жетдевицекапс](#getdevicecaps) .
...
*лпрект*<br/>
Указывает на структуру [Rect](/windows/desktop/api/windef/ns-windef-tagrect) , определяющую размеры прямоугольника. Этот параметр может иметь значение NULL. Для этого параметра также можно передать объект [крект](../../atl-mfc-shared/reference/crect-class.md) .
...
Если *ноптионс* равен 0, а *лпрект* имеет значение null, функция записывает текст в контекст устройства без использования прямоугольной области. По умолчанию текущая позиция не используется и не обновляется функцией. Если приложению необходимо обновить текущую точку при вызове `ExtTextOut`, приложение может `CDC` вызвать функцию члена [сеттексталигн](#settextalign) с параметром *нфлагс* , для которого задано значение TA_UPDATECP. Если этот флаг установлен, Windows игнорирует *x* и *y* при `ExtTextOut` последующих вызовах и использует текущую точку. Если приложение использует TA_UPDATECP для обновления текущей позицией, `ExtTextOut` устанавливает текущую точку в конец предыдущей строки текста или в расположение, указанное последним элементом массива, на который указывает *лпдксвидсс*, в зависимости от того, что выше.
...
*лпрект*<br/>
Указывает на структуру [Rect](/windows/desktop/api/windef/ns-windef-tagrect) , содержащую логические координаты прямоугольника для заполнения. Для этого параметра также можно передать объект [крект](../../atl-mfc-shared/reference/crect-class.md) .
...
Необходимо либо создать кисть с помощью функций члена [кбруш](../../mfc/reference/cbrush-class.md) [креатехатчбруш](../../mfc/reference/cbrush-class.md#createhatchbrush), [креатепаттернбруш](../../mfc/reference/cbrush-class.md#createpatternbrush)и `GetStockObject` [креатесолидбруш](../../mfc/reference/cbrush-class.md#createsolidbrush), либо получить с помощью функции Windows.

При заполнении указанного прямоугольника `FillRect` не включает правую и нижнюю стороны прямоугольника. GDI заполняет прямоугольник вплоть до, но не включает, правый столбец и нижнюю строку независимо от текущего режима сопоставления. `FillRect`Сравнивает значения `top`элементов, `bottom`, `left`и `right` указанного прямоугольника. Если `bottom` значение `right` `left`параметра меньше или равно илименьшеилиравно,прямоугольникнерисуется.`top`

`FillRect`аналогичен [CDC:: филлсолидрект](#fillsolidrect); `FillRect` однако принимает кисть и, следовательно, может использоваться для заливки прямоугольника сплошным цветом, раскрашенным цветом, заштрихованными кистями или шаблоном. `FillSolidRect`использует только сплошные цвета (обозначенные параметром COLORREF). `FillRect`обычно медленнее, `FillSolidRect`чем.
...
`CBrush` Кисть необходимо создать либо с помощью функций `CreateHatchBrush`элементов, `CreatePatternBrush` `CreateSolidBrush`, или, извлекаемых `GetStockObject`.
...
*лпрект*<br/>
Задает ограничивающий прямоугольник (в логических устройствах). Для этого параметра можно передать либо указатель на структуру данных [Rect](/windows/desktop/api/windef/ns-windef-tagrect) , либо `CRect` объект.
...
`FillSolidRect`очень похож на [CDC:: филлрект](#fillrect); Однако использует только сплошные цвета (обозначенные параметром COLORREF), в `FillRect` то время как принимает кисть и, следовательно, может использоваться для заполнения прямоугольника сплошным цветом, раскрашенным цветом, заштрихованными кистями или шаблоном. `FillSolidRect` `FillSolidRect`обычно выполняется быстрее, `FillRect`чем.
...
Предполагается, что область ограничена, как указано в *крколор*. Функция начинается с точки, заданной x и *y* , и продолжается во всех направлениях до границы цвета. `FloodFill`

Функция- `FloodFill` член поддерживает только контексты устройств памяти и устройства, поддерживающие технологию растровой изображения. Сведения о возможности RC_BITBLT см. в `GetDeviceCaps` разделе функция члена.

`ExtFloodFill` Функция предоставляет аналогичные возможности, но большую гибкость.

##  <a name="framerect"></a>CDC:: Фрамерект
...
*лпрект*<br/>
Указывает на структуру [Rect](/windows/desktop/api/windef/ns-windef-tagrect) или объект [крект](../../atl-mfc-shared/reference/crect-class.md) , который содержит логические координаты левого верхнего и правого нижнего угла прямоугольника. Также можно передать `CRect` объект для этого параметра.
...
Если `bottom` координата прямоугольника меньше или `top`равна, или если `right` меньше или равно `left`, прямоугольник не рисуется.

Граница, нарисованная `FrameRect` , находится в той же области, что и граница `Rectangle` , нарисованная функцией-членом `Rectangle` с теми же координатами (если использует перо, равное 1 логической единице). Внутренняя часть прямоугольника не заполняется `FrameRect`.

##  <a name="framergn"></a>CDC:: Фрамергн
...
##  <a name="getarcdirection"></a>CDC:: Жетаркдиректион
...
- AD_COUNTERCLOCKWISE дуги и прямоугольники нарисованы против часовой стрелки.

- AD_CLOCKWISEные дуги и прямоугольники рисуются по часовой стрелке.
...
- Происходит накопление ограничивающего прямоугольника DCB_ACCUMULATE.

- Ограничивающий прямоугольник DCB_RESET пуст.

- Ограничивающий прямоугольник DCB_SET не пуст.

- Накопление с границами DCB_ENABLE.

- Накопление с границами DCB_DISABLE отключено.
...
*нкаунт*<br/>
Задает длину строки. Для версии ANSI это число БАЙТОВ, а для функции Юникода это число слов. Дополнительные сведения см. в разделе [жетчарактерплацемент](/windows/desktop/api/wingdi/nf-wingdi-getcharacterplacementa).
...
*лпресултс*<br/>
Указатель на структуру [GCP_Results](/windows/desktop/api/wingdi/ns-wingdi-taggcp_resultsa) , которая получает результаты функции.

*dwFlags*<br/>
Указывает способ обработки строки в требуемых массивах. Этот параметр может быть одним или несколькими значениями, перечисленными в разделе *dwFlags* раздела [жетчарактерплацемент](/windows/desktop/api/wingdi/nf-wingdi-getcharacterplacementa) .
...
Эта функция члена эмулирует функциональность функции [жетчарактерплацемент](/windows/desktop/api/wingdi/nf-wingdi-getcharacterplacementa), как описано в Windows SDK.

##  <a name="getcharabcwidths"></a>CDC:: Жетчарабквидсс
...
*лпабк*<br/>
Указывает на массив структур [ABC](/windows/desktop/api/wingdi/ns-wingdi-abc) , которые получают ширину символов при возврате функции. Этот массив должен содержать по меньшей мере `ABC` столько структур, сколько символов в диапазоне, указанном параметрами *нфирстчар* и *нластчар* .

*lpABCF*<br/>
Указывает на предоставляемый приложением буфер с массивом структур [ABCFLOAT](/windows/desktop/api/wingdi/ns-wingdi-abcfloat) для получения ширины символов при возврате функции. Ширина, возвращаемая этой функцией, находится в формате IEEE с плавающей запятой.
...
Когда функция-член получает отрицательные значения ширины "A" или "C" для символа, этот символ включает в себя зависание или перестает отвечать. `GetCharABCWidths`

Чтобы преобразовать ширину ABC в единицы проектирования шрифта, приложение должно создать шрифт, высота которого (как `lfHeight` указано в элементе структуры [LOGFONT](/windows/desktop/api/wingdi/ns-wingdi-taglogfonta) ), равна `ntmSizeEM` значению, хранящемуся в элементе [невтекстметрик](/windows/desktop/api/wingdi/ns-wingdi-tagnewtextmetrica) дереве. (Значение `ntmSizeEM` члена можно получить, вызвав функцию Windows [EnumFontFamilies](/windows/desktop/api/wingdi/nf-wingdi-enumfontfamiliesa) .)

Ширина ABC символа по умолчанию используется для символов, находящихся за пределами диапазона текущего выбранного шрифта.

Чтобы получить ширину символов в шрифтах, отличных от TrueType, приложения должны использовать функцию Windows [жетчарвидс](/windows/desktop/api/wingdi/nf-wingdi-getcharwidtha) .
...
*лпабк*<br/>
Указатель на массив [ABC](/windows/desktop/api/wingdi/ns-wingdi-abc) , принимающий ширину символов. Этот массив должен содержать по меньшей мере `ABC` столько структур, сколько индексов глифов, заданных параметром *CGI* .
...
Эта функция члена эмулирует функциональность функции [жетчарабквидсси](/windows/desktop/api/wingdi/nf-wingdi-getcharabcwidthsi), как описано в Windows SDK.
...
Эта функция члена эмулирует функциональность функции [жетчарвидси](/windows/desktop/api/wingdi/nf-wingdi-getcharwidthi), как описано в Windows SDK.
...
*лпрект*<br/>
Указывает на структуру [Rect](/windows/desktop/api/windef/ns-windef-tagrect) или объект [крект](../../atl-mfc-shared/reference/crect-class.md) , предназначенный для получения размеров прямоугольника.

### <a name="return-value"></a>Возвращаемое значение

Тип области обрезки. Может принимать любое из следующих значений:
...
*лпколораджуст*<br/>
Указывает на структуру данных [колораджустмент](/windows/desktop/api/wingdi/ns-wingdi-tagcoloradjustment) для получения значений коррекции цвета.
...
Если функция выполнена, возвращаемое значение является значением [COLORREF](/windows/desktop/gdi/colorref) для текущего цвета кисти.

Если функция завершается ошибкой, возвращается значение CLR_INVALID.

### <a name="remarks"></a>Примечания

Эта функция члена эмулирует функциональность функции [жетдкбрушколор](/windows/desktop/api/wingdi/nf-wingdi-getdcbrushcolor), как описано в Windows SDK.
...
Если функция выполнена, возвращаемое значение является значением [COLORREF](/windows/desktop/gdi/colorref) для текущего цвета пера.

Если функция завершается ошибкой, возвращается значение CLR_INVALID.

### <a name="remarks"></a>Примечания

Эта функция члена использует функцию Win32 [жетдкпенколор](/windows/desktop/api/wingdi/nf-wingdi-getdcpencolor), как описано в Windows SDK.
...
*ниндекс*<br/>
Указывает тип возвращаемых данных. Список значений см. в разделе [жетдевицекапс](/windows/desktop/api/wingdi/nf-wingdi-getdevicecaps) в Windows SDK.
...
Иногда приложение может использовать `GetFontData` функцию-член для сохранения шрифта TrueType с документом. Для этого приложение определяет, можно ли внедрить шрифт, а затем извлекает весь файл шрифта, указывая 0 для параметров *двтабле*, *двоффсет*и *cbData* .

Приложения могут определить, можно ли внедрить шрифт, проверив `otmfsType` элемент структуры [аутлинетекстметрик](/windows/desktop/api/wingdi/ns-wingdi-outlinetextmetrica) . Если задан бит 1 `otmfsType` из, встраивание для шрифта не разрешено. Если бит 1 снят, шрифт может быть внедрен. Если задан бит 2, то внедрение будет доступно только для чтения.
...
Возвращаемое значение определяет характеристики выбранного в данный момент шрифта. Полный список возможных значений см. в разделе [жетфонтлангуажеинфо](/windows/desktop/api/wingdi/nf-wingdi-getfontlanguageinfo).

### <a name="remarks"></a>Примечания

Эта функция члена эмулирует функциональность функции [жетфонтлангуажеинфо](/windows/desktop/api/wingdi/nf-wingdi-getfontlanguageinfo), как описано в Windows SDK.
...
Если значение *нформат* равно 0, функция заполняет структуру [глифметрикс](/windows/desktop/api/wingdi/ns-wingdi-glyphmetrics) , но не возвращает данные структуры глифов.
...
*лпбуффер*<br/>
Указывает на буфер, в который функция копирует сведения о символе структуры. Если *нформат* указывает значение GGO_NATIVE, данные копируются в виде структур ТТПОЛИГОНХЕАДЕР и ттполикурве. Если это значение равно NULL, а *нформат* — значение GGO_BITMAP или GGO_NATIVE, функция возвращает необходимый размер буфера.

*lpmat2*<br/>
Указывает на структуру [MAT2](/windows/desktop/api/wingdi/ns-wingdi-mat2) , содержащую матрицу преобразования для символа. Этот параметр не может быть равен NULL, даже если для *нформат*задано значение GGO_NATIVE.
...
Структура глифа возвращается в виде последовательности контуров. Каждый профиль определяется структурой [ттполигонхеадер](/windows/desktop/api/wingdi/ns-wingdi-tagttpolygonheader) , за которой следует `TTPOLYCURVE` столько же структур, сколько необходимо для их описания. Все точки возвращаются в виде структур [поинтфкс](/windows/desktop/api/wingdi/ns-wingdi-tagpointfx) и представляют абсолютные позиции, а не относительные перемещения. Начальной точкой, заданной `pfxStart` элементом структуры [ттполигонхеадер](/windows/desktop/api/wingdi/ns-wingdi-tagttpolygonheader) , является точка, в которой начинается контур контура. Следующие структуры [ттполикурве](/windows/desktop/api/wingdi/ns-wingdi-tagttpolycurve) могут быть либо записями ломаных линий, либо записями сплайна. Записи ломаной линии — это ряд точек; линии, нарисованные между точками, описывают контур символа. Сплайновые записи представляют собой квадратичные кривые, используемые в TrueType (то есть в виде квадратичного b-сплайна).
...
Возвращает текущий графический режим при успешном выполнении. Список значений, которые может вернуть этот метод, см. в разделе [жетграфиксмоде](/windows/desktop/api/wingdi/nf-wingdi-getgraphicsmode).
...
Этот метод создает оболочку для функции Windows GDI [жетграфиксмоде](/windows/desktop/api/wingdi/nf-wingdi-getgraphicsmode).
...
![Подробные сведения об отливке пера](../../mfc/reference/media/vc318s1.gif "Подробные сведения об отливке пера")
...
*нпаирс*<br/>
Указывает число структур [кернингпаир](/windows/desktop/api/wingdi/ns-wingdi-tagkerningpair) , на которые указывает *лпкрнпаир*. Функция не будет копировать больше пар кернинга, чем указано в *нпаирс*.
...
В случае успеха флаги макета для текущего контекста устройства. В противном случае — GDI_ERROR. Для получения расширенных сведений об ошибках вызовите [GetLastError](/windows/desktop/api/errhandlingapi/nf-errhandlingapi-getlasterror). Список флагов макета см. в разделе [CDC:: сетлайаут](#setlayout).
...
Описание режимов сопоставления см. в `SetMapMode` описании функции-члена.

> [!NOTE]
>  Если вы вызовите [сетлайаут](#setlayout) , чтобы изменить макет DC на разметку справа налево `SetLayout` , автоматически изменит режим сопоставления на MM_ISOTROPIC. Следовательно, любой последующий вызов `GetMapMode` метода возвратит MM_ISOTROPIC.
...
*лпотм*<br/>
Указывает на массив структур [аутлинетекстметрик](/windows/desktop/api/wingdi/ns-wingdi-outlinetextmetrica) . Если этот параметр имеет значение NULL, функция возвращает размер буфера, необходимого для полученных данных метрики.
...
*нкаунт*<br/>
Задает [длину строки](/windows/desktop/gdi/specifying-length-of-text-output-string) , на которую указывает *лпсзстринг*.
...
Вызовите эту функцию-член, чтобы использовать выходной контекст устройства, [m_hDC](#m_hdc)и вычислить ширину и высоту строки текста, используя текущий шрифт.
...
Извлекает метрики для текущего шрифта, используя `m_hDC`, контекст устройства вывода.
...
*лпметрикс*<br/>
Указывает на структуру [текстметрик](/windows/desktop/api/wingdi/ns-wingdi-tagtextmetrica) , которая получает метрики.
...
*лппоинтс*<br/>
Указывает на массив структур данных [Point](/windows/desktop/api/windef/ns-windef-tagpoint) или `CPoint` объектов, где размещаются конечные точки линии и контрольные точки кривой.

*лптипес*<br/>
Указывает на массив байтов, в который помещаются типы вершин. Значения могут быть одним из следующих:

- PT_MOVETO указывает, что соответствующая точка в *лппоинтс* запускает несвязанную цифру.
...
Типы PT_BEZIERTO всегда встречаются в наборах из трех. Точка в пути, непосредственно предшествующая им, определяет начальную точку кривой Бзиер. Первые две точки PT_BEZIERTO являются контрольными точками, а третья точка PT_BEZIERTO — конечной точкой (если жестко запрограммирована).
...
*нкаунт*<br/>
Указывает общее количество структур данных [точки](/windows/desktop/api/windef/ns-windef-tagpoint) , которые могут быть помещены в массив *лппоинтс* . Это значение должно совпадать с числом байтов, которые могут быть помещены в массив *лптипес* .

### <a name="return-value"></a>Возвращаемое значение

Если параметр *нкаунт* имеет ненулевое значение, число перечисленных точек. Если *нкаунт* имеет значение 0, общее число точек в пути (и `GetPath` запись данных в буферы не производится). Если *нкаунт* не равно нулю и меньше числа точек в пути, возвращаемое значение равно-1.

### <a name="remarks"></a>Примечания

Контекст устройства должен содержать закрытый путь. Точки пути возвращаются в логических координатах. Точки хранятся по пути в координатах устройства, поэтому `GetPath` изменяет точки из координат устройства на логические координаты с помощью обратного текущего преобразования. Функцию члена можно вызвать до `GetPath`, чтобы преобразовать все кривые в контуре в сегменты линии. `FlattenPath`
...
Не все устройства поддерживают функцию `GetPixel`. Дополнительные сведения см. в разделе RC_BITBLT растровая функция в функции члена [жетдевицекапс](#getdevicecaps) .

Функция `GetPixel` члена имеет две формы. Первый принимает два значения координат; второй принимает либо структуру [Point](/windows/desktop/api/windef/ns-windef-tagpoint) , либо объект [CPoint](../../atl-mfc-shared/reference/cpoint-class.md) .
...
Описание режимов `SetPolyFillMode` заливки многоугольников см. в функции-члене.
...
Режим рисования. Список значений режима рисования см. в `SetROP2` описании функции-члена.
...
Вызовите эту функцию члена для получения [m_hDC](#m_hdc), контекста выходного устройства.
...
Режим растяжения по точечному рисунку определяет способ удаления информации из растровых изображений, которые растягиваются `StretchBlt` или сжимаются функцией-членом.
...
- TA_BOTTOM Задает выравнивание по оси x и нижней части ограничивающего прямоугольника.
...
- TA_NOUPDATECP указывает, что текущая заданная позицией не обновлена.
...
Флаги выравнивания текста определяют, как `TextOut` функции `ExtTextOut` -члены и выравнивать строку текста относительно начальной точки строки. Флаги выравнивания текста не обязательно являются одиночными битовыми флагами и могут быть равны 0. Чтобы проверить, установлен ли флаг, приложение должно выполнить следующие действия:
...
Цвет текста — это цвет переднего плана символов, нарисованных с помощью функций-членов текстового интерфейса [TextOut](#textout), [ExtTextOut](#exttextout) и [TabbedTextOut](#tabbedtextout).
...
*лпсизе*<br/>
Указатель на структуру [размера](/windows/desktop/api/windef/ns-windef-tagsize) , которая получает размеры массива индексов глифов в логических единицах. Это значение не может быть равно NULL.
...
Эта функция члена эмулирует функциональность функции [жеттекстекстентекспоинти](/windows/desktop/api/wingdi/nf-wingdi-gettextextentexpointi), как описано в Windows SDK.
...
Эта функция члена эмулирует функциональность функции [жеттекстекстентпоинти](/windows/desktop/api/wingdi/nf-wingdi-gettextextentpointi), как описано в Windows SDK.
...
*рксформ*<br/>
Ссылка на структуру [XForm](/windows/desktop/api/wingdi/ns-wingdi-tagxform) , которая получает текущее мировое пространство для преобразования страничного пространства.
...
Этот метод создает оболочку для функции Windows GDI [жетворлдтрансформ](/windows/desktop/api/wingdi/nf-wingdi-getworldtransform).
...
*пвертицес*<br/>
Указатель на массив структур [тривертекс](/windows/desktop/api/wingdi/ns-wingdi-trivertex) , каждый из которых определяет вершину треугольника.

*нвертицес*<br/>
Число вершин.

*пмеш*<br/>
Массив структур [GRADIENT_TRIANGLE](/windows/desktop/api/wingdi/ns-wingdi-gradient_triangle) в режиме треугольника или массив структур [GRADIENT_RECT](/windows/desktop/api/wingdi/ns-wingdi-gradient_rect) в режиме прямоугольника.

*нмешелементс*<br/>
Число элементов (треугольников или прямоугольников) в *пмеш*.

*двмоде*<br/>
Задает режим градиентной заливки. Список возможных значений см. в разделе [градиентфилл](/windows/desktop/api/wingdi/nf-wingdi-gradientfill) в Windows SDK.
...
Дополнительные сведения см. в `GradientFill` разделе Windows SDK.
...
Ненулевое значение, если строка рисуется, или значение `TextOut` 0, если функция или предоставляемая приложением функция вывода вернула 0, или если недостаточно памяти для создания точечного рисунка памяти для затемнения.

### <a name="remarks"></a>Примечания

Функция затемняет текст, независимо от выбранной кисти и фона. Функция `GrayString` члена использует текущий выбранный шрифт. Перед использованием этой функции необходимо выбрать режим сопоставления MM_TEXT.

Приложение может рисовать затемненные (серые) строки на устройствах, поддерживающих сплошной серый цвет, без вызова `GrayString` функции-члена. Системный цвет COLOR_GRAYTEXT — это сплошной серый цвет системы, используемый для рисования отключенного текста. Приложение может вызвать `GetSysColor` функцию Windows для получения значения цвета COLOR_GRAYTEXT. Если цвет отличается от 0 (черный), приложение может вызвать `SetTextColor` функцию-член, чтобы установить цвет текста на значение цвета, а затем нарисовать строку напрямую. Если полученный цвет является черным, приложение должно вызвать `GrayString` выделенный текст как Dim (серый).

Если *лпфнаутпут* имеет значение null, GDI использует функцию [текста](/windows/desktop/api/wingdi/nf-wingdi-textouta) Windows, а *лпдата* — в качестве дальнего указателя на символ для вывода. Если выводимые символы не могут обрабатываться `TextOut` функцией-членом (например, строка хранится в виде точечного рисунка), приложение должно предоставить собственную выходную функцию.

Также обратите внимание, что все функции обратного вызова должны перехватывать исключения Microsoft Foundation перед возвратом в Windows, так как исключения не могут быть вызваны через границы обратного вызова. Дополнительные сведения об исключениях см. в статье [исключения](../../mfc/exception-handling-in-mfc.md).

Функция обратного вызова, `GrayString` передаваемая в `__stdcall` , должна использовать соглашение о вызовах `__declspec`и должна быть экспортирована с помощью.

Если платформа находится в режиме предварительного просмотра, вызов `GrayString` функции-члена преобразуется `TextOut` в вызов, а функция обратного вызова не вызывается.

##  <a name="himetrictodp"></a>CDC:: Химетриктодп
...
##  <a name="himetrictolp"></a>CDC:: Химетриктолп
...
*лпрект*<br/>
Задает прямоугольник. Для этого параметра можно передать `CRect` либо объект, либо указатель `RECT` на структуру.
...
Инверсия — это логическая операция NOT, которая отражает биты каждого пикселя. При отображении монохромных экранов функция делает белые Пиксели черными и черными пикселами белым цветом. При отображении цвета инверсия зависит от того, как создаются цвета для отображения. При `InvertRect` двойном вызове с тем же прямоугольником монитор восстанавливает предыдущие цвета.
...
*point*<br/>
Задает конечную точку для линии. Для этого параметра можно передать `POINT` либо структуру, `CPoint` либо объект.
...
*лппоинтс*<br/>
Указывает на массив точек. Каждая точка в массиве является структурой [точек](/windows/desktop/api/windef/ns-windef-tagpoint) или объектом [CPoint](../../atl-mfc-shared/reference/cpoint-class.md) .

*нкаунт*<br/>
Количество точек в массиве.

*лпрект*<br/>
Указывает на структуру [Rect](/windows/desktop/api/windef/ns-windef-tagrect) или объект [крект](../../atl-mfc-shared/reference/crect-class.md) . Этот параметр используется в общем случае для сопоставления прямоугольника от логических устройств к единицам устройства.
...
По умолчанию `m_hDC` параметр `m_hAttribDC`равен значению `CDC`другого контекста устройства, заключенного в. Как правило, `CDC` вызовы GDI, которые создают выходные данные, отправляются в контекст устройства.`m_hDC` Можно инициализировать `m_hDC` и `m_hAttribDC` указывать на различные устройства. Дополнительные сведения об использовании этих двух контекстов устройств см. в описании класса [CDC](../../mfc/reference/cdc-class.md) .

##  <a name="maskblt"></a>CDC:: Маскблт
...
##  <a name="modifyworldtransform"></a>CDC:: Модифиворлдтрансформ
...
*рксформ*<br/>
Ссылка на структуру [XForm](/windows/desktop/api/wingdi/ns-wingdi-tagxform) , используемую для изменения универсального преобразования для данного контекста устройства.

*имоде*<br/>
Указывает, каким способом данные преобразования изменяют текущее преобразование мира. Список значений, которые может выполнить этот параметр, см. в разделе [модифиворлдтрансформ](/windows/desktop/api/wingdi/nf-wingdi-modifyworldtransform).
...
Этот метод создает оболочку для функции Windows GDI [модифиворлдтрансформ](/windows/desktop/api/wingdi/nf-wingdi-modifyworldtransform).
...
*point*<br/>
Задает новую точку. Для этого параметра можно передать `POINT` либо структуру, `CPoint` либо объект.
...
Предыдущий источник окна просмотра (в координатах устройства) в `CPoint` виде объекта.
...
Этот оператор используется для получения маркера `CDC` контекста устройства объекта.
...
##  <a name="paintrgn"></a>CDC::P Аинтргн
...
Не все контексты устройств поддерживают `PatBlt` функцию. Чтобы определить, поддерживает `PatBlt`ли контекст устройства, `GetDeviceCaps` вызовите функцию-член с индексом растеркапс и проверьте возвращаемое значение для флага RC_BITBLT.
...
*лпрект*<br/>
Задает ограничивающий прямоугольник. Для этого параметра можно передать `CRect` либо объект, либо указатель `RECT` на структуру.

*птстарт*<br/>
Задает начальную точку дуги. Эта точка не обязательно должна находиться в точности на дуги. Для этого параметра можно передать либо структуру [Point](/windows/desktop/api/windef/ns-windef-tagpoint) , либо объект [CPoint](../../atl-mfc-shared/reference/cpoint-class.md) .

*птенд*<br/>
Задает конечную точку дуги. Эта точка не обязательно должна находиться в точности на дуги. Для этого параметра можно передать `POINT` либо структуру, `CPoint` либо объект.
...
*лпбаундс*<br/>
Указывает на `RECT` структуру `CRect` или объект, содержащий координаты ограничивающего прямоугольника, используемого для вывода изображения. Координаты указываются в логических единицах.
...
*лппоинтс*<br/>
Указывает на массив структур данных [Point](/windows/desktop/api/windef/ns-windef-tagpoint) , содержащих конечные точки и контрольные точки сплайна.
...
*лппоинтс*<br/>
Указывает на массив структур данных [Point](/windows/desktop/api/windef/ns-windef-tagpoint) , содержащих конечные точки и контрольные точки.
...
*лппоинтс*<br/>
Указывает на массив структур данных [Point](/windows/desktop/api/windef/ns-windef-tagpoint) , содержащий конечные точки для каждого сегмента линии, а также конечные точки и контрольные точки для каждого сплайна бзиер.

*лптипес*<br/>
Указывает на массив, указывающий, как используется каждая точка в массиве *лппоинтс* . Могут принимать одно из следующих значений:
...
- PT_BEZIERTO Указывает, что эта точка является контрольной точкой или конечной точкой Бзиер сплайна.

Типы PT_BEZIERTO всегда встречаются в наборах из трех. Текущая позиции определяет начальную точку для сплайна Бзиер. Первые две точки PT_BEZIERTO являются контрольными точками, а третья точка PT_BEZIERTO — конечной точкой. Конечная точка станет новой текущей позицией. Если не существует трех последовательных точек PT_BEZIERTO, возникает ошибка.
...
- PT_CLOSEFIGURE Указывает, что фигура автоматически закрывается после завершения типа PT_LINETO или PT_BEZIERTO для этой точки. Линия отображается с этой точки до самой последней PT_MOVETO или `MoveTo` точки.

   Этот флаг сочетается с типом PT_LINETO для строки или с типом PT_BEZIERTO конечной точки Бзиер сплайна с помощью побитового оператора **или** . Текущая позиция равна конечной точке закрывающей строки.
...
Эта функция может использоваться для рисования непересекающихся фигур вместо последовательных вызовов `CDC::MoveTo`функций, `CDC::LineTo`и `CDC::PolyBezierTo` . Линии и сплайны рисуются с помощью текущего пера, а фигуры не заполнены. Если имеется активный путь, запущенный путем вызова `CDC::BeginPath` функции-члена, `PolyDraw` добавляет к пути. Точки `CDC::MoveTo`, содержащиеся в массиве *лппоинтс* и в *лптипес* , указывают, является ли каждая точка частью `CDC::BezierTo` операции `CDC::LineTo`, или. Также можно закрывать фигуры. Эта функция обновляет текущую точку.
...
*лппоинтс*<br/>
Указывает на массив точек, указывающих вершины многоугольника. Каждая точка в массиве является `POINT` структурой `CPoint` или объектом.
...
Линии выводятся из первой точки через последующие точки с использованием текущего пера. В отличие `LineTo` от функции члена, в `Polyline` функции не используется ни обновление текущей позицией.

Дополнительные сведения см. в разделе [PolyLine](/windows/desktop/api/wingdi/nf-wingdi-polyline) в Windows SDK.
...
*лппоинтс*<br/>
Указывает на массив структур данных [Point](/windows/desktop/api/windef/ns-windef-tagpoint) , содержащих вершины линии.
...
Каждый многоугольник, указанный в вызове функции `PolyPolygon` , должен быть закрытым. В отличие от многоугольников, `Polygon` созданных функцией члена, многоугольники, `PolyPolygon` созданные, не закрываются автоматически.
...
*point*<br/>
Задает точку для проверки логических координат. Для этого параметра можно передать `POINT` либо структуру, `CPoint` либо объект.
...
*лпрект*<br/>
Задает прямоугольник в логических единицах. Для этого параметра можно передать `CRect` либо объект, либо указатель `RECT` на структуру.
...
##  <a name="rectvisible"></a>CDC:: Ректвисибле
...
Вызовите эту функцию члена, `m_hAttribDC` чтобы установить значение null.
...
Это не приводит к возникновению ошибки `Detach` . К `CDC` объекту прикрепляется только контекст выходного устройства, и только он может быть отсоединен.

##  <a name="releaseoutputdc"></a>  CDC::ReleaseOutputDC

Вызовите эту функцию члена, чтобы `m_hDC` присвоить элементу значение null.
...
Эта функция-член не может быть вызвана, когда контекст выходного устройства `CDC` присоединен к объекту. Используйте функцию `Detach` члена для отсоединения контекста выходного устройства.

##  <a name="resetdc"></a>  CDC::ResetDC

Вызовите эту функцию члена, чтобы обновить контекст устройства, `CDC` упакованный объектом.
...
Контекст устройства обновляется на основе сведений, указанных в структуре Windows `DEVMODE` . Эта функция члена сбрасывает только контекст устройства атрибута.

Приложение, как правило, использует `ResetDC` функцию-член, когда окно `WM_DEVMODECHANGE` обрабатывает сообщение. Эту функцию-член также можно использовать для изменения ориентации бумаги или лотков бумаги при печати документа.
...
*лпрект*<br/>
Задает ограничивающий прямоугольник в логических единицах. Для этого параметра можно передать `CRect` либо объект, либо указатель `RECT` на структуру.

*point*<br/>
Координата x *точки* задает ширину эллипса для рисования скругленных углов (в логических единицах). Координата y *точки* указывает высоту эллипса для рисования скругленных углов (в логических единицах). Для этого параметра можно передать `POINT` либо структуру, `CPoint` либо объект.
...
Если *лпректупдате* имеет значение null, Windows не выполняет вычисление прямоугольника обновления. Если оба *пргнупдате* и *лпректупдате* имеют значение null, Windows не вычислит регион обновления. Если *пргнупдате* не равно null, Windows предполагает, что он содержит допустимый указатель на регион, обнаруженный процессом прокрутки (определяется `ScrollDC` функцией-членом). `CWnd::InvalidateRgn` При необходимости можно передать регион обновления, возвращенный в *лпректупдате* .

Приложение должно использовать `ScrollWindow` функцию-член класса `CWnd` , когда необходимо прокручивать всю клиентскую область окна. В противном случае он `ScrollDC`должен использовать.
...
- RGN_COPY. новый регион отсечения — это текущий путь.

- RGN_DIFF. новый регион обрезки включает области текущей вырезанной области, и эти элементы текущего пути исключаются.
...
- RGN_AND. новый регион обрезки объединяет пересекающиеся области текущей вырезанной области и область, обозначенную *пргн*.
...
- RGN_OR. новый регион отсечения объединяет текущую область обрезки и регион, идентифицируемый *пргн*.

- RGN_XOR. новый регион отсечения объединяет текущую область обрезки и область, обозначенную *пргн* , но исключает все перекрывающиеся области.

### <a name="return-value"></a>Возвращаемое значение

Тип области. Может принимать любое из следующих значений:
...
Указатель на заменяемый объект. Это указатель на объект одного из классов, производных от `CGdiObject`, `CPen`например, в зависимости от используемой версии функции. Если возникает ошибка, возвращается значение NULL. Эта функция может возвращать указатель на временный объект. Этот временный объект действителен только во время обработки одного сообщения Windows. Дополнительные сведения см. в разделе `CGdiObject::FromHandle`.

Версия функции-члена, которая принимает параметр Region, выполняет ту же задачу, что `SelectClipRgn` и функция-член. Его возвращаемое значение может быть любым из следующих:
...
Приложение может выбрать точечный рисунок только в контекстах устройства памяти и только в одном контексте устройства памяти за раз. Формат точечного рисунка должен быть либо монохромным, либо совместимым с контекстом устройства; Если это не так, `SelectObject` функция возвращает ошибку.

Для Windows 3,1 и более поздних `SelectObject` версий функция возвращает одно и то же значение, независимо от того, используется ли он в метафайле. В предыдущих версиях Windows `SelectObject` вернул ненулевое значение для Success и 0 в случае сбоя, если он использовался в метафайле.
...
Указатель на `CPalette` объект, идентифицирующий логическую палитру, замененную палитрой, заданной параметром *ппалетте*. Если возникает ошибка, она имеет значение NULL.
...
*ниндекс*<br/>
Указывает тип требуемого запасного объекта. Может принимать одно из следующих значений:

- Черная кисть BLACK_BRUSH.
...
- WHITE_BRUSHая белая кисть.

- BLACK_PEN черное перо.

- NULL_PEN пустое перо.

- Белое перо WHITE_PEN.

- Фиксированный системный шрифт ANSI_FIXED_FONT ANSI.
...
Обратите внимание, что функции Microsoft C++ Visual упрощают создание функции обратного вызова, передаваемой в `SetAbortProc`. Адрес, передаваемый `EnumObjects` функции-члену, является указателем на функцию, экспортируемую с `__stdcall` помощью `__declspec(dllexport)` и с соглашением о вызовах.

Кроме того, не нужно экспортировать имя функции в инструкции EXPORTS в файле определения модуля приложения. Вместо этого можно использовать модификатор функции **экспорта** , как в

**Экспорт bool callback** Афунктион ( **HDC**, `int` **);**
...
##  <a name="setarcdirection"></a>CDC:: Сетаркдиректион
...
- AD_COUNTERCLOCKWISEные цифры нарисованы против часовой стрелки.

- AD_CLOCKWISEные цифры нарисованы по часовой стрелке.
...
Эта функция члена не присоединяет контекст устройства к `CDC` объекту. К `CDC` объекту прикрепляется только контекст выходного устройства.
...
##  <a name="setboundsrect"></a>CDC:: Сетбаундсрект
...
- DCB_ACCUMULATE Добавьте прямоугольник, заданный параметром *лпректбаундс* , в ограничивающий прямоугольник (с помощью операции объединения прямоугольников).

- DCB_DISABLE границы отключения.

- DCB_ENABLE включить накопление границ. (Значение по умолчанию для накопления границ отключено.)

### <a name="return-value"></a>Возвращаемое значение

Текущее состояние ограничивающего прямоугольника, если функция выполнена успешно. Каки флаги, возвращаемое значение может быть сочетанием значений **DCB_** :
...
*point*<br/>
Задает координаты x и y нового источника. Каждое значение должно находиться в диапазоне 0-7. Для этого параметра можно передать `POINT` либо структуру, `CPoint` либо объект.
...
Координаты по умолчанию для источника кисти: (0, 0). Чтобы изменить источник `UnrealizeObject` кисти, вызовите функцию `CBrush` для объекта, `SetBrushOrg`вызовите, а затем вызовите `SelectObject` функцию-член, чтобы выбрать кисть в контексте устройства.

Не используйте `SetBrushOrg` с объектами акции `CBrush` .

##  <a name="setcoloradjustment"></a>CDC:: Сетколораджустмент
...
*лпколораджуст*<br/>
Указывает на структуру данных [колораджустмент](/windows/desktop/api/wingdi/ns-wingdi-tagcoloradjustment) , содержащую значения коррекции цвета.
...
Этот метод эмулирует функциональность функции [сетдкбрушколор](/windows/desktop/api/wingdi/nf-wingdi-setdcbrushcolor), как описано в Windows SDK.
...
Эта функция члена использует функцию Win32 [сетдкпенколор](/windows/desktop/api/wingdi/nf-wingdi-setdcpencolor), как описано в Windows SDK.
...
*имоде*<br/>
Задает графический режим. Список значений, которые может выполнить этот параметр, см. в разделе [сетграфиксмоде](/windows/desktop/api/wingdi/nf-wingdi-setgraphicsmode).
...
Этот метод создает оболочку для функции Windows GDI [сетграфиксмоде](/windows/desktop/api/wingdi/nf-wingdi-setgraphicsmode).
...
В случае неудачи GDI_ERROR. Чтобы получить расширенные сведения об ошибке, вызовите [GetLastError](/windows/desktop/api/errhandlingapi/nf-errhandlingapi-getlasterror).

### <a name="remarks"></a>Примечания

Как правило, вызов для окна `SetLayout` не вызывается. Вместо этого вы управляете макетом справа налево в окне, устанавливая [Расширенные стили окон](../../mfc/reference/styles-used-by-mfc.md#extended-window-styles) , такие как WS_EX_RTLREADING. Контекст устройства, например принтер или метафайл, не наследует этот макет. Единственный способ задать контекст устройства для макета справа налево — вызвать `SetLayout`.
...
В некоторых случаях, например с несколькими точечными рисунками, может потребоваться сохранить макет слева направо. В таких случаях следует подготовить изображение путем вызова метода `BitBlt` или `StretchBlt`, а затем установить флаг элемента управления Bitmap для *двлайаут* в значение LAYOUT_BITMAPORIENTATIONPRESERVED.

После изменения макета с помощью флага LAYOUT_RTL флаги, обычно задающие право или левое, меняются местами. Чтобы избежать путаницы, может потребоваться определить альтернативные имена для стандартных флагов. Список предлагаемых альтернативных имен флагов см. в разделе [сетлайаут](/windows/desktop/api/wingdi/nf-wingdi-setlayout) в Windows SDK.
...
- MM_ISOTROPIC логические устройства преобразуются в произвольные единицы с одинаковыми масштабируемыми осями; то есть 1 единица вдоль оси x равна 1 единице вдоль оси y. Используйте функции члена `SetViewportExt`и, чтобы указать нужные единицы и ориентацию осей. `SetWindowExt` При необходимости GDI вносит необходимые изменения, чтобы гарантировать, что единицы x и y будут иметь одинаковый размер.
...
- MM_TEXT. Каждое логическое устройство преобразуется в 1 пиксель устройства. Положительный x — справа; положительный y не работает.
...
Режим сопоставления определяет единицу измерения, используемую для преобразования логических устройств в единицы устройства. Он также определяет ориентацию осей x и y устройства. GDI использует режим сопоставления для преобразования логических координат в соответствующие координаты устройства. Режим MM_TEXT позволяет приложениям работать в пикселах устройства, где 1 единица равна 1 пикселю. Физический размер пикселя меняется от устройства к устройству.
...
> [!NOTE]
>  При вызове [сетлайаут](#setlayout) для изменения макета контроллера домена (контекста устройства) на макет `SetLayout` с письмом справа налево автоматически изменяет режим сопоставления на MM_ISOTROPIC.
...
Приложение, использующее только растровые шрифты, может `SetMapperFlags` использовать функцию, чтобы убедиться, что шрифт, выбранный средством сопоставления шрифтов, является привлекательным и удобочитаемым на указанном устройстве. Приложения, использующие масштабируемые шрифты (TrueType), обычно не `SetMapperFlags`используют.
...
Эта функция-член может быть вызвана только в том случае, если контекст устройства не `CDC` был присоединен к объекту. Эта функция члена задает `m_hDC` , но не присоединяет контекст устройства `CDC` к объекту.
...
*крколор*<br/>
Значение COLORREF RGB, указывающее цвет, используемый для рисования точки. Описание этого значения см. в разделе [COLORREF](/windows/desktop/gdi/colorref) в Windows SDK.

*point*<br/>
Задает логические координаты x и y устанавливаемой точки. Для этого параметра можно передать `POINT` либо структуру, `CPoint` либо объект.
...
Не все устройства поддерживают функцию `SetPixel`. Чтобы определить, поддерживает `SetPixel`ли устройство, `GetDeviceCaps` вызовите функцию-член с индексом растеркапс и проверьте возвращаемое значение для флага RC_BITBLT.
...
*point*<br/>
Задает логические координаты x и y устанавливаемой точки. Для этого параметра можно передать либо структуру данных [Point](/windows/desktop/api/windef/ns-windef-tagpoint) , либо объект [CPoint](../../atl-mfc-shared/reference/cpoint-class.md) .
...
*ндравмоде*<br/>
Задает новый режим рисования. Может принимать любое из следующих значений:
...
- R2_NOTCOPYPEN пиксель — это инверсия цвета пера.
...
- R2_NOTMERGEPEN пиксель — это обратный цвет R2_MERGEPEN (последний пиксель = не (пиксельный экран)).

- R2_MASKPEN пиксель — это сочетание цветов, общих для пера и экрана (последний пиксель = перо и пиксельный экран).

- R2_NOTMASKPEN пиксель — это обратный цвет R2_MASKPEN (последний пиксель = не (пиксельное перо и экран пикселей)).

- R2_XORPEN пиксель — это сочетание цветов, наявляющихся на планшете или на экране, но не в обоих (финальном пикселе — на экране с перьевым экраном).

- R2_NOTXORPEN пиксель — это обратный цвет R2_XORPEN (последний пиксель = NOT (пиксель пера с изображением XOR)).
...
*nStretchMode*<br/>
Задает режим растяжения. Может принимать любое из следующих значений:
...
||После установки режима растяжения ПОЛУТОНОВ приложение должно вызвать функцию Win32 [сетбрушоржекс](/windows/desktop/api/wingdi/nf-wingdi-setbrushorgex) , чтобы задать начало координат кисти. Если это не удается сделать, происходит неправильное выравнивание кисти.|
...
- TA_LEFT выстраивает точку с левой стороны ограничивающего прямоугольника. Этот параметр используется по умолчанию.

- TA_RIGHT выстраивает точку с правой стороны ограничивающего прямоугольника.

Вторая категория влияет на выравнивание текста по оси y:

- TA_BASELINE выровнять точку по базовой строке выбранного шрифта.

- TA_BOTTOM совмещает точку с нижней границей ограничивающего прямоугольника.

- TA_TOP совмещает точку с верхней границей ограничивающего прямоугольника. Этот параметр используется по умолчанию.

Третья категория определяет, обновляются ли текущие координаты при написании текста:

- TA_NOUPDATECP не обновляет текущую точку после каждого вызова функции вывода текста. Этот параметр используется по умолчанию.

- TA_UPDATECP Обновляет текущую точку по оси x после каждого вызова функции вывода текста. Новая позиции находится в правой части ограничивающего прямоугольника для текста. Если этот флаг установлен, координаты, указанные в вызовах `TextOut` функции-члена, игнорируются.
...
Функции- `ExtTextOut` члены ииспользуютэтифлагиприразмещениистрокитекстанадисплееилинаустройстве.`TextOut` Флаги определяют связь между определенной точкой и прямоугольником, ограничивающим текст. Координаты этой точки передаются в качестве параметров `TextOut` функции члена. Прямоугольник, ограничивающий текст, формируется смежными ячейками символов в текстовой строке.
...
*нчарекстра*<br/>
Указывает объем дополнительного пространства (в логических единицах), добавляемого к каждому символу. Если текущий режим сопоставления не `MM_TEXT`равен, *нчарекстра* преобразуется и округляется до ближайшего пикселя.
...
*нбреакекстра*<br/>
Указывает общее дополнительное пространство, добавляемое в строку текста (в логических единицах). Если текущий режим сопоставления не `MM_TEXT`равен, значение, заданное этим параметром, преобразуется в текущий режим сопоставления и округляется до ближайшей единицы устройства.
...
После вызова функции- `TextOut` членавызовфункциивыводатекста(например,)распределяетзаданныйдополнительныйпробелравномерномеждузаданнымчисломсимволовразрыва.`SetTextJustification` Символ разрыва обычно является символом пробела (ASCII 32), но может быть определен шрифтом в качестве другого символа.

Функция `GetTextExtent` -член обычно используется с `SetTextJustification`. `GetTextExtent`выполняет вычисление ширины заданной строки перед выравниванием. Приложение может определить, сколько пространства следует указать в параметре *нбреакекстра* , вычитая значение, `GetTextExtent` возвращаемое из ширины строки после выравнивания.
...
После того как каждая строка будет согласована, этот термин ошибки необходимо очистить, чтобы предотвратить его встраивание в следующую строку. Термин можно очистить, вызвав `SetTextJustification` with с параметром *нбреакекстра* , равным 0.
...
*point*<br/>
Указывает источник окна просмотра. Значения должны находиться в диапазоне от системы координат устройства. Для этого параметра можно передать `POINT` либо структуру, `CPoint` либо объект.
...
Если заданы следующие режимы сопоставления, вызовы `SetWindowExt` функций и `SetViewportExt` игнорируются:
...
*point*<br/>
Задает логические координаты нового источника окна. Для этого параметра можно передать `POINT` либо структуру, `CPoint` либо объект.
...
*рксформ*<br/>
Ссылка на структуру [XForm](/windows/desktop/api/wingdi/ns-wingdi-tagxform) , которая содержит данные преобразования.
...
Этот метод создает оболочку для функции Windows GDI [сетворлдтрансформ](/windows/desktop/api/wingdi/nf-wingdi-setworldtransform).

##  <a name="startdoc"></a>  CDC::StartDoc

Информирует драйвер устройства о запуске нового задания печати и то, что все последующие `StartPage` вызовы и `EndPage` должны быть помещены `EndDoc` в очередь в том же задании, пока не произойдет вызов.
...
*лпдоЦинфо*<br/>
Указывает на структуру [доЦинфо](/windows/desktop/api/wingdi/ns-wingdi-docinfoa) , содержащую имя файла документа и имя выходного файла.
...
Этот фрагмент кода получает принтер по умолчанию, открывает задание печати и помещает в очередь одну страницу с "Hello, World!" на нем. Поскольку текст, напечатанный этим кодом, не масштабируется по логическим устройствам принтера, выходной текст может содержать небольшие буквы, в результате чего результат становится нечитаемым. Для исправления масштабирования можно использовать функции масштабирования `SetMapMode`CDC `SetViewportOrg`, такие `SetWindowExt`как, и.
...
Система отключает `ResetDC` функцию – `StartPage` член между вызовами функций и `EndPage`.
...
Функция перемещает битовую карту из исходного устройства, заданного параметром псркдк, на целевое устройство, представленное объектом контекста устройства, для которого вызывается функция-член. `StretchBlt` Параметры *кссрк*, *ИСРК*, *нсрквидс*и *нсрчеигхт* определяют левый верхний угол и размеры исходного прямоугольника. Параметры *x*, *y*, *нвидс*и *нхеигхт* предоставляют левый верхний угол и размеры прямоугольника назначения. Операция растровой операции, заданная параметром *двроп* , определяет, как объединяются исходный точечный рисунок и биты, которые уже находятся на целевом устройстве.

Функция создает зеркальное изображение точечного рисунка, если знаки параметров нсрквидс и нвидс или нсрчеигхт и нхеигхт различаются. `StretchBlt` Если *нсрквидс* и *нвидс* имеют разные знаки, функция создает зеркальное изображение точечного рисунка вдоль оси x. Если *нсрчеигхт* и *нхеигхт* имеют разные знаки, функция создает зеркальное изображение точечного рисунка вдоль оси y.
...
Не все устройства поддерживают функцию `StretchBlt`. Чтобы определить, поддерживает `StretchBlt`ли устройство, `GetDeviceCaps` вызовите функцию-член с индексом растеркапс и проверьте возвращаемое значение для флага RC_STRETCHBLT.
...
По умолчанию текущая позиция не используется и не обновляется функцией. Если приложению необходимо обновить текущую точку при вызове функции, приложение может вызвать функцию члена [сеттексталигн](#settextalign) с параметром *нфлагс* , для которого задано значение TA_UPDATECP. Если этот флаг установлен, Windows игнорирует параметры *x* и *y* при `TabbedTextOut`последующих вызовах метода, вместо этого использует текущую точку.
...
Если приложению необходимо обновить текущую точку при вызове `TextOut`, приложение может `SetTextAlign` вызвать функцию члена с параметром *нфлагс* , имеющим значение TA_UPDATECP. Если этот флаг установлен, Windows игнорирует параметры *x* и *y* при `TextOut`последующих вызовах метода, вместо этого использует текущую точку.
...
Дополнительные сведения см. в разделе [транспарентблт](/windows/desktop/api/wingdi/nf-wingdi-transparentblt) в Windows SDK.
...
Неактивное окно с реализованной логической палитрой `UpdateColors` может вызываться в качестве альтернативы перерисовки клиентской области при изменении системной палитры.

Дополнительные сведения об использовании цветовых палитр см. в разделе [упдатеколорс](/windows/desktop/api/wingdi/nf-wingdi-updatecolors) в Windows SDK.

Функция `UpdateColors` -член обычно обновляет клиентскую область быстрее, чем перерисовка области. Однако поскольку функция выполняет преобразование цвета на основе цвета каждого пикселя перед изменением системной палитры, каждый вызов этой функции приводит к утрате некоторой точности цвета.
...
Эта функция выполняется успешно, только если текущее перо является геометрическим пером, созданным второй версией `CreatePen` функции-члена, или если перо создается с первой `CreatePen` версией и имеет ширину в единицах устройства, превышающую 1. Контекст устройства должен содержать закрытый путь. Все кривые Бзиер в пути преобразуются в последовательности прямых линий, приближенные к расширяющим кривым. Таким образом, после `WidenPath` вызова бзиер кривые не остаются в пути.
