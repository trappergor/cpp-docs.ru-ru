...
Реализация по умолчанию реагирует вызовом [ReleaseCapture](https://msdn.microsoft.com/library/windows/desktop/ms646261) функции Windows. Переопределите эта функция-член в производном классе для обработки других режимов.
...
Окно получает это сообщение, даже если он вызывает [ReleaseCapture](https://msdn.microsoft.com/library/windows/desktop/ms646261) сам. Приложения не следует пытаться установить захват мыши в ответ на это сообщение. При получении этого сообщения, окно перерисовываться, при необходимости, чтобы отразить новое состояние захвата мыши.
...
Когда `CWnd` больше не требуются все команды мыши, приложение должно вызвать [ReleaseCapture](https://msdn.microsoft.com/library/windows/desktop/ms646261) функцию, чтобы другие windows может получать ввод от мыши.
