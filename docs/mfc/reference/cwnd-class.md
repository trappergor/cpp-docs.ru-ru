...
Возвращает указатель на [MSG](../../mfc/reference/msg-structure1.md) структуру, содержащую сообщение окна обрабатывает в настоящий момент. Должен вызываться только когда **на**<em>сообщение</em> обработчика.
