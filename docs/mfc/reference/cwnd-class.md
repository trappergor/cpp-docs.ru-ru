...
|[in] *nDevice*|Устройство ввода, вызвавшего событие ввода. Список возможных значений см. в разделе устройств в разделе *uDevice* раздел *lParam* параметр [WM_APPCOMMAND](/windows/desktop/inputdev/wm-appcommand).|
