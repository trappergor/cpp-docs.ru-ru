...
### <a name="parameters"></a>Параметры  
 ...
 [in] *nIconsNum*  
 Указывает количество значков в группе. Этот параметр должен быть указан только для пользовательских (рисование владельцем) группы.  
...
### <a name="parameters"></a>Параметры  
 ...
 [in] *nIndex*  
 Указывает место вставки элемента, отсчитываемый от нуля индекс расположения.  
  
 [in] *bOnTop*  
 Значение TRUE, чтобы указать, что элемент следует вставить перед галереи ленты; в противном случае — значение FALSE.  
...
### <a name="parameters"></a>Параметры  
 [in] *bEnable*  
 Значение TRUE, чтобы включить изменение размеров меню; в противном случае — значение FALSE.  
  
 [in] *bVertcalOnly*  
 Значение TRUE, чтобы указать, что коллекции могут быть изменены размеры только по вертикали; Значение FALSE, чтобы указать, что коллекции могут быть изменены размеры горизонтальном и вертикальном направлениях.  
...
### <a name="parameters"></a>Параметры  
 [in] *bEnable*  
 Значение TRUE, чтобы указать, что включено на боковой панели; в противном случае — значение FALSE.  
...
### <a name="parameters"></a>Параметры  
 [in] *nGroupIndex*  
 Указывает отсчитываемый от нуля индекс для группы, имя которого требуется извлечь.  
...
### <a name="parameters"></a>Параметры  
 [in] *nItemIndex*  
 Указывает отсчитываемый от нуля индекс элемента, для которого необходимо получить текст подсказки.  
...
### <a name="parameters"></a>Параметры  
 [in] *основного контроллера домена*  
 Указатель на контекст устройства, который используется для рисования.  
  
 [in] *rectIcon*  
 Указывает ограничивающий прямоугольник значка для рисования.  
  
 [in] *nIconIndex*  
 Указывает отсчитываемый от нуля индекс в списке изображений значков в галерее значка для рисования.  
  
 [in] *pIcon*  
 Указатель на значок, который отрисовывается.  
  
 [in] *clrText*  
 Указывает цвет для текста элемента для рисования.  
...
### <a name="parameters"></a>Параметры  
 [in] *bSet*  
 Значение TRUE для отображения галереи ленты как кнопка с раскрывающимся меню; Значение FALSE, чтобы отобразить содержимое коллекции лент непосредственно на ленте.  
...
### <a name="parameters"></a>Параметры  
 [in] *nGroupIndex*  
 Указывает отсчитываемый от нуля индекс, для которого изменяется имя группы.  
...
### <a name="parameters"></a>Параметры  
 [in] *imagesPalette*  
 Задает список изображений, содержащий значки, которые отображаются в коллекции.  
  
 [in] *uiImagesPaletteResID*  
 Указывает идентификатор ресурса в список изображений, содержащий значки, которые отображаются в коллекции.  
...
### <a name="parameters"></a>Параметры  
 [in] *nID*  
 Указывает идентификатор команды, который отправляется в сообщении WM_COMMAND, когда пользователь выбирает элемент коллекции.  
