---
title: "Обработчик сообщения WM_COMMAND | Документы Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="wmcommand-message-handler"></a>Обработчик сообщения WM_COMMAND
Следующие записи сопоставления соответствует прототип функции.  
  
|Запись сопоставления|Прототип функции|  
|---------------|------------------------|  
|ON_COMMAND (\<идентификатор настроек, \<memberFxn настроек)|(afx_msg void memberFxn);|  
