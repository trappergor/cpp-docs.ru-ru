---
title: Класс CBrush | Документация Майкрософт
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
*nUsage*<br/>
Указывает, является ли `bmiColors[]` поля [BITMAPINFO](../../mfc/reference/bitmapinfo-structure.md) структуры данных (часть «упакованные DIB») содержать явные значения RGB или индексов в настоящее время реализованных логическую палитру. Параметр должен быть одним из следующих значений:
