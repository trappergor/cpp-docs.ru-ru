...
[in] [out] *pElem* указатель на элемент, добавляемый на главной панели ленты.
...
[in] [out] *pElem* указатель на элемент, добавляемый в нижней части главной панели ленты.
