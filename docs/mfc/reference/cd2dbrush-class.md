...
### <a name="return-value"></a>Возвращаемое значение  
 Значение между 0 и 1, указывающее степень непрозрачности кисти. Это значение является константой множитель, линейно Масштабирует значения альфа все пиксели, заполненные кистью. Значения непрозрачности приводится в диапазоне от 0 до 1 перед их умножения друг с другом.  
