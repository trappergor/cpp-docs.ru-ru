...
### <a name="remarks"></a>Примечания  
 Тема определяет визуальный стиль приложения. Тема не используется для рисования текста, если *hTheme* параметр `NULL`, или если [DrawThemeTextEx](http://msdn.microsoft.com/library/windows/desktop/bb773317) метод не поддерживается, или если [диспетчер окон рабочего стола](http://msdn.microsoft.com/library/windows/desktop/aa969540) () Композиции DWM) отключена.  
