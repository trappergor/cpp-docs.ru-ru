...
После того как определен обработчик сообщений, можно перейти к определению функции-члена для добавления или изменения кода.  
 ...
 Для перехода к определение функции-члена из [представление классов](http://msdn.microsoft.com/en-us/8d7430a9-3e33-454c-a9e1-a85e3d2db925), дважды щелкните имя функции в представлении классов.  
