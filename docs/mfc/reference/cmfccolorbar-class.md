...
|name|Описание|
|----------|-----------------|
|[Кмфкколорбар:: Кмфкколорбар](#cmfccolorbar)|Создает объект `CMFCColorBar`.|
...
Как правило, `CMFCColorBar` объект напрямую не создается. Вместо этого [класс кмфкколорменубуттон](../../mfc/reference/cmfccolormenubutton-class.md) (используемый в меню и панелях инструментов) или [класс кмфкколорбуттон](../../mfc/reference/cmfccolorbutton-class.md) создает `CMFCColorBar` объект.
...
Чтобы внедрить функциональные `CMFCColorBar` возможности в приложение, выполните следующие действия.
...
1. Установите все стили и включите или отключите функции `CMFCColorBar` объекта во время создания [класса кмфкколорменубуттон](../../mfc/reference/cmfccolormenubutton-class.md) . Объект динамически создает объект после того, как платформа вызывает метод.`CreatePopupMenu` `CMFCColorBar` `CMFCColorMenuButton`

Когда пользователь нажимает кнопку элемента управления "Цветовая шкала", `ON_COMMAND` платформа использует макрос для уведомления родителя элемента управления "Цветовая шкала". В макросе параметр идентификатора команды — это значение, назначенное кнопке элемента управления "Цветовая шкала" на шаге 1 (в этом примере это ID_CHAR_COLOR). Дополнительные сведения см. в статьях [класс кмфкколорменубуттон](../../mfc/reference/cmfccolormenubutton-class.md), [класс кмфкколорбуттон](../../mfc/reference/cmfccolorbutton-class.md), класс [кмфкколорпиккерктрл](../../mfc/reference/cmfccolorpickerctrl-class.md), класс [CFrameWndEx](../../mfc/reference/cframewndex-class.md)и классы классов [CMFCToolBar](../../mfc/reference/cmfctoolbar-class.md) .
...
[кмфкколорбар](../../mfc/reference/cmfccolorbar-class.md)

## <a name="requirements"></a>Требования

**Заголовок:** афксколорбар. h

##  <a name="adjustlocations"></a>Кмфкколорбар:: Аджустлокатионс
...
Этот метод вызывается платформой во время обработки сообщения WM_SIZE.
...
##  <a name="allowshowonlist"></a>Кмфкколорбар:: Алловшовонлист
...
##  <a name="calcsize"></a>Кмфкколорбар:: Калксизе
...
##  <a name="cmfccolorbar"></a>Кмфкколорбар:: Кмфкколорбар
...
##  <a name="contexttosize"></a>Кмфкколорбар:: Контексттосизе
...
|Параметр|Описание|
|---------------|-----------------|
|*бскуаребуттонс*|окне Значение TRUE, чтобы указать, что форма кнопок в элементе управления "Цветовая шкала" является квадратной; в противном случае — значение FALSE. Значение по умолчанию — TRUE.|
|*бцентербуттонс*|окне Значение TRUE, чтобы указать, что содержимое на кнопке элемента управления "Цветовая шкала" выравнивается по центру; в противном случае — значение FALSE. Значение по умолчанию — TRUE.|

### <a name="remarks"></a>Примечания

##  <a name="create"></a>Кмфкколорбар:: Create
...
*нколумнс*<br/>
окне Число столбцов в элементе управления "полоса цветов". Значение по умолчанию — 0.

*нровсдоккхорз*<br/>
окне Число строк в элементе управления "Цветовая шкала", когда оно закреплено по горизонтали. Значение по умолчанию — 0.

*нколдоккверт*<br/>
окне Число столбцов в элементе управления "Цветовая шкала", когда оно закреплено по вертикали. Значение по умолчанию — 0.
...
##  <a name="createcontrol"></a>Кмфкколорбар:: CreateControl
...
*ппарентвнд*<br/>
окне Указатель на родительское окно. Не может принимать значение NULL.
...
##  <a name="createpalette"></a>Кмфкколорбар:: Креатепалетте
...
|Параметр|Описание|
|---------------|-----------------|
|*arColors*|окне Массив цветов.|
|*задания*|окне Палитра цветов.|

### <a name="return-value"></a>Возвращаемое значение

Значение TRUE, если этот метод успешно выполнен; в противном случае — значение FALSE.

##  <a name="enableautomaticbutton"></a>Кмфкколорбар:: Енаблеаутоматикбуттон
...
##  <a name="enableotherbutton"></a>Кмфкколорбар:: Енаблеосербуттон
...
##  <a name="getcolor"></a>Кмфкколорбар:: "Color"
...
##  <a name="getcolorgridsize"></a>Кмфкколорбар:: Жетколоргридсизе
...
|Параметр|Описание|
|---------------|-----------------|
|*бвертдокк*|окне Значение TRUE, чтобы выполнить вычисление для элемента управления "полоса цветов", закрепленного по вертикали; в противном случае выполните вычисления для горизонтально закрепленного элемента управления.|

### <a name="return-value"></a>Возвращаемое значение

Объект [ксизе](../../atl-mfc-shared/reference/csize-class.md) , компонент `cx` которого содержит количество столбцов, а компонент компонента `cy` которого содержит количество строк.

##  <a name="getcommandid"></a>Кмфкколорбар:: Жеткоммандид
...
Когда пользователь выбирает новый цвет, платформа отправляет идентификатор команды в сообщении WM_COMMAND, чтобы уведомить родителя `CMFCColorBar` объекта.

##  <a name="getextraheight"></a>Кмфкколорбар:: Жетекстрахеигхт
...
|Параметр|Описание|
|---------------|-----------------|
|*ннумколумнс*|окне Если элемент управления "полоса цветов" содержит цвета документа, то число столбцов, отображаемых в сетке цветов документа. В противном случае это значение не используется.|

### <a name="return-value"></a>Возвращаемое значение

Вычисляемая необходимая высота.

##  <a name="gethighlightedcolor"></a>Кмфкколорбар:: Жесигхлигхтедколор
...
##  <a name="gethorzmargin"></a>Кмфкколорбар:: Жесорзмаргин
...
##  <a name="getvertmargin"></a>Кмфкколорбар:: Жетвертмаргин
...
##  <a name="initcolors"></a>Кмфкколорбар:: Инитколорс
...
|Параметр|Описание|
|---------------|-----------------|
|*ппалетте*|окне Указатель на объект Palette или значение NULL. Если этот параметр имеет значение NULL, этот метод использует палитру по умолчанию операционной системы.|
|*arColors*|окне Массив цветов.|
...
##  <a name="istearoff"></a>Кмфкколорбар:: Истеарофф
...
##  <a name="onkey"></a>Кмфкколорбар:: Онкэй
...
##  <a name="onsendcommand"></a>Кмфкколорбар:: Онсендкомманд
...
|Параметр|Описание|
|---------------|-----------------|
|*пбуттон*|окне Указатель на элемент управления, находящийся на панели инструментов.|

### <a name="return-value"></a>Возвращаемое значение

Значение TRUE, если этот метод успешно выполнен; в противном случае — значение FALSE.

##  <a name="onupdatecmdui"></a>Кмфкколорбар:: Онупдатекмдуи
...
##  <a name="opencolordialog"></a>Кмфкколорбар:: Опенколордиалог
...
##  <a name="rebuild"></a>Кмфкколорбар:: Rebuild
...
##  <a name="selectpalette"></a>Кмфкколорбар:: Селектпалетте
...
|Параметр|Описание|
|---------------|-----------------|
|*pDC*|окне Указатель на контекст устройства родительской кнопки текущего элемента управления "Цветовая шкала".|

### <a name="return-value"></a>Возвращаемое значение

Указатель на палитру, которая заменяется палитрой родительской кнопки текущего элемента управления "Цветовая шкала".

##  <a name="setcolor"></a>Кмфкколорбар:: Сетколор
...
##  <a name="setcolorname"></a>Кмфкколорбар:: Сетколорнаме
...
##  <a name="setcommandid"></a>Кмфкколорбар:: Сеткоммандид
...
##  <a name="setdocumentcolors"></a>Кмфкколорбар:: Сетдокументколорс
...
##  <a name="sethorzmargin"></a>Кмфкколорбар:: Сесорзмаргин
...
##  <a name="setproplist"></a>Кмфкколорбар:: Сетпроплист
...
|Параметр|Описание|
|---------------|-----------------|
|*пвндлист*|окне Указатель на объект элемента управления сетки свойств.|

##  <a name="setvertmargin"></a>Кмфкколорбар:: Сетвертмаргин
...
##  <a name="showcommandmessagestring"></a>Кмфкколорбар:: Шовкоммандмессажестринг
...
Этот метод отправляет сообщение WM_SETMESSAGESTRING владельцу элемента управления "Цветовая шкала".
