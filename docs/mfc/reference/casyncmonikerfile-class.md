...
- [Первые шаги Интернета: Асинхронные моникеры](../../mfc/asynchronous-monikers-on-the-internet.md)

- [Первые шаги Интернета: Элементы управления ActiveX](../../mfc/activex-controls-on-the-internet.md)
...
Дополнительные сведения об асинхронных моникеров и асинхронной привязки см. в разделе [IBindStatusCallback](/previous-versions/windows/internet-explorer/ie-developer/platform-apis/ms775060\(v=vs.85\)) интерфейс и [как асинхронной привязки и рабочего хранилища](/windows/desktop/Stg/how-asynchronous-binding-and-storage-work). Описание статистической обработки, см. в разделе [статистической обработки](/windows/desktop/com/aggregation). Все три раздела предназначены в пакете Windows SDK.
