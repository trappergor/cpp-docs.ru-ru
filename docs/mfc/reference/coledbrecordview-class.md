...
### <a name="remarks"></a>Примечания  
 Реализация по умолчанию вызывает соответствующий `Move` функцию-член `CRowset` объект, связанный с представлением записи.  
