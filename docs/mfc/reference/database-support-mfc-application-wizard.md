...
- **Источник данных**
   ...
   > [!NOTE]
   > Мастер потребителя ATL OLE DB и Мастер потребителя MFC ODBC не доступны в Visual Studio 2019 г. и более поздних версий. Функциональные возможности по-прежнему можно добавить вручную. Дополнительные сведения см. в разделе [создание объекта-получателя без использования мастера](../../data/oledb/creating-a-consumer-without-using-a-wizard.md).
