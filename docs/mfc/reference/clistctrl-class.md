...
### <a name="parameters"></a>Параметры  
 *dwStyle*  
 Задает стиль элемента управления списком. Любое сочетание стилей элемента управления "список" примените к элементу управления. В разделе [стилей окна представления списка](http://msdn.microsoft.com/library/windows/desktop/bb774739) в Windows SDK для полного списка этих стилей. Расширенные стили, определенные для элемента управления с помощью набора [SetExtendedStyle](#setextendedstyle).  
...
### <a name="remarks"></a>Примечания  
 Создании `CListCtrl` в два этапа. Во-первых, вызовите конструктор, а затем вызвать `Create`, который создает элемент представления списка и прикрепляет его к `CListCtrl` объекта.  
  
 Чтобы применить расширенные стили Windows к объекту списка элемента управления, вызовите [CreateEx](#createex) вместо `Create`.  
 ...
 *dwStyle*  
 Задает стиль элемента управления списком. Любое сочетание стилей элемента управления "список" примените к элементу управления. Полный список этих стилей см. в разделе [стилей окна представления списка](http://msdn.microsoft.com/library/windows/desktop/bb774739) в Windows SDK.  
...
### <a name="remarks"></a>Примечания  
 Этот метод реализует поведение макроса Win32 [ListView_GetBkImage](http://msdn.microsoft.com/library/windows/desktop/bb761246), как описано в Windows SDK.  
...
### <a name="remarks"></a>Примечания  
 Эта функция-член реализует поведение макроса Win32 [ListView_GetCheckState](http://msdn.microsoft.com/library/windows/desktop/bb761250), как описано в Windows SDK.  
...
### <a name="remarks"></a>Примечания  
 Эта функция-член реализует поведение макроса Win32 [ListView_GetColumnOrderArray](http://msdn.microsoft.com/library/windows/desktop/bb761254), как описано в Windows SDK.  
...
### <a name="return-value"></a>Возвращаемое значение  
 Сочетание расширенные стили, которые в настоящее время в списке просмотра элемента управления. Список этих расширенные стили, см. [расширенных стилей представления списка](http://msdn.microsoft.com/library/windows/desktop/bb774732) раздел в Windows SDK.  
  
### <a name="remarks"></a>Примечания  
 Эта функция-член реализует поведение макроса Win32 [ListView_GetExtendedListViewStyle](http://msdn.microsoft.com/library/windows/desktop/bb761264), как описано в Windows SDK.  
...
### <a name="remarks"></a>Примечания  
 ...
 Этот метод отправляет [LVM_GETGROUPRECT](http://msdn.microsoft.com/library/windows/desktop/bb774935) сообщение, которое описано в Windows SDK.  
...
### <a name="remarks"></a>Примечания  
 Эта функция-член реализует поведение макроса Win32 [ListView_GetHeader](http://msdn.microsoft.com/library/windows/desktop/bb761290), как описано в Windows SDK.  
...
### <a name="remarks"></a>Примечания  
 Эта функция-член реализует поведение макроса Win32 [ListView_GetHotItem](http://msdn.microsoft.com/library/windows/desktop/bb761294), как описано в Windows SDK. Горячий элемент был определен как текущий выбранный элемент при горячей отслеживания (Выбор при наведении) включен.  
...
### <a name="remarks"></a>Примечания  
 Эта функция-член реализует поведение макроса Win32 [ListView_GetHoverTime](http://msdn.microsoft.com/library/windows/desktop/bb761296), как описано в Windows SDK.  
...
### <a name="remarks"></a>Примечания  
 Это значение является **lParam** членом [LVITEM](http://msdn.microsoft.com/library/windows/desktop/bb774760) структуры, как описано в Windows SDK  
...
### <a name="remarks"></a>Примечания  
 Состояние элемента определяется **состояние** членом [LVITEM](http://msdn.microsoft.com/library/windows/desktop/bb774760) структуры, как описано в Windows SDK. Если задать или изменить состояние элемента **stateMask** элемент указывает, какие биты состояния, которые требуется изменить.  
...
### <a name="remarks"></a>Примечания  
 Эта функция-член реализует поведение макроса Win32 [ListView_GetNumberOfWorkAreas](http://msdn.microsoft.com/library/windows/desktop/bb774988), как описано в Windows SDK.  
...
### <a name="remarks"></a>Примечания  
 Эта функция-член реализует поведение макроса Win32 [ListView_GetSelectionMark](http://msdn.microsoft.com/library/windows/desktop/bb774998), как описано в Windows SDK.  
...
### <a name="remarks"></a>Примечания  
 Эта функция-член реализует поведение сообщения Win32 [LVM_GETTOOLTIPS](http://msdn.microsoft.com/library/windows/desktop/bb761085), как описано в Windows SDK. Реализация MFC `GetToolTips` возвращает `CToolTipCtrl` объект, который используется для управления списком, а не дескриптор для элемента управления всплывающей подсказки.  
...
### <a name="remarks"></a>Примечания  
 Эта функция-член реализует поведение макроса Win32 [ListView_GetWorkAreas](http://msdn.microsoft.com/library/windows/desktop/bb775024), как описано в Windows SDK.  
 ...
 *pFlags*  
 Указатель на целое число, который получает сведения о результатах теста. См. описание **флаги** членом [LVHITTESTINFO](http://msdn.microsoft.com/library/windows/desktop/bb774754) структуры в Windows SDK.  
...
### <a name="parameters"></a>Параметры  
 *pItem*  
 Указатель на [LVITEM](http://msdn.microsoft.com/library/windows/desktop/bb774760) структура, которая задает атрибуты элемента, как описано в Windows SDK.  
 ...
 *nMask*  
 *NMask* параметр указывает, какой элемент атрибутов, переданных как параметры являются допустимыми. Это может быть один или несколько значений маски, описанному в [LVITEM структуры](http://msdn.microsoft.com/library/windows/desktop/bb774760) в Windows SDK. Допустимые значения могут объединяться с помощью побитового оператора OR.  
  
 *nState*  
 Указывает состояние элемента, изображение состояния и изображение перекрытия. См. в разделах Windows SDK [структуры LVITEM](http://msdn.microsoft.com/library/windows/desktop/bb774760) Дополнительные сведения и [состояния представление списка элементов](http://msdn.microsoft.com/library/windows/desktop/bb774733) список Допустимые флаги.  
  
 *nStateMask*  
 Указывает, какие биты состояния элемента будут извлечены или изменены. В разделе [LVITEM структуры](http://msdn.microsoft.com/library/windows/desktop/bb774760) в Windows SDK для получения дополнительной информации.  
...
|Параметр|Описание:|  
|---------------|-----------------|  
|[in] *индекс*|Отсчитываемый от нуля индекс элемента в текущем управления представление списка.|  
...
|Параметр|Описание:|  
|---------------|-----------------|  
|[in] *идентификатор*|Уникальный идентификатор элемента.|  
...
|Параметр|Описание:|  
|---------------|-----------------|  
|[in] *индекс*|Отсчитываемый от нуля индекс элемента.|  
  
### <a name="return-value"></a>Возвращаемое значение  
 Уникальный идентификатор для указанного элемента.  
  
### <a name="remarks"></a>Примечания  
 Элемент управления list view внутренне отслеживает элементы по индексу. Это может представлять проблемы, так как индексы можно изменить во время существования элемента управления. При создании элемента управления представления списка, можно пометить элемент с Идентификатором. Этот идентификатор можно использовать для доступа к определенного элемента в течение времени существования элемента управления представления списка.  
  
 Обратите внимание, что в многопоточной среде индекс гарантируется только в том потоке, на котором размещается элемент управления представление списка, не в фоновых потоках.  
  
 Этот метод отправляет [LVM_MAPINDEXTOID](http://msdn.microsoft.com/library/windows/desktop/bb761139) сообщение, которое описано в Windows SDK.  
...
### <a name="remarks"></a>Примечания  
 Указанные элементы не будут обновлены фактически, пока не получит сообщения WM_PAINT окно представления списка. Для немедленного обновления, вызовите Windows [UpdateWindow](http://msdn.microsoft.com/library/windows/desktop/dd145167) функции после использования этой функции.  
...
### <a name="parameters"></a>Параметры  
 *size*  
 Объект `CSize` объект, указывающий объем горизонтальной и вертикальной прокрутки в пикселях. **y** членом *размер* делится на высоту в пикселях строки в элементе управления представления списка, и элемент управления может прокручиваться по результирующее число строк.  
...
### <a name="parameters"></a>Параметры  
 *CR*  
 Фоновый цвет, чтобы определить, или `CLR_NONE` значение без цвета фона. Элементы управления представления списка с цветами фона прорисовку значительно быстрее, чем без цвета фона. Сведения см. в разделе [COLORREF](http://msdn.microsoft.com/library/windows/desktop/dd183449) в Windows SDK.  
 ...
 *обязательно ознакомьтесь с*  
 Указывает, будет ли видимым изображение состояния элемента или нет. По умолчанию *обязательно ознакомьтесь с* — **TRUE** и отображается изображения состояния. Если *обязательно ознакомьтесь с* — **FALSE**, она не отображается.  
 ...
 *pColumn*  
 Адрес [LVCOLUMN](http://msdn.microsoft.com/library/windows/desktop/bb774743) атрибуты структуру, содержащую новый столбец, как описано в Windows SDK. Структура **маска** элемент указывает, какой столбец атрибуты для установки. Если **маска** задает `LVCF_TEXT` значение структуры **pszText** член является адрес строку, завершающуюся значением null и структура **cchTextMax**элемент обрабатывается.  
...
### <a name="remarks"></a>Примечания  
 Эта функция-член реализует поведение макроса Win32 [ListView_SetColumnOrderArray](http://msdn.microsoft.com/library/windows/desktop/bb775072), как описано в Windows SDK.  
 ...
 *CX*  
 Новая ширина столбца. Может быть как **LVSCW_AUTOSIZE** или **LVSCW_AUTOSIZE_USEHEADER**, как описано в [LVM_SETCOLUMNWIDTH](http://msdn.microsoft.com/library/windows/desktop/bb761163) в Windows SDK.  
...
### <a name="parameters"></a>Параметры  
 *dwNewStyle*  
 Сочетание расширенные стили для использования элементом управления представление списка. Список этих стилей, в разделе [расширенных стилей представления списка](http://msdn.microsoft.com/library/windows/desktop/bb774732) раздел в Windows SDK.  
  
### <a name="return-value"></a>Возвращаемое значение  
 Сочетание предыдущих расширенные стили, используемые элементом управления представление списка.  
  
### <a name="remarks"></a>Примечания  
 Эта функция-член реализует поведение макроса Win32 [ListView_SetExtendedListViewStyle](http://msdn.microsoft.com/library/windows/desktop/bb775076), как описано в Windows SDK.  
...
### <a name="remarks"></a>Примечания  
 Эта функция-член реализует поведение макроса Win32 [ListView_SetHotCursor](http://msdn.microsoft.com/library/windows/desktop/bb775082), как описано в Windows SDK.  
...
### <a name="remarks"></a>Примечания  
 Эта функция-член реализует поведение макроса Win32 [ListView_SetHotItem](http://msdn.microsoft.com/library/windows/desktop/bb775083), как описано в Windows SDK.  
...
### <a name="remarks"></a>Примечания  
 Эта функция-член реализует поведение макроса Win32 [ListView_SetHoverTime](http://msdn.microsoft.com/library/windows/desktop/bb775084), как описано в Windows SDK.  
...
### <a name="remarks"></a>Примечания  
 Эта функция-член реализует поведение макроса Win32 [ListView_SetIconSpacing](http://msdn.microsoft.com/library/windows/desktop/bb775085), как описано в Windows SDK.  
...
### <a name="parameters"></a>Параметры  
 *pItem*  
 Адрес [LVITEM](http://msdn.microsoft.com/library/windows/desktop/bb774760) атрибуты структуру, содержащую новый элемент, как описано в Windows SDK. Структура **iItem** и **iSubItem** члены определения элемента или подэлемента и структура **маска** элемент указывает, какие атрибуты следует задать. Дополнительные сведения о **маска** член, в разделе **примечания**.  
...
### <a name="remarks"></a>Примечания  
 **IItem** и **iSubItem** члены **LVITEM** структуры и *nItem* и *nSubItem* Параметры идентификации элементов и подэлементов, атрибуты которого должны быть заданы.  
...
### <a name="remarks"></a>Примечания  
 Эта функция-член реализует поведение макроса Win32 [ListView_SetItemCount](http://msdn.microsoft.com/library/windows/desktop/bb775093), как описано в Windows SDK.  
...
### <a name="remarks"></a>Примечания  
 Эта функция-член реализует поведение макроса Win32 [ListView_SetItemCountEx](http://msdn.microsoft.com/library/windows/desktop/bb775095), как описано в Windows SDKand должен вызываться только для представления виртуального списка.  
 ...
 *pItem*  
 Адрес [LVITEM](http://msdn.microsoft.com/library/windows/desktop/bb774760) структуры, как описано в Windows SDK. Структура **stateMask** указывает состояние, которое bits для изменений, а также структура **состояние** член содержит новые значения для этих файлов. Другие члены учитываются.  
...
### <a name="remarks"></a>Примечания  
 Эта функция-член реализует поведение макроса Win32 [ListView_SetSelectionMark](http://msdn.microsoft.com/library/windows/desktop/bb775112), как описано в Windows SDK.  
...
### <a name="parameters"></a>Параметры  
 *CR*  
 Объект **COLORREF** указав новый цвет фона текста. Сведения см. в разделе [COLORREF](http://msdn.microsoft.com/library/windows/desktop/dd183449) в Windows SDK.  
...
### <a name="parameters"></a>Параметры  
 *CR*  
 Объект **COLORREF** цвета текста. Сведения см. в разделе [COLORREF](http://msdn.microsoft.com/library/windows/desktop/dd183449) в Windows SDK.  
...
### <a name="remarks"></a>Примечания  
 Эта функция-член реализует поведение сообщения Win32 [LVM_SETTOOLTIPS](http://msdn.microsoft.com/library/windows/desktop/bb761216), как описано в Windows SDK.  
...
### <a name="remarks"></a>Примечания  
 Эта функция-член реализует поведение макроса Win32 [ListView_SetWorkAreas](http://msdn.microsoft.com/library/windows/desktop/bb775128), как описано в Windows SDK.  
 ...
 *LParam1* параметр является 32-разрядное значение, связанное с первым элементом, который сравнивается, и *lParam2* параметр имеет значение, связанное с второго элемента. Это значения, которые были указаны в *lParam* членом элементов [LVITEM](http://msdn.microsoft.com/library/windows/desktop/bb774760) структуры, если они были добавлены в список. *LParamSort* параметра совпадает со значением *dwData* значение.  
 ...
 Этот метод отправляет [LVM_SORTITEMS](http://msdn.microsoft.com/library/windows/desktop/bb761227) сообщение, которое описано в Windows SDK.  
...
>  В процессе сортировки нестабильны содержимое представления списка. Если функция обратного вызова отправляет сообщения к элементу управления list view, отличный от [LVM_GETITEM](http://msdn.microsoft.com/library/windows/desktop/bb774953), результаты будут непредсказуемыми.  
 ...
 Этот метод отправляет [LVM_SORTITEMSEX](http://msdn.microsoft.com/library/windows/desktop/bb761228) сообщение, которое описано в Windows SDK.  
...
### <a name="remarks"></a>Примечания  
 Эта функция-член реализует поведение макроса Win32 [ListView_SubItemHitTest](http://msdn.microsoft.com/library/windows/desktop/bb775135), как описано в Windows SDK.  
