---
title: 'TN054: Вызов DAO напрямую при использовании классов MFC DAO'
ms.date: 06/28/2018
f1_keywords:
- vc.mfc.dao
helpviewer_keywords:
...
ms.locfileid: "62399659"
---
# <a name="tn054-calling-dao-directly-while-using-mfc-dao-classes"></a>TN054: Вызов DAO напрямую при использовании классов MFC DAO
