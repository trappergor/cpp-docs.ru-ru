...
### [Класс CObject. Вопросы и ответы](cobject-class-frequently-asked-questions.md)
...
##### [Серверы автоматизации. Вопросы времени существования объектов](automation-servers-object-lifetime-issues.md)
...
#### [Объекты и источники данных. Создание и удаление](data-objects-and-data-sources-creation-and-destruction.md)
#### [Объекты и источники данных. Управление](data-objects-and-data-sources-manipulation.md)
...
#### [Перетаскивание. Реализация цели перетаскивания](drag-and-drop-implementing-a-drop-target.md)
...
##### [Элементы управления ActiveX MFC. Оптимизация](mfc-activex-controls-optimization.md)
...
##### [Элементы управления ActiveX MFC. Закраска элементов управления ActiveX](mfc-activex-controls-painting-an-activex-control.md)
##### [Элементы управления ActiveX MFC. События](mfc-activex-controls-events.md)
##### [Элементы управления ActiveX MFC. Добавление стандартных событий в элемент управления ActiveX](mfc-activex-controls-adding-stock-events-to-an-activex-control.md)
##### [Элементы управления ActiveX MFC. Добавление пользовательских событий](mfc-activex-controls-adding-custom-events.md)
##### [Элементы управления ActiveX MFC. Методы](mfc-activex-controls-methods.md)
##### [Элементы управления ActiveX MFC. Добавление стандартных методов](mfc-activex-controls-adding-stock-methods.md)
##### [Элементы управления ActiveX MFC. Добавление пользовательских методов](mfc-activex-controls-adding-custom-methods.md)
##### [Элементы управления ActiveX MFC. Возврат кодов ошибок из метода](mfc-activex-controls-returning-error-codes-from-a-method.md)
##### [Элементы управления ActiveX MFC. Свойства](mfc-activex-controls-properties.md)
##### [Элементы управления ActiveX MFC. Добавление стандартных свойств](mfc-activex-controls-adding-stock-properties.md)
##### [Элементы управления ActiveX MFC. Добавление пользовательских свойств](mfc-activex-controls-adding-custom-properties.md)
##### [Элементы управления ActiveX MFC. Реализация расширенных свойств](mfc-activex-controls-advanced-property-implementation.md)
##### [Элементы управления ActiveX MFC. Доступ ко внешним свойствам](mfc-activex-controls-accessing-ambient-properties.md)
##### [Элементы управления ActiveX MFC. Страницы свойств](mfc-activex-controls-property-pages.md)
##### [Элементы управления ActiveX MFC. Добавление дополнительной страницы пользовательских свойств](mfc-activex-controls-adding-another-custom-property-page.md)
##### [Элементы управления ActiveX MFC. Использование стандартных страниц свойств](mfc-activex-controls-using-stock-property-pages.md)
##### [Элементы управления ActiveX MFC. Создание сервера автоматизации](mfc-activex-controls-creating-an-automation-server.md)
##### [Элементы управления ActiveX MFC. Использование шрифтов](mfc-activex-controls-using-fonts.md)
##### [Элементы управления ActiveX MFC. Использование изображений в элементе управления ActiveX](mfc-activex-controls-using-pictures-in-an-activex-control.md)
##### [Элементы управления ActiveX MFC. Дополнительные разделы](mfc-activex-controls-advanced-topics.md)
##### [Элементы управления ActiveX MFC. Распространение элементов управления ActiveX](mfc-activex-controls-distributing-activex-controls.md)
##### [Элементы управления ActiveX MFC. Лицензирование элемента управления ActiveX](mfc-activex-controls-licensing-an-activex-control.md)
##### [Элементы управления ActiveX MFC. Локализация элемента управления ActiveX](mfc-activex-controls-localizing-an-activex-control.md)
##### [Элементы управления ActiveX MFC. Сериализация](mfc-activex-controls-serializing.md)
##### [Элементы управления ActiveX MFC. Создание подкласса элемента управления Windows](mfc-activex-controls-subclassing-a-windows-control.md)
###### [Отраженные идентификаторы сообщений окон](reflected-window-message-ids.md)
##### [Элементы управления ActiveX MFC. Использование привязки данных в элементе управления ActiveX](mfc-activex-controls-using-data-binding-in-an-activex-control.md)
...
##### [Контейнеры элементов управления ActiveX. Включение вложения элемента управления ActiveX вручную](activex-control-containers-manually-enabling-activex-control-containment.md)
##### [Контейнеры элементов управления ActiveX. Вставка элемента управления в приложение контейнера элементов управления](inserting-a-control-into-a-control-container-application.md)
...
#### [Пошаговое руководство: Добавление объекта CTaskDialog в приложение](walkthrough-adding-a-ctaskdialog-to-an-application.md)
...
#### [Практическое руководство. Обновление объектов пользовательского интерфейса](how-to-update-user-interface-objects.md)
...
## [TN056. Установка локализированных компонентов MFC](tn056-installation-of-localized-mfc-components.md)
