---
title: Точки подключения | Документация Майкрософт
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
![Реализовать точку подключения](../mfc/media/vc37lh1.gif "vc37lh1") реализовать точку подключения
...
![Точка подключения, реализованная с помощью MFC](../mfc/media/vc37lh2.gif "vc37lh2") подключения точки реализованы с помощью MFC
