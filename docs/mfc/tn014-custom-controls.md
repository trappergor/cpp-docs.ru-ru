...
Создание подклассов является термин Windows для замены [WndProc](http://msdn.microsoft.com/94ba8ffa-3c36-46d4-ac74-9bd10b1ffd26) окна с настраиваемый `WndProc` и вызов старый `WndProc` для функциональные возможности по умолчанию.
