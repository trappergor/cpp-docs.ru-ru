---
title: 'TN014: Пользовательские элементы управления | Документация Майкрософт'
ms.custom: ''
ms.date: 06/28/2018
ms.technology:
- cpp-mfc
...
Создание подклассов является термин Windows для замены [WndProc](https://msdn.microsoft.com/94ba8ffa-3c36-46d4-ac74-9bd10b1ffd26) окна с настраиваемый `WndProc` и вызов старый `WndProc` для функциональные возможности по умолчанию.
