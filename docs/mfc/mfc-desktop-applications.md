...
## <a name="in-this-section"></a>В этом разделе  
 ...
 [Классы](reference/mfc-classes.md)  
 Предоставляет ссылки и данные файла заголовка для классов MFC.  
  
 [Внутренние классы](reference/internal-classes.md)  
 ...
 [Макросы и глобальные объекты](reference/mfc-macros-and-globals.md)  
 Предоставляет ссылки на глобальные функции и макросы в библиотеке MFC.  
  
 [Структуры, стили, обратные вызовы и схемы сообщений](reference/structures-styles-callbacks-and-message-maps.md)  
 Предоставляет ссылки на структуры, стили, обратные вызовы и схемы сообщений, используемых библиотекой MFC.  
  
 [Мастеры и диалоговые окна MFC](reference/mfc-wizards-and-dialog-boxes.md)  
...
## <a name="related-sections"></a>Связанные разделы  
 ...
 [Отладка в Visual Studio](/visualstudio/debugger/debugging-in-visual-studio.md)  
