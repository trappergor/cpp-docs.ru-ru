...
7.  Для **реализации** типа, щелкните **методы Get и Set**.  
  
8.  В **функция Get** и **задать функцию** полях введите уникальные имена для вашей функций Get и Set или примите имена по умолчанию.  
