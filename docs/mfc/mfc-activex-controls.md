...
Существуют также примеры для элементов управления ActiveX MFC. Дополнительные сведения об этих примерах см. в разделе [примеры элементов управления: элементы ActiveX на основе MFC.](../overview/visual-cpp-samples.md)
