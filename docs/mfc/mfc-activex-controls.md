...
![Взаимодействие элемента контейнера элементов управления ActiveX и управления](../mfc/media/vc37221.gif "контейнера элементов управления ActiveX из взаимодействие и управления") <br/>
Взаимодействие между контейнере элементов управления ActiveX и оконного элемента управления ActiveX

Некоторые последние сведения по оптимизации элементов управления ActiveX, см. в разделе [элементы управления MFC ActiveX: Оптимизация](../mfc/mfc-activex-controls-optimization.md).
...
![Обработка сообщений в active оконного элемента управления ActiveX](../mfc/media/vc37223.gif "обработка сообщений в active оконного элемента управления ActiveX") <br/>
Windows обработки сообщений в оконного элемента управления ActiveX (активном)
