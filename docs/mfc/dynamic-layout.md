...
![Диалоговое окно до изменения размера.](../mfc/media/mfcdynamiclayout4.png "Диалоговое окно до изменения размера.")
...
Вы можете управлять динамическим макетом, указав сведения для каждого элемента управления в редакторе ресурсов в интегрированной среде разработки, или это можно сделать программно `CMFCDynamicLayout` , обратившись к объекту для определенного элемента управления и задавая свойства.
...
1. Для диалогового окна вызовите [жетдинамиклайаут](../mfc/reference/cwnd-class.md#getdynamiclayout), метод `CWnd` класса. `GetDynamicLayout` возвращает указатель на объект `CMFCDynamicLayout` .
