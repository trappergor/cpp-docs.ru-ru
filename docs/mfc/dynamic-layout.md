...
2. Для диалогового окна, вызовите [GetDynamicLayout](../mfc/reference/cwnd-class.md#getdynamiclayout), метод `CWnd` класса. `GetDynamicLayout` Возвращает указатель на `CMFCDynamicLayout` объект.
