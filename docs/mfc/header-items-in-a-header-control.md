---
title: Элементы заголовка в элементе управления заголовка | Документы Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
У вас есть много возможностей управления внешним видом и поведением заголовков элементов управления заголовка ([CHeaderCtrl](../mfc/reference/cheaderctrl-class.md)). Каждый заголовок элемент может иметь строку, растровое изображение, изображение из списка связанных изображений или 32-разрядное значение, определенное приложением связанные с ним. Строки, растрового изображения или изображения отображается в элементе заголовка.  
...
-   [Сортировка элементов в элемент управления заголовка](../mfc/ordering-items-in-the-header-control.md)  
