...
Visual C++ и этот ресурс RT_DLGINIT не обязательно использовать связанные функции MFC, поскольку существует API вместо по данным в ресурсе. С помощью Visual C++ позволяет гораздо легче писать, обслуживать и переводить приложения в долгосрочной перспективе.
