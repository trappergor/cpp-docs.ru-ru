...
- ID_EDIT_CLEAR_ALL очищает весь документ.
   ...
   Если вы решили реализовать эту команду, мы рекомендуем использовать этот идентификатор команды. См. пример для руководства MFC [SCRIBBLE](../overview/visual-cpp-samples.md) пример реализации.
...
- ID_OLE_INSERT_NEW вставляет новый объект OLE
   ...
   См. в разделе примера MFC OLE [OCLIENT](../overview/visual-cpp-samples.md) пример полную реализацию этой команды.
