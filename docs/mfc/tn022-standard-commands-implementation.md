---
title: 'TN022: Реализация команды на Standard | Документация Майкрософт'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
- ID_INDICATOR_CAPS: Индикатор блокировки ограничение.
...
Если вы решили реализовать эти индикаторы, мы рекомендуем использовать эти идентификаторы индикатор и сохранению порядка индикаторы в строке состояния (то есть в следующем порядке: EXT, CAP, NUM, SCRL, ЗАМ, РЕК.).
