---
title: Элементы управления "Вкладка" и вкладки свойств
ms.date: 11/04/2016
helpviewer_keywords:
...
[CMNCTRL1: Демонстрация общих классов управления, часть 1](../overview/visual-cpp-samples.md)

[CMNCTRL2: Демонстрация общих классов управления, часть 2](../overview/visual-cpp-samples.md)
