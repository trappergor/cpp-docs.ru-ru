---
title: Неустранимая ошибка компилятора ресурсов RC1101 | Документы Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-diagnostics
...
Нет ресурсов указано имя двоичного файла  
 ...
 Для параметра /fo, используйте следующий синтаксис:  
  
 **Версия-КАНДИДАТ /fo**   
 ***outfilename infilename.*  версия-кандидат**