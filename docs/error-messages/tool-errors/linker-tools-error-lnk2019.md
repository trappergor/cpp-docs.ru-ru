...
### <a name="a-symbol-is-defined-in-a-c-file-but-declared-without-using-extern-c-in-a-c-file"></a>Символ определен в файле C, но объявлен без использования extern "C" в файле C++
...
### <a name="a-symbol-is-defined-as-static-and-then-later-referenced-outside-the-file"></a>Символ определяется как static , а затем на него указывает ссылка за пределами файла
...
### <a name="a-static-member-of-a-class-isnt-defined"></a>staticЧлен класса не определен
...
### <a name="you-mix-code-that-uses-native-wchar_t-with-code-that-doesnt"></a>Вы занимаетесь смешением кода, который использует собственный wchar_t код с кодом, который не
...
### <a name="a-static-data-member-is-declared-but-not-defined"></a>staticЭлемент данных объявлен, но не определен
...
### <a name="inconsistent-wchar_t-type-definitions"></a>Непротиворечивые wchar_t определения типов
