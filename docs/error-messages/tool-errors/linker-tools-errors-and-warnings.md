---
title: Ошибки и предупреждения инструментов компоновщика
ms.date: 11/17/2017
helpviewer_keywords:
- errors [C++]
...
ms.locfileid: "59477422"
---
# <a name="linker-tools-errors-and-warnings"></a>Ошибки и предупреждения инструментов компоновщика

ССЫЛКА, LIB, DUMPBIN и EDITBIN создавать эти ошибки и предупреждения.

[!INCLUDE[error-boilerplate](../../error-messages/includes/error-boilerplate.md)]

## <a name="linker-errors"></a>Ошибки компоновщика
...
## <a name="linker-warnings"></a>Предупреждения компоновщика
