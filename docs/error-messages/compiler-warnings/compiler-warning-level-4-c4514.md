---
title: "Предупреждение компилятора (уровень 4) C4514 | Microsoft Docs"
ms.custom: ""
ms.date: "12/05/2016"
...
manager: "ghogen"
---
# Предупреждение компилятора (уровень 4) C4514
[!INCLUDE[vs2017banner](../../assembler/inline/includes/vs2017banner.md)]

"функция" : неиспользуемая встроенная функция была удалена  
  
 Оптимизатор удалил неиспользуемую встроенную функцию.  
