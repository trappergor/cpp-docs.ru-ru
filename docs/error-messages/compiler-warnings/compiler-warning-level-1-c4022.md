---
title: Предупреждение (уровень 1) C4022 компилятора | Документы Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-diagnostics
...
ms.locfileid: "33271750"
---
# <a name="compiler-warning-level-1-c4022"></a>Предупреждение (уровень 1) C4022 компилятора
«функция»: несоответствие указателей для фактического параметра «число»  
