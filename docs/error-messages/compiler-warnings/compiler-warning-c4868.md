...
Это предупреждение может возникать в результате действий по обеспечению совместимости компилятора с Visual Studio 2015 с обновлением 2. Код, скомпилированный в версии до Visual Studio 2015 с обновлением 2 можно приступить к созданию C4868.
