---
title: "Предупреждение компилятора (уровень 4) C4512 | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
---
# Предупреждение компилятора (уровень 4) C4512
...
-   Удалить **константный** или ссылочный оператор из элемента данных в классе.  
  
-   Использовать оператор \#pragma [warning](../../preprocessor/warning.md), чтобы отключить предупреждение.  
