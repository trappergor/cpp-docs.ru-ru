---
title: "Компилятор C4158 предупреждение (уровень 1) | Документы Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
допущение использования #pragma pointers_to_members(full_generality, inheritance)  
 ...
 Объект **#pragma pointers_to_members (***одного | несколько | виртуальных***)** был выдан без сопутствующего **#pragma pointers_to_members(full_generality)**.
