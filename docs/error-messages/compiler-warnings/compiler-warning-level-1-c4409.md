---
title: Предупреждение компилятора (уровень 1) C4409
ms.date: 11/04/2016
f1_keywords:
- C4409
helpviewer_keywords:
...
ms.locfileid: "80162469"
---
# <a name="compiler-warning-level-1-c4409"></a>Предупреждение компилятора (уровень 1) C4409

Недопустимый размер инструкции

В инструкции отсутствует форма с указанным размером. Использовался наименьший допустимый размер.
