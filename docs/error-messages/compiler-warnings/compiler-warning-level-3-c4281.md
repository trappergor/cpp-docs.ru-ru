---
title: Предупреждение компилятора (уровень 3) C4281
ms.date: 11/04/2016
f1_keywords:
- C4281
helpviewer_keywords:
...
ms.locfileid: "74051681"
---
# <a name="compiler-warning-level-3-c4281"></a>Предупреждение компилятора (уровень 3) C4281
