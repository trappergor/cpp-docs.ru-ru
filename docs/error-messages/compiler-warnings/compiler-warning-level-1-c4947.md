---
title: "Предупреждение компилятора (уровень 1) C4947 | Microsoft Docs"
ms.custom: ""
ms.date: "12/05/2016"
...
manager: "ghogen"
---
# Предупреждение компилятора (уровень 1) C4947
[!INCLUDE[vs2017banner](../../assembler/inline/includes/vs2017banner.md)]

""тип\_или\_член": помечен как устаревший  
  
 Член или тип был помечен как устаревший с помощью класса [ObsoleteAttribute](frlrfSystemObsoleteAttributeClassTopic).  
