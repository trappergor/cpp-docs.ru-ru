---
title: "Предупреждение (уровень 2) C4948 компилятора | Документы Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
Компилятор обнаружил несоответствие типов данных и типом данных, задайте для индексированного свойства.  
