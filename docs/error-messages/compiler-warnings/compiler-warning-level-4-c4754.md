...
Правила преобразования целого числа являются сложными и существует множество ловушек незначительные. В качестве альтернативы для исправлений C4754, можно обновить код, чтобы использовать [библиотека SafeInt](../../safeint/safeint-library.md).
