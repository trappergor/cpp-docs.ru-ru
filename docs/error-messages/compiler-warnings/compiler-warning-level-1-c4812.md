---
title: "Предупреждение компилятора (уровень&#160;1) C4812 | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
---
# Предупреждение компилятора (уровень&#160;1) C4812
[!INCLUDE[vs2017banner](../../assembler/inline/includes/vs2017banner.md)]

устаревший стиль объявления: используйте "новый\_синтаксис" как альтернативу  
