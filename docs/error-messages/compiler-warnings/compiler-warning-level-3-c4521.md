...
«класс»: указано несколько конструкторы копии  
  
 Класс имеет несколько конструкторов копирования одного типа. Это сообщение является информационным; конструкторы можно вызвать в программе.  
