---
title: "Предупреждение (уровень 3) C4640 компилятора | Документы Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
«экземпляр»: создание в конструкторе локального статического объекта не является потокобезопасной  
