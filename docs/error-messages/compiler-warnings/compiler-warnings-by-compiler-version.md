...
| C4746|постоянный доступ к "Name" зависит от/volatile: < ISO | параметр MS >; Рассмотрите возможность использования встроенных функций __iso_volatile_load/Store |
