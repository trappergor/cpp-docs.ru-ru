...
| Visual C++ 2017 г. обновление 1 | 19.10.25017.0 |  
  
Можно указать только основной номер, основной и дополнительный номера или основной и дополнительный номера, а номеров сборок для __/wv__ параметр, который отключает все предупреждения для версий старше указанного числа. Например, чтобы подавить предупреждения, появившиеся в Visual C++ 2015 с обновлением 2 и более поздних версий, можно использовать __/Wv:19.00.23900__. Чтобы отключить все предупреждения, в Visual C++ 2013 и более поздних версий, можно использовать __/wv: 18__.  
...
## <a name="warnings-introduced-in-visual-c-2017-update-1"></a>Предупреждения, появившиеся в Visual C++ 2017 г. обновление 1
  
Эти предупреждения и все предупреждения в более поздних версиях, подавляются с помощью параметра компилятора __/Wv:19.10.25000__.  
...
## <a name="warnings-introduced-in-visual-c-2017-rtm"></a>Предупреждения, появившиеся в Visual C++ RTM 2017 г.  
...
## <a name="warnings-introduced-in-visual-c-2015-update-3"></a>Предупреждения, появившиеся в Visual C++ 2015 с обновлением 3  
  
Эти предупреждения и все предупреждения в более поздних версиях, подавляются с помощью параметра компилятора __/Wv:19.00.24000__.  
...
## <a name="warnings-introduced-in-visual-c-2015-update-2"></a>Предупреждения, появившиеся в Visual C++ 2015 с обновлением 2  
  
Эти предупреждения и все предупреждения в более поздних версиях, подавляются с помощью параметра компилятора __/Wv:19.00.23900__.  
...
## <a name="warnings-introduced-in-visual-c-2015-update-1"></a>Предупреждения, появившиеся в Visual C++ 2015 с обновлением 1  
  
Эти предупреждения и все предупреждения в более поздних версиях, подавляются с помощью параметра компилятора __/Wv:19.00.23500__.  
  
|||  
|-|-|  
C4426 НАХОЖДЕНИЯ НЕПРАВИЛЬНОГО|Флаги оптимизации изменены после включения заголовка, может быть связано с #pragma optimize()
...
## <a name="warnings-introduced-in-visual-c-2015-rtm"></a>Предупреждения, появившиеся в Visual C++ 2015 RTM  
  
Эти предупреждения и все предупреждения в более поздних версиях, подавляются с помощью параметра компилятора __/Wv:19__.  
...
C4473|"*описание*": передано недостаточно аргументов для строки формата
C4474|"*описание*": передано слишком много аргументов для строки формата
C4475|"*описание*": модификатор длины "*модификатор*«не может использоваться с символом поля типа»*символ*" в описателе формата
C4476|"*описание*": неизвестный символ поля типа "*символ*" в описателе формата
C4477|"*описание*": строка формата "*строка*«требует аргумент типа»*тип*", но вариативный аргумент *номер* имеет тип "*типа*"
C4478|"*описание*": позиционные и непозиционные заполнители невозможно одновременно в одной строке формата
...
## <a name="warnings-introduced-in-visual-c-2013"></a>Предупреждения, появившиеся в Visual C++ 2013  
...
## <a name="warnings-introduced-in-visual-c-2012"></a>Предупреждения, появившиеся в Visual C++ 2012  
...
C4746|переменное обращение "*имя*" определяется параметром/volatile:\<iso\|MS > Установка; Рекомендуется использовать встроенные функции __iso_volatile_load/store
...
## <a name="warnings-introduced-in-visual-c-2010"></a>Предупреждения, появившиеся в Visual C++ 2010  
...
## <a name="warnings-introduced-in-visual-c-2008"></a>Предупреждения, появившиеся в Visual C++ 2008  
...
## <a name="warnings-introduced-in-visual-c-2005"></a>Предупреждения, появившиеся в Visual C++ 2005  
...
ОШИБКА C4819|Файл содержит символ, который невозможно представить в текущей кодовой странице (*номер*). Сохраните файл в формате Юникода для предотвращения потери данных
...
## <a name="warnings-introduced-in-visual-c-2003"></a>Предупреждения, появившиеся в Visual C++ 2003  
  
Эти предупреждения и все предупреждения в более поздних версиях, подавляются с помощью параметра компилятора __/Wv:13.10__.  
...
## <a name="warnings-introduced-in-visual-c-2002"></a>Предупреждения, появившиеся в Visual C++ 2002  
...
ПРЕДУПРЕЖДЕНИЕ C4165.|«HRESULT» преобразуется в «bool»; Вы уверены, что это желаемый?
...
C4371|"*объявление*": размещение класса могло измениться с предыдущей версии компилятора из-за улучшенной упаковки члена "*типа*"
