...
Это предупреждение появился в Visual Studio 2015, в Microsoft C++ версии компилятора 18.00. Чтобы отключить предупреждения из этой версии компилятора или более поздней версии, при переносе кода, используйте [/Wv:18](../../build/reference/compiler-option-warning-level.md) параметр компилятора.
