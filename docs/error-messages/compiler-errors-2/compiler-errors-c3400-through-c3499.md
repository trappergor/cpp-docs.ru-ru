...
|C3444 ошибки компилятора|Пустые статистического класса*класса*«должен инициализироваться с»{}"|
|[C3445 ошибки компилятора](compiler-error-c3445.md)|Список инициализация копии из "*типа*" нельзя использовать явный конструктор|
...
|[Ошибка компилятора C3499](compiler-error-c3499.md)|заданное лямбда-выражение с типом возвращаемого значения void не может возвращать значение|
