---
title: "Ошибка компилятора C3631 | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
## Пример  
 Ошибка C3631 возникает только при использовании **\/clr:oldSyntax**.  
  
 Следующий пример приводит к возникновению ошибки C3631:  
