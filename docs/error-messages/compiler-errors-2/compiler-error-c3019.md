...
неверный вид приращения в операторе For директивы OpenMP  
  
 Приращение часть OpenMP `for` цикл должен использовать индекс переменной слева и справа от оператора.  
