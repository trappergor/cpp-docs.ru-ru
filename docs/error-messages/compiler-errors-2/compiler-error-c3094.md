...
ms.locfileid: "62243236"
---
# <a name="compiler-error-c3094"></a>Ошибка компилятора C3094

"атрибут": анонимное использование не допускается

Неправильно задана область действия атрибута.  Дополнительные сведения см. в разделе [User-Defined Attributes](../../extensions/user-defined-attributes-cpp-component-extensions.md).
