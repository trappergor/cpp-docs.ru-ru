---
title: "Ошибка компилятора C2948 | Документы Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
явное создание экземпляра; спецификатор класса хранения «спецификатор» не разрешен при специализации  
 ...
 Не допускается использование спецификаторов класса хранения (например, `extern`) в специализации класса шаблона, который был ранее явно создан.
