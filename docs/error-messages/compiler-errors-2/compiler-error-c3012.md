---
title: "Ошибка компилятора C3012 | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
"встроенная функция": не допускается встроенная функция непосредственно внутри параллельной области  
 ...
 [Встроенная функция компилятора](../../intrinsics/compiler-intrinsics.md) не может находиться в области `omp``parallel`.  
