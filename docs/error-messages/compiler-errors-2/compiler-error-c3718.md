---
title: "Ошибка компилятора C3718 | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
---
# Ошибка компилятора C3718
[!INCLUDE[vs2017banner](../../assembler/inline/includes/vs2017banner.md)]

"событие" может вызываться только в контексте функции\-члена принимающего класса  
  
 Событие `event` может вызываться только из принимающего класса.  
