...
|[Ошибка компилятора C2815](compiler-error-c2815.md)|«operator delete»: первый формальный параметр должен быть "void \*", но "*тип*" было использовано|
