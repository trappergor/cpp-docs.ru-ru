---
title: Ошибка компилятора C3096 | Документация Майкрософт
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-diagnostics
...
ms.locfileid: "46026352"
---
# <a name="compiler-error-c3096"></a>Ошибка компилятора C3096

"атрибут": атрибут разрешен в членах данных только классов атрибутов

Атрибут был применен неправильно.
