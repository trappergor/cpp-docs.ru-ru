---
title: "Ошибка компилятора C2700 | Документы Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
"идентификатор": невозможно инициировать (для вывода подробностей используйте /W4)  
 ...
 Невозможно инициировать объект. Скомпилируйте с [/W4](../../build/reference/compiler-option-warning-level.md) дополнительные диагностические сведения.
