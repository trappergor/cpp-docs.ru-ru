---
title: "Ошибка компилятора C3271 | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
---
# Ошибка компилятора C3271
[!INCLUDE[vs2017banner](../../assembler/inline/includes/vs2017banner.md)]

"член": недопустимое значение "значение" для атрибута FieldOffset  
  
 Отрицательное число было передано в атрибут [FieldOffset](frlrfSystemRuntimeInteropServicesFieldOffsetAttributeClassTopic).  
