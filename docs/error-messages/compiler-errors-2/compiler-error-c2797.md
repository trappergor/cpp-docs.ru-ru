...
Это предупреждение является устаревшим в Visual Studio 2015. В Visual Studio 2013 и более ранних версий, Microsoft C++ компилятор реализует инициализация списка внутри список инициализации членов или инициализатор члена нестатических данных. До Visual Studio 2013 Update 3 в таких случаях инициализация автоматически преобразовывалась в вызов функции, что могло приводить к получению неверного кода. В Visual Studio 2013 Update 3 в таких случаях выводится ошибка.
