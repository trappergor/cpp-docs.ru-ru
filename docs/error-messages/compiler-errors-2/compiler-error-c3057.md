---
title: "Ошибка компилятора C3057 | Документы Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
"символ": динамическая инициализация символов threadprivate в настоящее время не поддерживается  
 ...
 Инициализированное значение символа, используемого в [threadprivate](../../parallel/openmp/reference/threadprivate.md) предложение должно быть известно во время компиляции.  
