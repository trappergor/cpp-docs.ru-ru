...
|[Ошибка компилятора C2902](compiler-error-c2902.md)|"*токена*": непредвиденный токен следующей «или универсальных», требуется идентификатор|  
...
|C2924 ошибки компилятора|аргумент процедуры __declspec(interrupt) не находится в R2|  
