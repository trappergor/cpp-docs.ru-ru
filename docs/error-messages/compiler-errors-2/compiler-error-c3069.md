---
title: "Ошибка компилятора C3069 | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
---
# Ошибка компилятора C3069
[!INCLUDE[vs2017banner](../../assembler/inline/includes/vs2017banner.md)]

Оператор "оператор": не допускается для типа перечисления  
  
 Оператор не поддерживается для перечислений CLR.  Дополнительные сведения см. в разделе [Использование операторов и перечислений](../Topic/Operators%20and%20Enumerations.md).  
