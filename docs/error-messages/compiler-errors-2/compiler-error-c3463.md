---
title: "Ошибка компилятора C3463 | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
---
# Ошибка компилятора C3463
[!INCLUDE[vs2017banner](../../assembler/inline/includes/vs2017banner.md)]

Тип "тип" не разрешен в атрибуте implements  
  
 Недопустимый тип передан в атрибут [implements](../Topic/implements%20\(C++\).md). Например, можно передать в `implements` интерфейс, но нельзя передать указатель на интерфейс.  
