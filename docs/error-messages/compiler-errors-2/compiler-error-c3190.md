---
title: Ошибка компилятора C3190 | Документы Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-diagnostics
...
«Создание экземпляра» с предоставленными аргументами шаблона не является явным созданием экземпляра любой функции-члена «тип»  
 ...
 Компилятор обнаружил попытку сделать функция явное создание экземпляра; Тем не менее предоставленного типа аргументов не совпадают все возможные функции.  
