...
«объявление»: методы свойства может быть связан только с нестатический данные-члены  
  
 `property` Расширенный атрибут неправильно применен к статическому члену данных.  
