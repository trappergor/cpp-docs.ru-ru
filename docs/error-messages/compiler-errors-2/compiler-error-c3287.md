...
тип "тип" (тип возврата GetEnumerator) должен иметь соответствующую общую функцию-член MoveNext и общее свойство Current  
 ...
 В разделе [как: Iterate Over a User-Defined коллекцию для каждого](../../dotnet/how-to-iterate-over-a-user-defined-collection-with-for-each.md) для получения дополнительной информации.  
