---
title: "Ошибка компилятора C3812 | Документы Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
«Свойство» должен быть первый токен в объявление свойства  
  
 При объявлении свойства, `__property` ключевое слово должно быть первой лексемой в строке.  
