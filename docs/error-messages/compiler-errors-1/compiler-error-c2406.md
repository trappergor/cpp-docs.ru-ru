---
title: Ошибка компилятора C2406 | Документация Майкрософт
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-diagnostics
...
ms.locfileid: "46047191"
---
# <a name="compiler-error-c2406"></a>Ошибка компилятора C2406

"идентификатор": имя не определено в "контекст"

Неопределенный идентификатор используется с `SIZE`, `LENGTH`, или оператор выбора члена (.).