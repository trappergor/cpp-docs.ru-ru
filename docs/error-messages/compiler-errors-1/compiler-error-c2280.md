...
## <a name="example-explicitly-deleted-functions"></a>Пример Явным образом удаленные функции
...
## <a name="example-uninitialized-data-members"></a>Пример Неинициализированный данные-члены
...
## <a name="example-movable-deletes-implicit-copy"></a>Пример Неявное копирование подвижной удалений
...
## <a name="example-indirect-base-members-deleted"></a>Пример Удалить косвенных базовых членов
