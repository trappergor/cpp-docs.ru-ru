---
title: "Неустранимая ошибка C1077 | Документы Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
ограничение компилятора: не может иметь больше "число" параметров командной строки  
 ...
 Может быть слишком много символов, определенных с [/D](../../build/reference/d-preprocessor-definitions.md). (Поместите определения в файле заголовка.)
