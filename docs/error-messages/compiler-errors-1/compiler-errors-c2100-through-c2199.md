...
|[Ошибка компилятора C2104](compiler-error-c2104.md)|"&" на учитывается битовым полем|
|[Ошибка компилятора C2105](compiler-error-c2105.md)|"*оператор*" требуется левостороннее значение|
...
|[Ошибка компилятора C2108](compiler-error-c2108.md)|Индекс имеет нецелый целочисленный тип|
|[Ошибка компилятора C2109](compiler-error-c2109.md)|нижнего индекса требуется массив или указатель|
...
|Ошибка компилятора C2119|"*идентификатор*": тип для "*тип*" не может быть выведен из пустого инициализатора|
...
|[Ошибка компилятора C2122](compiler-error-c2122.md)|"*идентификатор*": параметр прототипа в списке имен|
|Ошибка компилятора C2123|"*идентификатор*": шаблоны псевдонима не может быть специализированы явно или частично|
|[Ошибка компилятора C2124](compiler-error-c2124.md)|деление на ноль или остаток от деления на ноль|
|Ошибка компилятора C2125|«constexpr» несовместим с "*маркера*"|
|Ошибка компилятора C2126|"*идентификатор*" не может быть объявлен с описателем «constexpr»|
|Ошибка компилятора C2127|"*идентификатор*": недопустимая инициализация сущности «constexpr» с неконстантное выражение|
...
|[Ошибка компилятора C2131](compiler-error-c2131.md)|выражение не определяется константой|
...
|Ошибка компилятора C2136|Создание контракта API запрещено|
...
|[Ошибка компилятора C2139](compiler-error-c2139.md)|"*класс*": неопределенный класс не допускается в качестве аргумента в характеристике внутреннего типа компилятора "*признака*"|
...
|[Ошибка компилятора C2143](compiler-error-c2143.md)|Синтаксическая ошибка: отсутствует "*токен1*«до»*токен2*"|
...
|[Ошибка компилятора C2147](compiler-error-c2147.md)|Синтаксическая ошибка: "*маркера*" — это новое ключевое слово|
...
|[Ошибка компилятора C2155](compiler-error-c2155.md)|"?": недопустимый левый операнд, требуется арифметический тип или указателя|
...
|[Ошибка компилятора C2158](compiler-error-c2158.md)|"*тип*": директива #pragma make_public сейчас поддерживается только для собственных нешаблонных типов|
...
|[Ошибка компилятора C2163](compiler-error-c2163.md)|"*функция*": недоступен в качестве подставляемой функции|
...
|Ошибка компилятора C2176|Инструкция return не может находиться в обработчике блока функция try-связанном с конструктором|
|[Ошибка компилятора C2177](compiler-error-c2177.md)|слишком большая константа|
|[Ошибка компилятора C2178](compiler-error-c2178.md)|"*идентификатор*«не может объявляться с»*описатель*" описатель|
...
|[Ошибка компилятора C2183](compiler-error-c2183.md)|Синтаксическая ошибка: преобразования пуст|
...
|Ошибка компилятора C2187|Синтаксическая ошибка: "*маркера*" непредвиденный здесь элемент|
|[Ошибка компилятора C2188](compiler-error-c2188.md)|"*номер*": слишком большое значение для расширенных символов|
|Ошибка компилятора C2189|атрибут «alignas» не может применяться к битовому полю, параметру функции, объявлению исключения или переменная, объявленная с «зарегистрироваться» класс хранения|
...
|[Ошибка компилятора C2193](compiler-error-c2193.md)|"*идентификатор*": уже имеется в сегменте|
...
|[Ошибка компилятора C2196](compiler-error-c2196.md)|значение варианта выбора "*значение*" уже используется|
...
|[Ошибка компилятора C2199](compiler-error-c2199.md)|Синтаксическая ошибка: найдено "*идентификатор* (" в глобальной области видимости (было объявление действительно требовалось?)|
