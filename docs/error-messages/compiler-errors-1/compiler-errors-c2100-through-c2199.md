...
|[Ошибка компилятора C2108](compiler-error-c2108.md)|Индекс не имеет целый тип|
|[Ошибка компилятора C2109](compiler-error-c2109.md)|индекса требуется массив или указатель|
...
|C2176 ошибки компилятора|оператор return не может находиться в обработчике блока function try-связанный с конструктором|
|[Ошибка компилятора C2177](compiler-error-c2177.md)|слишком большая константа|
|[Ошибка компилятора C2178](compiler-error-c2178.md)|"*идентификатор*«не может объявляться с»*описатель*" спецификатор|
...
|[Ошибка компилятора C2183](compiler-error-c2183.md)|Синтаксическая ошибка: Единица преобразования пуста|
