---
title: "Ошибка компилятора C2298 | Microsoft Docs"
ms.custom: ""
ms.date: "12/05/2016"
...
manager: "ghogen"
---
# Ошибка компилятора C2298
[!INCLUDE[vs2017banner](../../assembler/inline/includes/vs2017banner.md)]

'операция' : недопустимая операция с выражением с указателем на функцию\-член  
  
 Выражение с указателем на функцию\-член должно вызывать функцию\-член.  
  
## Пример  
 В следующем примере продемонстрировано возникновение ошибки C2298.  
