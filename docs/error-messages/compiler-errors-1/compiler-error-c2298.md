---
title: Ошибка компилятора C2298 | Документы Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-diagnostics
...
ms.locfileid: "33171886"
---
# <a name="compiler-error-c2298"></a>Ошибка компилятора C2298
«Операция»: Недопустимая операция с указателем на функцию выражение элемента  
  
 Указатель функции члена выражение необходимо вызвать функцию-член.  
