---
title: Ошибка компилятора C2298 | Документация Майкрософт
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-diagnostics
...
ms.locfileid: "46064429"
---
# <a name="compiler-error-c2298"></a>Ошибка компилятора C2298

«Операция»: Недопустимая операция с указателем на член выражение функции

Указатель на функцию член выражение необходимо вызвать функцию-член.
