...
оптимизация, управляемая профилями, недоступна в OpenMP  
 ...
 Вы не сможете связать с [/LTCG: PGI](../../build/reference/ltcg-link-time-code-generation.md) любого модуля, скомпилированного с помощью [/GL](../../build/reference/gl-whole-program-optimization.md).  
