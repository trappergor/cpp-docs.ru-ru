...
|[Ошибка компилятора C2309](compiler-error-c2309.md)|для блока catch требуется объявление исключения в круглых скобках|  
|[Ошибка компилятора C2310](compiler-error-c2310.md)|в блоках catch должен быть указан один тип|  
|[Ошибка компилятора C2311](compiler-error-c2311.md)|"*типа*": перехвачено «...» в строке *номер*|  
...
|C2330 ошибки компилятора|"implementation_key( )" допускается только в области, ограниченной #pragma start_map_region/stop_map_region|  
