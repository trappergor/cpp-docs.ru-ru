...
---
# Неустранимые ошибки компилятора (C999-C1999)
...
|Ошибка|Сообщение|  
|------------|---------------|  
|[Fatal Error C999](../../error-messages/compiler-errors-1/fatal-error-c999.md)|НЕИЗВЕСТНОЕ СООБЩЕНИЕ. Выберите команду "Техническая поддержка" в меню "Справка" Visual C\+\+ или откройте справочный файл технической поддержки для получения дополнительных сведений|  
