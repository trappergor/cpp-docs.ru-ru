---
title: "Ошибка компилятора C2231 | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
---
# Ошибка компилятора C2231
[!INCLUDE[vs2017banner](../../assembler/inline/includes/vs2017banner.md)]

".": левый операнд указывает на "class\-key", используйте "–\>"  
  
 Операнд слева от операции выбора члена \(.\) является указателем, а не классом, структурой или объединением.  
