---
title: Ошибка компилятора C2121 | Документы Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-diagnostics
...
«#»: недопустимый знак: возможный результат раскрытия макроса  
 ...
 Недопустимый знак # мог быть вставлен неправильным макросом, который использует оператор вставки токена (##) вместо строкового оператора (#).