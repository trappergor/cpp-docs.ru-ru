---
title: "СТРУКТУРА (MASM) | Документы Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
Объявляет тип структуры, с указанным *fielddeclarations*. Каждое поле должно быть определение допустимые данные. То же, что [STRUC](../../assembler/masm/struc.md).  
