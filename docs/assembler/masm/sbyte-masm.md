...
Выделяет и инициализирует байт со знаком хранения для каждого `initializer`.  Может также использоваться как описатель типа в любом месте, где допустим тип.  
