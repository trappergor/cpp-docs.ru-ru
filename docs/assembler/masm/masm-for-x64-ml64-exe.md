...
### <a name="to-add-an-assembler-language-file-to-an-existing-visual-studio-c-project"></a>Добавление файла языка ассемблера в существующих Visual Studio C++ проекта
