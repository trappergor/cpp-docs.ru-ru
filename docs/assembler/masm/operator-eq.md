---
title: оператор EQ | Документы Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-masm
...
ms.locfileid: "32056929"
---
# <a name="operator-eq"></a>Оператор EQ
Возвращает значение true (-1), если *expression1* равняется *expression2*, или значение false (0), если это не так.  
