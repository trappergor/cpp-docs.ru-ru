...
При использовании с [. MODEL](../../assembler/masm/dot-model.md)запускает сегмент данных для неинициализированных данных (имя сегмента FAR_BSS или *имя*). (только 32-разрядный MASM.)
