...
|**Параметр/SAFESEH**|Помечает объект как содержащий нет обработчиков исключений или содержащая обработчики исключений, которые объявлены с [. SAFESEH](../../assembler/masm/dot-safeseh.md).<br /><br /> Недоступно в ml64.exe.|  
