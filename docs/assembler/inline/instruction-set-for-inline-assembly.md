---
title: Набор инструкций для встроенного кода на языке ассемблера
ms.date: 08/30/2018
ms.topic: reference
helpviewer_keywords:
...
ms.locfileid: "65445910"
---
# <a name="instruction-set-for-inline-assembly"></a>Набор инструкций для встроенного кода на языке ассемблера

**Блок, относящийся только к системам Microsoft**

Microsoft C++ компилятор поддерживает все коды операций при использовании Pentium 4 и AMD Athlon. Дополнительные инструкции, поддерживаемые целевой процессор могут создаваться с помощью [_emit Pseudoinstruction](../../assembler/inline/emit-pseudoinstruction.md).
